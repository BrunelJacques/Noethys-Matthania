...
def DemanderChoix(parent):
    ...
    titre = _("Quel protocole d'échanges souhaitez-vous utiliser ?")
    intro = _("Cliquez sur le protocole d'échange souhaité afin d'accéder à la fonctionnalité dédiée...")
    listeBoutons = [
        (_("Bordereau PES Recette ORMC"), _("Nouveau type de bordereau Recette ORMC (Ordre de Recette Multi Créanciers) fidèle au nouveau protocole d'échange PES V2 entre les collectivités locales et la DGFIP. Remplace le protocole ROLMRE à partir du 01/02/2014.")),
        (_("Rôle ROLMRE"), _("Le protocole ROLMRE est une procédure d'échanges de données utilisée dans les collectivités qui devient obsolète à partir du 01/02/2014. Au delà de cette date, il faut utiliser le bordereau PES ORMC.")),
        ]
...
def GetXML(dictDonnees={}):
    ...
    Adresse.setAttribute("V", _("Noethys %s") % versionLogiciel)
    ...
    for dictPiece in dictDonnees["pieces"] :
        ...
        cle1 = GetCle_modulo11((dictDonnees["code_collectivite"], dictDonnees["id_bordereau"], dictDonnees["exercice"][-2:], dictDonnees["mois"], "{:0>13}".format(dictPiece["num_dette"])))
        Cle1.setAttribute("V", str(cle1))
        BlocPiece.appendChild(Cle1)
        
        Cle2 = doc.createElement("Cle2")
        cle2 = GetCle_modulo23((dictDonnees["exercice"][-2:], dictDonnees["mois"], "00", "{:0>13}".format(dictPiece["num_dette"])))
...
if __name__ == "__main__":
    ...
    dictDonnees = {
        "nom_fichier" : _("fichier.xml"),
        "date_emission" : "2014-01-06",
        "id_poste" : _("123456"),
        "id_collectivite" : _("1"),
        "code_collectivite" : "2",
        "code_budget" : "1",
        ...
        "id_bordereau" : "5",
        "montant_total" : "22.50",
        "date_envoi" : "2014-01-07",
        "objet_dette" : _("Centre de Loisirs"),
        ...
        "pieces" : [
            {
            "id_piece" : "1",
            "libelle" : _("FACT0000123"),
            "num_dette" : "2013000017",
            "montant" : "10.50",
            "sequence" : "RCUR",
            "prelevement" : 1,
            ...
            "prelevement_titulaire" : _("DUPOND Gérard"),
            "prelevement_libelle" : "prelevement_libelle",
            "titulaire_civilite" : "Mr.",
            "titulaire_nom" : _("DUPOND"),
            "titulaire_prenom" : _("Gérard"),
            "titulaire_rue" : _("10 rue des oiseaux"),
            "titulaire_cp" : "29870",
            "titulaire_ville" : _("LANNILIS"),
            "objet_piece" : "objet",
