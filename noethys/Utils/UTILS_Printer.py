...
import datetime
import GestionDB
from ObjectListView.ListCtrlPrinter import ListCtrlPrinter, ReportFormat
...
class PreviewControlBar(wx.PyPreviewControlBar):
    def __init__(self, preview, buttons, parent):
        ...
        # Impression
        self.staticbox_impression_staticbox = wx.StaticBox(self, -1, _("Impression"))
        ...
        # Impression rapide
        self.staticbox_rapide_staticbox = wx.StaticBox(self, -1, _("Impression rapide"))
        ...
        # Navigation
        self.staticbox_navigation_staticbox = wx.StaticBox(self, -1, _("Navigation"))
...
class MyPreviewFrame(wx.PreviewFrame):
    def __init__(self, *args, **kwargs):
        ...
        liste_controles[0].SetToolTip(wx.ToolTip(_("Imprimer")))
        liste_controles[1].SetToolTip(wx.ToolTip(_("Aller à la première page")))
        liste_controles[2].SetToolTip(wx.ToolTip(_("Aller à la page précédente")))
        liste_controles[5].SetToolTip(wx.ToolTip(_("Aller à la page suivante")))
        liste_controles[6].SetToolTip(wx.ToolTip(_("Aller à la dernière page")))
        liste_controles[7].SetToolTip(wx.ToolTip(_("Zoom arrière")))
        liste_controles[9].SetToolTip(wx.ToolTip(_("Zoom avant")))
