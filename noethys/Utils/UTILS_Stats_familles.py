...
class Texte_nombre_familles(MODELES.Texte):
    ...
    def MAJ(self, DB=None, dictParametres={}):
        ...
        if len(listeDonnees) == 0 or listeDonnees[0][0] == 0 : 
            self.texte = _("Aucune famille dont les membres sont %ss.") % mot
        else:
            self.texte = _("%d familles dont les membres sont %ss.") % (len(listeDonnees), mot)
...
class Tableau_nombre_familles(MODELES.Tableau):
    ...
    def __init__(self):
        ...
        self.nom = _("Répartition du nombre de familles par activité")
    ...
    def MAJ(self, DB=None, dictParametres={}):
        ...
        # Création du tableau
        self.largeur = "400"
        self.colonnes = [ (_("Activité"), "250"), (_("Nombre de familles"), "150") ]
        self.lignes = []
...
class Graphe_nombre_familles(MODELES.Graphe):
    def __init__(self):
        ...
        self.nom = _("Comparatif du nombre de familles")
    ...
    def MAJ(self, figure=None, DB=None, dictParametres={}):
        ...
        # Titre
        title = ax.set_title(_("Comparatif du nombre de familles"), weight="bold", horizontalalignment = 'center')#, position=(0.5, 0.97))
...
class Tableau_repartition_caisses(MODELES.Tableau):
    ...
    def __init__(self):
        MODELES.Tableau.__init__(self)
        self.nom = _("Répartition des familles par caisse")
    ...
    def MAJ(self, DB=None, dictParametres={}):
        ...
        # Création du tableau
        self.largeur = "400"
        self.colonnes = [ (_("Caisse"), "250"), (_("Nombre de familles"), "150") ]
        self.lignes = []
...
class Graphe_repartition_caisses(MODELES.Graphe):
    def __init__(self):
        MODELES.Graphe.__init__(self)
        self.nom = _("Répartition par caisse")
    ...
    def MAJ(self, figure=None, DB=None, dictParametres={}):
        ...
        title = ax.set_title(_("Répartition par caisse"), weight="bold", horizontalalignment = 'center')#, position=(0.5, 0.97))
        matplotlib.pyplot.setp(title, rotation=0, fontsize=9)
        ax.set_aspect(1)
...
class Tableau_nombre_membres(MODELES.Tableau):
    ...
    def __init__(self):
        MODELES.Tableau.__init__(self)
        self.nom = _("Nombre de membres présents")
    ...
    def MAJ(self, DB=None, dictParametres={}):
        ...
        if dictParametres["mode"] == "presents" :
            ...
            self.nom = _("Nombre de membres inscrits")

        # Création du tableau
        self.largeur = "400"
        self.colonnes = [ (_("Nombre de membres"), "250"), (_("Nombre de familles"), "150") ]
        self.lignes = []
...
class Tableau_qf_tarifs(MODELES.Tableau):
    ...
    def __init__(self):
        MODELES.Tableau.__init__(self)
        self.nom = _("Quotients familiaux par tranches de tarifs")
    ...
    def MAJ(self, DB=None, dictParametres={}):
        ...
        # Création du tableau
        self.largeur = "400"
        self.colonnes = [ (_("Tranche QF"), "250"), (_("Nombre de familles"), "150") ]
        self.lignes = []
...
class Tableau_qf_defaut(MODELES.Tableau):
    ...
    def __init__(self):
        MODELES.Tableau.__init__(self)
        self.nom = _("Quotients familiaux par tranches de 100")
...
class Graphe_qf_defaut(MODELES.Graphe):
    ...
    def MAJ(self, figure=None, DB=None, dictParametres={}):
        ...
        # Axe horizontal
        ax.set_xlabel(_("Tranches"), fontsize=8)
        ind = arange(len(listeLabels)) 
        ax.set_xticks(ind + width) 
        ax.set_xticklabels(listeLabels)
        labelsx = ax.get_xticklabels()
