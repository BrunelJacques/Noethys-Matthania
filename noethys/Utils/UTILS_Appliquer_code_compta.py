...
def Appliquer():
    ...
    dlg = wx.TextEntryDialog(None, _("Quel code comptable souhaitez-vous appliquer ?"), _("Sélection d'un code comptable"), "")
    if dlg.ShowModal() == wx.ID_OK:
    ...
    dlg = wx.MessageDialog(None, _("Souhaitez-vous vraiment appliquer le code comptable '%s' aux %d prestations sélectionnées ?\n\n(PS : Cette modification n'aura aucun impact sur les montants facturés)") % (code_compta, nbrePrestations), _("Confirmation"), wx.YES_NO|wx.NO_DEFAULT|wx.CANCEL|wx.ICON_QUESTION)
