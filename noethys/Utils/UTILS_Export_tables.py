...
class Importer():
    ...
    def DemandeChoix(self):
        ...
        dlg = wx.MultiChoiceDialog(None, _("Sélectionnez le contenu à importer :"), _("Importation"), listeContenu)
    ...
    def Ajouter(self, index=0, nbre=0, dictID={}):
        dlgAttente = wx.BusyInfo(_("Merci de patienter..."), None)
        # Importation
        self.dictID = dictID
        self.DB = GestionDB.DB()
...
if __name__ == "__main__":
    ...
    # exportation.Ajouter(ID=2, nom=_("Activité1"))
