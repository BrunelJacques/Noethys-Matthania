...
class Table():
    ...
    def Get_data(self):
        ...
        self.parent.DB.ExecuterReq(req,MsgBox="ExecuterReq")
            ...
            for index, nom_champ in enumerate(listeChamps):
                ...
                if nom_champ not in self.exclure_champs:
                    ...
                    if valeur and nom_champ in self.champs_images:
                        ...
                        nom_fichier_image = "%s.%s" % (uuid.uuid4(), image.format.lower())
...
class Table_structures(Table):
    def Get_data(self):
        return [{"model": "core.Structure", "pk": 1, "fields": {"nom": "Structure par défaut"}},]
...
class Table_individus(Table):
    def __init__(self, parent, **kwds):
        ...
        DB_photos.ExecuterReq(req,MsgBox="ExecuterReq")
...
class Table_prestations(Table):
    def __init__(self, parent, **kwds):
        ...
        parent.DB.ExecuterReq(req,MsgBox="ExecuterReq")
        self.dictFactures = {}
