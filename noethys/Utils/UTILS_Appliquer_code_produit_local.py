...
def Appliquer():
    ...
    dlg = wx.TextEntryDialog(None, _("Quel code produit local souhaitez-vous appliquer ?"), _("Sélection d'un code produit local"), "")
    if dlg.ShowModal() == wx.ID_OK:
    ...
    dlg = wx.MessageDialog(None, _("Souhaitez-vous vraiment appliquer le produit local '%s' aux %d prestations sélectionnées ?\n\n(PS : Cette modification n'aura aucun impact sur les montants facturés)") % (code_produit_local, nbrePrestations), _("Confirmation"), wx.YES_NO|wx.NO_DEFAULT|wx.CANCEL|wx.ICON_QUESTION)
    ...
    # Application
    dlgAttente = wx.BusyInfo(_("Veuillez patienter..."), None)
