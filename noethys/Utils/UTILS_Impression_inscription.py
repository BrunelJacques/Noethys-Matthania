            ...
            if dictValeur["select"] == True:
                ...
                if cadre_principal != None:
                    ...
                    if "intro" in DICT_OPTIONS and DICT_OPTIONS["intro"] != None or "tableau" in DICT_OPTIONS and DICT_VALEURS["tableau"] == True:
                        ...
                        dataTableau.append((_("Confirmation d'inscription"),))
                    ...
                    if "tableau" in DICT_OPTIONS and DICT_OPTIONS["tableau"] == True:
                        ...
                        dataTableau.append((_("Nom"), Paragraph(DICT_VALEURS["{INDIVIDU_NOM}"], paraStyle)))
                        dataTableau.append((_("Prénom"), Paragraph(DICT_VALEURS["{INDIVIDU_PRENOM}"], paraStyle)))
                        dataTableau.append((_("Activité"), Paragraph(DICT_VALEURS["{ACTIVITE_NOM_LONG}"], paraStyle)))
                        dataTableau.append((_("Groupe"), Paragraph(DICT_VALEURS["{GROUPE_NOM_LONG}"], paraStyle)))
                        dataTableau.append((_("Catégorie"), Paragraph(DICT_VALEURS["{NOM_CATEGORIE_TARIF}"], paraStyle)))
