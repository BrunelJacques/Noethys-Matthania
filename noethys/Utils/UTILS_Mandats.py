...
ERREUR1 = _("Le mandat n'a pas été utilisé durant plus de 36 mois. Il faut donc refaire un nouveau mandat.")
ERREUR2 = _("Ce mandat ponctuel a déjà été utilisé une fois. Il faut refaire un nouveau mandat.")

LISTE_SEQUENCES = [
    (_("Automatique"), "auto"),
    (_("Prélèvement ponctuel (OOFF)"), "OOFF"),
    (_("Premier prélèvement d'une série (FRST)"), "FRST"),
    (_("Prélèvement suivant d'une série (RCUR)"), "RCUR"),
    (_("Dernier prélèvement d'une série (FNAL)"), "FNAL"),
    ]
