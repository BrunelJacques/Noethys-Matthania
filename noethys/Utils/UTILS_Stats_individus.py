...
def GetDictGenres(DB, dictParametres) :
    ...
    dictGenres = { 
        "M" : {"quantite" : 0, "label1" : _("Garçons"), "label2" : _("garçons"), "couleur" : (134, 172, 253) },
        "F" : {"quantite" : 0, "label1" : _("Filles"), "label2" : _("filles"), "couleur" : (253, 172, 220) },
        "None" : {"quantite" : 0, "label1" : _("N.C."), "label2" : _("individus dont le genre est inconnu"), "couleur" : (170, 170, 170) },
        }
...
def GetListeActivitesPro(DB, dictParametres) :
    ...
    for IDcategorie, nomCategorie, IDindividu in listeDonnees :
        if nomCategorie == None :
            nomCategorie = _("Catégorie inconnue")
...
def GetListeNiveauxScolaires(DB, dictParametres) :
    ...
    for IDniveau, ordre, nomNiveau, IDindividu in listeDonnees :
        if nomNiveau == None : nomNiveau = _("Niveau inconnu")
...
class Texte_nombre_individus(MODELES.Texte):
    ...
    def MAJ(self, DB=None, dictParametres={}):
        ...
        if len(listeDonnees) == 0 or listeDonnees[0][0] == 0 : 
            self.texte = _("Aucun individu %s.") % mot
        else:
            self.texte = _("%d individus %ss.") % (len(listeDonnees), mot)
...
class Tableau_nombre_individus(MODELES.Tableau):
    ...
    def __init__(self):
        ...
        self.nom = _("Répartition du nombre d'individus par activité")
    ...
    def MAJ(self, DB=None, dictParametres={}):
        ...
        # Création du tableau
        self.largeur = "400"
        self.colonnes = [ (_("Activité"), "250"), (_("Nombre d'individus"), "150") ]
        self.lignes = []
...
class Graphe_nombre_individus(MODELES.Graphe):
    def __init__(self):
        ...
        self.nom = _("Comparatif du nombre d'individus")
    ...
    def MAJ(self, figure=None, DB=None, dictParametres={}):
        ...
        # Titre
        title = ax.set_title(_("Comparatif du nombre d'individus"), weight="bold", horizontalalignment = 'center')#, position=(0.5, 0.97))
...
class Tableau_repartition_genre(MODELES.Tableau):
    ...
    def __init__(self):
        MODELES.Tableau.__init__(self)
        self.nom = _("Répartition par genre")
    ...
    def MAJ(self, DB=None, dictParametres={}):
        ...
        # Création du tableau
        self.largeur = "400"
        self.colonnes = [ (_("Genre"), "250"), (_("Nombre d'individus"), "150") ]
        self.lignes = []
...
class Graphe_repartition_genre(MODELES.Graphe):
    ...
    def MAJ(self, figure=None, DB=None, dictParametres={}):
        ...
        title = ax.set_title(_("Répartition par genre"), weight="bold", horizontalalignment = 'center')#, position=(0.5, 0.97))
        matplotlib.pyplot.setp(title, rotation=0, fontsize=9)
        ax.set_aspect(1)
...
class Tableau_repartition_ages(MODELES.Tableau):
    ...
    def __init__(self):
        MODELES.Tableau.__init__(self)
        self.nom = _("Répartition des individus par âge")
    ...
    def MAJ(self, DB=None, dictParametres={}):
        ...
        # Création du tableau
        self.largeur = "400"
        self.colonnes = [ (_("Age"), "250"), (_("Nombre d'individus"), "150") ]
        self.lignes = []
        ...
        for age in listeAges :
            ...
            if age == None : 
                age = _("Date de naissance inconnue")
            else :
                age = str(age)
...
class Graphe_repartition_ages(MODELES.Graphe):
    ...
    def MAJ(self, figure=None, DB=None, dictParametres={}):
        ...
        # Axe horizontal
        ax.set_xlabel(_("Ages"), fontsize=8)
        ind = arange(len(listeLabels)) 
        ax.set_xticks(ind + width) 
        ax.set_xticklabels(listeLabels)
        labelsx = ax.get_xticklabels()
        ...
        # Titre
        title = ax.set_title(_("Répartition par âge"), weight="bold", horizontalalignment = 'center')#, position=(0.5, 0.97))
        matplotlib.pyplot.setp(title, rotation=0, fontsize=9)
...
class Tableau_repartition_annees_naiss(MODELES.Tableau):
    ...
    def __init__(self):
        MODELES.Tableau.__init__(self)
        self.nom = _("Répartition des individus par année de naissance")
    ...
    def MAJ(self, DB=None, dictParametres={}):
        ...
        # Création du tableau
        self.largeur = "400"
        self.colonnes = [ (_("Année de naissance"), "250"), (_("Nombre d'individus"), "150") ]
        self.lignes = []
        ...
        for annee in listeAnnees :
            ...
            if annee == None : 
                annee = _("Année de naissance inconnue")
            else :
                annee = str(annee)
...
class Graphe_repartition_annees_naiss(MODELES.Graphe):
    ...
    def MAJ(self, figure=None, DB=None, dictParametres={}):
        ...
        # Axe horizontal
        ax.set_xlabel(_("Années"), fontsize=8)
        ...
        # Titre
        title = ax.set_title(_("Répartition par année de naissance"), weight="bold", horizontalalignment = 'center')#, position=(0.5, 0.97))
        matplotlib.pyplot.setp(title, rotation=0, fontsize=9)
...
class Tableau_repartition_villes(MODELES.Tableau):
    ...
    def __init__(self):
        MODELES.Tableau.__init__(self)
        self.nom = _("Répartition des individus par ville de résidence")
    ...
    def MAJ(self, DB=None, dictParametres={}):
        ...
        # Création du tableau
        self.largeur = "400"
        self.colonnes = [ (_("Ville de résidence"), "210"), (_("Distance"), "70"), (_("Nombre d'individus"), "120") ]
        self.lignes = []
...
class Graphe_repartition_villes(MODELES.Graphe):
    def __init__(self):
        MODELES.Graphe.__init__(self)
        self.nom = _("Répartition par ville de résidence")
    ...
    def MAJ(self, figure=None, DB=None, dictParametres={}):
        ...
        if len(listeVilles) > nbreMax :
            ...
            listeVilles.append((nbreAutres, _("Autres")))
        ...
        cam = ax.pie(listeValeurs, labels=listeLabels, colors=listeCouleurs, autopct='%1.1f%%', shadow=False)
        title = ax.set_title(_("Répartition par ville"), weight="bold", horizontalalignment = 'center')#, position=(0.5, 0.97))
        matplotlib.pyplot.setp(title, rotation=0, fontsize=9)
        ax.set_aspect(1)
        labels, labelsPourcent = cam[1], cam[2]
        matplotlib.pyplot.setp(labels, rotation=0, fontsize=9) 
...
##        self.nom = _("Distances et répartition par ville")
...
##
##        title = ax.set_title(_("Distances entre les villes"), weight="bold", horizontalalignment = 'center')#, position=(0.5, 0.97))
##        matplotlib.pyplot.setp(title, rotation=0, fontsize=9)
##
...
class Tableau_activites_professionnelles(MODELES.Tableau):
    ...
    def __init__(self):
        MODELES.Tableau.__init__(self)
        self.nom = _("Répartition des individus par activité professionnelle")
    ...
    def MAJ(self, DB=None, dictParametres={}):
        ...
        # Création du tableau
        self.largeur = "400"
        self.colonnes = [ (_("Activité professionnelle"), "250"), (_("Nombre d'individus"), "150") ]
        self.lignes = []
...
class Graphe_activites_professionnelles(MODELES.Graphe):
    def __init__(self):
        MODELES.Graphe.__init__(self)
        self.nom = _("Répartition par activité professionnelle")
    ...
    def MAJ(self, figure=None, DB=None, dictParametres={}):
        ...
        cam = ax.pie(listeValeurs, labels=listeLabels, colors=listeCouleurs, autopct='%1.1f%%', shadow=False)
        title = ax.set_title(_("Répartition par activité professionnelle"), weight="bold", horizontalalignment = 'center')#, position=(0.5, 0.97))
        matplotlib.pyplot.setp(title, rotation=0, fontsize=9)
        ax.set_aspect(1)
        labels, labelsPourcent = cam[1], cam[2]
        matplotlib.pyplot.setp(labels, rotation=0, fontsize=9) 
...
class Tableau_nouveaux_individus(MODELES.Tableau):
    ...
    def __init__(self):
        MODELES.Tableau.__init__(self)
        self.nom = _("Nouveaux individus (selon le premier jour de présence)")
    ...
    def MAJ(self, DB=None, dictParametres={}):
        ...
        # Création du tableau
        self.largeur = "400"
        self.colonnes = [ (_("Mois"), "250"), (_("Nombre d'individus"), "150") ]
        self.lignes = []
        
        for annee, mois in listeMoisPeriode :
            if (annee, mois) in dictResultats :
                label = "%s %s" % (MODELES.LISTE_NOMS_MOIS[mois-1], annee)
...
class Graphe_nouveaux_individus(MODELES.Graphe):
    ...
    def MAJ(self, figure=None, DB=None, dictParametres={}):
        ...
        # Axe vertical
        ax.set_ylabel(_("Nbre d'individus"), fontsize=8)
        
        labels = ax.get_yticklabels()
        matplotlib.pyplot.setp(labels, rotation=0, fontsize=9) 
        
        # Titre
        title = ax.set_title(_("Nouveaux individus sur la période"), weight="bold", horizontalalignment = 'center')#, position=(0.5, 0.97))
        matplotlib.pyplot.setp(title, rotation=0, fontsize=9)
...
class Graphe_arrivee_individus(MODELES.Graphe):
    def __init__(self):
        MODELES.Graphe.__init__(self)
        self.nom = _("Arrivée des individus présents")
...
##            ax.plot(listeX, ligne, color='red', lw=1, label=_("Evolution moyenne"))

        # Titre
        title = ax.set_title(_("Arrivée des individus présents"), weight="bold", horizontalalignment = 'center')#, position=(0.5, 0.97))
        matplotlib.pyplot.setp(title, rotation=0, fontsize=9)
...
class Tableau_repartition_ecoles(MODELES.Tableau):
    ...
    def __init__(self):
        MODELES.Tableau.__init__(self)
        self.nom = _("Répartition des individus par école <BR>(au premier jour de la période)")
    ...
    def MAJ(self, DB=None, dictParametres={}):
        ...
        # Création du tableau
        self.largeur = "400"
        self.colonnes = [ (_("Ecole"), "250"), (_("Nombre d'individus"), "150") ]
        self.lignes = []
...
class Graphe_repartition_ecoles(MODELES.Graphe):
    ...
    def MAJ(self, figure=None, DB=None, dictParametres={}):
        ...
        cam = ax.pie(listeValeurs, labels=listeLabels, colors=listeCouleurs, autopct='%1.1f%%', shadow=False)
        title = ax.set_title(_("Répartition des individus par école"), weight="bold", horizontalalignment = 'center')#, position=(0.5, 0.97))
        matplotlib.pyplot.setp(title, rotation=0, fontsize=9)
        ax.set_aspect(1)
        labels, labelsPourcent = cam[1], cam[2]
        matplotlib.pyplot.setp(labels, rotation=0, fontsize=9) 
...
class Tableau_repartition_niveaux_scolaires(MODELES.Tableau):
    ...
    def __init__(self):
        MODELES.Tableau.__init__(self)
        self.nom = _("Répartition des individus par niveau scolaire <BR>(au premier jour de la période)")
    ...
    def MAJ(self, DB=None, dictParametres={}):
        ...
        # Création du tableau
        self.largeur = "400"
        self.colonnes = [ (_("Niveau scolaire"), "250"), (_("Nombre d'individus"), "150") ]
        self.lignes = []
...
class Graphe_repartition_niveaux_scolaires(MODELES.Graphe):
    ...
    def MAJ(self, figure=None, DB=None, dictParametres={}):
        ...
        cam = ax.pie(listeValeurs, labels=listeLabels, colors=listeCouleurs, autopct='%1.1f%%', shadow=False)
        title = ax.set_title(_("Répartition des individus par niveau scolaire"), weight="bold", horizontalalignment = 'center')#, position=(0.5, 0.97))
        matplotlib.pyplot.setp(title, rotation=0, fontsize=9)
        ax.set_aspect(1)
        labels, labelsPourcent = cam[1], cam[2]
        matplotlib.pyplot.setp(labels, rotation=0, fontsize=9) 
...
if __name__ == '__main__':
    ...
    dictParametres = {
        ...
        "dictActivites" : {1 : _("Centre de Loisirs"), 2 : _("Action 10-14 ans"), 3 : _("Camp 4-6 ans"), 4 : _("Camp 6-9 ans"), 5 : _("Camp 10-14 ans"), 6 : _("Art floral"), 7 : _("Yoga")},
        }
