...
##            texte = _("IDindividu %d") % IDindividu
##            categorie = None
##            description = _("IDunite%d - IDgroupe%d") % (IDunite, IDgroupe)
##            icon = None
##            
...
##        catExemple = Category(_("Catégorie Exemple"), (0, 255, 0), True)
...
##        description = _("Ceci est la description de l'event 1")
