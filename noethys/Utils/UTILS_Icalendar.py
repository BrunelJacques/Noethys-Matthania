...
class Calendrier():
    ...
    def RechercheElement(self, component=None, nom="DTSTART", type="date"):
        ...
        if nom in component :
            ...
            if type == "texte" : return "%s" % component[nom]
        else :
            return None
    ...
    def GetVacances(self):
        ...
        listeCorrespondances = [
            (_("hiver"), _("Février")),
            (_("printemps"), _("Pâques")),
            (_("Toussaint"), _("Toussaint")),
            (_("Noël"), _("Noël")),
            ]
        ...
        for annee, dictDates in dictTemp.items() :
            if dictDates["date_debut"] != None and dictDates["date_fin"] != None :
                listeResultats.append({"annee" : annee, "nom" : _("Eté"), "date_debut" : dictDates["date_debut"], "date_fin" : dictDates["date_fin"]})
