...
class Calendrier():
    ...
    def GetVacances(self):
        ...
        for item in self.data:
            if item["fields"]["zones"] == "Zone %s" % self.zone.upper() and "end_date" in item["fields"] and "Enseignants" not in item["fields"].get("population", ""):
                ...
                if "Hiver" in description: nom = "Février"
                elif "Printemps" in description: nom = "Pâques"
                elif "Été" in description: nom = "Eté"
                elif "Toussaint" in description: nom = "Toussaint"
                elif "Noël" in description: nom = "Noël"
                else: nom = None
