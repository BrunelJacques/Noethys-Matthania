...
class Dialog(wx.Dialog):
    def __init__(self, parent, IDfamille=None):
        ...
        self.SetTitle(_("Saisie du RIB"))
                                
        # RIB
        self.box_rib_staticbox = wx.StaticBox(self, -1, _("Coordonnées bancaires"))
        
        self.label_cle_iban = wx.StaticText(self, -1, _("Clé IBAN"))
        self.label_etab = wx.StaticText(self, -1, _("Etab."))
        self.label_guichet = wx.StaticText(self, -1, _("Guichet"))
        self.label_numero = wx.StaticText(self, -1, _("Compte"))
        self.label_cle_rib = wx.StaticText(self, -1, _("Clé RIB"))
        
        self.ctrl_cle_iban = wx.TextCtrl(self, -1, _("FR76"), style=wx.TE_CENTRE)
        ...
        self.ctrl_cle_rib = wx.TextCtrl(self, -1, "", style=wx.TE_CENTRE, validator = MyValidator())
        ...
        # Mémo
        self.box_memo_staticbox = wx.StaticBox(self, -1, _("Observations"))
    ...
    def __set_properties(self):
        ...
        self.ctrl_cle_rib.SetToolTip(wx.ToolTip(_("Saisissez ici la clé RIB")))
    ...
    def ControleRIB(self):
        ...
        rib = "%s%s%s%s" % (etab, guichet, numero, cle)
    ...
    def OnBoutonOk(self, event):
        ...
        if self.radio_membre.GetValue() == True :
            if IDindividu == None :
                dlg = wx.MessageDialog(self, _("Il est impossible d'activer le prélèvement :\nVous n'avez pas sélectionné de titulaire du compte bancaire !"), _("Erreur de saisie"), wx.OK | wx.ICON_EXCLAMATION)
                dlg.ShowModal()
                dlg.Destroy()
            ...
            if nom == "" or rue == "" or cp == "" or ville == "" or cp == None or ville == None :
                dlg = wx.MessageDialog(self, _("Il est impossible d'activer le prélèvement :\nVous n'avez pas renseigné le titulaire du compte bancaire !"), _("Erreur de saisie"), wx.OK | wx.ICON_EXCLAMATION)
                dlg.ShowModal()
                dlg.Destroy()
