...
class DLG_Question(wx.Dialog):
    def __init__(self, interface, message=u"", icone=None, couleurClaire=wx.Colour(206, 196, 190), couleurFoncee=wx.Colour(169, 156, 146),
                                        bouton_non=True, texte_non=_("Non"), image_non="Efface.png",
                                        bouton_oui=True, texte_oui=_("Oui"), image_oui="Validation.png",
...
##        self.label_message = wx.StaticText(self, -1, "\n".join(message))
        ...
        # Boutons
        self.ctrl_non = GB.GradientButton(self, -1, wx.Bitmap(Chemins.GetStaticPath("Images/Badgeage/%s" % image_non), wx.BITMAP_TYPE_ANY), " %s " % texte_non)
        ...
        self.ctrl_oui = GB.GradientButton(self, -1, wx.Bitmap(Chemins.GetStaticPath("Images/Badgeage/%s" % image_oui), wx.BITMAP_TYPE_ANY), " %s " % texte_oui)
        ...
        self.label_attente = wx.StaticText(self, -1, _("Veuillez patienter..."))
...
class DLG_Choix(DLG_Question):
    ...
    def __init__(self, interface=None, message="", listeItems=[], multiSelection=True):
        DLG_Question.__init__(self, interface, message, icone="question", texte_non=_("Annuler"), texte_oui=_("Ok"),
...
##    dlg1 = DLG_Message(None, message="Bonjour Kévin", icone="commentaire", secondes=2)
    ...
    # Version QUESTION
##    dlg = DLG_Question(None, message=_("Restes-tu manger à la cantine ce midi ?"), icone="question")
...
##    dlg.Destroy()
    ...
    # Version CHOIX
    listeItems = [_("Choix 1"), _("Choix 2"), _("Choix 3")]
    dlg = DLG_Choix(None, message=_("Quel choix ?"), listeItems=listeItems, multiSelection=False)
    if dlg.ShowModal() == wx.ID_YES :
