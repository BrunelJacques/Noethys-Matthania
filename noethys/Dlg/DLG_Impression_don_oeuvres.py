...
class Dialog(wx.Dialog):
    def __init__(self, parent, IDcotisation=None):
        ...
        # Bénéficiaire
        self.stbBenefic = wx.StaticBox(self, -1, _("Bénéficiaire"))
        self.label_nom_beneficiaire = wx.StaticText(self.stbBenefic, -1, _("Nom :"))
        self.ctrl_nom_beneficiaire = wx.TextCtrl(self.stbBenefic, -1, "")
        self.label_adresse_beneficiaire = wx.StaticText(self.stbBenefic, -1, _("Adresse :"))
        self.ctrl_adresse_beneficiaire = wx.TextCtrl(self.stbBenefic, -1, "")
        self.label_objet = wx.StaticText(self.stbBenefic, -1, _("Objet :"))
        self.ctrl_objet = wx.TextCtrl(self.stbBenefic, -1, "")
        self.label_type = wx.StaticText(self.stbBenefic, -1, _("Type :"))
        self.ctrl_type = wx.TextCtrl(self.stbBenefic, -1, "")
        
        # Donateur
        self.stbDonateur = wx.StaticBox(self, -1, _("Donateur"))
        self.label_nom_donateur = wx.StaticText(self.stbDonateur, -1, _("Nom :"))
        self.radio_nom_auto = wx.RadioButton(self.stbDonateur, -1, "", style=wx.RB_GROUP)
        self.ctrl_nom_auto = Choix_donateur(self.stbDonateur)
        self.radio_nom_autre = wx.RadioButton(self.stbDonateur, -1, _("Autre :"))
        self.ctrl_nom_autre = wx.TextCtrl(self.stbDonateur, -1, "")
        self.label_adresse_donateur = wx.StaticText(self.stbDonateur, -1, _("Adresse :"))
        self.ctr_adresse_donateur = wx.TextCtrl(self.stbDonateur, -1, "")
        
        # Versement
        self.stbVersmt = wx.StaticBox(self, -1, _("Versement"))
        self.label_date_versement = wx.StaticText(self.stbVersmt, -1, _("Date :"))
        self.ctrl_date_versement = CTRL_Saisie_date.Date2(self.stbVersmt)
        self.label_mode_versement = wx.StaticText(self.stbVersmt, -1, _("Mode :"))
        self.radio_mode_auto = wx.RadioButton(self.stbVersmt, -1, "", style=wx.RB_GROUP)
        self.ctrl_mode_auto = CTRL_Mode(self.stbVersmt)
        self.radio_mode_autre = wx.RadioButton(self.stbVersmt, -1, _("Autre :"))
        self.ctrl_mode_autre = wx.TextCtrl(self.stbVersmt, -1, "")
        
        # Mémorisation des paramètres de l'organisme bénéficiaire
        self.ctrl_memoriser_organisme = wx.CheckBox(self, -1, _("Mémoriser l'organisme bénéficiaire"))
        font = self.GetFont() 
        font.SetPointSize(7)
        ...
        # Date édition
        self.label_date_edition = wx.StaticText(self, -1, _("Date d'édition :"))
    ...
    def __set_properties(self):
        self.SetTitle(_("Edition d'un reçu Dons aux Oeuvres"))
        self.ctrl_memoriser_organisme.SetToolTip(wx.ToolTip(_("Cochez cette case pour ne pas avoir à re-saisir les données sur l'organisme la prochaine fois !")))
        ...
        self.ctrl_nom_auto.SetToolTip(wx.ToolTip(_("Sélectionnez un destinataire")))
        ...
        self.ctrl_mode_auto.SetToolTip(wx.ToolTip(_("Sélectionnez ici le mode de versement")))
        self.ctrl_mode_autre.SetToolTip(wx.ToolTip(_("Saisissez ici un autre mode de versement")))
        self.ctrl_date_edition.SetToolTip(wx.ToolTip(_("Saisissez ici la date d'édition du document")))
    ...
    def __do_layout(self):
        ...
        staticbox_versement = wx.StaticBoxSizer(self.stbVersmt, wx.VERTICAL)
        ...
        staticbox_donateur = wx.StaticBoxSizer(self.stbDonateur, wx.VERTICAL)
        ...
        staticbox_beneficiaire = wx.StaticBoxSizer(self.stbBenefic, wx.VERTICAL)
    ...
    def OnBoutonEmail(self, event): 
        ...
        UTILS_Envoi_email.EnvoiEmailFamilles(parent=self, IDfamille=self.IDfamille, nomDoc=FonctionsPerso.GenerationNomDoc("RECUDONAUXOEUVRES", "pdf"), categorie="recu_don_oeuvres")
    ...
    def CreationPDF(self, nomDoc=FonctionsPerso.GenerationNomDoc("RECUDONAUXOEUVRES", "pdf"), afficherDoc=True):
        ...
        if self.totalVentilation < self.montant :
            dlg = wx.MessageDialog(self, _("Cette cotisation n'a pas été réglée en intégralité.\n\nSouhaitez-vous quand même l'éditer ?"), _("Confirmation"), wx.YES_NO|wx.NO_DEFAULT|wx.CANCEL|wx.ICON_EXCLAMATION)
