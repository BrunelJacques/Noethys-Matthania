...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        self.staticbox_identite_staticbox = wx.StaticBox(self, -1, _("Nom"))
    ...
    def __set_properties(self):
        self.SetTitle(_("Saisie d'un établissement bancaire"))
        self.ctrl_nom.SetToolTip(wx.ToolTip(_("Saisissez le nom de l'établissement")))
        self.ctrl_rue.SetToolTip(wx.ToolTip(_("Saisissez la rue de l'établissement")))
    ...
    def OnBoutonOk(self, event):
        if self.GetNom() == "" :
            dlg = wx.MessageDialog(self, _("Vous n'avez saisi aucun nom pour cet établissement !"), _("Erreur de saisie"), wx.OK | wx.ICON_EXCLAMATION)
            dlg.ShowModal()
            dlg.Destroy()
