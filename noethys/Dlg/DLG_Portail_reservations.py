...
class Dialog(wx.Dialog):
    def __init__(self, parent, track=None):
        ...
        # Bandeau
        intro = _("Vous pouvez gérer ici la demande de façon manuelle. Commencez par cliquer sur le bouton 'Appliquer la demande' pour voir apparaître les modifications demandées dans la grille des conso. Vous pouvez alors effectuer manuellement d'éventuelles modifications avant de valider.")
        titre = _("Traitement manuel des réservations")
        self.SetTitle(titre)
        ...
        # Facturation
        self.box_facturation_staticbox = wx.StaticBox(self, wx.ID_ANY, _("Facturation"))
        ...
        # Grille
        self.box_grille_staticbox = wx.StaticBox(self, wx.ID_ANY, _("Grille des consommations"))
        ...
        if self.ctrl_grille.grille.tarifsForfaitsCreditsPresents:
            self.box_forfaits_staticbox = wx.StaticBox(self, wx.ID_ANY, _("Forfaits-crédits"))
    ...
    def OnBoutonOutils(self, event):
        ...
        item = wx.MenuItem(menuPop, 10, _("Recalculer toutes les prestations"), _("Recalculer toutes les prestations"))
        ...
        item = wx.MenuItem(menuPop, 20, _("Imprimer la liste des réservations"), _("Imprimer la liste des réservations affichées"))
        ...
        item = wx.MenuItem(menuPop, 30, _("Envoyer la liste des réservations par Email"), _("Envoyer la liste des réservations affichées par Email"))
