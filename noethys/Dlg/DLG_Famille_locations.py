...
class Panel(wx.Panel):
    ...
    def InitLabelbook(self):
        self.listePages = [
            (_("locations"), _("Locations"), Page_locations(self, self.IDfamille), wx.Bitmap(Chemins.GetStaticPath('Images/32x32/Location.png'), wx.BITMAP_TYPE_PNG)),
            (_("demandes"), _("Demandes"), Page_demandes(self, self.IDfamille), wx.Bitmap(Chemins.GetStaticPath('Images/32x32/Location_demande.png'), wx.BITMAP_TYPE_PNG)),
            ]
