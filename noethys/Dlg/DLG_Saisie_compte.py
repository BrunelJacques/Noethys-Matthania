...
class Dialog(wx.Dialog):
    def __init__(self, parent, IDcompte=None, defaut=0):
        ...
        self.label_nom = wx.StaticText(self, -1, _("Intitulé :"))
        self.ctrl_nom = wx.TextCtrl(self, -1, "")
        self.label_numero = wx.StaticText(self, -1, _("Numéro :"))
        self.ctrl_numero = wx.TextCtrl(self, -1, "")
        
        # Coordonnées bancaires
        self.box_infos_staticbox = wx.StaticBox(self, -1, _("Coordonnées bancaires"))
        self.label_info = wx.StaticText(self, -1,
                                        _("(Ces informations sont uniquement nécessaires pour les prélèvements automatiques)"))
        self.label_raison = wx.StaticText(self, -1, _("Raison sociale :"))
        self.ctrl_raison = wx.TextCtrl(self, -1, "")
        
        self.label_etab = wx.StaticText(self, -1, _("N° Etab. :"))
        self.ctrl_etab = wx.TextCtrl(self, -1, "")
        self.label_guichet = wx.StaticText(self, -1, _("N° Guichet :"))
        self.ctrl_guichet = wx.TextCtrl(self, -1, "")
        
        self.label_cle_rib = wx.StaticText(self, -1, _("Clé RIB :"))
        self.ctrl_cle_rib = wx.TextCtrl(self, -1, "")
        self.label_cle_iban = wx.StaticText(self, -1, _("Clé IBAN :"))
        self.ctrl_cle_iban = wx.TextCtrl(self, -1, _("FR76"))
                
        self.label_iban = wx.StaticText(self, -1, _("N° IBAN :"))
        self.ctrl_iban = wx.TextCtrl(self, -1, "")
        ...
        self.label_bic = wx.StaticText(self, -1, _("N° BIC :"))
        self.ctrl_bic = wx.TextCtrl(self, -1, "")
        
        self.label_nne = wx.StaticText(self, -1, _("N°Compta :"))
        self.ctrl_nne = wx.TextCtrl(self, -1, "")
        self.label_ics = wx.StaticText(self, -1, _("N° ICS :"))
        self.ctrl_ics = wx.TextCtrl(self, -1, "")

        # Compte DFT
        self.box_dft_staticbox = wx.StaticBox(self, -1, _("Compte DFT"))
        self.label_dft_titulaire = wx.StaticText(self, -1, _("Titulaire du compte :"))
        self.ctrl_dft_titulaire = wx.TextCtrl(self, -1, "")
        self.label_dft_iban = wx.StaticText(self, -1, _("N° IBAN DFT :"))
        self.ctrl_dft_iban = wx.TextCtrl(self, -1, "")
    ...
    def __set_properties(self):
        self.SetTitle(_("Saisie d'un compte bancaire"))
        self.ctrl_numero.SetMinSize((200, -1))
        self.label_info.SetForegroundColour(wx.Colour(180, 180, 180))
        self.label_info.SetFont(wx.Font(7, wx.DEFAULT, wx.NORMAL, wx.NORMAL, 0, ""))
        self.ctrl_nom.SetToolTip(wx.ToolTip(_("Saisissez un intitulé pour ce compte (Ex : 'Compte crèche')")))
        self.ctrl_numero.SetToolTip(wx.ToolTip(_("Saisissez le numéro de compte")))
        self.ctrl_raison.SetToolTip(wx.ToolTip(_("Saisissez la raison sociale de l'organisme (Ex : 'Centre social'")))
        self.ctrl_etab.SetToolTip(wx.ToolTip(_("Saisissez le code établissement du compte")))
        self.ctrl_guichet.SetToolTip(wx.ToolTip(_("Saisissez le code guichet du compte")))
        self.ctrl_cle_rib.SetToolTip(wx.ToolTip(_("Saisissez la clé RIB du compte")))
        self.ctrl_cle_iban.SetToolTip(wx.ToolTip(_("Saisissez la clé IBAN du compte (FR76 pour la France)")))
        self.ctrl_bic.SetToolTip(wx.ToolTip(_("Saisissez le numéro BIC du compte")))
        self.ctrl_iban.SetToolTip(wx.ToolTip(_("Saisissez le numéro IBAN du compte")))
        self.ctrl_controle_iban.SetToolTip(
            _("Une coche verte apparaît si les coordonnées bancaires sont valides"))
        self.ctrl_nne.SetToolTip(
            _("Code comptable de l'organisme qui sera appliqué par défaut aux dépots"))
        self.ctrl_ics.SetToolTip(wx.ToolTip(_("Saisissez le code ICS de l'organisme (pour les prélèvements automatiques SEPA)")))
        self.ctrl_dft_titulaire.SetToolTip(wx.ToolTip(_("Saisissez le nom du titulaire du compte DFT")))
        self.ctrl_dft_iban.SetToolTip(wx.ToolTip(_("Saisissez le numéro IBAN du compte DFT")))
    ...
    def Sauvegarde(self):
        ...
        if nom == "" :
            dlg = wx.MessageDialog(self, _("Vous devez obligatoirement saisir un nom pour ce compte !"), _("Erreur"), wx.OK | wx.ICON_EXCLAMATION)
            dlg.ShowModal()
            dlg.Destroy()
        ...
        if numero == "" :
            dlg = wx.MessageDialog(self, _("Etes-vous sûr de ne pas saisir de numéro de compte ?"), _("Confirmation"), wx.YES_NO|wx.NO_DEFAULT|wx.CANCEL|wx.ICON_QUESTION)
