...
class CTRL_Cocher(platebtn.PlateButton):
    def __init__(self, parent, ctrl_liste=None):
        platebtn.PlateButton.__init__(self, parent, -1, " Cocher", wx.Bitmap(Chemins.GetStaticPath("Images/16x16/Cocher.png"), wx.BITMAP_TYPE_ANY))
        self.SetToolTip(wx.ToolTip(_("Cliquez ici pour cocher ou décocher rapidement tous les éléments de cette liste")))
        self.ctrl_liste = ctrl_liste
        self.SetBackgroundColour(wx.WHITE)

        menu = UTILS_Adaptations.Menu()
        item = wx.MenuItem(menu, 10, "Tout cocher", "Cliquez ici pour cocher tous les éléments de la liste")
        item.SetBitmap(wx.Bitmap(Chemins.GetStaticPath("Images/16x16/Cocher.png"), wx.BITMAP_TYPE_ANY))
        menu.AppendItem(item)
        item = wx.MenuItem(menu, 20, "Tout décocher", "Cliquez ici pour décocher tous les éléments de la liste")
...
class CTRL_Activites(HTL.HyperTreeList):
    def __init__(self, parent): 
        ...
        self.SetToolTip(wx.ToolTip(_("Cochez les activités et groupes à afficher")))
        
        # Création des colonnes
        self.AddColumn(_("Activité/groupe"))
...
class CTRL_Ecoles(HTL.HyperTreeList):
    def __init__(self, parent): 
        ...
        self.SetToolTip(wx.ToolTip(_("Cochez les écoles et classes à afficher")))
        
        # Création des colonnes
        self.AddColumn(_("Ecole/classe"))
            ...
            if self.regroupement == "ecole" or (self.regroupement == "classe" and len(dictEcole["classes"]) > 0) :
                ...
                if len(listeClasses) > 0 :
                    ...
                    for listeOrdresNiveaux, nomClasse, txtNiveaux, IDclasse, date_debut, date_fin in listeClasses :
                        nomSaison = _("Du %s au %s") % (UTILS_Dates.DateEngFr(str(date_debut)), UTILS_Dates.DateEngFr(str(date_fin)) )
                        labelClasse = "%s (%s)" % (nomClasse, nomSaison)
...
class Page_Activites(wx.Panel):
    def __init__(self, parent):
        ...
        self.label_saut_activites = wx.StaticText(self, -1, _("Sauts de page :"))
        self.checkbox_saut_activites = wx.CheckBox(self, -1, _("Après l'activité"))
        self.checkbox_saut_groupes = wx.CheckBox(self, -1, _("Après le groupe"))
        
        # Propriétés
        self.checkbox_saut_activites.SetToolTip(wx.ToolTip(_("Cochez cette case pour insérer un saut de page après chaque activité")))
        self.checkbox_saut_groupes.SetToolTip(wx.ToolTip(_("Cochez cette case pour insérer un saut de page après chaque groupe")))
...
class Page_Scolarite(wx.Panel):
    def __init__(self, parent):
        ...
        self.checkbox_ecoles = wx.CheckBox(self, -1, _("Ecole"))
        self.checkbox_classes = wx.CheckBox(self, -1, _("Classe"))
        self.checkbox_inconnus = wx.CheckBox(self, -1, _("Afficher scolarité inconnue"))
        self.ctrl_ecoles = CTRL_Ecoles(self)
        self.ctrl_ecoles.SetMinSize((380, 50))

        self.label_saut_ecoles = wx.StaticText(self, -1, _("Sauts de page :"))
        self.checkbox_saut_ecoles = wx.CheckBox(self, -1, _("Après l'école"))
        self.checkbox_saut_classes = wx.CheckBox(self, -1, _("Après la classe"))
        ...
        # Propriétés
        self.checkbox_ecoles.SetToolTip(wx.ToolTip(_("Cochez cette case pour regrouper les individus par école ")))
        self.checkbox_classes.SetToolTip(wx.ToolTip(_("Cochez cette case pour regrouper les individus par classe")))
        self.checkbox_inconnus.SetToolTip(wx.ToolTip(_("Cochez cette case pour afficher les individus dont la scolarité est inconnue")))
        self.checkbox_saut_ecoles.SetToolTip(wx.ToolTip(_("Cochez cette case pour insérer un saut de page après chaque école")))
        self.checkbox_saut_classes.SetToolTip(wx.ToolTip(_("Cochez cette case pour insérer un saut de page après chaque classe")))
...
class Page_Evenements(wx.Panel):
    def __init__(self, parent):
        ...
        self.checkbox_evenements = wx.CheckBox(self, -1, _("Regrouper par évènement"))
        ...
        self.label_saut_evenements = wx.StaticText(self, -1, _("Sauts de page :"))
        self.checkbox_saut_evenements = wx.CheckBox(self, -1, _("Après l'évènement"))
        ...
        # Propriétés
        self.checkbox_evenements.SetToolTip(wx.ToolTip(_("Cochez cette case pour regrouper les consommations par évènement")))
        self.checkbox_saut_evenements.SetToolTip(wx.ToolTip(_("Cochez cette case pour insérer un saut de page après chaque évènement")))
...
class Page_Etiquettes(wx.Panel):
    def __init__(self, parent):
        ...
        self.checkbox_etiquettes = wx.CheckBox(self, -1, _("Regrouper par étiquette"))
        self.ctrl_etiquettes = CTRL_Etiquettes.CTRL(self, activeMenu=False, onCheck=None)
        self.ctrl_etiquettes.SetMinSize((250, 50))
        self.label_saut_etiquettes = wx.StaticText(self, -1, _("Sauts de page :"))
        self.checkbox_saut_etiquettes = wx.CheckBox(self, -1, _("Après l'étiquette"))
        ...
        # Propriétés
        self.checkbox_etiquettes.SetToolTip(wx.ToolTip(_("Cochez cette case pour regrouper les consommations par étiquette")))
        self.checkbox_saut_etiquettes.SetToolTip(wx.ToolTip(_("Cochez cette case pour insérer un saut de page après chaque étiquette")))
...
class Page_Unites(wx.Panel):
    def __init__(self, parent):
        ...
        # Propriétés
        self.bouton_monter.SetToolTip(wx.ToolTip(_("Cliquez ici pour monter l'unité sélectionnée dans la liste")))
        self.bouton_descendre.SetToolTip(wx.ToolTip(_("Cliquez ici pour descendre l'unité sélectionnée dans la liste")))
        self.bouton_reinit.SetToolTip(wx.ToolTip(_("Cliquez ici pour réinitialiser la liste complète des unités")))
...
class Page_Colonnes(wx.Panel):
    def __init__(self, parent):
        ...
        # Propriétés
        self.bouton_ajouter.SetToolTip(wx.ToolTip(_("Cliquez ici pour ajouter une colonne personnalisée")))
        self.bouton_modifier.SetToolTip(wx.ToolTip(_("Cliquez ici pour modifier la colonne sélectionnée dans la liste")))
        self.bouton_supprimer.SetToolTip(wx.ToolTip(_("Cliquez ici pour supprimer la colonne sélectionnée dans la liste")))
        self.bouton_monter.SetToolTip(wx.ToolTip(_("Cliquez ici pour monter la colonne sélectionnée dans la liste")))
        self.bouton_descendre.SetToolTip(wx.ToolTip(_("Cliquez ici pour descendre la colonne sélectionnée dans la liste")))
...
class Page_Options(wx.Panel):
    def __init__(self, parent):
        ...
        # Propriétés
        self.bouton_reinit.SetToolTip(wx.ToolTip(_("Cliquez ici pour réinitialiser les options")))
...
class CTRL_Parametres(wx.Notebook):
    def __init__(self, parent):
        ...
        self.listePages = [
            {"code" : "activites", "ctrl" : Page_Activites(self), "label" : _("Activités"), "image" : "Activite.png"},
            {"code" : "scolarite", "ctrl" : Page_Scolarite(self), "label" : _("Scolarité"), "image" : "Classe.png"},
            {"code" : "evenements", "ctrl": Page_Evenements(self), "label": _("Evènements"), "image": "Evenement.png"},
            {"code" : "etiquettes", "ctrl" : Page_Etiquettes(self), "label" : _("Etiquettes"), "image" : "Etiquette.png"},
            {"code" : "unites", "ctrl" : Page_Unites(self), "label" : _("Unités"), "image" : "Tableau_colonne.png"},
            {"code" : "colonnes", "ctrl": Page_Colonnes(self), "label": _("Colonnes perso."), "image": "Tableau_colonne.png"},
...
class Dialog(wx.Dialog):
    def __init__(self, parent, date=None):
        ...
        titre = _("Impression d'une liste de consommations")
        ...
        self.bouton_export = CTRL_Bouton_image.CTRL(self, texte=_("Export sous Excel"), cheminImage="Images/32x32/Excel.png")
    ...
    def __set_properties(self):
        self.SetTitle(_("Impression d'une liste de consommations"))
        self.radio_journ.SetToolTip(wx.ToolTip(_("Cochez ici pour sélectionner une liste journalière")))
        self.radio_period.SetToolTip(wx.ToolTip(_("Cochez ici pour sélectionner une liste périodique")))
        self.bouton_aide.SetToolTip(wx.ToolTip(_("Cliquez ici pour obtenir de l'aide")))
        self.bouton_export.SetToolTip(wx.ToolTip(_("Cliquez ici pour exporter les données vers Excel")))
...
##        if typeListe != "journ" :
##            dlg = wx.MessageDialog(self, _("L'export sous Excel n'est disponible que pour le mode journalier !"), _("Information"), wx.OK | wx.ICON_EXCLAMATION)
##            dlg.ShowModal()
##            dlg.Destroy()
##            return
            ...
            for ligne in lignes :
                ...
                for valeur in ligne :
                    ...
                    if isinstance(valeur, Paragraph) :
                        valeur = valeur.text
                    # Largeur colonne
                    if type(valeur) == six.text_type and (_("Nom - ") in valeur or valeur == "Informations") :
    ...
    def Impression(self, modeExport=False):
        ...
        if listeDates == None : listeDates = []
        if len(listeDates) == 0 :
            dlg = wx.MessageDialog(self, _("Vous devez sélectionner au moins une date !"), _("Erreur de saisie"), wx.OK | wx.ICON_EXCLAMATION)
            dlg.ShowModal()
            dlg.Destroy()
            return False
        ...
        if self.GetPage("scolarite").GetRegroupement() in ("ecole", "classe") :
            ...
            if len(listeEcoles) == 0 :
                dlg = wx.MessageDialog(self, _("Vous devez obligatoirement cocher au moins une école !"), _("Erreur de saisie"), wx.OK | wx.ICON_EXCLAMATION)
                dlg.ShowModal()
                dlg.Destroy()
                return False
            ...
            if len(listeClasses) == 0 and self.GetPage("scolarite").GetRegroupement() == "classe" :
                dlg = wx.MessageDialog(self, _("Vous devez obligatoirement cocher au moins une classe !"), _("Erreur de saisie"), wx.OK | wx.ICON_EXCLAMATION)
                dlg.ShowModal()
                dlg.Destroy()
                return False
        ...
        if self.GetPage("evenements").checkbox_evenements.GetValue() == True :
            ...
            if len(listeEvenements) == 0 :
                dlg = wx.MessageDialog(self, _("Vous devez obligatoirement cocher au moins un évènement !"), _("Erreur de saisie"), wx.OK | wx.ICON_EXCLAMATION)
                dlg.ShowModal()
                dlg.Destroy()
                return False
        ...
        if self.GetPage("etiquettes").checkbox_etiquettes.GetValue() == True :
            ...
            if len(listeEtiquettes) == 0 :
                dlg = wx.MessageDialog(self, _("Vous devez obligatoirement cocher au moins une étiquette !"), _("Erreur de saisie"), wx.OK | wx.ICON_EXCLAMATION)
                dlg.ShowModal()
                dlg.Destroy()
                return False
        ...
        if len(dictChoixUnites) == 0 :
            dlg = wx.MessageDialog(self, _("Vous devez obligatoirement sélectionner au moins une unité !"), _("Erreur de saisie"), wx.OK | wx.ICON_EXCLAMATION)
            dlg.ShowModal()
            dlg.Destroy()
            return False
        ...
        for IDactivite in listeActivites :
            ...
            if valide == False :
                dlg = wx.MessageDialog(self, _("Vous devez obligatoirement avoir au moins une unité à afficher pour chaque activité !"), _("Erreur de saisie"), wx.OK | wx.ICON_EXCLAMATION)
                dlg.ShowModal()
                dlg.Destroy()
                return False
        ...
        DlgAttente = wx.BusyInfo(_("Recherche des données..."), self)
...
##            dictOuvertures[IDactivite][IDgroupe].append(IDunite)
        ...
        def CreationTitreDocument():
            ...
            if typeListe == "journ" :
                titre = _("Consommations du %s") % UTILS_Dates.DateComplete(min(listeDates))
            else:
                titre = _("Consommations")
            dataTableau.append((titre, _("%s\nEdité le %s") % (UTILS_Organisateur.GetNom(), dateDuJour)))
            style = TableStyle([
        ...
        def CreationTitreTableau(nomActivite="", nomGroupe="", nomEcole="", nomClasse="", couleurFond=couleur_fond_titre, couleurTexte=colors.black, tailleGroupe=14):
            ...
            if self.GetPage("scolarite").GetRegroupement() == "ecole" :
                if nomEcole == None : nomEcole = _("Ecole inconnue")
                ligne[1] = (Paragraph(nomEcole, styleClasse))

            if self.GetPage("scolarite").GetRegroupement() == "classe":
                if nomEcole == None : nomEcole = _("Ecole inconnue")
                if nomClasse == None : nomClasse = _("Classe inconnue")
                    ...
                    for dictClasse in listeInfosScolarite :
                        ...
                        for IDevenement in listeEvenements :
                            ...
                            for IDetiquette in listeIDetiquette :
                                ...
                                if dictParametres["afficher_photos"] != "non" :
                                    labelsColonnes.append(Paragraph(_("Photo"), styleEntetes))
                                    largeursColonnes.append(tailleImageFinal+6)

                                labelsColonnes.append(Paragraph(_("Nom - prénom"), styleEntetes))
                                ...
                                if dictParametres["afficher_age"] == True :
                                    labelsColonnes.append(Paragraph(_("Age"), styleEntetes))
                                ...
                                if dictParametres["afficher_informations"] == True :
                                    labelsColonnes.append(Paragraph(_("Informations"), styleEntetes))
                                ...
                                if typeListe == "period" :
                                    ...
                                    for date, positionG, positionD in listePositionsDates :
                                        ...
                                        listeJoursAbrege = (_("Lun."), _("Mar."), _("Mer."), _("Jeu."), _("Ven."), _("Sam."), _("Dim."))
                                        listeMoisAbrege = (_("janv."), _("fév."), _("mars"), _("avril"), _("mai"), _("juin"), _("juil."), _("août"), _("sept."), _("oct"), _("nov."), _("déc."))
                                        try :
                                ...
                                for IDindividu, nom, prenom, age in listeIndividus :
                                    ...
                                    if IDindividu in dictMemos :
                                        for date in listeDates :
                                            if date in dictMemos[IDindividu] :
                                                ...
                                                if typeListe == "period" :
                                                    memo_texte = "%02d/%02d/%04d : %s" % (date.day, date.month, date.year, memo_texte)
                                                if len(memo_texte) > 0 and memo_texte[-1] != "." : memo_texte += "."
                                        ...
                                        for IDfamille in listeIDfamille :
                                            if IDfamille in dictCotisations:
                                                if dictCotisations[IDfamille]["nbre"] == 1 :
                                                    texteCotisation = _("1 cotisation manquante : %s") % dictCotisations[IDfamille]["cotisations"]
                                                else:
                                                    texteCotisation = _("%d cotisations manquantes : %s") % (dictCotisations[IDfamille]["nbre"], dictCotisations[IDfamille]["cotisations"])
                                        ...
                                        for IDfamille in listeIDfamille :
                                            if IDfamille in dictPieces:
                                                if dictPieces[IDfamille]["nbre"] == 1 :
                                                    textePiece = _("1 pièce manquante : %s") % dictPieces[IDfamille]["pieces"]
                                                else:
                                                    textePiece = _("%d pièces manquantes : %s") % (dictPieces[IDfamille]["nbre"], dictPieces[IDfamille]["pieces"])
                                    ...
                                    if texte_sieste != None and texte_sieste != "" :
                                        if len(texte_sieste) > 0 and texte_sieste[-1] != "." : texte_sieste += "."
                                    ...
                                    if IDindividu in dictInfosMedicales :
                                        for infoMedicale in dictInfosMedicales[IDindividu] :
                                            ...
                                            if description != None and description != "" :
                                                texte = "<b>%s</b> : %s" % (intitule, description) # >
                                            else:
                                                texte = "%s" % intitule # >
                                            ...
                                            if traitement == 1 and description_traitement != None and description_traitement != "" :
                                                ...
                                                if date_debut_traitement != None and date_fin_traitement == None :
                                                    texteDatesTraitement = _(" à partir du %s") % UTILS_Dates.DateEngFr(date_debut_traitement)
                                                if date_debut_traitement == None and date_fin_traitement != None :
                                                    texteDatesTraitement = _(" jusqu'au %s") % UTILS_Dates.DateEngFr(date_fin_traitement)
                                                texte += _("Traitement%s : %s.") % (texteDatesTraitement, description_traitement)
                                ...
                                for indexCol in range(0, len(labelsColonnes)) :
                                    ...
                                    if indexCol == colNomsIndividus :
                                        if indexLigne == 1 :
                                            ...
                                            valeur = _("%d individus") % indexLigne
                                    ligne.append(valeur)
                                listeLignesExport.append(ligne)
    ...
    def TriClasses(self, listeScolarite=[], dictEcoles={}):
        ...
        if self.GetPage("scolarite").GetAfficherInconnus() == True :
            if self.GetPage("scolarite").GetRegroupement() == "ecole" and None in listeScolarite :
                listeResultats.append({"IDecole": None, "nomEcole": _("Ecole inconnue"), "nomClasse": None, "IDclasse": None})
            if self.GetPage("scolarite").GetRegroupement() == "classe" and None in listeScolarite :
                listeResultats.append({"IDecole": None, "nomEcole": _("Ecole inconnue"), "nomClasse": _("Classe inconnue"), "IDclasse": None})
