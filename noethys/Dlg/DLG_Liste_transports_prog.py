...
class Panel(wx.Panel):
    def __init__(self, parent):
        ...
        self.box_liste_staticbox = wx.StaticBox(self, -1, _("Liste des programmations de transports"))
...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = _("Vous pouvez ici consulter, modifier et supprimer les programmations de transports.")
        titre = _("Liste des programmations de transports")
        self.SetTitle(titre)
