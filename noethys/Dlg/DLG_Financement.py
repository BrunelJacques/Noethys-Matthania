...
class CTRL_Titre(wx.Panel):
    def __init__(self, parent):
        ...
        # Titre
        self.label_titre = wx.StaticText(self, -1, _("Aller\nplus loin\navec\nNoethys"), style=wx.ALIGN_CENTER)
...
class Page_documentation(wx.Panel):
    def __init__(self, parent):
        ...
        # Boutons
        self.bouton_aide = CTRL_Bouton_image.CTRL(self, texte=_("En savoir plus"), cheminImage="Images/32x32/Aide.png")
        self.bouton_imprimer = CTRL_Bouton_image.CTRL(self, texte=_("Bon de commande"), cheminImage="Images/32x32/Imprimante.png")
        self.bouton_fermer = CTRL_Bouton_image.CTRL(self, texte=_("Fermer"), cheminImage="Images/32x32/Fermer.png")

        # Propriétés
        self.bouton_aide.SetToolTip(wx.ToolTip(_("Cliquez ici pour en savoir plus sur le manuel de référence")))
        self.bouton_imprimer.SetToolTip(wx.ToolTip(_("Cliquez ici pour imprimer le bon de commande et les conditions générales de vente")))
    ...
    def OnBoutonImprimer(self, event):
        try:
            ...
            dlg = wx.MessageDialog(None, _("Noethys ne peut pas ouvrir le PDF !\n\nVeuillez vérifier qu'un autre PDF n'est pas déjà ouvert en arrière-plan..."),_("Erreur"), wx.OK | wx.ICON_ERROR)
            dlg.ShowModal()
            dlg.Destroy()
...
class Page_connecthys(wx.Panel):
    def __init__(self, parent):
        ...
        # Propriétés
        self.bouton_aide.SetToolTip(wx.ToolTip(_("Cliquez ici pour en savoir plus sur Connecthys Easy")))
        self.bouton_imprimer.SetToolTip(wx.ToolTip(_("Cliquez ici pour imprimer le bon de commande et les conditions générales de vente")))
        self.bouton_fermer.SetToolTip(wx.ToolTip(_("Cliquez ici pour fermer")))
...
class Page_formations(wx.Panel):
    def __init__(self, parent):
        ...
        # Propriétés
        self.bouton_aide.SetToolTip(wx.ToolTip(_("Cliquez ici pour en savoir plus sur les formations")))
        self.bouton_fermer.SetToolTip(wx.ToolTip(_("Cliquez ici pour fermer")))
...
class Page_developpement(wx.Panel):
    def __init__(self, parent):
        ...
        # Propriétés
        self.bouton_aide.SetToolTip(wx.ToolTip(_("Cliquez ici pour en savoir plus")))
        self.bouton_fermer.SetToolTip(wx.ToolTip(_("Cliquez ici pour fermer")))
    ...
    def OnBoutonAide(self, event):
        dlg = wx.MessageDialog(None, _("Pour en savoir davantage sur les développements, consultez le concepteur de Noethys depuis le menu Aide > Envoyer un email à l'auteur."), _("Information"), wx.OK | wx.ICON_INFORMATION)
        dlg.ShowModal()
        dlg.Destroy()
...
class Dialog(wx.Dialog):
    def __init__(self, parent, code=None):
        ...
        self.parent = parent
        self.SetTitle(_("L'offre de services de Noethys"))
        #self.ctrl_titre = CTRL_Titre(self)

        self.liste_pages = [
            {"code": "documentation", "titre" : _("Documentation"), "page" : Page_documentation(self), "image": 'Images/32x32/Livre.png'},
            {"code": "connecthys", "titre": _("Connecthys Easy"), "page": Page_connecthys(self), "image": 'Images/32x32/Connecthys.png'},
            {"code": "formations", "titre": _("Formations"), "page": Page_formations(self), "image": 'Images/32x32/Classe.png'},
            {"code": "developpement", "titre": _("Développement"), "page": Page_developpement(self), "image": 'Images/32x32/Questionnaire.png'},
        ]

        if Affiche_assistance():
            self.liste_pages.append({"code": "assistance", "titre": _("Assistance"), "page": Page_assistance(self), "image": 'Images/32x32/Assistance.png'})
