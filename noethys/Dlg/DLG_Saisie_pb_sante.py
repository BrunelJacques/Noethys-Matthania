...
# LISTE_TYPES = [
#     (1, _("Maladie"), "Medical.png"),
#     (2, _("Alimentation"), "Medical.png"),
#     (3, _("Médicamentation"), "Medicament.png"),
#     (4, _("Allergie"), "Medical.png"),
#     (5, _("Accident"), "Pansement.png"),
#     (6, _("Hospitalisation"), "Hopital.png"),
#     (7, _("Opération"), "Stethoscope.png"),
#     (8, _("Autre"), "Medical.png"),
#     ]
...
class Dialog(wx.Dialog):
    def __init__(self, parent, IDindividu=None, IDprobleme=None):
        ...
        # Caractéristiques
        self.staticbox_gauche_staticbox = wx.StaticBox(self, -1, _("Caractéristiques"))
        ...
        self.label_intitule = wx.StaticText(self, -1, _("Intitulé :"))
        self.ctrl_intitule = wx.TextCtrl(self, -1, "")
        self.label_periode = wx.StaticText(self, -1, _("Période :"))
        self.radio_indefinie = wx.RadioButton(self, -1, _("Indéfinie"), style = wx.RB_GROUP)
        self.radio_definie = wx.RadioButton(self, -1, "")
        self.label_periode_du = wx.StaticText(self, -1, "Du")
        self.ctrl_periode_debut = CTRL_Saisie_date.Date(self)
        self.label_periode_au = wx.StaticText(self, -1, _("au"))
        ...
        # Traitement
        self.staticbox_traitement_staticbox = wx.StaticBox(self, -1, _("Traitement médical"))
        self.ctrl_coche_traitement = wx.CheckBox(self, -1, _("Traitement médical"))
        self.ctrl_description_traitement = wx.TextCtrl(self, -1, "", style=wx.TE_MULTILINE)
        self.ctrl_description_traitement.SetMinSize((-1, 60))
        self.label_traitement_du = wx.StaticText(self, -1, "Du")
        self.ctrl_traitement_debut = CTRL_Saisie_date.Date(self)
        self.label_traitement_periode_au = wx.StaticText(self, -1, _("au"))
        self.ctrl_traitement_fin = CTRL_Saisie_date.Date(self)
        
        # Eviction
        self.staticbox_eviction_staticbox = wx.StaticBox(self, -1, _("Eviction de l'activité"))
        self.ctrl_coche_eviction = wx.CheckBox(self, -1, _("Eviction de l'activité"))
        self.label_eviction_du = wx.StaticText(self, -1, "Du")
        self.ctrl_eviction_debut = CTRL_Saisie_date.Date(self)
        self.label_eviction_au = wx.StaticText(self, -1, _("au"))
        self.ctrl_eviction_fin = CTRL_Saisie_date.Date(self)
        
        # Diffusion de l'info
        self.staticbox_diffusion_staticbox = wx.StaticBox(self, -1, _("Diffusion de l'information"))
        self.ctrl_listing_enfants = wx.CheckBox(self, -1, _("Afficher sur le listing des informations médicales"))
        self.ctrl_listing_presences = wx.CheckBox(self, -1, _("Afficher sur le listing des consommations"))
        self.ctrl_listing_repas = wx.CheckBox(self, -1, _("Afficher sur la commande des repas"))
    ...
    def __set_properties(self):
        self.SetTitle(_("Saisie d'une information médicale"))
        self.ctrl_categorie.SetToolTip(wx.ToolTip(_("Selectionnez une catégorie médicale")))
        self.bouton_categories.SetToolTip(wx.ToolTip(_("Cliquez ici pour accéder au paramétrage des catégories médicales")))
        self.ctrl_intitule.SetFont(wx.Font(10, wx.DEFAULT, wx.NORMAL, wx.BOLD, 0, ""))
        self.ctrl_intitule.SetToolTip(wx.ToolTip(_("Saisissez l'intitule de l'information")))
        self.radio_indefinie.SetToolTip(wx.ToolTip(_("Sans période définie")))
        self.radio_definie.SetToolTip(wx.ToolTip(_("Définir une période")))
        self.ctrl_periode_debut.SetToolTip(wx.ToolTip(_("Saisissez une date de début")))
        self.ctrl_periode_fin.SetToolTip(wx.ToolTip(_("Saisissez une date de fin")))
        self.ctrl_description.SetToolTip(wx.ToolTip(_("Saisissez une description pour le problème de santé")))
        self.ctrl_coche_traitement.SetToolTip(wx.ToolTip(_("Cochez cette case pour saisir un traitement médical")))
        self.ctrl_description_traitement.SetToolTip(wx.ToolTip(_("Saisissez ici le détail du traitement médical")))
        self.ctrl_traitement_debut.SetToolTip(wx.ToolTip(_("Saisissez ici la date de debut du traitement")))
        self.ctrl_traitement_fin.SetToolTip(wx.ToolTip(_("Saisissez ici la date de fin de traitement")))
        self.ctrl_coche_eviction.SetToolTip(wx.ToolTip(_("Cochez cette case si cette information médicale nécessite une éviction de l'activité")))
        self.ctrl_eviction_debut.SetToolTip(wx.ToolTip(_("Saisissez ici la date de début de l'éviction")))
        self.ctrl_eviction_fin.SetToolTip(wx.ToolTip(_("Saisissez ici la date de fin de la periode d'éviction")))
        self.ctrl_listing_enfants.SetToolTip(wx.ToolTip(_("Cliquez ici pour diffuser l'information sur le listing enfants")))
        self.ctrl_listing_presences.SetToolTip(wx.ToolTip(_("Cliquez ici pour diffuser l'information sur le listing des consommations")))
        self.ctrl_listing_repas.SetToolTip(wx.ToolTip(_("Cliquez ici pour diffuser l'information sur la commande des repas")))
        self.bouton_aide.SetToolTip(wx.ToolTip(_("Cliquez ici pour obtenir de l'aide")))
        self.bouton_annuler.SetToolTip(wx.ToolTip(_("Cliquez ici pour valider la saisie")))
        self.bouton_ok.SetToolTip(wx.ToolTip(_("Cliquez ici pour annuler et fermer")))
    ...
    def Sauvegarde(self):
        ...
        if description_traitement == 1 : 
            if description_traitement == "" :
                dlg = wx.MessageDialog(self, _("Vous devez obligatoirement saisir le détail du traitement !"), _("Erreur de saisie"), wx.OK | wx.ICON_EXCLAMATION)
                dlg.ShowModal()
                dlg.Destroy()
                self.ctrl_description_traitement.SetFocus()
                return False
            if date_debut_traitement == None :
                dlg = wx.MessageDialog(self, _("Vous devez obligatoirement saisir une date de début pour le traitement !"), _("Erreur de saisie"), wx.OK | wx.ICON_EXCLAMATION)
                dlg.ShowModal()
                dlg.Destroy()
                self.ctrl_traitement_debut.SetFocus()
                return False
            if date_fin_traitement == None :
                dlg = wx.MessageDialog(self, _("Vous devez obligatoirement saisir une date de fin pour le traitement !"), _("Erreur de saisie"), wx.OK | wx.ICON_EXCLAMATION)
                dlg.ShowModal()
                dlg.Destroy()
        ...
        if eviction == 1 : 
            if date_debut_eviction == None :
                dlg = wx.MessageDialog(self, _("Vous devez obligatoirement saisir une date de début pour l'éviction !"), _("Erreur de saisie"), wx.OK | wx.ICON_EXCLAMATION)
                dlg.ShowModal()
                dlg.Destroy()
                self.ctrl_eviction_debut.SetFocus()
                return False
            if date_fin_eviction == None :
                dlg = wx.MessageDialog(self, _("Vous devez obligatoirement saisir une date de fin pour l'éviction !"), _("Erreur de saisie"), wx.OK | wx.ICON_EXCLAMATION)
                dlg.ShowModal()
                dlg.Destroy()
