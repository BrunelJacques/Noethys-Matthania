...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = _("Vous pouvez ici consulter la liste complète des contrats générés dans le logiciel. Les commandes proposées vous permettent de modifier, supprimer ou imprimer des contrats. Pour supprimer un lot de contrats, cochez-les et utilisez le bouton Supprimer.")
        titre = _("Liste des contrats")
    ...
    def __set_properties(self):
        self.SetTitle(_("Liste des contrats"))
        self.bouton_ouvrir_fiche.SetToolTip(wx.ToolTip(_("Cliquez ici pour ouvrir la fiche famille du contrat sélectionné dans la liste")))
        self.bouton_apercu.SetToolTip(wx.ToolTip(_("Cliquez ici pour créer un aperçu avant impression de la liste")))
        self.bouton_imprimer.SetToolTip(wx.ToolTip(_("Cliquez ici pour imprimer directement la liste")))
        self.bouton_supprimer.SetToolTip(wx.ToolTip(_("Cliquez ici pour supprimer le contrat sélectionné dans la liste")))
        self.bouton_modifier.SetToolTip(wx.ToolTip(_("Cliquez ici pour modifier le contrat sélectionné dans la liste")))
