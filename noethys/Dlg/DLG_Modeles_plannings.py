...
from Ol import OL_Modeles_plannings
...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = _("Vous pouvez ici saisir, modifier ou supprimer des modèles de plannings.Ceux-ci sont notamment utilisés pour la génération automatique de consommations dans les contrats.")
        titre = _("Gestion des modèles de plannings")
        self.SetTitle(titre)
        self.ctrl_bandeau = CTRL_Bandeau.Bandeau(self, titre=titre, texte=intro, hauteurHtml=30, nomImage="Images/32x32/Calendrier.png")
        self.ctrl_listview = OL_Modeles_plannings.ListView(self, id=-1, style=wx.LC_REPORT|wx.SUNKEN_BORDER|wx.LC_SINGLE_SEL|wx.LC_HRULES|wx.LC_VRULES)
        self.ctrl_listview.MAJ()
        self.ctrl_recherche = OL_Modeles_plannings.CTRL_Outils(self, listview=self.ctrl_listview)
