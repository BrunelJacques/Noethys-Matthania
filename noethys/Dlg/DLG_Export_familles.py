...
class Dialog(wx.Dialog):
    def __init__(self, parent, IDfamille=None):
        ...
        if self.IDfamille == None :
            texte = _("des familles")
        else :
            texte = _("de la famille")

        # Bandeau
        intro = _("Vous pouvez ici exporter les données %s au format XML. Vous pouvez enregistrer le fichier généré dans le répertoire souhaité ou l'envoyer par email.") % texte
        titre = _("Exporter les données %s") % texte
        self.SetTitle(titre)
        ...
        self.bouton_enregistrer.SetToolTip(wx.ToolTip(_("Enregistrer le fichier XML")))
        ...
        self.bouton_email.SetToolTip(wx.ToolTip(_("Envoyer le fichier XML par Email")))
    ...
    def OnBoutonEnregistrer(self, event):
        ...
        txtMessage = _("Le fichier XML a été créé avec succès. Souhaitez-vous l'ouvrir dès maintenant ?")
