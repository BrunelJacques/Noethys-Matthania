...
class CTRL_Groupes(wx.CheckListBox):
    ...
    def MAJ(self):
        ...
        for nomGroupe, IDtype_groupe_activite in self.listeDonnees :
            if nomGroupe == None :
                nomGroupe = _("Groupe d'activité inconnu")
...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        # Bandeau
        intro = _("Vous pouvez ici afficher la liste détaillée des déductions. Commencez par saisir une période de référence puis sélectionnez les activités à afficher. Il est ensuite possible d'imprimer les résultats ou de les exporter sous Ms Excel.")
        titre = _("Liste des déductions")
    ...
    def __set_properties(self):
        ...
        self.bouton_supprimer.SetToolTip(wx.ToolTip(_("Cliquez ici pour supprimer la déduction sélectionnée dans la liste")))
        self.bouton_modifier.SetToolTip(wx.ToolTip(_("Cliquez ici pour modifier la déduction sélectionnée dans la liste")))
