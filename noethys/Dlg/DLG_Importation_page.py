...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        # Bandeau
        intro = _("Vous pouvez ici importer un document à partir d'un fichier présent sur le disque dur ou depuis d'un scanner connecté à votre ordinateur.")
        titre = _("Importation d'un document")
    ...
    def __set_properties(self):
        self.SetTitle(_("Importation d'un document"))
        self.bouton_dossier.SetToolTip(wx.ToolTip(_("Importer un document depuis un dossier")))
        self.bouton_scanner.SetToolTip(wx.ToolTip(_("Importer un document depuis un scanner")))
