...
from Ol import OL_PlanComptable
...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        self.parent = parent
        intro = _("Le compte comptable détermine la destination dans la comptabilité par la nature de la ligne de tarification")
        titre = _("Gestion du Plan Comptable")
        self.ctrl_bandeau = CTRL_Bandeau.Bandeau(self, titre=titre, texte=intro,  hauteurHtml=15, nomImage="Images/22x22/Smiley_nul.png")
        self.ctrl_listview = OL_PlanComptable.ListView(self,self, id=-1, style=wx.LC_REPORT|wx.SUNKEN_BORDER|wx.LC_SINGLE_SEL|wx.LC_HRULES|wx.LC_VRULES)
        self.ctrl_listview.MAJ()
        self.ctrl_recherche = OL_PlanComptable.CTRL_Outils(self, listview=self.ctrl_listview)
    ...
    def __set_properties(self):
        self.SetTitle(_("DLG_PlanComptable"))
        self.ctrl_listview.SetToolTip(_("Double Cliquez pour choisir et fermer la fenêtre"))
        self.bouton_ajouter.SetToolTip(_("Cliquez ici pour ajouter un Compte"))
        self.bouton_modifier.SetToolTip(_("Cliquez ici pour modifier le Compte sélectionné dans la liste"))
        self.bouton_supprimer.SetToolTip(_("Cliquez ici pour supprimer le Compte sélectionné dans la liste"))
