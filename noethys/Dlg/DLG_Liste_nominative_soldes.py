...
class CTRL_Presents(wx.Panel):
    def __init__(self, parent):
        ...
        self.radio_inscrits = wx.RadioButton(self, -1, _("Toutes les prestations"), style=wx.RB_GROUP)
        self.radio_presents = wx.RadioButton(self, -1, _("Uniquement les prestations"))
...
class Parametres(wx.Panel):
    ...
    def __set_properties(self):
        ...
        self.ctrl_groupes.SetToolTip(wx.ToolTip(_("Cochez les groupes à afficher")))
        self.ctrl_categories.SetToolTip(wx.ToolTip(_("Cochez les catégories à afficher")))
...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        titre = _("Liste des soldes individuels")
        self.SetTitle(titre)
