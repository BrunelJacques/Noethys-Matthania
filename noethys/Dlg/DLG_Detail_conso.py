...
class Dialog(wx.Dialog):
    def __init__(self, parent, dictConso={}, texteInfoBulle=""):
        ...
        intro = _("Prenez connaissance des informations détaillées concernant cette consommation et modifier certains de ses paramètres.")
        titre = _("Détail d'une consommation")
        ...
        self.staticbox_infos = wx.StaticBox(self, -1, _("Informations"))
        self.ctrl_infos = wx.TextCtrl(self, -1, texteInfos, style=wx.TE_MULTILINE) #MyHtml(self, texteInfos)
        
        # Paramètres
        self.staticbox_param = wx.StaticBox(self, -1, _("Paramètres"))
    ...
    def __set_properties(self):
        self.SetTitle(_("Détail d'une consommation"))
    ...
    def GetTexteInfos(self):
        ...
        if self.dictInfoConso.IDconso == None :
            texte += _("IDconso : Consommation non enregistrée\n")
        else:
            texte += _("IDconso : %d\n") % self.dictInfoConso.IDconso
        
        texte += _("IDfamille : %d") % self.dictInfoConso.IDfamille
