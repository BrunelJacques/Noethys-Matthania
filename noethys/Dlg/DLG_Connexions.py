...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = _("Vous pouvez ici consulter la liste complète des connexions au serveur MySQL.")
        titre = _("Connexions réseau")
    ...
    def __set_properties(self):
        self.SetTitle(_("Connexions réseau"))
        self.bouton_apercu.SetToolTip(wx.ToolTip(_("Cliquez ici pour visualiser un aperçu avant impression")))
