...
class OL_Tarifs(FastObjectListView):
    ...
    def InitObjectListView(self):
        ...
        liste_Colonnes = [
            ...
            ColumnDefn(_("Du"), 'left', 80, "date_debut", typeDonnee="date", stringConverter=FormateDate),
            ColumnDefn(_("au"), 'left', 80, "date_fin", typeDonnee="date", stringConverter=FormateDate),
            ColumnDefn(_("Label"), "left", 220, "label", typeDonnee="texte"),
...
class Dialog(wx.Dialog):
    def __init__(self, parent, track=None, dictInfosLocation={}):
        ...
        # Tarifs
        self.box_tarifs_staticbox = wx.StaticBox(self, -1, _("Tarifs disponibles"))
        self.label_tarifs = wx.StaticText(self, -1, _("Cliquez sur un tarif pour le sélectionner ou double-cliquez pour le sélectionner et le valider directement."))
    ...
    def __set_properties(self):
        self.SetTitle(_("Saisie d'une prestation"))
        self.ctrl_tarifs.SetToolTip(wx.ToolTip(_("Sélectionnez un tarif à appliquer")))
