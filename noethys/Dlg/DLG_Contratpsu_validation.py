...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = _("Avant de générer les factures d'une activité de type P.S.U., vous devez commencer par générer ici les mensualités pour le mois souhaité. Notez qu'il est est possible de saisir manuellement un nombre d'heures de régularisation avant de valider la génération.")
        ...
        self.label_info = wx.StaticText(self, -1, _("Remarque : Vous pouvez double-cliquer dans la colonne 'H. régular.' pour saisir un nombre positif ou négatif d'heures de régularisation."))
    ...
    def __set_properties(self):
        ...
        self.bouton_detail.SetToolTip(wx.ToolTip(_("Cliquez ici pour afficher un aperçu du détail de la mensualité sélectionnée")))
        self.bouton_supprimer.SetToolTip(wx.ToolTip(_("Cliquez ici pour supprimer les prestations existantes des lignes sélectionnées ou cochées")))
