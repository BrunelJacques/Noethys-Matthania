...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        # Bandeau
        intro = _("Vous pouvez ici consulter un simple calendrier qui affiche les périodes de vacances et les jours fériés. Le triangle rouge indique la date du jour. Vous pouvez permuter l'affichage annuel / mensuel en cliquant sur le bouton en haut à gauche.")
        titre = _("Calendrier")
    ...
    def __do_layout(self):
        ...
        # Calendrier
        grid_sizer_base.Add(self.ctrl_calendrier, 0, wx.EXPAND|wx.LEFT|wx.RIGHT, 10)
