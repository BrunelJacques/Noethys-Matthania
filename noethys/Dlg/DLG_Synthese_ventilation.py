...
class Page_prestations(wx.Panel):
    def __init__(self, parent):
        ...
        self.label_date_debut = wx.StaticText(self, -1, _("Période du"))
...
class CTRL_Parametres(wx.Choicebook):
    def __init__(self, parent):
        ...
        self.listePanels = [
            ("DEPOTS", _("Affiche les dépôts sélectionnés"), Page_depots(self)),
            ("PRESTATIONS", _("Affiche les prestations ventilées sur une période"), Page_prestations(self)),
        ]
...
class Dialog(wx.Dialog):
    ...
    def __set_properties(self):
        ...
        self.radio_mois.SetToolTip(wx.ToolTip(_("Cliquez ici pour afficher les résultats par mois")))
        self.radio_annee.SetToolTip(wx.ToolTip(_("Cliquez ici pour afficher les résultats par années")))
        self.check_details.SetToolTip(wx.ToolTip(_("Cliquez ici pour afficher les détails dans les résultats")))
        self.bouton_actualiser.SetToolTip(wx.ToolTip(_("Cliquez ici pour actualiser les résultats")))
