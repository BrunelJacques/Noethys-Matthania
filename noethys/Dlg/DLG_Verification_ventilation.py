...
class Dialog(wx.Dialog):
    def __init__(self, parent, tracks=None, IDcompte_payeur=None):
        ...
        # Actions
        self.staticbox_actions_staticbox = wx.StaticBox(self, -1, _("Ventilation automatique"))
        self.bouton_selection = CTRL_Bouton_image.CTRL(self, texte=_("Uniquement la ligne sélectionnée"), cheminImage="Images/32x32/Magique.png")
        self.bouton_coches = CTRL_Bouton_image.CTRL(self, texte=_("Uniquement les lignes cochées"), cheminImage="Images/32x32/Magique.png")
        self.bouton_toutes = CTRL_Bouton_image.CTRL(self, texte=_("Toutes les lignes affichées"), cheminImage="Images/32x32/Magique.png")
    ...
    def __set_properties(self):
        self.SetTitle(_("Vérification de la ventilation"))
        self.bouton_ouvrir_fiche.SetToolTip(wx.ToolTip(_("Cliquez ici pour ouvrir la fiche famille sélectionnée dans la liste")))
        self.bouton_selection.SetToolTip(wx.ToolTip(_("Cliquez ici pour ventiler automatiquement la ligne sélectionnée")))
        self.bouton_coches.SetToolTip(wx.ToolTip(_("Cliquez ici pour ventiler automatiquement les lignes cochées")))
        self.bouton_toutes.SetToolTip(wx.ToolTip(_("Cliquez ici pour ventiler automatiquement toutes les lignes affichées")))
