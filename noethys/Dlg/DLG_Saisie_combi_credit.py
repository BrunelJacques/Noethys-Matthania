...
class Dialog(wx.Dialog):
    def __init__(self, parent, IDactivite=None, listeUnites=[], afficheOptions=True):
        ...
        self.check_quantite = wx.CheckBox(self, -1, _("Quantité max. :"))
    ...
    def __set_properties(self):
        self.SetTitle(_("Saisie d'une combinaison"))
        self.check_quantite.SetToolTip(wx.ToolTip(_("Vous pouvez définir ici un plafond maximal")))
    ...
    def OnBoutonOk(self, event): 
        ...
        if self.check_quantite.GetValue() == True :
            ...
            if quantite == 0 or quantite == "" or quantite == None :
                dlg = wx.MessageDialog(self, _("La quantité max. que vous avez saisi ne semble pas valide !"), "Erreur", wx.OK | wx.ICON_EXCLAMATION)
                dlg.ShowModal()
                dlg.Destroy()
