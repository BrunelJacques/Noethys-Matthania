...
class Dialog(wx.Dialog):
    def __init__(self, parent, IDanalytique=None, defaut=0):
        ...
        if self.IDanalytique != None :
            self.SetTitle(_("Modification d'un poste analytique"))
            self.Importation() 
        else :
            self.SetTitle(_("Saisie d'un poste analytique"))

    def __set_properties(self):
        self.ctrl_nom.SetToolTip(wx.ToolTip(_("Saisissez le nom du poste")))
        self.ctrl_abrege.SetToolTip(wx.ToolTip(_("Saisissez le nom abrégé du poste (en majuscules)")))
