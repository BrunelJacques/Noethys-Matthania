...
class CTRL(HTL.HyperTreeList):
    def __init__(self, parent): 
        ...
        listeColonnes = [
            ( _("Label/Famille"), 400, wx.ALIGN_LEFT),
            ( _("Date"), 90, wx.ALIGN_LEFT),
            ( _("Individu"), 180, wx.ALIGN_LEFT),
            ( _("IDprestation"), 90, wx.ALIGN_LEFT),
            ]
        numColonne = 0
...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = _("Vous pouvez ici consulter la liste des prestations qui ne possèdent pas de consommations associées. Double-cliquez sur une ligne pour ouvrir la fiche famille correspondante.")
        titre = _("Prestations sans consommations")
        self.SetTitle(titre)
