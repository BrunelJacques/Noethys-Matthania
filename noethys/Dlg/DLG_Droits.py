...
from Ol import OL_Modeles_droits
...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = _("Vous pouvez ici saisir, modifier ou supprimer des modèles de droits.")
        titre = _("Gestion des modèles de droits")
        self.SetTitle(titre)
        ...
        self.ctrl_recherche = OL_Modeles_droits.CTRL_Outils(self, listview=self.ctrl_listview)
