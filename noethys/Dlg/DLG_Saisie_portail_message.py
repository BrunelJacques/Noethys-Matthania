...
class Dialog(wx.Dialog):
    ...
    def __set_properties(self):
        ...
        self.ctrl_titre.SetToolTip(wx.ToolTip(_("Saisissez ici un titre interne pour ce message. Ce titre n'apparaîtra pas sur le portail.")))
        self.ctrl_texte.SetToolTip(wx.ToolTip(_("Saisissez ici le texte qui apparaîtra sur la page d'accueil du portail")))
        self.radio_oui.SetToolTip(wx.ToolTip(_("Sélectionnez cette option pour toujours afficher ce message sur le portail")))
        self.radio_dates.SetToolTip(wx.ToolTip(_("Sélectionnez cette option pour afficher message sur le portail uniquement entre les dates souhaitées")))
