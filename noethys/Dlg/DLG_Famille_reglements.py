...
# Auteur:           Ivan LUCAS, JB, Jacques Brunel Ajout Duplication de règlements
...
class CTRL_Prelevement(wx.Panel):
    def __init__(self, parent, IDfamille=None):
        ...
        self.hyper_prelevement = Hyperlien(self, label=_("Prélèvement automatique"), infobulle=_("Cliquez ici pour activer le prélèvement automatique et saisir les coordonnées bancaires de la famille"), URL="prelevement")
...
class CTRL_Recu(wx.Panel):
    def __init__(self, parent, IDfamille=None):
        ...
        self.ctrl_image = wx.StaticBitmap(self, -1, self.image_nonvalide)
        self.hyper_prelevement = Hyperlien(self, label=_("Reçus par Email"), infobulle=_("Cliquez ici pour activer l'envoi automatique par email des reçus de règlements"), URL="recu")
    ...
    def OnClic(self):
        ...
        intro = _("Sélectionnez ici l'adresse Email à laquelle envoyer les reçus de règlements. Noethys proposera ainsi juste après la saisie d'un règlement l'envoi du reçu correspondant.")
        titre = _("Activation de l'envoi des reçus par Email")
...
class CTRL_Depot(wx.Panel):
    ...
    def OnClic(self):
        ...
        from Dlg import DLG_Selection_email
        intro = _("Sélectionnez ici l'adresse Email à laquelle envoyer les avis de dépôt des règlements. Noethys enverra ainsi un avis de dépôt après la validation d'un dépôt de règlements.")
        titre = _("Activation de l'envoi des avis de dépôt par Email")
...
class Panel(wx.Panel):
    def __init__(self, parent, IDfamille=None):
        ...
        self.staticbox_reglements = wx.StaticBox(self, -1, _("Règlements"))
        ...
        self.bouton_modifier.SetToolTip(_("Cliquez ici pour modifier le règlement sélectionné"))
        self.bouton_supprimer.SetToolTip(_("Cliquez ici pour supprimer le règlement sélectionné"))
    ...
    def OnBoutonImprimer(self, event):
        ...
        # Item Recu 
        item = wx.MenuItem(menuPop, 10, _("Editer un reçu (PDF)"))
    ...
    def OnBoutonVentilationAuto(self, event):
        ...
        item = wx.MenuItem(menuPop, 201, _("Ventiler automatiquement le règlement sélectionné"))
        ...
        item = wx.MenuItem(menuPop, 202, _("Ventiler automatiquement tous les règlements"))
        item.SetBitmap(wx.Bitmap(Chemins.GetStaticPath("Images/16x16/Magique.png"), wx.BITMAP_TYPE_PNG))
        menuPop.Append(item)
        self.Bind(wx.EVT_MENU, self.ctrl_reglements.VentilationAuto, id=202)

        item = wx.MenuItem(menuPop, 203, _("Voir la ventilation des règlements"))
        item.SetBitmap(wx.Bitmap(Chemins.GetStaticPath("Images/16x16/Magique.png"), wx.BITMAP_TYPE_PNG))
        menuPop.Append(item)
