...
class Dialog(wx.Dialog):
    def __init__(self, parent, label=u"", montant=0.0):
        ...
        # Bandeau
        intro = _("Vous pouvez ici saisir un montant et un label personnalisés pour la prestation qui va être créée.")
        titre = _("Prestation personnalisée")
        self.SetTitle(titre)
...
if __name__ == "__main__":
    ...
    frame_1 = Dialog(None, label=_("Cinéma"))
