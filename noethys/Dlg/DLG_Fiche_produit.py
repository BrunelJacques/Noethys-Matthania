...
class Page_Locations(wx.Panel):
    def __init__(self, parent, IDproduit=None):
        ...
        # Properties
        self.bouton_ajouter.SetToolTip(wx.ToolTip(_("Cliquez ici pour ajouter une location")))
        self.bouton_modifier.SetToolTip(wx.ToolTip(_("Cliquez ici pour modifier la location sélectionnée dans la liste")))
        self.bouton_supprimer.SetToolTip(wx.ToolTip(_("Cliquez ici pour supprimer la location sélectionnée dans la liste")))
...
class Timeline(TL.TimelinePerso):
    ...
    def _load_data(self):
        ...
        categorie = TL.Category(_("Location"), (156, 205, 255), True)
        for IDlocation, IDfamille, date_debut, date_fin, quantite in listeLocations :
        ...
        categorie_disponible = TL.Category(_("Stock disponible"), (233, 255, 156), True)
        categorie_loue = TL.Category(_("Quantité louée"), (204, 227, 250), True)
...
class CTRL_Onglets(wx.Notebook):
    def __init__(self, parent, IDlocation=None):
        ...
        self.listePages = [
            {"code": "locations", "ctrl": Page_Locations(self, self.IDlocation), "label": _("Locations"), "image": "Location.png"},
            {"code": "chronologie", "ctrl": Page_Chronologie(self, self.IDlocation), "label": _("Chronologie"), "image": "Timeline.png"},
        ]
...
class Dialog(wx.Dialog):
    def __init__(self, parent, IDproduit=None):
        ...
        self.bouton_fermer = CTRL_Bouton_image.CTRL(self, id=wx.ID_CANCEL, texte=_("Fermer"), cheminImage="Images/32x32/Annuler.png")
    ...
    def __set_properties(self):
        ...
        self.bouton_fermer.SetToolTip(wx.ToolTip(_("Cliquez ici pour fermer la fiche produit")))
