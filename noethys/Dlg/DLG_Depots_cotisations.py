...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        titre = _("Gestion des dépôts de cotisations")
    ...
    def __set_properties(self):
        self.SetTitle(_("Gestion des dépôts de cotisations"))
        self.bouton_ajouter.SetToolTip(wx.ToolTip(_("Cliquez ici pour ajouter un dépôt")))
        self.bouton_modifier.SetToolTip(wx.ToolTip(_("Cliquez ici pour modifier le dépôt sélectionné dans la liste")))
