...
class Dialog(wx.Dialog):
    ...
    def __set_properties(self):
        self.SetTitle(_("Saisie d'un contact"))
        self.ctrl_nom.SetToolTip(wx.ToolTip(_("Saisissez le nom du contact")))
        self.ctrl_prenom.SetToolTip(wx.ToolTip(_("Saisissez le prénom du contact")))
        self.ctrl_rue.SetToolTip(wx.ToolTip(_("Saisissez la rue du contact")))
        self.ctrl_tel.SetToolTip(wx.ToolTip(_("Saisissez le numéro de téléphone fixe du contact")))
        self.ctrl_mobile.SetToolTip(wx.ToolTip(_("Saisissez le numéro de portable du contact")))
    ...
    def OnBoutonOk(self, event):
        if not self.ctrl_nom.GetValue():
            dlg = wx.MessageDialog(self, _("Vous devez obligatoirement saisir au moins un nom !"), _("Erreur de saisie"), wx.OK | wx.ICON_EXCLAMATION)
            dlg.ShowModal()
            dlg.Destroy()
