...
class Dialog(wx.Dialog):
    def __init__(self, parent, IDproduit=None):
        ...
        # Bandeau
        intro = _("Sélectionnez un produit pour afficher son planning de locations. Faites un clic droit sur le planning pour accéder aux fonctions d'ajout, de modification et de suppression.")
        titre = _("Planning des locations")
        self.SetTitle(titre)
