...
class Page_planning(wx.Panel):
    def __init__(self, parent, clsbase=None):
        ...
        self.bouton_generer = CTRL_Bouton_image.CTRL(self, texte=_("Générer les consommations"), cheminImage="Images/32x32/Magique.png")
    ...
    def __set_properties(self):
        self.bouton_ajouter.SetToolTip(wx.ToolTip(_("Cliquez ici pour ajouter un paramètre de planning")))
        self.bouton_modifier.SetToolTip(wx.ToolTip(_("Cliquez ici pour modifier le paramètre de planning sélectionné")))
        self.bouton_supprimer.SetToolTip(wx.ToolTip(_("Cliquez ici pour supprimer le paramètre de planning sélectionné")))
        ...
        self.bouton_generer.SetToolTip(wx.ToolTip(_("Cliquez ici pour générer les consommations selon le planning")))
...
class Page_consommations(wx.Panel):
    ...
    def __set_properties(self):
        self.bouton_ajouter.SetToolTip(wx.ToolTip(_("Cliquez ici pour ajouter une consommation")))
        self.bouton_modifier.SetToolTip(wx.ToolTip(_("Cliquez ici pour modifier la consommation sélectionnée")))
        self.bouton_supprimer.SetToolTip(wx.ToolTip(_("Cliquez ici pour supprimer la consommation sélectionnée")))
        self.bouton_apercu.SetToolTip(wx.ToolTip(_("Cliquez ici pour afficher un aperçu avant impression de la liste")))
        self.bouton_imprimer.SetToolTip(wx.ToolTip(_("Cliquez ici pour imprimer la liste")))
...
class Notebook(wx.Notebook):
    def __init__(self, parent, clsbase=None):
        ...
        self.AddPage(self.page_planning, _("Planning"))

        # Page consommations
        self.page_consommations = Page_consommations(self, clsbase)
        self.AddPage(self.page_consommations, _("Consommations"))
...
class Panel(wx.Panel):
    def __init__(self, parent, clsbase=None):
        ...
        # Prévisions
        self.staticbox_previsions_staticbox = wx.StaticBox(self, -1, _("Présences prévisionnelles"))
        ...
        # Absences
        self.staticbox_absences_staticbox = wx.StaticBox(self, -1, _("Absences RTT"))
        self.label_absences_prevues = wx.StaticText(self, -1, _("Prévues :"))
        self.ctrl_absences_prevues = CTRL_Saisie_duree.CTRL(self, size=(50, -1))
        self.label_absences_prises = wx.StaticText(self, -1, _("Prises :"))
        self.ctrl_absences_prises = CTRL_Saisie_duree.CTRL(self, size=(50, -1))
        self.ctrl_absences_prises.Enable(False)
        self.label_absences_solde = wx.StaticText(self, -1, _("Restantes :"))
        ...
        self.label_arrondi = wx.StaticText(self, -1, _("Arrondi :"))
        self.liste_arrondi_type = [(None, _("Aucun")), ("tranche_horaire", _("Tranche horaire")), ("duree", _("Durée"))]
        self.liste_arrondi_delta = [(10, _("10 min")), (15, _("15 min")), (30, _("30 min")), (60, _("60 min"))]
    ...
    def __set_properties(self):
        self.ctrl_absences_prevues.SetToolTip(wx.ToolTip(_("Saisissez ici le nombre d'heures d'absences prévues (RTT)")))
        self.ctrl_arrondi_type.SetToolTip(wx.ToolTip(_("Sélectionnez un type d'arrondi")))
        self.ctrl_arrondi_delta.SetToolTip(wx.ToolTip(_("Sélectionnez le deltade l'arrondi")))
    ...
    def Validation(self):
        ...
        if nbreConso == 0 :
            dlg = wx.MessageDialog(self, _("Vous n'avez saisi aucune consommation prévisionnelle ! Souhaitez-vous tout de même continuer ?\n\nPour saisir des consommations, vous avez deux possibilités : Soit vous créez un planning dans l'onglet 'Planning' puis cliquez sur 'Générer les consommations', soit vous saisissez manuellement les consommations souhaitées depuis l'onglet 'Consommations'."), _("Avertissement"), wx.YES_NO|wx.NO_DEFAULT|wx.CANCEL|wx.ICON_EXCLAMATION)
