...
from Dlg.DLG_Factures_generation_parametres import Panel as Page1
from Dlg.DLG_Factures_generation_selection import Panel as Page2
from Dlg.DLG_Factures_generation_actions import Panel as Page3


class Dialog(wx.Dialog):
    def __init__(self, parent):
        wx.Dialog.__init__(self, parent, -1, name="DLG_Facturation", style=wx.DEFAULT_DIALOG_STYLE|wx.RESIZE_BORDER|wx.MAXIMIZE_BOX|wx.MINIMIZE_BOX)
        self.parent = parent
        
        intro = _("Vous pouvez ici générer des factures. Page 1 : Sélectionnez des paramètres puis cliquez sur Suite pour afficher les factures disponibles. Page 2 : Cochez les factures à générer puis cliquez sur Suite. Page 3 : Vous pouvez effectuer d'autres actions sur les factures générées.")
        titre = _("Génération de factures")
        self.SetTitle(titre)
