...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        # Bandeau
        intro = _("Vous pouvez consulter ici la liste des actions des procédures de badgeage. Commencez par sélectionner une date de référence puis actualisez l'affichage de la liste.")
        titre = _("Journal de badgeage")
        self.SetTitle(titre)
    ...
    def __set_properties(self):
        self.ctrl_date.SetToolTip(wx.ToolTip(_("Sélectionnez une date")))
