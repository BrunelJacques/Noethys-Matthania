...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = _("Vous pouvez ici saisir, modifier ou supprimer des modes de règlements que vous pourrez utiliser lors de la saisie de règlements.")
        titre = _("Gestion des modes de règlements")
        ...
        self.bouton_creer_mode_prelevement = CTRL_Bouton_image.CTRL(self, texte=_("Créer un mode Prélèvement"), cheminImage="Images/32x32/Prelevement.png")
    ...
    def __set_properties(self):
        self.bouton_ajouter.SetToolTip(wx.ToolTip(_("Cliquez ici pour ajouter un mode de règlement")))
        self.bouton_modifier.SetToolTip(wx.ToolTip(_("Cliquez ici pour modifier le mode de règlement sélectionné dans la liste")))
        self.bouton_supprimer.SetToolTip(wx.ToolTip(_("Cliquez ici pour supprimer le mode de règlement sélectionné dans la liste")))
        self.bouton_creer_mode_prelevement.SetToolTip(wx.ToolTip(_("Cliquez ici pour créer automatiquement un mode 'Prélèvement'")))
    ...
    def Creer_mode_prelevement(self, event=None):
        ...
        # Confirmation
        dlg = wx.MessageDialog(self, _("Confirmez-vous la création d'un mode de règlement 'Prélèvement automatique' ?"), _("Confirmation"), wx.YES_NO | wx.NO_DEFAULT | wx.CANCEL | wx.ICON_QUESTION)
        reponse = dlg.ShowModal()
        dlg.Destroy()
        if reponse != wx.ID_YES:
            return
        ...
        # Sauvegarde
        DB = GestionDB.DB()
        listeDonnees = [("label", _("Prélèvement automatique")), ]
