...
class Dialog(wx.Dialog):
    def __init__(self, parent, IDfamille=None):
        ...
        intro = _("Vous pouvez ici visualiser uniquement la répartition des ventilations par règlement. Double-cliquez sur un règlement pour faire apparaître sa ventilation détaillée.")
        titre = _("Répartition de la ventilation")
    ...
    def __set_properties(self):
        self.SetTitle(_("Répartition de la ventilation"))
