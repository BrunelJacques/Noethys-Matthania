...
class Panel(wx.Panel):
    def __init__(self, parent, IDfamille=None):
        ...
        # Propriétés
        self.bouton_ajouter.SetToolTip(wx.ToolTip(_("Cliquez ici pour saisir une cotisation")))
        self.bouton_modifier.SetToolTip(wx.ToolTip(_("Cliquez ici pour modifier la cotisation sélectionnée")))
        self.bouton_supprimer.SetToolTip(wx.ToolTip(_("Cliquez ici pour supprimer la cotisation sélectionnée")))
        self.bouton_imprimer.SetToolTip(wx.ToolTip(_("Cliquez ici pour imprimer un document")))
    ...
    def OnBoutonImprimer(self, event):
        ...
        item = wx.MenuItem(menuPop, 40, _("Imprimer la cotisation"))
        ...
        item = wx.MenuItem(menuPop, 10, _("Editer un reçu Dons aux Oeuvres (PDF)"))
        bmp = wx.Bitmap(Chemins.GetStaticPath("Images/16x16/Apercu.png"), wx.BITMAP_TYPE_PNG)
        item.SetBitmap(bmp)
        menuPop.AppendItem(item)
