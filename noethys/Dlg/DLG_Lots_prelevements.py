...
from Ol import OL_Lots_prelevements
...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = _("Vous pouvez ici saisir, modifier ou supprimer des lots de prélèvements.")
        titre = _("Gestion des lots de prélèvements")
        self.SetTitle(titre)
        ...
        self.ctrl_recherche = OL_Lots_prelevements.CTRL_Outils(self, listview=self.ctrl_listview)
