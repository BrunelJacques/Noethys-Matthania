...
class Track(object):
    ...
    def GetTexteInfoBulle(self):
        ...
        dictDonnees = {
            ...
            "texte" : texte,
            "pied" : "Double-cliquez pour accéder au détail",
            }
        return dictDonnees
...
class CTRL(wx.Panel):
    ...
    def MakeToolBar2(self):
        ...
        tbar.AddSimpleTool(ID_OUTIL_AFFICHAGE_LABELS, _("Afficher les labels associés aux données"), wx.Bitmap(Chemins.GetStaticPath("Images/32x32/Calque_label.png"), wx.BITMAP_TYPE_ANY), _("Afficher les labels associés aux données"), aui.ITEM_CHECK)
        ...
        tbar.AddSimpleTool(ID_OUTIL_AFFICHAGE_REMPLISSAGE, _("Afficher le remplissage des objets associés aux données"), wx.Bitmap(Chemins.GetStaticPath("Images/32x32/Calque_fond.png"), wx.BITMAP_TYPE_ANY), _("Afficher le remplissage des objets associés aux données"), aui.ITEM_CHECK)
        ...
        tbar.AddSimpleTool(ID_OUTIL_AFFICHAGE_COULEURS, _("Synchroniser les couleurs du remplissage avec les données"), wx.Bitmap(Chemins.GetStaticPath("Images/32x32/Calque_couleurs.png"), wx.BITMAP_TYPE_ANY), _("Synchroniser les couleurs du remplissage avec les données"), aui.ITEM_CHECK)
        ...
        tbar.AddSimpleTool(ID_OUTIL_AFFICHAGE_BORDS, _("Afficher les bords des objets associés aux données"), wx.Bitmap(Chemins.GetStaticPath("Images/32x32/Calque_bords.png"), wx.BITMAP_TYPE_ANY), _("Afficher les bords des objets associés aux données"), aui.ITEM_CHECK)
