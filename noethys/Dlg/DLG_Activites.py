...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = _("Vous pouvez ici saisir, modifier ou supprimer des activités. Une activité peut être un Accueil de Loisirs, un séjour de vacances, une cantine scolaire, une garderie périscolaire, une crèche, une activité sportive ou culturelle, etc...")
        titre = _("Gestion des activités")
        ...
        self.bouton_exporter = wx.BitmapButton(self, -1, wx.Bitmap(Chemins.GetStaticPath("Images/16x16/Document_export.png"), wx.BITMAP_TYPE_ANY))

        # Commande télécharger
        self.ctrl_image = wx.StaticBitmap(self, -1, wx.Bitmap(Chemins.GetStaticPath("Images/16x16/Updater.png"), wx.BITMAP_TYPE_ANY))
        self.hyper_telecharger = Hyperlien(self, label=_("Télécharger des paramétrages d'activités"), infobulle=_("Cliquez ici pour télécharger et importer des paramétrages d'activités"), URL="telecharger")
    ...
    def __set_properties(self):
        self.SetTitle(_("Gestion des activités"))
        self.bouton_ajouter.SetToolTip(_("Cliquez ici pour créer une activité"))
        self.bouton_modifier.SetToolTip(_("Cliquez ici pour modifier l'activité sélectionnée dans la liste"))
        self.bouton_supprimer.SetToolTip(_("Cliquez ici pour supprimer l'activité sélectionnée dans la liste"))
        self.bouton_dupliquer.SetToolTip(_("Cliquez ici pour dupliquer l'activité sélectionnée dans la liste"))
        self.bouton_importer.SetToolTip(_("Cliquez ici pour importer un paramétrage d'activité (.nxa)"))
        self.bouton_exporter.SetToolTip(_("Cliquez ici pour exporter un ou plusieurs paramétrages d'activités (.nxa)"))
