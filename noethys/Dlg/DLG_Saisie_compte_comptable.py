...
class Dialog(wx.Dialog):
    def __init__(self, parent, IDcompte=None):
        ...
        self.label_numero = wx.StaticText(self, wx.ID_ANY, _("Numéro :"))
        self.ctrl_numero = wx.TextCtrl(self, wx.ID_ANY, "")
    ...
    def __set_properties(self):
        self.ctrl_nom.SetToolTip(wx.ToolTip(_("Saisissez le nom du compte")))
        self.ctrl_numero.SetToolTip(wx.ToolTip(_("Saisissez le numéro du compte")))
    ...
    def Sauvegarde(self):
        ...
        if numero == "" :
            dlg = wx.MessageDialog(self, _("Vous devez obligatoirement saisir un numéro !"), _("Erreur"), wx.OK | wx.ICON_EXCLAMATION)
            dlg.ShowModal()
            dlg.Destroy()
