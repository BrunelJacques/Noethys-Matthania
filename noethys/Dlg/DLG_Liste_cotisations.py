...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = _("Vous pouvez ici consulter la liste complète des cotisations créées dans le logiciel.")
        ...
        self.ctrl_cotisations = CTRL_Liste_cotisations.CTRL(self)
...
##        self.ctrl_cotisations.MAJ() 
    ...
    def __do_layout(self):
        ...
        grid_sizer_base.Add(self.ctrl_cotisations, 1, wx.LEFT|wx.RIGHT|wx.EXPAND, 10)
    ...
    def OnBoutonAide(self, event): 
        ...
        UTILS_Aide.Aide("Listedescotisations")
