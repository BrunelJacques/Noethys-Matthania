...
from Ol import OL_Categories_travail
...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = _("Vous pouvez ici saisir, modifier ou supprimer des catégories socio-professionnelles. Celles-ci sont utilisées dans les fiches individuelles.")
        titre = _("Gestion des catégories socio-professionnelles")
        ...
        self.ctrl_recherche = OL_Categories_travail.CTRL_Outils(self, listview=self.ctrl_listview)
    ...
    def __set_properties(self):
        self.SetTitle(_("Gestion des catégories socio-professionnelles"))
    ...
    def OnBoutonAide(self, event): 
        ...
        UTILS_Aide.Aide("Catgoriessocioprofessionnelles")
