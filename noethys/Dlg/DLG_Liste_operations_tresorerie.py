...
class Dialog(wx.Dialog):
    def __init__(self, parent, IDcompte_bancaire=None):
        ...
        intro = _("Vous pouvez consulter ici la liste des opérations d'un compte bancaire. Sélectionnez un compte dans la liste déroulante et ajoutez rapidement des opérations grâce aux boutons raccourcis situés au-dessus de la liste.")
        titre = _("Liste des opérations de trésorerie")
        self.SetTitle(titre)
        ...
        self.barreOutils.AddLabelTool(ID_AJOUTER_DEBIT, label=_("Ajouter un débit"), bitmap=wx.Bitmap(Chemins.GetStaticPath("Images/22x22/Addition.png"), wx.BITMAP_TYPE_PNG), shortHelp=_("Ajouter une opération au débit"), longHelp=_("Ajouter une opération au débit"))
        self.barreOutils.AddLabelTool(ID_AJOUTER_CREDIT, label=_("Ajouter un crédit"), bitmap=wx.Bitmap(Chemins.GetStaticPath("Images/22x22/Addition.png"), wx.BITMAP_TYPE_PNG), shortHelp=_("Ajouter une opération au crédit"), longHelp=_("Ajouter une opération au crédit"))
        self.barreOutils.AddLabelTool(ID_AJOUTER_VIREMENT, label=_("Ajouter un virement"), bitmap=wx.Bitmap(Chemins.GetStaticPath("Images/22x22/Addition.png"), wx.BITMAP_TYPE_PNG), shortHelp=_("Ajouter un virement"), longHelp=_("Ajouter un virement"))
        try :
        ...
        self.bouton_tresorerie = CTRL_Bouton_image.CTRL(self, texte=_("Trésorerie"), cheminImage="Images/32x32/Tresorerie.png")
    ...
    def __set_properties(self):
        self.bouton_ajouter.SetToolTip(wx.ToolTip(_("Cliquez ici pour ajouter une opération")))
        self.bouton_modifier.SetToolTip(wx.ToolTip(_("Cliquez ici pour modifier l'opération sélectionnée dans la liste")))
        self.bouton_supprimer.SetToolTip(wx.ToolTip(_("Cliquez ici pour supprimer l'opération sélectionné dans la liste")))
        ...
        self.bouton_tresorerie.SetToolTip(wx.ToolTip(_("Cliquez ici pour ouvrir le suivi de la trésorerie")))
    ...
    def Ajouter(self, event=None):
        ...
        item = wx.MenuItem(menuPop, 20, _("Ajouter une opération au crédit"))
        item.SetBitmap(wx.Bitmap(Chemins.GetStaticPath("Images/16x16/Addition.png"), wx.BITMAP_TYPE_PNG))
        menuPop.AppendItem(item)
        self.Bind(wx.EVT_MENU, self.ctrl_operations.AjouterCredit, id=20)

        item = wx.MenuItem(menuPop, 30, _("Ajouter un virement"))
        item.SetBitmap(wx.Bitmap(Chemins.GetStaticPath("Images/16x16/Addition.png"), wx.BITMAP_TYPE_PNG))
        menuPop.AppendItem(item)
