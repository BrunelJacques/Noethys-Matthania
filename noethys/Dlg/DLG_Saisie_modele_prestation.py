...
class Dialog(wx.Dialog):
    def __init__(self, parent, IDmodele=None):
        ...
        if self.IDmodele == None :
            titre = _("Saisie d'un modèle de prestation")
        else:
            titre = _("Modification d'un modèle de prestation")
        self.SetTitle(titre)
        intro = _("Vous pouvez saisir ou modifier ici les caractéristiques d'un modèle de prestation. Un modèle permet une saisie rapide de plusieurs prestations aux caractéristiques identiques.")
        ...
        self.label_categorie_tarif = wx.StaticText(self, -1, _("Catégorie :"))
        self.ctrl_categorie_tarif = Choix_categorie_tarif(self)
        self.label_tarif = wx.StaticText(self, -1, _("Tarif :"))
        ...
        # Tarification
        self.staticbox_tarification_staticbox = wx.StaticBox(self, -1, _("Tarification"))
    ...
    def __set_properties(self):
        self.ctrl_categorie.SetToolTip(wx.ToolTip(_("Sélectionnez ici la catégorie de la prestation")))
        self.ctrl_label.SetToolTip(wx.ToolTip(_("Saisissez un intitulé pour cette prestation")))
        self.radio_type_familiale.SetToolTip(wx.ToolTip(_("Selectionnez cette case si la prestation concerne toute la famille")))
        self.radio_type_individuelle.SetToolTip(wx.ToolTip(_("Selectionnez cette case si la prestation ne concerne qu'un individu")))
        self.ctrl_activite.SetToolTip(wx.ToolTip(_("Selectionnez ici l'activité concernée par la prestation")))
        self.ctrl_categorie_tarif.SetToolTip(wx.ToolTip(_("Selectionnez ici la catégorie de tarif rattaché a cette prestation")))
        self.ctrl_tarif.SetToolTip(wx.ToolTip(_("Selectionnez un tarif parmi ceux proposés")))
