...
class Dialog(wx.Dialog):
    ...
    def __set_properties(self):
        ...
        self.bouton_categorie.SetToolTip(wx.ToolTip(_("Cliquez ici pour accéder à la gestion des catégories de messages")))
        self.ctrl_afficher_accueil.SetToolTip(wx.ToolTip(_("Cochez cette case pour afficher ce message sur la page d'accueil")))
    ...
    def OnBoutonOk(self, event): 
        ...
        if self.ctrl_parution.GetDate() == None :
            dlg = wx.MessageDialog(self, _("Vous devez obligatoirement saisir une date de parution !"), _("Erreur de saisie"), wx.OK | wx.ICON_EXCLAMATION)
            dlg.ShowModal()
            dlg.Destroy()
