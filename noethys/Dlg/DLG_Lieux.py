...
# -*- coding: iso-8859-15 -*-
#------------------------------------------------------------------------
# Application :    Noethys, transformé port en lieu
...
from Ol import OL_Lieux

try: import psyco; psyco.full()
except: pass

DICT_CATEGORIES = {
    "gare" : {"singulier":_("gare"), "pluriel":_("gares"), "masculinFeminin":"e", "image":"Train"},
    "intercamp" : {"singulier":_("intercamp"), "pluriel":_("intercamps"), "masculinFeminin":"e", "image":"Horloge3"},
    "aeroport" : {"singulier":_("aéroport"), "pluriel":_("aéroports"), "masculinFeminin":"", "image":"Avion"},
    "port" : {"singulier":_("lieu"), "pluriel":_("lieux"), "masculinFeminin":"", "image":"Ecole"},
    "station" : {"singulier":_("station de métro"), "pluriel":_("stations de métro"), "masculinFeminin":"e", "image":"Metro"},
    }

class Dialog(wx.Dialog):
    def __init__(self, parent, categorie="aeroport", mode="gestion"):
        wx.Dialog.__init__(self, None, -1, name="DLG_Lieux", style=wx.DEFAULT_DIALOG_STYLE|wx.RESIZE_BORDER|wx.MAXIMIZE_BOX|wx.MINIMIZE_BOX)
        self.parent = parent
        self.mode = mode
        ...
        if self.mode == "selection" :
            intro = _("Vous pouvez ici sélectionner un%s %s. Double-cliquez sur une ligne pour effectuer rapidement la sélection.") % (self.masculinFeminin, self.categorieSingulier)
            titre = _("Sélection d'un%s %s") % (self.masculinFeminin, self.categorieSingulier)
    ...
    def __set_properties(self):
        self.bouton_ajouter.SetToolTip(_("Cliquez ici pour ajouter un%s %s") % (self.masculinFeminin, self.categorieSingulier))
        self.bouton_modifier.SetToolTip(_("Cliquez ici pour modifier le lieu sélectionné dans la liste"))
        self.bouton_supprimer.SetToolTip(_("Cliquez ici pour supprimer le lieu sélectionné dans la liste"))
