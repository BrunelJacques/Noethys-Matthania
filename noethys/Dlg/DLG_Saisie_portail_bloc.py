...
class PAGE_Texte(wx.Panel):
    ...
    def Validation(self):
        if len(self.ctrl_editeur.GetValue()) == 0 :
            dlg = wx.MessageDialog(self, _("Vous devez obligatoirement saisir un texte !"), "Erreur de saisie", wx.OK | wx.ICON_EXCLAMATION)
            dlg.ShowModal()
            dlg.Destroy()
...
class PAGE_Onglets(wx.Panel):
    def __init__(self, parent):
        ...
        # Propriétés
        self.bouton_ajouter.SetToolTip(wx.ToolTip(_("Cliquez ici pour ajouter un onglet")))
        self.bouton_modifier.SetToolTip(wx.ToolTip(_("Cliquez ici pour modifier l'onglet sélectionné dans la liste")))
        self.bouton_supprimer.SetToolTip(wx.ToolTip(_("Cliquez ici pour supprimer l'onglet sélectionné dans la liste")))
        self.bouton_monter.SetToolTip(wx.ToolTip(_("Cliquez ici pour monter l'onglet sélectionné dans la liste")))
        self.bouton_descendre.SetToolTip(wx.ToolTip(_("Cliquez ici pour descendre l'onglet sélectionné dans la liste")))
    ...
    def Validation(self):
        if len(self.GetParametres()["elements"]) == 0 :
            dlg = wx.MessageDialog(self, _("Vous devez créer au moins un onglet pour ce modèle !"), _("Erreur de saisie"), wx.OK | wx.ICON_EXCLAMATION)
            dlg.ShowModal()
            dlg.Destroy()
            return False
        return True
...
class PAGE_Blog(wx.Panel):
    def __init__(self, parent):
        ...
        # Propriétés
        self.bouton_ajouter.SetToolTip(wx.ToolTip(_("Cliquez ici pour ajouter un article")))
        self.bouton_modifier.SetToolTip(wx.ToolTip(_("Cliquez ici pour modifier l'article sélectionné dans la liste")))
        self.bouton_supprimer.SetToolTip(wx.ToolTip(_("Cliquez ici pour supprimer l'article sélectionné dans la liste")))
...
class PAGE_Calendrier(wx.Panel):
    def __init__(self, parent):
        ...
        # Propriétés
        self.bouton_ajouter.SetToolTip(wx.ToolTip(_("Cliquez ici pour ajouter un évènement")))
...
class PAGE_Trombi(wx.Panel):
    def __init__(self, parent):
        ...
        # Propriétés
        self.bouton_ajouter.SetToolTip(wx.ToolTip(_("Cliquez ici pour ajouter un individu")))
        self.bouton_modifier.SetToolTip(wx.ToolTip(_("Cliquez ici pour modifier l'individu sélectionné dans la liste")))
        self.bouton_supprimer.SetToolTip(wx.ToolTip(_("Cliquez ici pour supprimer l'individu sélectionné dans la liste")))
        self.bouton_monter.SetToolTip(wx.ToolTip(_("Cliquez ici pour monter l'individu sélectionné dans la liste")))
        self.bouton_descendre.SetToolTip(wx.ToolTip(_("Cliquez ici pour descendre l'individu sélectionné dans la liste")))
    ...
    def Validation(self):
        if len(self.GetParametres()["elements"]) == 0 :
            dlg = wx.MessageDialog(self, _("Vous devez créer au moins un individu pour ce trombinoscope !"), _("Erreur de saisie"), wx.OK | wx.ICON_EXCLAMATION)
            dlg.ShowModal()
            dlg.Destroy()
            return False
        return True
...
class CTRL_Parametres(LB.FlatImageBook):
    def __init__(self, parent):
        ...
        self.listePages = [
            (_("bloc_texte"), _("Texte"), PAGE_Texte(self), wx.Bitmap(Chemins.GetStaticPath('Images/32x32/Texte_bloc.png'), wx.BITMAP_TYPE_PNG)),
            (_("bloc_onglets"), _("Onglets"), PAGE_Onglets(self), wx.Bitmap(Chemins.GetStaticPath('Images/32x32/Onglets.png'), wx.BITMAP_TYPE_PNG)),
            (_("bloc_blog"), _("Blog"), PAGE_Blog(self), wx.Bitmap(Chemins.GetStaticPath('Images/32x32/Blog.png'), wx.BITMAP_TYPE_PNG)),
            (_("bloc_calendrier"), _("Calendrier"), PAGE_Calendrier(self), wx.Bitmap(Chemins.GetStaticPath('Images/32x32/Calendrier.png'), wx.BITMAP_TYPE_PNG)),
            (_("bloc_trombi"), _("Portraits"), PAGE_Trombi(self), wx.Bitmap(Chemins.GetStaticPath('Images/32x32/Trombi.png'), wx.BITMAP_TYPE_PNG)),
        ]
...
class Dialog(wx.Dialog):
    def __init__(self, parent, IDbloc=None):
        ...
        self.label_page = wx.StaticText(self, -1, _("Page :"))
        self.ctrl_page = CTRL_Page(self)

        self.label_couleur = wx.StaticText(self, -1, _("Couleur :"))
        ...
        # Init
        if self.IDbloc == None :
            self.SetTitle(_("Saisie d'un bloc"))
        else :
            self.SetTitle(_("Modification d'un bloc"))
            self.Importation()
        self.ctrl_titre.SetFocus()

    def __set_properties(self):
        self.ctrl_titre.SetToolTip(wx.ToolTip(_("Saisissez ici le titre du bloc")))
        self.ctrl_page.SetToolTip(wx.ToolTip(_("Sélectionnez ici la page dans laquelle vous souhaitez insérer ce bloc")))
        self.ctrl_couleur.SetToolTip(wx.ToolTip(_("Sélectionnez ici la couleur du bloc")))
    ...
    def OnBoutonOk(self, event):
        ...
        if titre == "" :
            dlg = wx.MessageDialog(self, _("Vous devez obligatoirement saisir un titre pour ce bloc !"), _("Erreur de saisie"), wx.OK | wx.ICON_EXCLAMATION)
            dlg.ShowModal()
            dlg.Destroy()
            self.ctrl_titre.SetFocus()
            return False
