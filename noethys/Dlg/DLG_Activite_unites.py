...
class Panel(wx.Panel):
    def __init__(self, parent, IDactivite=None, nouvelleActivite=False):
        ...
        # Unités
        self.staticbox_unites_staticbox = wx.StaticBox(self, -1, _("Unités de consommation"))
        ...
        # Remplissage
        self.staticbox_remplissage_staticbox = wx.StaticBox(self, -1, _("Unités de remplissage"))
