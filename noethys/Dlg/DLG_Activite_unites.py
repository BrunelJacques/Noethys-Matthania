...
class Panel(wx.Panel):
    def __init__(self, parent, IDactivite=None, nouvelleActivite=False):
        ...
        # Unités
        self.stbUnites = wx.StaticBox(self, -1, _("Unités de consommation"))
        self.ctrl_unites = OL_Unites.ListView(self.stbUnites, IDactivite=self.IDactivite, id=-1, name="OL_unites", style=wx.LC_REPORT|wx.SUNKEN_BORDER|wx.LC_SINGLE_SEL|wx.LC_HRULES|wx.LC_VRULES)
        self.ctrl_unites.SetMinSize((100, 100))
        self.ctrl_unites.MAJ()
        self.bouton_unites_ajouter = wx.BitmapButton(self.stbUnites, -1, wx.Bitmap(Chemins.GetStaticPath(u"Images/16x16/Ajouter.png"), wx.BITMAP_TYPE_ANY))
        self.bouton_unites_modifier = wx.BitmapButton(self.stbUnites, -1, wx.Bitmap(Chemins.GetStaticPath(u"Images/16x16/Modifier.png"), wx.BITMAP_TYPE_ANY))
        self.bouton_unites_supprimer = wx.BitmapButton(self.stbUnites, -1, wx.Bitmap(Chemins.GetStaticPath(u"Images/16x16/Supprimer.png"), wx.BITMAP_TYPE_ANY))
        self.bouton_unites_monter = wx.BitmapButton(self.stbUnites, -1, wx.Bitmap(Chemins.GetStaticPath(u"Images/16x16/Fleche_haut.png"), wx.BITMAP_TYPE_ANY))
        self.bouton_unites_descendre = wx.BitmapButton(self.stbUnites, -1, wx.Bitmap(Chemins.GetStaticPath(u"Images/16x16/Fleche_bas.png"), wx.BITMAP_TYPE_ANY))
        
        # Remplissage
        self.stbRempliss = wx.StaticBox(self, -1, _("Unités de remplissage"))
        self.ctrl_remplissage = OL_Unites_remplissage.ListView(self.stbRempliss, IDactivite=self.IDactivite, id=-1, name="OL_unites", style=wx.LC_REPORT|wx.SUNKEN_BORDER|wx.LC_SINGLE_SEL|wx.LC_HRULES|wx.LC_VRULES)
        self.ctrl_remplissage.SetMinSize((100, 100))
        self.ctrl_remplissage.MAJ()
        self.bouton_remplissage_ajouter = wx.BitmapButton(self.stbRempliss, -1, wx.Bitmap(Chemins.GetStaticPath(u"Images/16x16/Ajouter.png"), wx.BITMAP_TYPE_ANY))
        self.bouton_remplissage_modifier = wx.BitmapButton(self.stbRempliss, -1, wx.Bitmap(Chemins.GetStaticPath(u"Images/16x16/Modifier.png"), wx.BITMAP_TYPE_ANY))
        self.bouton_remplissage_supprimer = wx.BitmapButton(self.stbRempliss, -1, wx.Bitmap(Chemins.GetStaticPath(u"Images/16x16/Supprimer.png"), wx.BITMAP_TYPE_ANY))
        self.bouton_remplissage_monter = wx.BitmapButton(self.stbRempliss, -1, wx.Bitmap(Chemins.GetStaticPath(u"Images/16x16/Fleche_haut.png"), wx.BITMAP_TYPE_ANY))
        self.bouton_remplissage_descendre = wx.BitmapButton(self.stbRempliss, -1, wx.Bitmap(Chemins.GetStaticPath(u"Images/16x16/Fleche_bas.png"), wx.BITMAP_TYPE_ANY))
    ...
    def __set_properties(self):
        self.ctrl_unites.SetToolTip(wx.ToolTip(_("Liste des consommations")))
        self.bouton_unites_ajouter.SetToolTip(wx.ToolTip(_("Cliquez ici pour créer une unité de consommation")))
        self.bouton_unites_modifier.SetToolTip(wx.ToolTip(_("Cliquez ici pour modifier l'unité de consommation sélectionnée dans la liste")))
        self.bouton_unites_supprimer.SetToolTip(wx.ToolTip(_("Cliquez ici pour supprimer l'unité de consommation sélectionnée dans la liste")))
        self.bouton_unites_monter.SetToolTip(wx.ToolTip(_("Cliquez ici pour monter l'unité sélectionnée dans la liste")))
        self.bouton_unites_descendre.SetToolTip(wx.ToolTip(_("Cliquez ici pour descendre l'unité sélectionnée dans la liste")))
        self.ctrl_remplissage.SetToolTip(wx.ToolTip(_("Liste des unités de remplissage")))
        self.bouton_remplissage_ajouter.SetToolTip(wx.ToolTip(_("Cliquez ici pour créer une unité de remplissage")))
        self.bouton_remplissage_modifier.SetToolTip(wx.ToolTip(_("Cliquez ici pour modifier l'unité de remplissage sélectionnée dans la liste")))
        self.bouton_remplissage_supprimer.SetToolTip(wx.ToolTip(_("Cliquez ici pour supprimer l'unité de remplissage selectionnée dans la liste")))
        self.bouton_remplissage_monter.SetToolTip(wx.ToolTip(_("Cliquez ici pour monter l'unité sélectionnée dans la liste")))
        self.bouton_remplissage_descendre.SetToolTip(wx.ToolTip(_("Cliquez ici pour descendre l'unité sélectionnée dans la liste")))
        
    def __do_layout(self):
        grid_sizer_base = wx.FlexGridSizer(rows=3, cols=1, vgap=10, hgap=10)
        grid_sizer_boutons_ouvertures = wx.FlexGridSizer(rows=5, cols=1, vgap=5, hgap=5)
        staticbox_remplissage = wx.StaticBoxSizer(self.stbRempliss, wx.VERTICAL)
        ...
        staticbox_unites = wx.StaticBoxSizer(self.stbUnites, wx.VERTICAL)
