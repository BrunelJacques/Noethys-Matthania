...
##        print self.source.GetSize()
    ...
    def Draw(self,dc):
        ...
        dc.DrawText(_("Cadre de sélection"), self.posxCadre+3, self.posyCadre+1)
...
class Dialog(wx.Dialog):
    def __init__(self, parent, image=None, tailleCadre=(384, 384), titre=_("Editeur photo"), listeVisages=[]):
    ...
    def __set_properties(self):
        self.SetTitle(_("Editeur de photo"))
        self.bouton_aide.SetToolTip(wx.ToolTip(_("Cliquez ici pour obtenir de l'aide")))
        self.bouton_ok.SetToolTip(wx.ToolTip(_("Cliquez ici pour valider l'image")))
        self.bouton_annuler.SetToolTip(wx.ToolTip(_("Cliquez ici pour annuler")))
        
        self.bouton_rotation_gauche.SetToolTip(wx.ToolTip(_("Cliquez ici pour effectuer une rotation de 90°\n dans le sens inverse des aiguilles d'une montre")))
        self.bouton_rotation_droite.SetToolTip(wx.ToolTip(_("Cliquez ici pour effectuer une rotation de 90°\n dans le sens des aiguilles d'une montre")))
        self.slider_zoom.SetToolTip(wx.ToolTip(_("Ajustez avec cette fonction zoom\nla taille de la photo")))
        self.bouton_reinit.SetToolTip(wx.ToolTip(_("Cliquez ici pour réinitialiser la position\net la taille de la photo initiale")))
