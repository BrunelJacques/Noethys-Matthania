...
class Panel(wx.Panel):
    def __init__(self, parent, clsbase=None):
        ...
        # Mensualités
        self.staticbox_mensualites_staticbox = wx.StaticBox(self, -1, _("Récapitulatif"))
    ...
    def __set_properties(self):
        self.bouton_recapitulatif_apercu.SetToolTip(wx.ToolTip(_("Cliquez ici pour afficher un aperçu avant impression de la liste")))
        self.bouton_recapitulatif_imprimer.SetToolTip(wx.ToolTip(_("Cliquez ici pour imprimer la liste")))
