...
class Dialog(wx.Dialog):
    def __init__(self, parent, IDfamille=None):
        ...
        intro = _("Vous pouvez ici visualiser le détail des déductions appliquées pour chaque type d'aide journalière. Double-cliquez sur une aide pour faire apparaître les déductions correspondantes.")
        titre = _("Détail des aides journalières appliquées")
    ...
    def __set_properties(self):
        self.SetTitle(_("Détail des aides journalières appliquées"))
