...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        # Bandeau
        titre = _("Commandes des repas")
        intro = _("Vous pouvez ici créer des commandes de repas. Sélectionnez un modèle de commande puis cliquez sur le bouton Ajouter pour créer une nouvelle commande. Si aucun modèle de commande n'existe, vous devez obligatoirement commencer par en créer un avant de saisir une commande.")
        self.SetTitle(titre)
    ...
    def __set_properties(self):
        self.ctrl_modele.SetToolTip(wx.ToolTip(_("Sélectionnez un modèle de commandes")))
        self.bouton_modeles.SetToolTip(wx.ToolTip(_("Cliquez ici pour ajouter, modifier ou supprimer des modèles de commandes")))
        self.bouton_ajouter.SetToolTip(wx.ToolTip(_("Cliquez ici pour créer une nouvelle commande")))
        self.bouton_modifier.SetToolTip(wx.ToolTip(_("Cliquez ici pour modifier la commande sélectionnée dans la liste")))
        self.bouton_supprimer.SetToolTip(wx.ToolTip(_("Cliquez ici pour supprimer la commande sélectionnée dans la liste")))
