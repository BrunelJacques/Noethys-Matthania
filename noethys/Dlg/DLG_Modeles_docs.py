...
LISTE_CATEGORIES = [
    ("facture", _("Facture")),
    ("rappel", _("Rappel")),
    ("attestation", _("Attestation de présence")),
...
class Dialog(wx.Dialog):
    ...
    def __set_properties(self):
        ...
        self.bouton_importer.SetToolTip(wx.ToolTip(_("Cliquez ici pour importer un modèle de document (.ndc)")))
        self.bouton_exporter.SetToolTip(wx.ToolTip(_("Cliquez ici pour exporter le modèle sélectionné dans la liste (.ndc)")))
        ...
        self.bouton_fonds.SetToolTip(wx.ToolTip(_("Cliquez ici pour accéder au paramétrage des fonds de page")))
