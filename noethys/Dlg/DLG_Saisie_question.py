...
class CTRL_Choix(FastObjectListView):
    ...
    def InitObjectListView(self):            
        ...
        liste_Colonnes = [
            ColumnDefn(_("IDchoix"), "left", 0, "IDchoix"),
            ColumnDefn(_("Label"), 'left', 410, "label", isSpaceFilling=True),
            ]

        self.rowFormatter = rowFormatter
        self.SetColumns(liste_Colonnes)
        self.SetEmptyListMsg(_("Aucun choix"))
    ...
    def Modifier(self, event=None):
        ...
        if track == None :
            dlg = wx.MessageDialog(self, _("Vous n'avez sélectionné aucun choix dans la liste !"), _("Erreur"), wx.OK | wx.ICON_EXCLAMATION)
            dlg.ShowModal()
            dlg.Destroy()
            return
        dlg = DLG_Saisie_choix_question.Dialog(self)
...
class Dialog(wx.Dialog):
    def __init__(self, parent, type="individu", IDquestion=None):
        ...
        self.label_controle = wx.StaticText(self, -1, _("Contrôle :"))
        self.ctrl_controle = CTRL_Controle(self)
        self.label_visible = wx.StaticText(self, -1, _("Visible :"))
        self.ctrl_visible = wx.CheckBox(self, -1, "")
        self.ctrl_visible.SetValue(True) 
        
        # Apercu
        self.box_apercu_staticbox = wx.StaticBox(self, -1, _("Valeurs par defaut"))
        ...
        # Choix
        self.box_choix_staticbox = wx.StaticBox(self, -1, _("Liste de choix"))
        ...
        self.label_hauteur = wx.StaticText(self, -1, _("Hauteur du contrôle :"))
        self.ctrl_hauteur = wx.SpinCtrl(self, -1, "")
        self.ctrl_hauteur.SetRange(-1, 500)
        self.label_valmin = wx.StaticText(self, -1, _("Valeur minimale :"))
        self.ctrl_valmin = wx.SpinCtrl(self, -1, "")
        self.ctrl_valmin.SetRange(0, 99999)
        self.label_valmax = wx.StaticText(self, -1, _("Valeur maximale :"))
    ...
    def __set_properties(self):
        self.SetTitle(_("Saisie d'une question"))
        self.ctrl_label.SetToolTip(wx.ToolTip(_("Saisissez ici le label de la question")))
        self.ctrl_categorie.SetToolTip(wx.ToolTip(_("Sélectionnez ici la catégorie de la question")))
        self.ctrl_controle.SetToolTip(wx.ToolTip(_("Sélectionnez ici le type de contrôle souhaité")))
        self.ctrl_visible.SetToolTip(wx.ToolTip(_("Cochez cette case pour rendre visible cette question")))
        self.bouton_ajouter_choix.SetToolTip(wx.ToolTip(_("Cliquez ici pour ajouter une nouvelle question")))
        self.bouton_modifier_choix.SetToolTip(wx.ToolTip(_("Cliquez ici pour modifier la ligne sélectionnée dans la liste")))
        self.bouton_supprimer_choix.SetToolTip(wx.ToolTip(_("Cliquez ici pour supprimer la ligne sélectionnée dans la liste")))
        self.bouton_monter_choix.SetToolTip(wx.ToolTip(_("Cliquez ici pour monter la ligne sélectionnée dans la liste")))
        self.bouton_descendre_choix.SetToolTip(wx.ToolTip(_("Cliquez ici pour descendre la ligne sélectionnée dans la liste")))
        self.bouton_aide.SetToolTip(wx.ToolTip(_("Cliquez ici pour obtenir de l'aide")))
        self.ctrl_hauteur.SetToolTip(wx.ToolTip(_("Saisissez ici la hauteur du contrôle (en pixels)\nIndiquez '-1' pour définir une taille automatiquement")))
        self.ctrl_valmin.SetToolTip(wx.ToolTip(_("Saisissez ici la valeur minimale du contrôle")))
        self.ctrl_valmax.SetToolTip(wx.ToolTip(_("Saisissez ici la valeur maximale du contrôle")))
    ...
    def OnBoutonOk(self, event): 
        ...
        if label == "" :
            dlg = wx.MessageDialog(self, _("Vous n'avez saisi aucun label !"), _("Erreur"), wx.OK | wx.ICON_EXCLAMATION)
            dlg.ShowModal()
            dlg.Destroy()
            return
