...
class Dialog(wx.Dialog):
    def __init__(self, parent, listeBoutons=[], titre=_("Quel type de prélèvement souhaitez-vous créer ?"), intro=_("Cliquez sur la norme souhaitée..."), minSize=(500, 400)):
...
if __name__ == "__main__":
    ...
    listeBoutons = [
        (_("Label 1"), _("Description 1")),
        (_("Label 2"), _("Description 2")),
        ]
