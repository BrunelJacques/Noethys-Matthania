...
class Dialog(wx.Dialog):
    def __init__(self, parent, IDcompte_payeur=None):
        ...
        intro = _("Vous pouvez ici consulter la liste complète des lettres de rappel créées dans le logiciel.")
        titre = _("Liste des lettres de rappel")
        self.SetTitle(titre)
        self.ctrl_bandeau = CTRL_Bandeau.Bandeau(self, titre=titre, texte=intro, hauteurHtml=30, nomImage="Images/32x32/Facture.png")

        self.ctrl_rappels = CTRL_Liste_rappels.CTRL(self, IDcompte_payeur=IDcompte_payeur)
    ...
    def __do_layout(self):
        ...
        grid_sizer_base.Add(self.ctrl_rappels, 1, wx.LEFT|wx.RIGHT|wx.EXPAND, 10)
    ...
    def OnBoutonAide(self, event): 
        ...
        UTILS_Aide.Aide("Listedeslettresderappel")
