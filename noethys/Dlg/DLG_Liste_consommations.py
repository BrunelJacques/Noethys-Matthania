...
class CTRL_Activite(wx.Choice):
    ...
    def SetListeDonnees(self):
        self.listeNoms = [_("Toutes les activités")]
        self.listeID = [None,]
        DB = GestionDB.DB()
...
class CTRL_Annee(wx.Choice):
    ...
    def SetListeDonnees(self):
        self.listeNoms = [_("Toutes les années")]
        self.listeID = [None,]
        DB = GestionDB.DB()
...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = _("Vous pouvez ici consulter la liste complète des consommations saisies dans le logiciel.")
        titre = _("Liste détaillée des consommations")
    ...
    def __set_properties(self):
        self.SetTitle(_("Liste détaillée des consommations"))
        self.ctrl_activite.SetToolTip(wx.ToolTip(_("Sélectionnez un filtre d'activité")))
        self.bouton_supprimer.SetToolTip(wx.ToolTip(_("Cliquez ici pour supprimer la consommation sélectionnée dans la liste")))
