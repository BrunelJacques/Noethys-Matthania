...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        # Bandeau
        intro = _("Vous pouvez consulter ici la liste des consommations badgées sur une période choisie. Commencez par sélectionner une période de référence puis actualisez l'affichage de la liste.")
        titre = _("Consommations badgées")
        self.SetTitle(titre)
        ...
        # Log
        self.box_log_staticbox = wx.StaticBox(self, -1, _("Consommations"))
    ...
    def __set_properties(self):
        self.ctrl_date_debut.SetToolTip(wx.ToolTip(_("Sélectionnez une date")))
        self.ctrl_date_fin.SetToolTip(wx.ToolTip(_("Sélectionnez une date")))
        self.bouton_log_apercu.SetToolTip(wx.ToolTip(_("Cliquez ici pour afficher un apercu avant impression")))
