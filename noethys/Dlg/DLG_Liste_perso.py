...
class Dialog(wx.Dialog):
    def __init__(self, parent, IDlot=None):
        ...
        # Bandeau
        intro = _("Vous pouvez afficher ici les résultats d'une requête SQL. Pour en savoir davantage sur le langage SQL, consultez les sites dédiés sur internet.")
        titre = _("Liste personnalisée")
        self.SetTitle(titre)
        self.ctrl_bandeau = CTRL_Bandeau.Bandeau(self, titre=titre, texte=intro, hauteurHtml=30, nomImage="Images/32x32/Sql.png")
        
        # Paramètres
        self.box_parametres_staticbox = wx.StaticBox(self, wx.ID_ANY, _("Requête SQL"))
    ...
    def __set_properties(self):
        ...
        self.bouton_actualiser.SetToolTip(wx.ToolTip(_("Cliquez ici pour afficher les résultats de la requête")))
