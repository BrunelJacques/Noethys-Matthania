...
LISTE_CATEGORIES = [
    ("consommations", _("Consommations")),
    ("prestations", _("Prestations")),
    ("factures", _("Factures")),
    ("reglements", _("Règlements")),
    ("depots", _("Dépôts de règlements")),
    ("cotisations", _("Cotisations")),
]
...
class Dialog(wx.Dialog):
    def __init__(self, parent, IDperiode=None):
        ...
        if self.IDperiode != None :
            self.Importation()
            titre = _("Modification d'une période de gestion")
        else :
            titre = _("Saisie d'une période de gestion")
        self.SetTitle(titre)
    ...
    def __set_properties(self):
        ...
        self.ctrl_verrou.SetToolTip(wx.ToolTip(_("Cochez les éléments à verrouiller")))
    ...
    def Sauvegarde(self):
        ...
        if date_debut == None :
            dlg = wx.MessageDialog(self, _("Vous devez obligatoirement saisir une date de début de période !"), _("Erreur"), wx.OK | wx.ICON_EXCLAMATION)
            dlg.ShowModal()
            dlg.Destroy()
        ...
        if date_fin == None :
            dlg = wx.MessageDialog(self, _("Vous devez obligatoirement saisir une date de fin de période !"), _("Erreur"), wx.OK | wx.ICON_EXCLAMATION)
            dlg.ShowModal()
            dlg.Destroy()
