...
class Dialog(wx.Dialog):
    def __init__(self, parent, nouveau=False):
        ...
        if nouveau == True :
            intro = _("Vous pouvez saisir ici une consommation de type quantité. Tapez la quantité dans le champ de saisie ou utilisez les flèches.")
            titre = _("Saisie d'une quantité")
        else:
            intro = _("Vous pouvez modifier ici une consommation de type quantité. Tapez la quantité dans le champ de saisie ou utilisez les flèches.")
            titre = _("Modification d'une quantité")
        self.SetTitle(titre)
        ...
        self.ctrl_quantite = wx.SpinCtrl(self, -1, "1", min=1, max=1000, style=wx.TE_PROCESS_ENTER)
