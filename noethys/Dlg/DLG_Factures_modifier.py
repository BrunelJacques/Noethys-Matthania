...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        # Bandeau
        intro = _("Sélectionnez une ou plusieurs caractéristiques à modifier. Cliquez sur Ok pour appliquer les modifications aux factures sélectionnées.")
        titre = _("Modification des caractéristiques des factures")
        self.SetTitle(titre)
        ...
        self.check_emission = wx.CheckBox(self, -1, _("Date d'émission :"))
        self.ctrl_emission = CTRL_Saisie_date.Date2(self)

        self.check_echeance = wx.CheckBox(self, -1, _("Date d'échéance :"))
        self.ctrl_echeance = CTRL_Saisie_date.Date2(self)

        self.check_mention1 = wx.CheckBox(self, -1, _("Mention 1 :"))
        self.ctrl_mention1 = wx.TextCtrl(self, -1, "")

        self.check_mention2 = wx.CheckBox(self, -1, _("Mention 2 :"))
        self.ctrl_mention2 = wx.TextCtrl(self, -1, "")

        self.check_mention3 = wx.CheckBox(self, -1, _("Mention 3 :"))
    ...
    def __set_properties(self):
        self.check_lot.SetToolTip(wx.ToolTip(_("Cochez pour modifier cette caractéristique")))
        self.ctrl_lot.SetToolTip(wx.ToolTip(_("Sélectionnez un lot de factures dans la liste")))
        self.check_emission.SetToolTip(wx.ToolTip(_("Cochez pour modifier cette caractéristique")))
        self.ctrl_emission.SetToolTip(wx.ToolTip(_("Sélectionnez une date d'émission")))
        self.check_echeance.SetToolTip(wx.ToolTip(_("Cochez pour modifier cette caractéristique")))
        self.ctrl_echeance.SetToolTip(wx.ToolTip(_("Sélectionnez une date d'échéance")))
        self.check_mention1.SetToolTip(wx.ToolTip(_("Cochez pour modifier cette caractéristique")))
        self.ctrl_mention1.SetToolTip(wx.ToolTip(_("Saisissez une mention")))
        self.check_mention2.SetToolTip(wx.ToolTip(_("Cochez pour modifier cette caractéristique")))
        self.ctrl_mention2.SetToolTip(wx.ToolTip(_("Saisissez une mention")))
        self.check_mention3.SetToolTip(wx.ToolTip(_("Cochez pour modifier cette caractéristique")))
        self.ctrl_mention3.SetToolTip(wx.ToolTip(_("Saisissez une mention")))
    ...
    def GetValeurs(self):
        ...
        if self.check_lot.GetValue() == True:
            ...
            if IDlot == None:
                dlg = wx.MessageDialog(self, _("Vous n'avez sélectionné aucun lot dans la liste proposée !"), _("Erreur de saisie"), wx.OK | wx.ICON_EXCLAMATION)
                dlg.ShowModal()
                dlg.Destroy()
                return False
        ...
        if self.check_emission.GetValue() == True:
            ...
            if date_emission == None:
                dlg = wx.MessageDialog(self, _("La date d'émission saisie n'est pas valide !"), _("Erreur de saisie"), wx.OK | wx.ICON_EXCLAMATION)
                dlg.ShowModal()
                dlg.Destroy()
                return False
        ...
        if self.check_echeance.GetValue() == True:
            ...
            if date_echeance == None:
                dlg = wx.MessageDialog(self, _("La date d'échéance saisie n'est pas valide !"), _("Erreur de saisie"), wx.OK | wx.ICON_EXCLAMATION)
                dlg.ShowModal()
                dlg.Destroy()
                return False
        ...
        if len(dict_valeurs) == 0 :
            dlg = wx.MessageDialog(self, _("Vous devez choisir au moins une caractéristique à modifier !"), _("Erreur de saisie"), wx.OK | wx.ICON_EXCLAMATION)
            dlg.ShowModal()
            dlg.Destroy()
            return False
