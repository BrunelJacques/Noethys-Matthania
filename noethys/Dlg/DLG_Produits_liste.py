...
class Panel(wx.Panel):
    ...
    def __set_properties(self):
        self.bouton_consulter.SetToolTip(wx.ToolTip(_("Cliquez ici pour consulter la fiche produit")))
...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = _("Vous pouvez ici consulter la liste des produits. Double-cliquez sur une ligne pour afficher la fiche produit correspondante.")
        titre = _("Liste des produits")
        self.SetTitle(titre)
