    ...
    def GetNomsTitulairesFamille(self, IDfamille):
        ...
        for IDindividu in self.dictTitulairesFamilles[IDfamille]  :
            ...
            if IDcivilite != None :
                ...
                civiliteAbrege = ""
            if civiliteAbrege == None : civiliteAbrege = ""
        ...
        if len(listeNoms) == 2 : return _("%s et %s") % (listeNoms[0], listeNoms[1])
        if len(listeNoms) > 2 :
            texteNoms = ""
            for nom in listeNoms[:-2] :
                texteNoms += "%s, " % nom
            texteNoms += _(" et ") + listeNoms[-1]
            return texteNoms
...
class Choice_liens(wx.Choice):
    ...
    def GetListeTypesLiens(self):
        ...
        listeChoix2 = []
        index = 0
        listeChoix2.append(_("n'a aucun lien"))
...
class CTRL_Saisie_Liens(HTL.HyperTreeList):
    def __init__(self, parent, id=wx.ID_ANY, pos=wx.DefaultPosition,
        ...
        self.AddColumn(_("Type de lien"))
        self.SetColumnWidth(1, 170)
        self.AddColumn(_("Niveau d'autorisation"))
        self.SetColumnWidth(2, 200)
        self.SetMainColumn(0)
                        
        # Création des branches
        self.root = self.AddRoot(_("Les liens"))
...
##                        ctrl_autorisations.SetIDautorisation(IDautorisation)
    ...
    def CreationBranches(self):
        ...
        for IDfamille in self.donnees.listeIDfamillesRattachees :
            ...
            label = _("Famille de %s") % self.donnees.GetNomsTitulairesFamille(IDfamille)
                    ...
                    if IDcategorie in self.donnees.dictLiens[IDfamille][self.IDindividu] :
                        ...
                        for IDindividu, dictIndividu in dictIndividus.items()  :
                            ...
                            if IDcategorie == 4 and IDindividu == None:
                                ...
                                infobulle = _("Sélectionnez le niveau d'autorisation de %s vis-à-vis de %s") % (prenom, self.donnees.dictInfosIndividus[self.IDindividu]["prenom"])
...
class Dialog_liens(wx.Dialog):
    def __init__(self, parent, IDindividu=None, IDfamille=None):
        ...
        intro = _("Vous bénéficiez ici d'une vue d'ensemble des liens unissant les membres de la famille sélectionnée. Vous pouvez utiliser un glisser-déposer avec votre souris sur chaque onglet pour afficher plusieurs individus à la fois.")
        self.ctrl_bandeau = CTRL_Bandeau.Bandeau(self, titre=_("Définition des liens"), texte=intro, hauteurHtml=30, nomImage="Images/32x32/Famille.png")
    ...
    def __set_properties(self):
        self.SetTitle(_("Définition des liens"))
