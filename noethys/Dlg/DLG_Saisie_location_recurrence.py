...
class Dialog(wx.Dialog):
    def __init__(self, parent, donnees=None):
        ...
        # Heures
        self.box_heures_staticbox = wx.StaticBox(self, -1, _("Horaires"))
        self.label_heure_debut = wx.StaticText(self, -1, "De")
        self.ctrl_heure_debut = CTRL_Saisie_heure.Heure(self)
        self.label_heure_fin = wx.StaticText(self, -1, _("à"))
    ...
    def __set_properties(self):
        self.SetTitle(_("Appliquer une récurrence"))
        ...
        self.ctrl_feries.SetToolTip(wx.ToolTip(_("Cochez cette case pour inclure également les jours fériés")))
    ...
    def OnBoutonOk(self, event):
        ...
        if date_debut > date_fin:
            dlg = wx.MessageDialog(self, _("Vous devez obligatoirement saisir une heure de fin supérieure à l'heure de début !"), _("Erreur de saisie"), wx.OK | wx.ICON_EXCLAMATION)
            dlg.ShowModal()
            dlg.Destroy()
            self.ctrl_heure_fin.SetFocus()
            return
