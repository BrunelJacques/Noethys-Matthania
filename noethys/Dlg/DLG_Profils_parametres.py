...
from Ol import OL_Profils_parametres
...
class Dialog(wx.Dialog):
    def __init__(self, parent, categorie=""):
        ...
        intro = _("Vous pouvez ici saisir, modifier ou supprimer des profils de configuration. Ces profils vous permettent de mémoriser des configurations pour une réutilisation ultérieure plus simple.")
        titre = _("Gestion des profils de configuration")
        ...
        self.ctrl_listview = OL_Profils_parametres.ListView(self, id=-1, categorie=categorie, style=wx.LC_REPORT|wx.SUNKEN_BORDER|wx.LC_SINGLE_SEL|wx.LC_HRULES|wx.LC_VRULES)
        self.ctrl_listview.MAJ()
        self.ctrl_recherche = OL_Profils_parametres.CTRL_Outils(self, listview=self.ctrl_listview)
    ...
    def __set_properties(self):
        self.SetTitle(_("Gestion des profils de configuration"))
        self.bouton_ajouter.SetToolTip(wx.ToolTip(_("Cliquez ici pour ajouter un profil")))
        self.bouton_modifier.SetToolTip(wx.ToolTip(_("Cliquez ici pour modifier le profil sélectionné")))
        self.bouton_supprimer.SetToolTip(wx.ToolTip(_("Cliquez ici pour supprimer le profil sélectionné")))
        self.bouton_dupliquer.SetToolTip(wx.ToolTip(_("Cliquez ici pour dupliquer le profil sélectionné")))
        self.bouton_defaut.SetToolTip(wx.ToolTip(_("Cliquez ici pour définir ce profil par défaut")))
    ...
    def GetDernierProfilCree(self):
        return self.ctrl_listview.dernierProfilCree
