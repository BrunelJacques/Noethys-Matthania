...
class EditeurAvecBoutons(wxpg.PyTextCtrlEditor):
    ...
    def CreateControls(self, propGrid, property, pos, sz):
        ...
        buttons.GetButton(0).SetToolTip(wx.ToolTip(_("Cliquez ici pour rétablir la valeur par défaut")))
...
class Dialog(wx.Dialog):
    def __init__(self, parent, listeDonnees=[]):
        ...
        intro = _("Vous pouvez ici modifier les hauteurs de lignes et largeurs des colonnes. Pour rétablir la valeur initiale d'une ligne, cliquez sur celle-ci et cliquez sur le bouton Réinitialiser situé à droite de la colonne.")
        titre = _("Paramètres de la grille")
        self.SetTitle(titre)
        ...
        self.bouton_reinit = wx.BitmapButton(self, -1, wx.Bitmap(Chemins.GetStaticPath("Images/BoutonsImages/Reinitialiser.png"), wx.BITMAP_TYPE_ANY))
    ...
    def __set_properties(self):
        ...
        self.bouton_reinit.SetToolTip(wx.ToolTip(_("Cliquez ici pour rétablir toutes les valeurs par défaut")))
