...
from Ol import OL_Badgeage_procedures
...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = _("Vous pouvez ici saisir, modifier ou supprimer des procédures de badgeage.")
        titre = _("Gestion des procédures de badgeage")
        self.SetTitle(titre)
        ...
        self.bouton_vocal = CTRL_Bouton_image.CTRL(self, texte=_("Configuration de la synthèse vocale"), cheminImage="Images/32x32/Vocal.png")
    ...
    def __set_properties(self):
        self.bouton_ajouter.SetToolTip(wx.ToolTip(_("Cliquez ici pour ajouter une procédure")))
        self.bouton_modifier.SetToolTip(wx.ToolTip(_("Cliquez ici pour modifier la procédure sélectionnée dans la liste")))
        self.bouton_supprimer.SetToolTip(wx.ToolTip(_("Cliquez ici pour supprimer la procédure sélectionnée dans la liste")))
        self.bouton_dupliquer.SetToolTip(wx.ToolTip(_("Cliquez ici pour dupliquer la procédure sélectionnée dans la liste")))
        self.bouton_defaut.SetToolTip(wx.ToolTip(_("Cliquez ici pour définir la procédure sélectionnée comme celle par défaut")))
