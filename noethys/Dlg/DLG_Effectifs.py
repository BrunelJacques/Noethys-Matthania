...
class CTRL(aui.AuiNotebook):
    def __init__(self, parent):
        ...
        self.AddPage(self.ctrl_nbre_inscrits, _("Inscrits par activité"))
        try :
            self.SetPageTooltip(2, _("Affiche l'état des inscriptions totales. \nVous pouvez glisser-déposer cet onglet pour déplacer la page."))
        except :
            pass
        ...
        self.AddPage(self.ctrl_evenements, _("Evènements"))
        try :
            self.SetPageTooltip(2, _("Affiche l'état des évènements. \nVous pouvez glisser-déposer cet onglet pour déplacer la page."))
        except :
            pass
        """
        ...
        try :
            self.SetPageTooltip(3, _("Affiche l'état des locations. \nVous pouvez glisser-déposer cet onglet pour déplacer la page."))
        except :
            pass
        """
