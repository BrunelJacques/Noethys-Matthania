...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        self.staticbox_adresse_staticbox = wx.StaticBox(self, -1, _("Adresse"))
        ...
        self.label_tel = wx.StaticText(self, -1, _("Tél. Cabinet :"))
        self.ctrl_tel = CTRL_Saisie_tel.Tel(self, intitule=_("cabinet"))
        self.label_mobile = wx.StaticText(self, -1, _("Tél. Mobile :"))
    ...
    def __set_properties(self):
        self.SetTitle(_("Saisie d'un médecin"))
        self.ctrl_nom.SetToolTip(wx.ToolTip(_("Saisissez le nom de famille du médecin")))
        self.ctrl_prenom.SetToolTip(wx.ToolTip(_("Saisissez le prénom du médecin")))
        self.ctrl_rue.SetToolTip(wx.ToolTip(_("Saisissez la rue du cabinet du médecin")))
        self.ctrl_tel.SetToolTip(wx.ToolTip(_("Saisissez le numéro de téléphone du cabinet")))
        self.ctrl_mobile.SetToolTip(wx.ToolTip(_("Saisissez le numéro de mobile du médecin")))
    ...
    def OnBoutonOk(self, event):
        if self.GetNom() == "" :
            dlg = wx.MessageDialog(self, _("Vous n'avez saisi aucun nom !"), _("Erreur de saisie"), wx.OK | wx.ICON_EXCLAMATION)
            dlg.ShowModal()
            dlg.Destroy()
