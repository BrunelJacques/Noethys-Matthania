...
class Options(wx.Panel):
    def __init__(self, parent):
        ...
        self.radio_avec = wx.RadioButton(self, -1, _("Uniquement familles avec code"))
        self.radio_sans = wx.RadioButton(self, -1, _("Uniquement familles sans code"))
...
class Parametres(wx.Panel):
    def __init__(self, parent):
        ...
        self.ctrl_activites = CTRL_Selection_activites_groupes.CTRL(self.stbActivite)
...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = _("Vous pouvez ici consulter la liste des codes comptables des familles. Double-cliquez sur une ligne pour modifier le code comptable correspondant.")
        titre = _("Liste des codes comptables")
        self.SetTitle(titre)
    ...
    def __set_properties(self):
        self.bouton_modifier.SetToolTip(wx.ToolTip(_("Cliquez ici pour modifier le code comptable de la ligne sélectionnée")))
        self.bouton_ouvrir_fiche.SetToolTip(wx.ToolTip(_("Cliquez ici pour ouvrir la fiche de la famille sélectionnée")))
    ...
    def GetLabelParametres(self):
        ...
        if option == "AVEC" : listeParametres.append(_("Uniquement les familles avec code"))
        if option == "SANS" : listeParametres.append(_("Uniquement les familles sans code"))
