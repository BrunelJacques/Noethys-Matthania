...
class Dialog(wx.Dialog):
    ...
    def __set_properties(self):
        self.SetTitle(_("Saisie d'une image interactive"))
        self.ctrl_nom.SetToolTip(wx.ToolTip(_("Saisissez ici un nom pour cette image interactive")))
    ...
    def OnBoutonOk(self, event):
        ...
        if IDdonnee == None :
            dlg = wx.MessageDialog(self, _("Vous devez obligatoirement sélectionner une donnée dans la liste proposée !"), _("Erreur de saisie"), wx.OK | wx.ICON_EXCLAMATION)
            dlg.ShowModal()
            dlg.Destroy()
            return
