...
class Dialog(wx.Dialog):
    def __init__(self, parent, IDexercice=None, defaut=0):
        ...
        if self.IDexercice != None :
            self.SetTitle(_("Modification d'un exercice"))
            self.Importation() 
        else :
            self.SetTitle(_("Saisie d'un exercice"))

    def __set_properties(self):
        self.ctrl_nom.SetToolTip(wx.ToolTip(_("Saisissez le nom de l'exercice")))
        self.ctrl_date_debut.SetToolTip(wx.ToolTip(_("Saisissez la date de début de l'exercice")))
        self.ctrl_date_fin.SetToolTip(wx.ToolTip(_("Saisissez la date de fin de l'exercice")))
