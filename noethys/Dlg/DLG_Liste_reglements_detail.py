...
from Ol import OL_Liste_reglements_detail
import GestionDB
...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = _("Vous pouvez ici consulter la liste complète des règlements saisis dans le logiciel avec le détail de la ventilation par facture et par nom de prestation.")
        titre = _("Liste détaillée des règlements")
        self.SetTitle(titre)
        ...
        # Liste
        self.listviewAvecFooter = OL_Liste_reglements_detail.ListviewAvecFooter(self)
