...
class CTRL_Page_choix(wx.Panel):
    def __init__(self, parent, IDquestion=None):
        ...
        self.IDquestion = IDquestion
        self.label_intro = wx.StaticText(self, -1, _("L'un des choix suivants est sélectionné :"))
    ...
    def Validation(self):
        ...
        if criteres == "" :
            dlg = wx.MessageDialog(self, _("Vous devez obligatoirement cocher au moins un item !"), _("Erreur"), wx.OK | wx.ICON_EXCLAMATION)
            dlg.ShowModal()
            dlg.Destroy()
            return False
        return True
...
class CTRL_Page_coche(wx.Panel):
    def __init__(self, parent):
        wx.Panel.__init__(self, parent, id=-1, style=wx.TAB_TRAVERSAL) 
        self.radio_coche = wx.RadioButton(self, -1, _("Est coché"), style=wx.RB_GROUP)
        self.radio_decoche = wx.RadioButton(self, -1, _("Est décoché"))
        self.__do_layout()
...
class CTRL_Page_texte(wx.Panel):
    def __init__(self, parent):
        ...
        self.radio_vide = wx.RadioButton(self, -1, _("Est vide"))
        self.radio_pasvide = wx.RadioButton(self, -1, _("N'est pas vide"))
...
class CTRL_Page_vide(wx.Panel):
    ...
    def Validation(self):
        dlg = wx.MessageDialog(self, _("Vous n'avez sélectionné aucune question !"), _("Erreur"), wx.OK | wx.ICON_EXCLAMATION)
        dlg.ShowModal()
        dlg.Destroy()
        return False
...
class CTRL_Page(wx.Panel):
    def __init__(self, parent, IDquestion=None, titre=u"", image=None, filtre=None):
        ...
        if filtre == "texte" : 
            ...
            self.ctrl_contenu = CTRL_Page_vide(self, texte=_("Aucun filtre disponible pour cette question !"))
...
if __name__ == "__main__":
    ...
    #dialog_1.SetValeur("CONTIENT", _("Ceci est un test  !"))
