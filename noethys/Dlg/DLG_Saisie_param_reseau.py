...
class Dialog(wx.Dialog):
    def __init__(self, parent, intro=None):
        ...
        if intro == None :
            intro = _("Veuillez saisir les paramètres de connexion :")

        self.box_contenu_staticbox = wx.StaticBox(self, -1, _("Paramètres de connexion"))
        self.label_intro = wx.StaticText(self, -1, intro)
        self.label_port = wx.StaticText(self, -1, _("Port :"))
        self.ctrl_port = wx.TextCtrl(self, -1, "3306")
    ...
    def __set_properties(self):
        self.SetTitle(_("Paramètres de connexion"))
        self.ctrl_port.SetMinSize((60, -1))
        self.ctrl_port.SetToolTip(wx.ToolTip(_("Saisissez ici le numéro de port")))
        self.ctrl_hote.SetToolTip(wx.ToolTip(_("Saisissez ici l'hôte")))
        self.ctrl_utilisateur.SetToolTip(wx.ToolTip(_("Saisissez ici l'utilisateur")))
        self.ctrl_mdp.SetToolTip(wx.ToolTip(_("Saisissez ici le mot de passe")))
