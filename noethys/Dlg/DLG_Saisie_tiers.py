...
class Dialog(wx.Dialog):
    def __init__(self, parent, IDtiers=None):
        ...
        if self.IDtiers != None :
            self.SetTitle(_("Modification d'un tiers"))
            self.Importation() 
        else :
            self.SetTitle(_("Saisie d'un tiers"))

    def __set_properties(self):
        self.ctrl_nom.SetToolTip(wx.ToolTip(_("Saisissez le nom du tiers")))
        self.ctrl_observations.SetToolTip(wx.ToolTip(_("Saisissez des observations sur le tiers")))
