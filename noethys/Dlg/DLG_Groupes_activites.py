...
from Ol import OL_Groupes_activites
...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = _("Vous pouvez ici saisir, modifier ou supprimer des groupes d'activités. Ceux-ci sont ensuite associés à des activités afin de faciliter, par exemple, l'édition de factures ou d'attestations groupées...")
        titre = _("Gestion des groupes d'activités")
        ...
        self.ctrl_recherche = OL_Groupes_activites.CTRL_Outils(self, listview=self.ctrl_listview)
    ...
    def __set_properties(self):
        self.SetTitle(_("Gestion des groupes d'activités"))
        self.bouton_ajouter.SetToolTip(wx.ToolTip(_("Cliquez ici pour ajouter un groupe d'activité")))
        self.bouton_modifier.SetToolTip(wx.ToolTip(_("Cliquez ici pour modifier le groupe d'activité sélectionné dans la liste")))
        self.bouton_supprimer.SetToolTip(wx.ToolTip(_("Cliquez ici pour supprimer le groupe d'activité sélectionné dans la liste")))
    ...
    def OnBoutonAide(self, event): 
        ...
        UTILS_Aide.Aide("Groupesdactivits")
