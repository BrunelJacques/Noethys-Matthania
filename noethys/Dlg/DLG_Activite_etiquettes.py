...
class Panel(wx.Panel):
    def __init__(self, parent, IDactivite=None, nouvelleActivite=False):
        ...
        self.staticbox_groupes_staticbox = wx.StaticBox(self, -1, _("Etiquettes de consommations"))
        ...
        self.label_info = wx.StaticText(self, -1, _("Les étiquettes sont optionnelles. Elles servent à associer à des consommations des actions, des intervenants, des salles, des états, etc..."))
