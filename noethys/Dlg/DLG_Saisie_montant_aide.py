        ...
        for dictCombinaison in self.dictMontant["combinaisons"] :
            ...
            for dictUnite in listeUnites :
                ...
                if IDunite in self.dictUnites :
                    ...
                    label += _("[Unité ID%d inconnue]") % IDunite + " + "
...
class Dialog(wx.Dialog):
    def __init__(self, parent, IDactivite=None, dictMontant={}):
        ...
        self.label_combinaisons = wx.StaticText(self, -1, _("Combinaisons :"))
    ...
    def __set_properties(self):
        self.SetTitle(_("Saisie d'un montant"))
        self.ctrl_montant.SetToolTip(wx.ToolTip(_("Saisissez ici un montant en euros")))
        self.bouton_ajouter.SetToolTip(wx.ToolTip(_("Cliquez ici pour ajouter une combinaisons d'unités")))
        self.bouton_modifier.SetToolTip(wx.ToolTip(_("Cliquez ici pour modifier la combinaison d'unités sélectionnées dans la liste")))
        self.bouton_supprimer.SetToolTip(wx.ToolTip(_("Cliquez ici pour supprimer la combinaison d'unités sélectionnées dans la liste")))
    ...
    def OnBoutonOk(self, event): 
        ...
        if len(dictMontant["combinaisons"]) == 0 :
            dlg = wx.MessageDialog(self, _("Vous devez créer obligatoirement une combinaison d'unités !"), _("Erreur de saisie"), wx.OK | wx.ICON_EXCLAMATION)
            dlg.ShowModal()
            dlg.Destroy()
            return
