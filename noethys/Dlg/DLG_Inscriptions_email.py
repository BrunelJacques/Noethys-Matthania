...
class Dialog(wx.Dialog):
    def __init__(self, parent, filtres=[]):
        ...
        # Bandeau
        intro = _("Cochez les inscriptions à envoyer par Email puis cliquez sur le bouton 'Transférer vers l'éditeur d'Emails'.")
        titre = _("Envoi de inscriptions par Email")
        self.SetTitle(titre)
        ...
        # Inscriptions
        self.box_inscriptions_staticbox = wx.StaticBox(self, -1, _("Liste des inscriptions"))
        self.ctrl_liste_inscriptions = CTRL_Liste_inscriptions.CTRL(self, filtres=filtres)
        
        # Options
        self.box_options_staticbox = wx.StaticBox(self, -1, _("Options des inscriptions"))
    ...
    def __set_properties(self):
        ...
        self.bouton_ok.SetToolTip(wx.ToolTip(_("Cliquez ici pour transférer les inscriptions vers l'éditeur d'Emails")))
    ...
    def OnBoutonAide(self, event): 
        ...
        UTILS_Aide.Aide("Transmettredesinscriptionsparema")
    ...
    def OnBoutonOk(self, event): 
        ...
        if len(tracks) == 0 : 
            dlg = wx.MessageDialog(self, _("Vous n'avez sélectionné aucune inscription à envoyer par Email !"), _("Erreur"), wx.OK | wx.ICON_EXCLAMATION)
            dlg.ShowModal()
            dlg.Destroy()
            return
