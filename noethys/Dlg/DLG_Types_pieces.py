...
from Ol import OL_Types_pieces
...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = _("Vous pouvez ici saisir, modifier ou supprimer des types de pièces. Vous pouvez définir une période de validité pour chacune des pièces et choisir d'associer ces types de pièces à des individus ou à des familles.")
        titre = _("Gestion des types de pièces")
        ...
        self.ctrl_recherche = OL_Types_pieces.CTRL_Outils(self, listview=self.ctrl_listview)
    ...
    def __set_properties(self):
        self.SetTitle(_("Gestion des types de pièces"))
        self.bouton_ajouter.SetToolTip(wx.ToolTip(_("Cliquez ici pour ajouter un type de pièce")))
        self.bouton_modifier.SetToolTip(wx.ToolTip(_("Cliquez ici pour modifier le type de pièce sélectionné dans la liste")))
        self.bouton_supprimer.SetToolTip(wx.ToolTip(_("Cliquez ici pour supprimer le type de pièce sélectionné dans la liste")))
