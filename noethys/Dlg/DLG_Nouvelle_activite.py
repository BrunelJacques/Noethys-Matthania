...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        # Intro
        self.label_intro = wx.StaticText(self, -1, _("Double-cliquez sur 'Créer une nouvelle activité' ou sur l'un des assistants proposés :"))
    ...
    def __set_properties(self):
        self.SetTitle(_("Créer une nouvelle activité"))
        self.bouton_aide.SetToolTip(wx.ToolTip(_("Cliquez ici pour obtenir de l'aide")))
        self.bouton_ok.SetToolTip(wx.ToolTip(_("Cliquez ici pour ouvrir l'assistant sélectionné dans la liste")))
    ...
    def OnBoutonOk(self, event): 
        ...
        if index == -1 :
            dlg = wx.MessageDialog(self, _("Vous devez sélectionner un assistant dans la liste !"), _("Erreur de saisie"), wx.OK | wx.ICON_EXCLAMATION)
            dlg.ShowModal()
            dlg.Destroy()
            return 
