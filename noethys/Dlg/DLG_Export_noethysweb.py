...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        # Bandeau
        intro = _("Utilisez cette fonctionnalité pour convertir votre base de données au format Noethysweb. Saisissez un mot de passe deux fois et cliquez sur le bouton Générer.")
        titre = _("Exporter les données vers Noethysweb")
        self.SetTitle(titre)
        ...
        self.label_repertoire = wx.StaticText(self, -1, "Répertoire :")
        ...
        self.bouton_generer = CTRL_Bouton_image.CTRL(self, texte=_("Générer"), cheminImage="Images/32x32/Sauvegarder.png")
    ...
    def __set_properties(self):
        ...
        self.ctrl_mdp.SetToolTip(wx.ToolTip(_("Saisissez le mot de passe qui sera utilisée pour crypter la sauvegarde")))
    ...
    def OnBoutonGenerer(self, event):
        ...
        dlgAttente = wx.BusyInfo(_("Cette opération peut prendre quelques minutes. Veuillez patienter..."), self)
        ...
        dlg = wx.MessageDialog(self, _("Le fichier a été généré avec succès."), _("Confirmation"), wx.OK | wx.ICON_INFORMATION)
        dlg.ShowModal()
        dlg.Destroy()
        return True
