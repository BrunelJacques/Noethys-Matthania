...
class Dialog(wx.Dialog):
    ...
    def __set_properties(self):
        ...
        self.bouton_imprimer.SetToolTip(wx.ToolTip(_("Cliquez ici pour imprimer le tableau affiché")))
        self.bouton_apercu.SetToolTip(wx.ToolTip(_("Cliquez ici pour afficher un aperçu avant impression du tableau")))
