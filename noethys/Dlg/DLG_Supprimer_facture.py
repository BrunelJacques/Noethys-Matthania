...
class Dialog(wx.Dialog):
    ...
    def __set_properties(self):
        self.bouton_annulation.SetToolTip(wx.ToolTip(_("Cliquez ici pour annuler la ou les factures sélectionnées")))
        self.bouton_suppression.SetToolTip(wx.ToolTip(_("Cliquez ici pour supprimer totalement la ou les factures sélectionnées")))
