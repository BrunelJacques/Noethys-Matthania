...
class Panel(wx.Panel):
    ...
    def __set_properties(self):
        self.ctrl_tarification.SetToolTip(_("Seuls les groupes et catégories_tarifs avec type_campeur correspondantes sont affichés"))
        self.bouton_ajouter_categorie.SetToolTip(_("Cliquez ici pour ajouter une catégorie de tarif"))
        self.bouton_modifier_categorie.SetToolTip(_("Cliquez ici pour modifier la catégorie sélectionnés"))
        self.bouton_supprimer_categorie.SetToolTip(_("Cliquez ici pour supprimer la catégorie sélectionnée"))
        #self.bouton_ajouter_tarif.SetToolTip(_(u"Cliquez ici pour ajouter un nom de prestation ou un tarif"))
        self.bouton_modifier_tarif.SetToolTip(_("Cliquez ici pour modifier l'item sélectionné"))
        self.bouton_supprimer_tarif.SetToolTip(_("Cliquez ici pour supprimer l'item sélectionné"))
        #self.bouton_dupliquer_tarif.SetToolTip(_(u"Cliquez ici pour dupliquer l'item sélectionné"))
...
class MyFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.ctrl= Panel(panel, IDactivite=686)
