...
class Dialog(wx.Dialog):
    def __init__(self, parent, grid=None, label="", IDindividu=None, date=None, dictTransports=[]):
        ...
        intro = _("Vous pouvez ici saisir, modifier ou supprimer des transports.")
        titre = _("Transports %s") % label
        self.SetTitle(titre)
    ...
    def __set_properties(self):
        self.bouton_ajouter.SetToolTip(wx.ToolTip(_("Cliquez ici pour ajouter un transport")))
        self.bouton_modifier.SetToolTip(wx.ToolTip(_("Cliquez ici pour modifier le transport sélectionné dans la liste")))
        self.bouton_supprimer.SetToolTip(wx.ToolTip(_("Cliquez ici pour supprimer le transport sélectionné dans la liste")))
