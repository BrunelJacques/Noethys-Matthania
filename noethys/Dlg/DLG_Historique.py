...
class CTRL_Utilisateur(wx.Choice):
    ...
    def GetListeDonnees(self):
        listeItems = [ _("<< Tous les utilisateurs >>"),]
...
class CTRL_Categorie(wx.Choice):
    ...
    def GetListeDonnees(self):
        listeItems = [ _("<< Toutes les catégories >>"),]
        self.dictDonnees = { 0 : {"ID":None}, }
        index = 1
...
class CTRL_Famille(wx.Choice):
    ...
    def GetListeDonnees(self):
        listeItems = [ _("<< Toutes les familles >>"),]
        self.dictDonnees = { 0 : {"ID":None}, }
        index = 1
        listeTitulaires = []
...
class CTRL_Individu(wx.Choice):
    ...
    def GetListeDonnees(self):
        listeItems = [ _("<< Tous les individus >>"),]
        self.dictDonnees = { 0 : {"ID":None}, }
        db = GestionDB.DB()
...
class Dialog(wx.Dialog):
    def __init__(self, parent, IDutilisateur=None, IDfamille=None, IDindividu=None, IDcategorie=None):
        ...
        # Bandeau
        intro = _("Vous pouvez ici consulter l'historique des actions effectuées dans Noethys.")
        titre = _("Historique")
