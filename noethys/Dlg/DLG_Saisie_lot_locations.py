...
class Dialog(wx.Dialog):
    def __init__(self, parent, IDlocation=None, periode=None):
        ...
        # Action
        self.box_action_staticbox = wx.StaticBox(self, -1, _("Location à recopier"))
        if len(self.dictModele) > 0 :
            ...
            texte = _("ERREUR : Location introuvable")
    ...
    def __set_properties(self):
        self.SetTitle(_("Saisie par lot"))
    ...
    def OnBoutonAide(self, event): 
        ...
        UTILS_Aide.Aide("Tableaudeslocations")
    ...
    def OnBoutonOk(self, event):
        ...
        dlg = wx.MessageDialog(None, _("Confirmez-vous le recopiage de la location sur %d dates ?") % len(listeDates), _("Confirmation"), wx.YES_NO|wx.NO_DEFAULT|wx.CANCEL|wx.ICON_QUESTION)
        ...
        dlgAttente = wx.BusyInfo(_("Veuillez patienter durant le traitement..."), None)
