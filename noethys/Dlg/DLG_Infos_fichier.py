...
class Informations():
    ...
    def Categorie_general(self):
        ...
        listeItems.append((_("Date de création"), ut.DateEngFr(dictInfos["date_creation"])))
        ...
        listeItems.append((_("Nombre de tables de données"), str(len(listeTables)+2)))
    ...
    def Categorie_stats(self):
        ...
        # Nbre de dépôts
        GetQuantite(_("Nombre de dépôts bancaires"), "IDdepot", "depots")

        # Nbre de factures
        GetQuantite(_("Nombre de factures"), "IDfacture", "factures")

        # Nbre de règlements
        GetQuantite(_("Nombre de règlements"), "IDreglement", "reglements")

        # Nbre de pièces
        GetQuantite(_("Nombre de pièces"), "pieIDnumPiece", "matPieces")

        # Nbre de lignes de pièces
        ...
        if len(donnees) > 0 :
            ...
            nbre = "Base non installée"
        listeItems.append((_("Nombre de documents scannés"), str(nbre)))
...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = _("Double clic sur le chapitre à consulter ou à réduire")
        titre = _("Informations sur la base de données")
