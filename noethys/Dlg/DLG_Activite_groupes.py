...
class Panel(wx.Panel):
    ...
    def __set_properties(self):
        ...
        self.bouton_modifier.SetToolTip(wx.ToolTip(_("Cliquez ici pour modifier le groupe selectionné dans la liste")))
        self.bouton_supprimer.SetToolTip(wx.ToolTip(_("Cliquez ici pour supprimer le groupe selectionné dans la liste")))
        self.bouton_monter.SetToolTip(wx.ToolTip(_("Cliquez ici pour monter le groupe sélectionné dans la liste")))
        self.bouton_descendre.SetToolTip(wx.ToolTip(_("Cliquez ici pour descendre le groupe sélectionné dans la liste")))
    ...
    def Validation(self):
        ...
        if nbreGroupes == 0 :
            dlg = wx.MessageDialog(self, _("Vous devez créer au moins un groupe !\n\nSi vous n'avez aucun groupe, créez juste un groupe intitulé par exemple 'Groupe unique'."), _("Erreur de saisie"), wx.OK | wx.ICON_EXCLAMATION)
            dlg.ShowModal()
            dlg.Destroy()
            return False
        # Validation
