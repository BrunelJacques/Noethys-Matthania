...
class Dialog(wx.Dialog):
    def __init__(self, parent, listeDonnees=[], listeDonneesDefaut=[]):
        ...
        intro = _("Vous pouvez configurer ici les colonnes de la liste. Utilisez les flèches pour modifier l'ordre des colonnes et décochez les colonnes à masquer.")
    ...
    def __set_properties(self):
        self.bouton_premier.SetToolTip(_("Cliquez ici pour déplacer la colonne sélectionnée au début de la liste"))
        self.bouton_monter.SetToolTip(_("Cliquez ici pour déplacer la colonne sélectionnée vers le haut"))
        self.bouton_descendre.SetToolTip(_("Cliquez ici pour déplacer la colonne sélectionnée vers le bas"))
        self.bouton_dernier.SetToolTip(_("Cliquez ici pour déplacer la colonne sélectionnée à la fin de la liste"))
        self.bouton_reinitialiser.SetToolTip(_("Cliquez ici restaurer les valeurs par défaut"))
