...
from Ol import OL_Liste_comptes
...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = _("Vous pouvez consulter ici les soldes des comptes bancaires. Double-cliquez sur un compte pour accéder au détail des opérations.")
        titre = _("Liste des comptes")
        self.SetTitle(titre)
        ...
        self.bouton_modifier = wx.BitmapButton(self, -1, wx.Bitmap(Chemins.GetStaticPath("Images/16x16/Loupe.png"), wx.BITMAP_TYPE_ANY))
    ...
    def __set_properties(self):
        self.bouton_modifier.SetToolTip(wx.ToolTip(_("Cliquez ici pour accéder au compte bancaire sélectionné")))
