...
from Ctrl import CTRL_Liste_presents
...
class Dialog(wx.Dialog):
    def __init__(self, parent, listeIDconso=[]):
        ...
        intro = _("Vous pouvez ici consulter la liste des consommations liées à l'unité de remplissage sélectionnée.")
        ...
        self.ctrl_refus = CTRL_Liste_presents.CTRL(self, listeIDconso=listeIDconso)
    ...
    def __set_properties(self):
        ...
        self.bouton_imprimer.SetToolTip(wx.ToolTip(_("Cliquez ici pour imprimer cette liste (PDF)")))
...
if __name__ == "__main__":
    ...
    dialog_1 = Dialog(None, listeIDconso=[])
