...
class Dialog(wx.Dialog):
    def __init__(self, parent, dictDonnees = {}):
        ...
        # Périodes
        self.staticbox_periodes_staticbox = wx.StaticBox(self, -1, _("Sélectionnez une ou plusieurs périodes"))
        self.ctrl_periodes = CTRL_Grille_periode.CTRL(self)            
        self.ctrl_toutes = wx.CheckBox(self, -1, _("Toutes les périodes"))
    ...
    def __set_properties(self):
        self.SetTitle(_("Sélection de périodes"))
