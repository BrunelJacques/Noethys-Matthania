...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = _("Vous pouvez ici consulter et imprimer la liste des comptes internet. Vous pouvez utiliser les fonctions Activer et Désactiver disponibles à droite de la liste pour modifier l'activation des comptes cochés.")
        ...
        self.radio_tous = wx.RadioButton(self, -1, _("Toutes les familles"), style=wx.RB_GROUP)
        self.radio_sans_activite = wx.RadioButton(self, -1, _("Les familles inactives depuis plus de"))
        self.ctrl_date_sans_activite = wx.Choice(self, -1, choices=[x[2] for x in CHOIX_DELAIS])
        self.ctrl_date_sans_activite.Select(0)
        self.radio_avec_activite = wx.RadioButton(self, -1, _("Les familles actives depuis"))
        ...
        self.bouton_email = CTRL_Bouton_image.CTRL(self, texte=_("Envoyer les codes internet par Email"), cheminImage="Images/32x32/Emails_exp.png")
        self.bouton_reinit_passwords = CTRL_Bouton_image.CTRL(self, texte=_("Réinitialiser les mots de passe"), cheminImage="Images/32x32/Actualiser.png")
    ...
    def __set_properties(self):
        self.SetTitle(_("Liste des comptes internet"))
        ...
        self.bouton_actif.SetToolTip(wx.ToolTip(_("Cliquez ici activer les comptes cochés dans la liste")))
        self.bouton_inactif.SetToolTip(wx.ToolTip(_("Cliquez ici désactiver les comptes cochés dans la liste")))
        self.bouton_aide.SetToolTip(wx.ToolTip(_("Cliquez ici pour obtenir de l'aide")))
        self.bouton_email.SetToolTip(wx.ToolTip(_("Cliquez ici pour envoyer un email contenant des codes internet aux familles cochées")))
        self.bouton_reinit_passwords.SetToolTip(wx.ToolTip(_("Cliquez ici pour réinitialiser les mots de passe des familles cochées")))
        self.bouton_fermer.SetToolTip(wx.ToolTip(_("Cliquez ici pour fermer")))
