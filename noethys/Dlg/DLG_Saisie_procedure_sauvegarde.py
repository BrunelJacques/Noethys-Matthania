...
class CTRL_Conditions(wx.Panel) :
    def __init__(self, parent) :
        ...
        self.box_jour_staticbox = wx.StaticBox(self, wx.ID_ANY, _("Jour"))
        self.check_jour = wx.CheckBox(self, wx.ID_ANY, _("Si le jour est parmi les jours cochés :"))
        self.label_jours_scolaire = wx.StaticText(self, wx.ID_ANY, _("Sem. scolaires : "))
        self.check_scolaire_lundi = wx.CheckBox(self, wx.ID_ANY, "L")
        self.check_scolaire_mardi = wx.CheckBox(self, wx.ID_ANY, "M")
        self.check_scolaire_mercredi = wx.CheckBox(self, wx.ID_ANY, "M")
        self.check_scolaire_jeudi = wx.CheckBox(self, wx.ID_ANY, "J")
        self.check_scolaire_vendredi = wx.CheckBox(self, wx.ID_ANY, "V")
        self.check_scolaire_samedi = wx.CheckBox(self, wx.ID_ANY, "S")
        self.check_scolaire_dimanche = wx.CheckBox(self, wx.ID_ANY, "D")
        self.label_jours_vacances = wx.StaticText(self, wx.ID_ANY, _("Sem. vacances : "))
        self.check_vacances_lundi = wx.CheckBox(self, wx.ID_ANY, "L")
        self.check_vacances_mardi = wx.CheckBox(self, wx.ID_ANY, "M")
        self.check_vacances_mercredi = wx.CheckBox(self, wx.ID_ANY, "M")
        self.check_vacances_jeudi = wx.CheckBox(self, wx.ID_ANY, "J")
        self.check_vacances_vendredi = wx.CheckBox(self, wx.ID_ANY, "V")
        self.check_vacances_samedi = wx.CheckBox(self, wx.ID_ANY, "S")
        self.check_vacances_dimanche = wx.CheckBox(self, wx.ID_ANY, "D")
        
        # Heure
        self.box_heure_staticbox = wx.StaticBox(self, wx.ID_ANY, _("Heure"))
        self.check_heure = wx.CheckBox(self, wx.ID_ANY, _("Si l'heure est comprise entre"))
        self.ctrl_heure_debut = CTRL_Saisie_heure.Heure(self)
        self.label_heure_et = wx.StaticText(self, wx.ID_ANY, _("et"))
        self.ctrl_heure_fin = CTRL_Saisie_heure.Heure(self)

        # Poste
        self.box_poste_staticbox = wx.StaticBox(self, wx.ID_ANY, _("Poste"))
        ...
        try :
            ...
            labelPoste = _("Ce poste")
        self.radio_poste_1 = wx.RadioButton(self, wx.ID_ANY, labelPoste, style=wx.RB_GROUP)
        self.radio_poste_2 = wx.RadioButton(self, wx.ID_ANY, _("Parmi les postes suivants :"))
        self.ctrl_postes = wx.TextCtrl(self, wx.ID_ANY, "")#, style=wx.TE_MULTILINE)

        # Dernière sauvegarde
        self.box_derniere_staticbox = wx.StaticBox(self, wx.ID_ANY, _("Dernière sauvegarde"))
        self.check_derniere = wx.CheckBox(self, wx.ID_ANY, _("Si dernière sauv. date de plus de"))
        self.listeDelais = [(1, _("1 jour")), ]
        for x in range(2, 31) :
            self.listeDelais.append((x, _("%d jours") % x))
        listeLabels = []
        ...
        # Utilisateur
        self.box_utilisateur_staticbox = wx.StaticBox(self, wx.ID_ANY, _("Utilisateur"))
        self.check_utilisateur = wx.CheckBox(self, wx.ID_ANY, _("Si l'utilisateur est :"))
        self.radio_utilisateur_1 = wx.RadioButton(self, wx.ID_ANY, _("Moi (%s)") % self.GetUtilisateur()[1], style=wx.RB_GROUP)
        self.radio_utilisateur_2 = wx.RadioButton(self, wx.ID_ANY, _("Parmi les utilisateurs cochés :"))
    ...
    def __set_properties(self):
        self.check_jour.SetToolTip(wx.ToolTip(_("Cochez cette case pour activer une condition de jour")))
        self.check_scolaire_lundi.SetToolTip(wx.ToolTip(_("Lundi")))
        self.check_scolaire_mardi.SetToolTip(wx.ToolTip(_("Mardi")))
        self.check_scolaire_mercredi.SetToolTip(wx.ToolTip(_("Mercredi")))
        self.check_scolaire_jeudi.SetToolTip(wx.ToolTip(_("Jeudi")))
        self.check_scolaire_vendredi.SetToolTip(wx.ToolTip(_("Vendredi")))
        self.check_scolaire_samedi.SetToolTip(wx.ToolTip(_("Samedi")))
        self.check_scolaire_dimanche.SetToolTip(wx.ToolTip(_("Dimanche")))
        self.check_vacances_lundi.SetToolTip(wx.ToolTip(_("Lundi")))
        self.check_vacances_mardi.SetToolTip(wx.ToolTip(_("Mardi")))
        self.check_vacances_mercredi.SetToolTip(wx.ToolTip(_("Mercredi")))
        self.check_vacances_jeudi.SetToolTip(wx.ToolTip(_("Jeudi")))
        self.check_vacances_vendredi.SetToolTip(wx.ToolTip(_("Vendredi")))
        self.check_vacances_samedi.SetToolTip(wx.ToolTip(_("Samedi")))
        self.check_vacances_dimanche.SetToolTip(wx.ToolTip(_("Dimanche")))
        self.check_heure.SetToolTip(wx.ToolTip(_("Cochez cette case pour activer une condition d'heure")))
        self.ctrl_heure_debut.SetToolTip(wx.ToolTip(_("Saisissez une heure minimale")))
        self.ctrl_heure_fin.SetToolTip(wx.ToolTip(_("Saisissez une heure maximale")))
        self.check_poste.SetToolTip(wx.ToolTip(_("Cochez cette case pour activer une condition de poste")))
        self.radio_poste_1.SetToolTip(wx.ToolTip(_("Uniquement pour ce poste")))
        self.radio_poste_2.SetToolTip(wx.ToolTip(_("Uniquement parmi une liste de postes cochés")))
        self.ctrl_postes.SetToolTip(wx.ToolTip(_("Saisissez les noms de poste du réseau séparés par des points-virgules (;)")))
        self.check_derniere.SetToolTip(wx.ToolTip(_("Cochez cette case pour activer une condition de délai")))
        self.ctrl_derniere.SetToolTip(wx.ToolTip(_("Sélectionnez un délai")))
        self.check_utilisateur.SetToolTip(wx.ToolTip(_("Cochez cette case pour activer une condition d'utilisateur")))
        self.radio_utilisateur_1.SetToolTip(wx.ToolTip(_("Uniquement cet utilisateur")))
        self.radio_utilisateur_2.SetToolTip(wx.ToolTip(_("Uniquement parmi une liste d'utilisateurs cochés")))
        self.ctrl_utilisateurs.SetToolTip(wx.ToolTip(_("Cochez les utilisateurs")))
    ...
    def GetDonnees(self):
        ...
        if self.check_jour.GetValue() == True :
            ...
            if jours_scolaires == None and jours_vacances == None :
                dlg = wx.MessageDialog(self, _("Vous avez coché la condition 'jour' mais vous n'avez coché aucun jour !"), _("Erreur de saisie"), wx.OK | wx.ICON_EXCLAMATION)
                dlg.ShowModal()
                dlg.Destroy()
                return False
        ...
        if self.check_heure.GetValue() == True :
            ...
            if heure_min == None or heure_max == None :
                dlg = wx.MessageDialog(self, _("Vous avez coché la condition 'heure' mais les heures saisies ne sont pas valides !"), _("Erreur de saisie"), wx.OK | wx.ICON_EXCLAMATION)
                dlg.ShowModal()
                dlg.Destroy()
                return False
            heures = "%s;%s" % (heure_min, heure_max)
        ...
        if self.check_poste.GetValue() == True :
            ...
            if self.radio_poste_2.GetValue() == True :
                ...
                if poste == "" :
                    dlg = wx.MessageDialog(self, _("Vous avez coché la condition 'poste' mais sans saisir de noms de postes !"), _("Erreur de saisie"), wx.OK | wx.ICON_EXCLAMATION)
                    dlg.ShowModal()
                    dlg.Destroy()
                    return False
        ...
        if self.check_utilisateur.GetValue() == True :
            ...
            if self.radio_utilisateur_2.GetValue() == True :
                ...
                if len(listeUtilisateurs) == 0 :
                    dlg = wx.MessageDialog(self, _("Vous avez coché la condition 'utilisateur' mais sans cocher d'utilisateurs dans la liste !"), _("Erreur de saisie"), wx.OK | wx.ICON_EXCLAMATION)
                    dlg.ShowModal()
                    dlg.Destroy()
                    return False
...
class CTRL_Options(wx.Panel) :
    def __init__(self, parent) :
        ...
        # Interface
        self.box_interface_staticbox = wx.StaticBox(self, wx.ID_ANY, _("Interface utilisateur"))
        self.check_demander = wx.CheckBox(self, wx.ID_ANY, _("Demander à l'utilisateur la confirmation du lancement de la sauvegarde"))
        self.check_demander.SetValue(True)
        self.check_confirmation = wx.CheckBox(self, wx.ID_ANY, _("Afficher un message de confirmation si sauvegarde réussie"))
        self.check_interface = wx.CheckBox(self, wx.ID_ANY, _("Afficher l'interface du module de sauvegarde"))

        # Suppression
        self.box_suppression_staticbox = wx.StaticBox(self, wx.ID_ANY, _("Sauvegardes obsolètes"))
        self.check_suppression = wx.CheckBox(self, wx.ID_ANY, _("Supprimer les sauvegardes présentes dans le répertoire datant de plus de"))
        self.listeAnciennete = [(2, _("2 jours")), (5, _("5 jours")), (7, _("1 semaine")), (14, _("2 semaines")), (21, _("3 semaines")), (30, _("1 mois")), (60, _("2 mois")), (90, _("3 mois")), (180, _("6 mois")), (365, _("1 année")), (730, _("2 années")), (1095, _("3 années")),]
        listeLabels = []
    ...
    def __set_properties(self):
        self.check_demander.SetToolTip(wx.ToolTip(_("Noethys affichera une boîte de dialogue proposant la sauvegarde. A défaut, la sauvegarde sera réalisée automatiquement sans demander l'avis de l'utilisateur.")))
        self.check_interface.SetToolTip(wx.ToolTip(_("Pour afficher l'interface utilisateur avant la sauvegarde afin de permettre à l'utilisateur de modifier certains paramètres.")))
        self.check_confirmation.SetToolTip(wx.ToolTip(_("Pour afficher un message de confirmation si la sauvegarde a été réussie.")))
        self.check_suppression.SetToolTip(wx.ToolTip(_("Cochez cette case pour activer la suppression automatique des sauvegardes les plus anciennes")))
        self.ctrl_suppression.SetToolTip(wx.ToolTip(_("Sélectionnez l'ancienneté des sauvegardes à supprimer")))
...
class CTRL_Parametres(wx.Notebook):
    def __init__(self, parent):
        ...
        listePages = [
            (_("sauvegarde"), _("Sauvegarde"), DLG_Sauvegarde.CTRL_Parametres(self, labelControleNom=_("Préfixe")), "Sauvegarder_param.png"),
            (_("conditions"), _("Conditions"), CTRL_Conditions(self), "Cocher.png"),
            (_("options"), _("Options"), CTRL_Options(self), "Options.png"),
            ]
...
class Dialog(wx.Dialog):
    def __init__(self, parent, IDsauvegarde=None):
        ...
        # Généralités
        self.box_generalites_staticbox = wx.StaticBox(self, -1, _("Généralites"))
        self.label_nom = wx.StaticText(self, -1, _("Nom de la procédure :"))
        ...
        if self.IDsauvegarde != None :
            self.Importation() 
            self.SetTitle(_("Modification d'une procédure de sauvegarde automatique"))
        else:
            self.ctrl_parametres.GetPageAvecCode("sauvegarde").ctrl_nom.SetValue("Noethys")

    def __set_properties(self):
        self.SetTitle(_("Saisie d'une procédure de sauvegarde automatique"))
        self.ctrl_nom.SetToolTip(wx.ToolTip(_("Saisissez un nom pour cette procédure de sauvegarde (Ex : 'Ma sauvegarde 1')")))
        self.ctrl_observations.SetToolTip(wx.ToolTip(_("Vous pouvez saisir des observations [Optionnel]")))
    ...
    def Sauvegarde(self):
        ...
        if nom == "" :
            dlg = wx.MessageDialog(self, _("Vous devez saisir un nom pour cette procédure de sauvegarde !"), _("Erreur de saisie"), wx.OK | wx.ICON_EXCLAMATION)
            dlg.ShowModal()
            dlg.Destroy()
