...
class Dialog(wx.Dialog):
    def __init__(self, parent, mode="gestion"):
        ...
        if self.mode == "selection" :
            intro = _("Vous pouvez ici sélectionner un contact dans le carnet d'adresses. Double-cliquez sur une ligne pour effectuer rapidement la sélection.")
            titre = _("Sélection d'un contact")
            self.SetTitle(_("Sélection d'un contact"))
        else:
            intro = _("Vous pouvez ici saisir, modifier ou supprimer des contacts dans le carnet d'adresses. Ceux-ci peuvent notamment être ensuite utilisés dans l'éditeur d'emails.")
            titre = _("Gestion du carnet d'adresses")
            self.SetTitle(_("Gestion du carnet d'adresses"))
    ...
    def __set_properties(self):
        self.bouton_ajouter.SetToolTip(wx.ToolTip(_("Cliquez ici pour ajouter un contact")))
        self.bouton_modifier.SetToolTip(wx.ToolTip(_("Cliquez ici pour modifier le contact sélectionné dans la liste")))
        self.bouton_supprimer.SetToolTip(wx.ToolTip(_("Cliquez ici pour supprimer le contact sélectionné dans la iste")))
