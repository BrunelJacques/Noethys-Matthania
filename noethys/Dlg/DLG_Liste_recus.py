...
class Dialog(wx.Dialog):
    def __init__(self, parent, IDfamille=None):
        ...
        intro = _("Vous pouvez ici consulter la liste complète des reçus de règlements créés dans le logiciel.")
        titre = _("Liste des reçus de règlements")
        ...
        self.ctrl_recherche = OL_Recus.CTRL_Outils(self, listview=self.ctrl_listview)
    ...
    def __set_properties(self):
        self.SetTitle(_("Liste des reçus de règlements"))
        self.bouton_ouvrir_fiche.SetToolTip(wx.ToolTip(_("Cliquez ici pour ouvrir la fiche famille du reçu sélectionné dans la liste")))
        self.bouton_supprimer.SetToolTip(wx.ToolTip(_("Cliquez ici pour supprimer le reçu sélectionné dans la liste")))
    ...
    def OnBoutonAide(self, event): 
        ...
        UTILS_Aide.Aide("Listedesreusderglements")
