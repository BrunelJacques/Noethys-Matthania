...
class Dialog(wx.Dialog):
    def __init__(self, parent, categorie=None):
        ...
        # Bandeau
        titre = _("Gestion des classes")
        intro = _("Vous pouvez ici paramétrer les classes pour chaque école. Vous devez obligatoirement indiquer pour chacune un nom, les dates de la saison et les niveaux scolaires concernés. Vous devez créer de nouvelles classes à chaque saison.")
        self.SetTitle(titre)
    ...
    def __set_properties(self):
        self.ctrl_ecole.SetToolTip(wx.ToolTip(_("Sélectionnez ici une école")))
        self.bouton_ajouter.SetToolTip(wx.ToolTip(_("Cliquez ici pour créer une classe")))
        self.bouton_modifier.SetToolTip(wx.ToolTip(_("Cliquez ici pour modifier la classe sélectionnée dans la liste")))
        self.bouton_supprimer.SetToolTip(wx.ToolTip(_("Cliquez ici pour supprimer la classe sélectionnée dans la liste")))
