...
class Dialog(wx.Dialog):
    def __init__(self, parent, texte=u"", titre=_("Information"), size=(360, 410), nePlusAfficher=False):
        ...
        # Boutons de commande
        self.check_nePlusAfficher = wx.CheckBox(self, -1, _("Ne plus afficher ce message"))
    ...
    def __set_properties(self):
        self.check_nePlusAfficher.SetToolTip(wx.ToolTip(_("Cochez cette case pour ne plus afficher ce message")))
        self.bouton_ok.SetToolTip(wx.ToolTip(_("Cliquez ici pour fermer ce message")))
...
if __name__ == "__main__":
    ...
    dialog_1 = Dialog(None, texte=TEXTE, titre=_("Message"), nePlusAfficher=True, size=(600, 200))
