...
class CTRL_Allocataire(wx.CheckBox):
    def __init__(self, parent):
        ...
        # dans Noethys il s'agissait de saisir le titulaire bénéficiaire des allocations, remplacé par simple coche
        self.parent = parent
...
class Panel(wx.Panel):
    ...
    def __set_properties(self):
        self.ctrl_caisse.SetToolTip(_("Sélectionnez une caisse"))
        self.bouton_caisses.SetToolTip(_("Cliquez ici pour accéder à la gestion des caisses"))
        self.ctrl_numero.SetToolTip(_("Saisissez le numéro d'allocataire"))
        ...
        self.bouton_ajouter.SetToolTip(_("Cliquez ici pour ajouter une aide journalière"))
        self.bouton_modifier.SetToolTip(_("Cliquez ici pour modifier l'aide sélectionnée dans la liste"))
        self.bouton_supprimer.SetToolTip(_("Cliquez ici pour supprimer l'aide sélectionnée dans la liste"))
