...
class Dialog(wx.Dialog):
    def __init__(self, parent, type="individu", IDcategorie=None):
        ...
        self.box_contenu_staticbox = wx.StaticBox(self, -1, "")
        ...
        self.ctrl_couleur = csel.ColourSelect(self, -1, "", couleur_defaut, size=(60, 20))
    ...
    def __set_properties(self):
        ...
        self.ctrl_label.SetToolTip(wx.ToolTip(_("Saisissez ici un label")))
        self.ctrl_couleur.SetToolTip(wx.ToolTip(_("Cliquez ici pour sélectionner la couleur de cette catégorie")))
        self.ctrl_visible.SetToolTip(wx.ToolTip(_("Cochez cette case pour afficher cette catégorie")))
    ...
    def OnBoutonOk(self, event): 
        ...
        if label == "" :
            dlg = wx.MessageDialog(self, _("Vous devez obligatoirement saisir un label !"), _("Erreur"), wx.OK | wx.ICON_EXCLAMATION)
            dlg.ShowModal()
            dlg.Destroy()
            return
