...
class Panel(wx.Panel):
    def __init__(self, parent, IDindividu=None, dictFamillesRattachees={}):
        ...
        # Propriétés
        self.bouton_ajouter.SetToolTip(wx.ToolTip(_("Cliquez ici pour saisir une pièce")))
        self.bouton_modifier.SetToolTip(wx.ToolTip(_("Cliquez ici pour modifier la pièce sélectionnée")))
        self.bouton_supprimer.SetToolTip(wx.ToolTip(_("Cliquez ici pour supprimer la pièce sélectionnée")))
        self.bouton_ajouter_cotisation.SetToolTip(wx.ToolTip(_("Cliquez ici pour saisir une cotisation individuelle")))
        self.bouton_modifier_cotisation.SetToolTip(wx.ToolTip(_("Cliquez ici pour modifier la cotisation individuelle sélectionnée")))
        self.bouton_supprimer_cotisation.SetToolTip(wx.ToolTip(_("Cliquez ici pour supprimer la cotisation individuelle sélectionnée")))
