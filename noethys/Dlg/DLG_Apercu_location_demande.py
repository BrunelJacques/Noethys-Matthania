...
class Dialog(wx.Dialog):
    def __init__(self, parent, provisoire=False, titre=_("Aperçu d'une demande de location"), intro=_("Vous pouvez ici créer un aperçu PDF du document sélectionné.")):
