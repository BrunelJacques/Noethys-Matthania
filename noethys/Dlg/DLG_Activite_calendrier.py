...
class Panel(wx.Panel):
    ...
    def __set_properties(self):
        self.ctrl_ouvertures.SetToolTip(wx.ToolTip(_("Calendrier des ouvertures et des évènements")))
        self.bouton_ouvertures_modifier.SetToolTip(wx.ToolTip(_("Cliquez ici pour modifier le calendrier des ouvertures et des évènements")))
