...
# Site internet :  www.noethys.com modifié Matthania
...
class Facture():
    def __init__(self):
        ...
        self.champs = [ 
            (_("Numéro ID de la famille"), "2582", "{IDFAMILLE}"),
            (_("Civilité des titulaires de dossier"), _("M."), "{FAMILLE_CIVILITE}"),
            (_("Nom titulaire 1  sans civilité"), _("DUPOND Gérard"), "{FAMILLE_NOM_SANS}"),
            (_("Désignation correspondance"), _("M.Mme DUPONT Léo et Léa"), "{FAMILLE_NOM}"),
            (_("Rue de la famille"), _("10 rue des oiseaux"), "{FAMILLE_RUE}"),
            (_("Code postal de la famille"), "29200", "{FAMILLE_CP}"),
            (_("Ville de la famille"), _("BREST"), "{FAMILLE_VILLE}"),
            
            (_("Nom de l'organisateur"), _("Association Noethys"), "{ORGANISATEUR_NOM}"),
            (_("Rue de l'organisateur"), _("Avenue des Lilas"), "{ORGANISATEUR_RUE}"),
            (_("Code postal de l'organisateur"), "29870", "{ORGANISATEUR_CP}"),
            (_("Ville de l'organisateur"), _("LANNILIS"), "{ORGANISATEUR_VILLE}"),
            (_("Téléphone de l'organisateur"), "01.98.01.02.03", "{ORGANISATEUR_TEL}"),
            (_("Fax de l'organisateur"), "01.04.05.06.", "{ORGANISATEUR_FAX}"),
            (_("Mail de l'organisateur"), _("noethys") + "@gmail.com", "{ORGANISATEUR_MAIL}"),
            (_("Site internet de l'organisateur"), "www.noethys.com", "{ORGANISATEUR_SITE}"),
            (_("Numéro d'agrément de l'organisateur"), "0256ORG234", "{ORGANISATEUR_AGREMENT}"),
            (_("Numéro SIRET de l'organisateur"), "123456789123", "{ORGANISATEUR_SIRET}"),
            (_("Code APE de l'organisateur"), _("NO123"), "{ORGANISATEUR_APE}"),

            (_("Code-barres - Numéro de facture"), "F123456", "{CODEBARRES_NUM_FACTURE}"),

            (_("Nature de la pièce"), "facture", "{NATURE}"),
            (_("Numéro si pièce FAC,AVO"), "1234567", "{NUM_FACTURE}"),
            (_("Numéro pièce avec préfixe"), "No Facture : 123456", "{TEXTE_NUMERO}"),
            (_("Date d'édition de la facture (court)"), "19/09/2011", "{DATE_EDITION}"),
            (_("Date d'édition de la facture (long)"), _("Lundi 9 septembre 2011"), "{DATE_EDITION_LONG}"),
            (_("Date d'échéance de paiement (court)"), "10/01/2011", "{DATE_ECHEANCE}"),
            (_("Texte échéance de paiement"), _("Date d'échéance : 10/01/2011"), "{TEXTE_ECHEANCE}"),
            (_("Libellé pour qualifier le montant"), "Montant de la facture:", "{LIB_MONTANT}"),
            (_("Montant pièce(s) jointe"), "1000.00 €", "{MONTANT}"),
...
class Famille():
    def __init__(self):
        ...
        self.champs = [ 
            ...
            (_("Nom titulaire 1  sans civilité"), _("DUPOND Gérard"), "{FAMILLE_NOM_SANS}"),
            (_("Désignation correspondance"), _("M.Mme DUPONT Léo et Léa"), "{FAMILLE_NOM}"),
            (_("Nom du titulaire 1"), _("DUPOND"), "{INDIVIDU_NOM}"),
            (_("Prénom du titulaire 1"), _("Gérard"), "{INDIVIDU_PRENOM}"),
            (_("Rue de l'adresse de la famille"), _("10 rue des oiseaux"), "{FAMILLE_RUE}"),
            (_("Code postal de l'adresse de la famille"), "29200", "{FAMILLE_CP}"),
            (_("Ville de l'adresse de la famille"), _("BREST"), "{FAMILLE_VILLE}"),
            (_("Régime social de la famille"), _("Régime général"), "{FAMILLE_REGIME}"),
            (_("Caisse de la famille"), _("C.A.F."), "{FAMILLE_CAISSE}"),
            (_("Numéro d'allocataire de la famille"), "0123456X", "{FAMILLE_NUMALLOC}"),
...
class Inscription():
    def __init__(self):
        ...
        self.champs = [ 
            ...
            (_("Civilité des titulaires de dossier"), _("M."), "{FAMILLE_CIVILITE}"),
            (_("Nom titulaire 1  sans civilité"), _("DUPOND Gérard"), "{FAMILLE_NOM_SANS}"),
            (_("Désignation correspondance"), _("M.Mme DUPOND Léo et Léa"), "{FAMILLE_NOM}"),
            (_("Rue de l'adresse de la famille"), _("10 rue des oiseaux"), "{FAMILLE_RUE}"),
            (_("Code postal de l'adresse de la famille"), "29200", "{FAMILLE_CP}"),
            (_("Ville de l'adresse de la famille"), _("BREST"), "{FAMILLE_VILLE}"),
            (_("Régime social de la famille"), _("Régime général"), "{FAMILLE_REGIME}"),
