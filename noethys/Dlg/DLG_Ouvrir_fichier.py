...
class MyDialog(wx.Dialog):
    def __init__(self, parent, fichierOuvert=None):
        ...
        # Liste fichiers
        self.box_fichiers_staticbox = wx.StaticBox(self, -1, _("Liste des fichiers"))
        ...
        self.hyper_telecharger = Hyperlien(self, label=_("Télécharger d'autres fichiers exemples"), infobulle=_("Cliquez ici pour télécharger d'autres fichiers exemples sur internet"), URL="telecharger")
