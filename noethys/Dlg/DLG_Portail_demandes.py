...
class Dialog(wx.Dialog):
    def __init__(self, parent, IDfamille=None):
        ...
        # Bandeau
        intro = _("Double-cliquez sur une ligne pour traiter la demande correspondante ou cliquez sur le bouton 'Commencer' pour traiter la première demande de la liste.")
        titre = _("Traitement des demandes")
        self.SetTitle(titre)
        self.ctrl_bandeau = CTRL_Bandeau.Bandeau(self, titre=titre, texte=intro, hauteurHtml=30, nomImage="Images/32x32/Connecthys.png")

        # Demandes
        self.box_demandes_staticbox = wx.StaticBox(self, wx.ID_ANY, _("Liste des demandes"))
        ...
        self.check_cacher_traitees = wx.CheckBox(self, -1, _("Cacher les demandes traitées"))
        ...
        self.bouton_ok = CTRL_Bouton_image.CTRL(self, texte=_("Commencer"), cheminImage="Images/32x32/Loupe.png")
    ...
    def __set_properties(self):
        self.bouton_traiter.SetToolTip(wx.ToolTip(_("Cliquez ici pour traiter la demande sélectionnée dans la liste")))
        ...
        self.check_cacher_traitees.SetToolTip(wx.ToolTip(_("Cochez cette case pour cacher les demandes déjà traitées")))
