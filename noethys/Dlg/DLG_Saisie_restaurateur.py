...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        # Nom
        self.staticbox_nom_staticbox = wx.StaticBox(self, -1, _("Nom du restaurateur"))
        ...
        self.ctrl_tel = CTRL_Saisie_tel.Tel(self, intitule=_("restaurateur"))
    ...
    def __set_properties(self):
        self.SetTitle(_("Ajout d'un restaurateur"))
        self.ctrl_nom.SetToolTip(wx.ToolTip(_("Saisissez le nom du restaurateur")))
