...
class Calendrier(gridlib.Grid, glr.GridWithLabelRenderersMixin): 
    ...
    def SaisieLot(self):
        ...
        if dlg.ShowModal() == wx.ID_OK:
            ...
            try :
                ...
                dlg2 = wx.MessageDialog(self, _("Désolé, le problème suivant a été rencontré dans le traitement par lot des ouvertures : \n\n%s") % err, _("Erreur"), wx.OK | wx.ICON_ERROR)
                dlg2.ShowModal()
                dlg2.Destroy()
        dlg.Destroy()
    ...
    def GetListeGroupes(self):
        ...
        if len(listeGroupes) == 0 :
            dictTemp = { "IDgroupe" : 0, "nom" : _("Sans groupe") }
            listeGroupes.append(dictTemp)
        return listeGroupes
...
class Dialog(wx.Dialog):
    def __init__(self, parent, IDactivite=None, dictSelections={}, activeIncompatibilites=True):
        ...
        intro = _("Cliquez sur les cases blanches pour sélectionner des combinaisons d'unités. <U>Important :</U> Cliquez avec le bouton droit de la souris sur les cases Dates pour utiliser le Copier-Coller ou utilisez la fonction de traitement par lot pour effectuer des saisies ou modifications encore plus rapides.")
        titre = _("Sélection de combinaisons d'unités")
        self.SetTitle(titre)
        ...
        self.listeLegende = [
            { "label" : _("Sélections"), "couleur" : COULEUR_SELECTION, "ctrl_label" : None, "ctrl_img" : None },
    ...
    def __set_properties(self):
        ...
        self.bouton_saisie_lot.SetToolTip(wx.ToolTip(_("Cliquez ici saisir ou supprimer un lot")))
