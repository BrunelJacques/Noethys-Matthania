...
LARGEUR_COLONNE = 158
LISTE_NOMS_MOIS = [_("Janvier"), _("Février"), _("Mars"), _("Avril"), _("Mai"), _("Juin"), _("Juillet"), _("Août"), _("Septembre"), _("Octobre"), _("Novembre"), _("Décembre")]
IMAGE_FOND = None

THEMES = {
    _("Plage de cailloux") : "Images/Special/Cailloux.jpg",
    _("Gouttes d'eau") : "Images/Special/Eau.jpg",
    _("Feuille d'été") : "Images/Special/Feuille.jpg",
    _("Ballet de lignes") : "Images/Special/Lignes.jpg",
    _("Montgolfières") : "Images/Special/Montgolfiere.jpg",
    _("Mosaïque") : "Images/Special/Mosaique.jpg",
    }
...
class Page_Options(wx.Panel):
    def __init__(self, parent):
        ...
        self.check_photos = wx.CheckBox(self, -1, "")
        self.check_photos.SetValue(True)
        self.label_photos = wx.StaticText(self, -1, _("Afficher les photos :"))
        self.ctrl_photos = wx.Choice(self, -1, choices=[_("Petite taille"), _("Moyenne taille"), _("Grande taille")])
        self.ctrl_photos.SetSelection(1)

        self.check_theme = wx.CheckBox(self, -1, "")
        self.check_theme.SetValue(True)
        self.label_theme = wx.StaticText(self, -1, _("Inclure le thème :"))
        self.ctrl_theme = wx.Choice(self, -1, choices=list(THEMES.keys()))
        self.ctrl_theme.SetStringSelection(_("Feuille d'été"))
        ...
        # Propriétés
        self.check_photos.SetToolTip(wx.ToolTip(_("Cochez cette case pour utiliser un thème graphique")))
        self.ctrl_photos.SetToolTip(wx.ToolTip(_("Selectionnez ici le thème souhaité")))
        self.check_photos.SetToolTip(wx.ToolTip(_("Cochez cette case pour afficher les photos des individus")))
        self.ctrl_photos.SetToolTip(wx.ToolTip(_("Selectionnez ici la taille des photos")))
...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = _("Vous pouvez ici imprimer la liste des anniversaires des individus inscrits sur les activités cochées et présents sur la période donnée. Il est possible d'inclure un thème graphique et les photos individuelles.")
        titre = _("Liste des anniversaires")
        self.SetTitle(titre)
    ...
    def OnBoutonOk(self, event):
        ...
        self.EcritStatusBar(_("Recherche des individus..."))
        ...
        if len(listeIndividus) == 0:
            dlg = wx.MessageDialog(self, _("Aucun individu n'a été trouvé avec les paramètres spécifiés !"), _("Erreur"), wx.OK | wx.ICON_EXCLAMATION)
            dlg.ShowModal()
            dlg.Destroy()
        ...
        self.EcritStatusBar(_("Recherche des dates de naissance..."))
        ...
        if dictParametres["taille_photo"] != 0 :
            ...
            for IDindividu in listeIDindividus:
                self.EcritStatusBar(_("Recherche des photos... %d/%d") % (index, len(listeIDindividus)))
        ...
        # ---------------- Création du PDF -------------------
        self.EcritStatusBar(_("Création du PDF..."))
