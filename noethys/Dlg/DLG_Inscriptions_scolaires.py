...
from Ol import OL_Inscriptions_scolaires
...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        # Inscrits
        self.box_inscrits_staticbox = wx.StaticBox(self, -1, _("Aucun inscrit"))
    ...
    def __set_properties(self):
        self.bouton_ajouter.SetToolTip(wx.ToolTip(_("Cliquez ici pour inscrire un ou plusieurs individus")))
        self.bouton_modifier.SetToolTip(wx.ToolTip(_("Cliquez ici pour modifier l'inscription sélectionnée")))
        self.bouton_supprimer.SetToolTip(wx.ToolTip(_("Cliquez ici pour supprimer l'inscription sélectionnée")))
        self.bouton_apercu.SetToolTip(wx.ToolTip(_("Cliquez ici pour afficher un apercu avant impression")))
        self.bouton_imprimer.SetToolTip(wx.ToolTip(_("Cliquez ici pour imprimer la liste des inscrits")))
...
##        grid_sizer_contenu.AddGrowableCol(0)
    ...
    def SetLabelBoxInscrits(self, nbre=0):
        if nbre == 0 : label = _("Aucun inscrit")
        elif nbre == 1 : label = _("1 inscrit")
        else : label = _("%d inscrits") % nbre
