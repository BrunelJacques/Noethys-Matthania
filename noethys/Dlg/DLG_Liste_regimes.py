...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = _("Vous pouvez ici consulter et imprimer la liste des régimes, caisses et numéros d'allocataire de chaque famille. Sélectionnez un ou plusieurs groupes d'activités ou certaines activités en particulier avant de cliquer sur le bouton 'Rafraîchir la liste' pour afficher les résultats.")
        titre = _("Liste des régimes et caisses")
    ...
    def __set_properties(self):
        self.SetTitle(_("Liste des régimes et caisses"))
    ...
    def OnBoutonAide(self, event): 
        ...
        UTILS_Aide.Aide("Listedesrgimesetcaissesdesfamill")
