...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        self.sizer_nom_staticbox = wx.StaticBox(self, -1, _("1. Nom du vaccin"))
        self.sizer_duree_staticbox = wx.StaticBox(self, -1, _("2. Durée de validité"))
        self.sizer_maladies_staticbox = wx.StaticBox(self, -1, _("3. Maladies associées"))
        ...
        self.radio_duree_2 = wx.RadioButton(self, -1, _("Validité limitée : "))
    ...
    def __set_properties(self):
        self.ctrl_nom.SetToolTip(wx.ToolTip(_("Saisissez ici un nom de vaccin. Par exemple : 'DT Polio'")))
        self.radio_duree_1.SetToolTip(wx.ToolTip(_("Sélectionnez 'Illimitée' si le vaccin est valable à vie")))
        self.radio_duree_2.SetToolTip(wx.ToolTip(_("Sélectionnez 'Limitée' si vous pouvez définir une durée pour ce vaccin")))
    ...
    def OnBoutonOk(self, event):
        ...
        if textNom == "" :
            dlg = wx.MessageDialog(self, _("Vous devez obligatoirement donner un nom à ce vaccin !"), _("Erreur"), wx.OK | wx.ICON_EXCLAMATION)
            dlg.ShowModal()
            dlg.Destroy()
        ...
        if self.ctrl_maladies.GetIDcoches() == 0:
            dlg = wx.MessageDialog(self, _("Vous devez associer des maladies à ce vaccin"), _("Erreur"), wx.OK | wx.ICON_EXCLAMATION)
            dlg.ShowModal()
            dlg.Destroy()
            return
