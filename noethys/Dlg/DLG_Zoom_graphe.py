...
class PanelGraph(wx.Panel):
    ...
    def Save_image(self):
        ...
        dlg = wx.FileDialog(self, message=_("Enregistrer le graphe sous..."),
        ...
        if dlg.ShowModal() == wx.ID_OK:
            ...
            message = _("Le graphe a été sauvegardé avec succès")
            dlg = wx.MessageDialog(self, message, _("Sauvegarde"), wx.OK | wx.ICON_INFORMATION)
            dlg.ShowModal()
            dlg.Destroy()
                
    def Clipboard_image(self):
        self.canvas.Copy_to_Clipboard()
        message = _("Le graphe a été envoyé dans le presse-papiers.")
        dlg = wx.MessageDialog(self, message, _("Presse-papiers"), wx.OK | wx.ICON_INFORMATION)
        dlg.ShowModal()
        dlg.Destroy()
...
class Dialog(wx.Dialog):
    def __init__(self, parent, figure=None):
        ...
        self.bouton_save_image = CTRL_Bouton_image.CTRL(self, texte=_("Enregistrer le graphe"), cheminImage="Images/32x32/Disk.png")
        self.bouton_clipboard_image = CTRL_Bouton_image.CTRL(self, texte=_("Copier le graphe dans le presse-papiers"), cheminImage="Images/32x32/Clipboard.png")
        self.bouton_imprimer_image = CTRL_Bouton_image.CTRL(self, texte=_("Imprimer le graphe"), cheminImage="Images/32x32/Imprimante.png")
    ...
    def __set_properties(self):
        self.SetTitle(_("Visualisateur de graphe"))
        ...
        self.bouton_save_image.SetToolTip(wx.ToolTip(_("Cliquez ici pour enregistrer le graphe au format image")))
        self.bouton_clipboard_image.SetToolTip(wx.ToolTip(_("Cliquez ici pour envoyer le graphe dans le presse-papiers")))
        self.bouton_imprimer_image.SetToolTip(wx.ToolTip(_("Cliquez ici pour publier le graphe au format PDF")))
