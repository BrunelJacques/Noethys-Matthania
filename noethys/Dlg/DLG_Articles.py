...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = _("Vous pouvez ici saisir, modifier ou supprimer des articles (regroupement de lignes sur les factures).")
        titre = _("Liste des Articles")
        self.ctrl_bandeau = CTRL_Bandeau.Bandeau(self, titre=titre, texte=intro,  hauteurHtml=15, nomImage="Images/22x22/Smiley_nul.png")
        self.ctrl_listview = OL_Articles.ListView(self, id=-1, style=wx.LC_REPORT|wx.SUNKEN_BORDER|wx.LC_SINGLE_SEL|wx.LC_HRULES|wx.LC_VRULES)
        self.ctrl_listview.MAJ()
        self.ctrl_recherche = OL_Articles.CTRL_Outils(self, listview=self.ctrl_listview)
    ...
    def __set_properties(self):
        self.SetTitle(_("DLG_Articles"))
        self.bouton_ajouter.SetToolTip(_("Cliquez ici pour ajouter un article"))
        self.bouton_modifier.SetToolTip(_("Cliquez ici pour modifier l'article sélectionné dans la liste"))
        self.bouton_supprimer.SetToolTip(_("Cliquez ici pour supprimer l'article sélectionné dans la liste"))
