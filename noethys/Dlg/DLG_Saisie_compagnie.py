...
class Dialog(wx.Dialog):
    def __init__(self, parent, titre=_("Saisie d'une compagnie")):
        wx.Dialog.__init__(self, parent, -1, style=wx.DEFAULT_DIALOG_STYLE|wx.RESIZE_BORDER|wx.MAXIMIZE_BOX|wx.MINIMIZE_BOX)
        self.parent = parent   
        self.titre = titre
        
        # Nom
        self.staticbox_nom_staticbox = wx.StaticBox(self, -1, _("Nom de la compagnie"))
    ...
    def __set_properties(self):
        ...
        self.ctrl_nom.SetToolTip(wx.ToolTip(_("Saisissez le nom de la compagnie")))
