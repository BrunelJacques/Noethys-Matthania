...
class Dialog(wx.Dialog):
    def __init__(self, parent, IDfamille=None):
        ...
        intro = _("Vous pouvez ici consulter la liste complète des attestations de présence créées dans le logiciel.")
        titre = _("Liste des attestations de présence")
...
##        self.ctrl_listview = OL_Attestations.ListView(self, id=-1, IDfamille=self.IDfamille, name="OL_attestations", style=wx.LC_HRULES|wx.LC_VRULES|wx.LC_REPORT|wx.SUNKEN_BORDER|wx.LC_SINGLE_SEL)
    ...
    def __set_properties(self):
        self.SetTitle(_("Liste des attestations"))
        self.bouton_ouvrir_fiche.SetToolTip(wx.ToolTip(_("Cliquez ici pour ouvrir la fiche famille de l'attestation sélectionnée dans la liste")))
        self.bouton_supprimer.SetToolTip(wx.ToolTip(_("Cliquez ici pour supprimer l'attestation sélectionnée dans la liste")))
