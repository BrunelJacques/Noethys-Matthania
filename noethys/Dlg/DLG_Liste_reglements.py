...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = _("Vous pouvez ici consulter la liste complète des règlements saisis dans le logiciel.")
        ...
        self.ctrl_tri = wx.Choice(self, -1, choices = (_("Ordre de saisie"), _("Date"), _("Mode de règlement"), _("Emetteur"), _("Numéro de pièce"), _("Famille"), _("Nom de payeur"), "Montant"))
    ...
    def __set_properties(self):
        self.SetTitle(_("Liste des règlements"))
        ...
        self.bouton_modifier.SetToolTip(wx.ToolTip(_("Cliquez ici pour modifier le règlement sélectionné dans la liste")))
        self.bouton_supprimer.SetToolTip(wx.ToolTip(_("Cliquez ici pour supprimer le règlement sélectionné dans la liste")))
