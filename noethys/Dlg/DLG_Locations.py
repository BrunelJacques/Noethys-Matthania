...
class Panel(wx.Panel):
    def __init__(self, parent, bordure=0):
        ...
        self.check_locations_actives = wx.CheckBox(self, -1, _("Afficher les locations en cours"))
...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = _("Vous pouvez ici visualiser, saisir, modifier ou supprimer des locations.")
        titre = _("Liste des locations")
        self.SetTitle(titre)
