...
class MyHtml(html.HtmlWindow):
    ...
    def OnLinkClicked(self, link):
        FonctionsPerso.LanceFichierExterne(_("https://www.noethys.com"))
...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        self.label_fichiers = wx.StaticText(self, -1, _("Sélectionnez un fichier exemple puis cliquez sur Ok :"))
    ...
    def __set_properties(self):
        self.SetTitle(_("Bienvenue"))
        self.bouton_ok.SetToolTip(wx.ToolTip(_("Cliquez ici pour ouvrir le fichier sélectionné dans la liste")))
        self.bouton_annuler.SetToolTip(wx.ToolTip(_("Cliquez ici pour fermer cette fenêtre")))
    ...
    def OnBoutonOk(self, event):
        ...
        if index == -1 :
            dlg = wx.MessageDialog(self, _("Vous n'avez sélectionné aucun fichier dans la liste !\n\nSi vous ne souhaitez pas ouvrir de fichier maintenant, cliquez sur le bouton Fermer. Vous pourrez le faire ultérieurement depuis le menu Fichier > Ouvrir un fichier."), _("Erreur"), wx.OK | wx.ICON_EXCLAMATION)
            dlg.ShowModal()
            dlg.Destroy()
            return 
