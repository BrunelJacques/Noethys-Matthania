...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = _("Vous pouvez ici saisir, modifier ou supprimer des périodes de vacances. Cliquez sur 'Importer depuis Internet' pour télécharger automatiquement les périodes depuis le site de l'Education Nationale.")
        titre = _("Gestion des périodes de vacances")
        ...
        self.bouton_importation = CTRL_Bouton_image.CTRL(self, texte=_("Importer depuis internet"), cheminImage="Images/32x32/Fleche_bas.png")
    ...
    def __set_properties(self):
        self.SetTitle(_("Gestion des périodes de vacances"))
        self.bouton_ajouter.SetToolTip(wx.ToolTip(_("Cliquez ici pour ajouter une période de vacances")))
        self.bouton_modifier.SetToolTip(wx.ToolTip(_("Cliquez ici pour modifier la période de vacances sélectionnée dans la liste")))
        self.bouton_supprimer.SetToolTip(wx.ToolTip(_("Cliquez ici pour supprimer la période de vacances sélectionnée dans la liste")))
        self.bouton_aide.SetToolTip(wx.ToolTip(_("Cliquez ici pour obtenir de l'aide")))
        self.bouton_importation.SetToolTip(wx.ToolTip(_("Cliquez ici pour importer des périodes depuis le site internet de l'Education Nationale")))
