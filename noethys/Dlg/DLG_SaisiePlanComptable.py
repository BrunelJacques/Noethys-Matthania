...
class Dialog(wx.Dialog):
    def __init__(self, parent,mode):
        ...
        self.mode = mode
        self.parent = parent
        self.titre = ("Gestion d'un Compte")
        intro = ("Définit le regroupement des lignes dans la compta")
        self.SetTitle("DLG_SaisiePlanComptable")
        ...
        self.staticbox_nom = wx.StaticBox(self, -1, _("Identifiant du Compte"))
        self.staticbox_caracter = wx.StaticBox(self, -1, _("Caractéristiques du Compte"))
    ...
    def __set_properties(self):
        ...
        self.ctrl_code.SetToolTip(_("16carMaxi - Saisissez ici un code de Compte qui permettra de l'appeler directement. "))
        self.ctrl_libelle.SetToolTip(_("128carMax - Saisissez ici une déscription du Compte dans sa nature comptable"))
        self.ctrl_compta.SetToolTip(_("8carMax - Saisissez ici le numéro de compte du plan comptable"))
    ...
    def OnBoutonOk(self, event):
        ...
        try:
            ...
            if textCode == "":
                message = "Vous devez obligatoirement donner un code à ce Compte_ !"
        except:
            message = "Un code compte ne doit pas avoir de caractère spécial ou un accent_ !"
            textCode = ""
        if textCode == "" :
