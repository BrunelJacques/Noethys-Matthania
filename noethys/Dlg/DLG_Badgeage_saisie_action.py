...
from Ctrl import CTRL_Badgeage_conditions
from Ctrl import CTRL_Badgeage_action
...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        # Mémo des mots-clés
        self.box_motscles_staticbox = wx.StaticBox(self, -1, _("Mots-clés disponibles pour les messages"))
        texte = """
        <FONT SIZE=-2>
    ...
    def __set_properties(self):
        self.SetTitle(_("Saisie d'une action"))
