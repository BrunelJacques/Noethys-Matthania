...
class Dialog(wx.Dialog):
    def __init__(self, parent, listeActivites=[], dateMin=None, dateMax=None, listeSelections=[]):
        ...
        # Intro
        self.label_intro = wx.StaticText(self, -1, _("Cochez les champs à insérer dans votre état :"))
        ...
        self.hyper_select = Hyperlien(self, label=_("Tout cocher"), infobulle=_("Cliquez ici pour tout cocher"), URL="tout")
        self.label_separation = wx.StaticText(self, -1, "|")
        self.hyper_deselect = Hyperlien(self, label=_("Tout décocher"), infobulle=_("Cliquez ici pour tout décocher"), URL="rien")
    ...
    def __set_properties(self):
        self.SetTitle(_("Sélection des champs"))
        self.bouton_ajouter.SetToolTip(wx.ToolTip(_("Cliquez ici pour ajouter un champ personnalisé")))
        self.bouton_modifier.SetToolTip(wx.ToolTip(_("Cliquez ici pour modifier le champ personnalisé sélectionné dans la liste")))
        self.bouton_supprimer.SetToolTip(wx.ToolTip(_("Cliquez ici pour supprimer le champ personnalisé sélectionné dans la iste")))
