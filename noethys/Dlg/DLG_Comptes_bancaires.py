...
from Ol import OL_Comptes_bancaires
...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = _("Vous pouvez ici saisir, modifier ou supprimer des comptes bancaires. Ces données sont utilisées lors du dépôt bancaire des règlements puisque vous pouvez associer un règlement à un compte dès sa saisie.")
        titre = _("Gestion des comptes bancaires")
        self.ctrl_bandeau = CTRL_Bandeau.Bandeau(self, titre=titre, texte=intro, hauteurHtml=30, nomImage="Images/32x32/Reglement.png")
        self.ctrl_listview = OL_Comptes_bancaires.ListView(self, id=-1, style=wx.LC_REPORT|wx.SUNKEN_BORDER|wx.LC_SINGLE_SEL|wx.LC_HRULES|wx.LC_VRULES)
        self.ctrl_listview.MAJ()
        self.ctrl_recherche = OL_Comptes_bancaires.CTRL_Outils(self, listview=self.ctrl_listview)
    ...
    def __set_properties(self):
        self.SetTitle(_("Gestion des comptes bancaires"))
        self.bouton_ajouter.SetToolTip(wx.ToolTip(_("Cliquez ici pour ajouter un compte")))
        self.bouton_modifier.SetToolTip(wx.ToolTip(_("Cliquez ici pour modifier le compte sélectionné dans la liste")))
        self.bouton_supprimer.SetToolTip(wx.ToolTip(_("Cliquez ici pour supprimer le compte sélectionné dans la liste")))
        self.bouton_defaut.SetToolTip(wx.ToolTip(_("Cliquez ici pour définir le compte sélectionné comme celui par défaut")))
