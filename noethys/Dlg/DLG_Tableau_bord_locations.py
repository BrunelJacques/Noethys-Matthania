...
class Page_locations(wx.Panel):
    def __init__(self, parent):
        ...
        self.check_locations_actives = wx.CheckBox(self, -1, _("Afficher uniquement les locations en cours"))
        ...
        # Propriétés
        self.bouton_ajouter_location.SetToolTip(wx.ToolTip(_("Cliquez ici pour saisir une location")))
        self.bouton_modifier_location.SetToolTip(wx.ToolTip(_("Cliquez ici pour modifier la location sélectionnée")))
        self.bouton_supprimer_location.SetToolTip(wx.ToolTip(_("Cliquez ici pour supprimer la location sélectionnée")))
        self.check_locations_actives.SetToolTip(wx.ToolTip(_("Cochez cette case pour afficher uniquement les locations actives")))
...
class Page_demandes(wx.Panel):
    def __init__(self, parent, IDfamille=None):
        ...
        # Filtres
        self.check_attente_avec_possibilites = wx.CheckBox(self, -1, _("Demandes avec disponibilités"))
        self.check_attente_sans_possibilites = wx.CheckBox(self, -1, _("Demandes sans disponibilités"))
        self.check_attente_refusees = wx.CheckBox(self, -1, _("Demandes refusées"))
        self.check_attente_attribuees = wx.CheckBox(self, -1, _("Demandes attribuées"))
        ...
        # Propriétés
        self.bouton_ajouter_demande.SetToolTip(wx.ToolTip(_("Cliquez ici pour saisir une demande de location")))
        self.bouton_modifier_demande.SetToolTip(wx.ToolTip(_("Cliquez ici pour modifier la demande de location sélectionnée")))
        self.bouton_supprimer_demande.SetToolTip(wx.ToolTip(_("Cliquez ici pour supprimer la demande de location sélectionnée")))
...
class Panel(wx.Panel):
    ...
    def InitLabelbook(self):
        ...
        self.listePages = [
            (_("images"), _("Images"), DLG_Categories_produits_images.Panel(self.ctrl_labelbook, bordure=bordure), wx.Bitmap(Chemins.GetStaticPath('Images/32x32/Image_interactive.png'), wx.BITMAP_TYPE_PNG)),
            (_("produits"), _("Produits"), DLG_Produits_liste.Panel(self.ctrl_labelbook, bordure=bordure), wx.Bitmap(Chemins.GetStaticPath('Images/32x32/Produit.png'), wx.BITMAP_TYPE_PNG)),
            (_("locations"), _("Locations"), DLG_Locations.Panel(self.ctrl_labelbook, bordure=bordure), wx.Bitmap(Chemins.GetStaticPath('Images/32x32/Location.png'), wx.BITMAP_TYPE_PNG)),
            (_("demandes"), _("Demandes"), DLG_Locations_demandes.Panel(self.ctrl_labelbook, bordure=bordure), wx.Bitmap(Chemins.GetStaticPath('Images/32x32/Location_demande.png'), wx.BITMAP_TYPE_PNG)),
            ]
