...
class CTRL_Choix_regroupement(wx.Choice):
    def __init__(self, parent):
        ...
        self.listeDonnees = [
            ...
            {"label" : _("Montant de la déduction"), "code": "montant_deduction"},
            {"label" : _("Label de la déduction"), "code": "nom_deduction"},
            {"label" : _("Label de l'aide"), "code": "nom_aide"},
            ]
...
class CTRL_Choix_caisse(wx.Choice):
    def __init__(self, parent):
        ...
        DB.Close()
        self.listeDonnees = [{"label": _("Toutes les caisses"), "ID": None}]
...
class Parametres(wx.Panel):
    def __init__(self, parent, listview=None):
        ...
        self.label_caisse = wx.StaticText(self, -1, _("Caisse :"))
    ...
    def __set_properties(self):
        ...
        self.ctrl_regroupement.SetToolTip(wx.ToolTip(_("Sélectionnez le niveau de regroupement")))
        self.ctrl_caisse.SetToolTip(wx.ToolTip(_("Sélectionnez un filtre pour la caisse associée à l'aide")))
    ...
    def __do_layout(self):
        ...
        grid_sizer_affichage.Add(self.ctrl_caisse, 0, wx.EXPAND, 0)
    ...
    def Actualiser(self, event=None):
        ...
        listeParametres = [ 
            _("Période du %s au %s") % (UTILS_Dates.DateEngFr(str(date_debut)), UTILS_Dates.DateEngFr(str(date_fin))),
            _("Activités : %s") % activites,
            ]
...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = _("Vous pouvez ici éditer une synthèse des déductions pour une période donnée. Commencez par sélectionner une date de début et de fin et cliquer sur le bouton Actualiser. Vous pouvez affiner vos résultats et modifier l'affichage des données grâce aux options proposées.")
        titre = _("Synthèse des déductions")
        self.SetTitle(titre)
