...
from Ol import OL_Transfert_RIB
...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        self.hyper_valides = Hyperlien(self, label=_("Cocher les valides"), infobulle=_("Cliquez ici pour cocher uniquement les valides"), URL="valides")
        ...
        self.bouton_ok = CTRL_Bouton_image.CTRL(self, texte=_("Valider"), cheminImage="Images/32x32/Valider.png")
    ...
    def __set_properties(self):
        ...
        self.bouton_ok.SetToolTip(wx.ToolTip(_("Cliquez ici pour lancer la conversion des RIB en mandats SEPA")))
