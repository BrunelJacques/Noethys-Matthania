...
from Ol import OL_Categories_operations
...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = _("Vous pouvez ici saisir, modifier ou supprimer des catégories comptables.")
        titre = _("Gestion des catégories comptables")
        ...
        self.radio_debit = wx.RadioButton(self, -1, _("Débit"), style=wx.RB_GROUP)
        self.radio_credit = wx.RadioButton(self, -1, _("Crédit"))
    ...
    def __set_properties(self):
        self.SetTitle(_("Gestion des catégories comptables"))
