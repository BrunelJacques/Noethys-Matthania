...
class Dialog(wx.Dialog):
    ...
    def __set_properties(self):
        self.SetTitle(_("Saisie d'une unité de remplissage"))
        self.ctrl_nom.SetToolTip(wx.ToolTip(_("Saisissez ici le nom complet de l'unité de remplissage")))
        self.ctrl_abrege.SetMinSize((80, -1))
        self.ctrl_abrege.SetToolTip(wx.ToolTip(_("Saisissez ici le nom abrégé de l'unité de remplissage")))
        self.ctrl_seuil.SetToolTip(wx.ToolTip(_("Saisisez le nombre de places qui constitue le seuil d'alerte")))
        self.ctrl_unites.SetToolTip(wx.ToolTip(_("Cochez les unités qui doivent être associées")))
        self.ctrl_etiquettes.SetToolTip(wx.ToolTip(_("Cochez les étiquettes qui doivent être associées")))
        ...
        self.ctrl_heure_min.SetToolTip(wx.ToolTip(_("[OPTIONNEL] Saisissez une plage horaire conditionnelle")))
        self.ctrl_heure_max.SetToolTip(wx.ToolTip(_("[OPTIONNEL] Saisissez une plage horaire conditionnelle")))
        self.check_afficher_page_accueil.SetToolTip(wx.ToolTip(_("Afficher cette unité dans le cadre Effectifs de la page d'accueil")))
        self.check_afficher_grille_conso.SetToolTip(wx.ToolTip(_("Afficher cette unité dans la grille des consommations")))
    ...
    def Sauvegarde(self):
        ...
        if heure_min != None and self.ctrl_heure_min.Validation() == False :
            dlg = wx.MessageDialog(self, _("L'heure minimale semble être incorrecte !"), _("Erreur"), wx.OK | wx.ICON_EXCLAMATION)
            dlg.ShowModal()
            dlg.Destroy()
        ...
        if heure_max != None and self.ctrl_heure_max.Validation() == False :
            dlg = wx.MessageDialog(self, _("L'heure maximale semble être incorrecte !"), _("Erreur"), wx.OK | wx.ICON_EXCLAMATION)
            dlg.ShowModal()
            dlg.Destroy()
        ...
        if (heure_min != None and heure_max == None) or (heure_min == None and heure_max != None) :
            dlg = wx.MessageDialog(self, _("La plage horaire est incomplète !"), _("Erreur"), wx.OK | wx.ICON_EXCLAMATION)
            dlg.ShowModal()
            dlg.Destroy()
            self.ctrl_heure_min.SetFocus()
            return False
