...
class MyDialog(wx.Dialog):
    def __init__(self, parent, title="", texteIntro="", ):
        ...
        self.label_url = wx.StaticText(self, -1, _("URL :"))
    ...
    def __set_properties(self):
        self.SetTitle(_("Saisie d'une URL"))
        self.ctrl_label.SetToolTip(wx.ToolTip(_("Saisissez ici le label")))
        self.ctrl_url.SetToolTip(wx.ToolTip(_("Saisissez ici l'URL")))
    ...
    def OnBoutonOk(self, event):
        ...
        if label == "" :
            dlg = wx.MessageDialog(self, _("Vous devez saisir un label !"), "Erreur", wx.OK)
            dlg.ShowModal()
            dlg.Destroy()
        ...
        if URL == "" :
            dlg = wx.MessageDialog(self, _("Vous devez saisir une URL !"), "Erreur", wx.OK)
            dlg.ShowModal()
            dlg.Destroy()
