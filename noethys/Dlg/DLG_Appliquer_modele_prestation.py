...
class Dialog(wx.Dialog):
    def __init__(self, parent, IDfamille=None):
        ...
        titre = _("Saisir une prestation à partir d'un modèle")
        intro = _("Cette fonctionnalité vous permet de créer rapidement une prestation en fonction d'un modèle prédéfini.")
        self.SetTitle(titre)
    ...
    def __set_properties(self):
        self.ctrl_modele.SetToolTip(wx.ToolTip(_("Sélectionnez le modèle à appliquer")))
        self.ctrl_individu.SetToolTip(wx.ToolTip(_("Sélectionnez l'individu à associer à cette prestation")))
        self.ctrl_date.SetToolTip(wx.ToolTip(_("Sélectionnez la date de la prestation (aujourd'hui par défaut)")))
        self.ctrl_montant.SetToolTip(wx.ToolTip(_("Le montant de la prestation est proposé automatiquement mais vous pouvez le modifier librement")))
        self.bouton_modeles.SetToolTip(wx.ToolTip(_("Cliquez ici pour ajouter, modifier ou supprimer des modèles de prestations")))
    ...
    def OnBoutonOk(self, event):
        ...
        if dictModele == None:
            dlg = wx.MessageDialog(self, _("Vous devez obligatoirement sélectionner un modèle dans la liste !"), _("Erreur de saisie"), wx.OK | wx.ICON_EXCLAMATION)
            dlg.ShowModal()
            dlg.Destroy()
            return
        ...
        if self.ctrl_individu.IsEnabled() == True :
            ...
            if IDindividu == None:
                dlg = wx.MessageDialog(self, _("Vous devez obligatoirement sélectionner un individu !"), _("Erreur de saisie"), wx.OK | wx.ICON_EXCLAMATION)
                dlg.ShowModal()
                dlg.Destroy()
        ...
        if self.ctrl_date.Validation() == False :
            dlg = wx.MessageDialog(self, _("La date ne semble pas valide !"), _("Erreur de saisie"), wx.OK | wx.ICON_EXCLAMATION)
            dlg.ShowModal()
            dlg.Destroy()
