...
class Dialog(wx.Dialog):
    ...
    def __set_properties(self):
        ...
        self.radio_tous.SetToolTip(wx.ToolTip(_("Cochez ici pour sélectionner tous les individus")))
        self.radio_inscrits.SetToolTip(wx.ToolTip(_("Cochez ici pour sélectionner des inscrits")))
        ...
        self.check_archives.SetToolTip(wx.ToolTip(_("Cochez cette case pour inclure les individus archivés")))
        self.check_effaces.SetToolTip(wx.ToolTip(_("Cochez cette case pour inclure les individus effacés")))
        self.check_rfid.SetToolTip(wx.ToolTip(_("Cochez cette case pour activer la détection des badges RFID")))
