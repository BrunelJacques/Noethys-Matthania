...
class Dialog(wx.Dialog):
    def __init__(self, parent, dictPiece,dictFamillesRattachees):
        ...
        self.stbTiers = wx.StaticBox(self, -1, _("Tiers"))
        self.label_individu = wx.StaticText(self.stbTiers, -1, _("Individu inscrit :"))
        self.ctrl_nom_individu = wx.TextCtrl(self.stbTiers, -1, "",size=(50, 20))
        self.label_famille = wx.StaticText(self.stbTiers, -1,  _("Famille :"))
        self.ctrl_nom_famille = wx.TextCtrl(self.stbTiers, -1, "",size=(50, 20))
        self.bouton_famille = wx.Button(self.stbTiers, -1, "...", size=(20, 20))
        self.label_payeur = wx.StaticText(self.stbTiers, -1, _("Tiers payeur :"))
        self.ctrl_nom_payeur = wx.TextCtrl(self.stbTiers, -1, "",size=(50, 20))

        self.stbCampG = wx.StaticBox(self, -1, _("Activite"))
        self.label_activite = wx.StaticText(self.stbCampG, -1, _("Activité (hors cotisation et transport):"))
        self.ctrl_nom_activite = wx.TextCtrl(self.stbCampG, -1, "",size=(50, 20))
        self.bouton_activite = wx.Button(self.stbCampG, -1, "...", size=(20, 20))
        self.label_groupe = wx.StaticText(self.stbCampG, -1,  _("Groupe :"))
        self.ctrl_nom_groupe = wx.TextCtrl(self.stbCampG, -1, "",size=(50, 20))
        self.label_tarif = wx.StaticText(self.stbCampG, -1, _("Catégorie Tarif:"))
        self.ctrl_nom_tarif = wx.TextCtrl(self.stbCampG, -1, "",size=(50, 20))

        self.stbPrix = wx.StaticBox(self, -1,_("Prix de l'activité"))
        self.label_prix1 = wx.StaticText(self.stbPrix, -1, _("Actuel :"))
        self.ctrl_prix1 = CTRL_Saisie_euros.CTRL(self.stbPrix)
        self.bouton_prix1 = wx.Button(self.stbPrix, -1, "...", size=(20, 20))
        self.label_prix2 = wx.StaticText(self.stbPrix, -1, _("Nouveau :"))
        self.ctrl_prix2 = CTRL_Saisie_euros.CTRL(self.stbPrix)
        self.bouton_prix2 = wx.Button(self.stbPrix, -1, "...", size=(20, 20))

        self.stbPieceGauche = wx.StaticBox(self, -1, _("Pièce"))
        self.label_nature = wx.StaticText(self.stbPieceGauche, -1, _("Nature :"))
        self.ctrl_nom_nature = wx.TextCtrl(self.stbPieceGauche, -1, "",size=(150, 20))
        self.bouton_piece = wx.Button(self.stbPieceGauche, -1, "...", size=(20, 20))
        self.label_etat = wx.StaticText(self.stbPieceGauche, -1,  _("Etat pièce :"))
        self.ctrl_nom_etat = wx.TextCtrl(self.stbPieceGauche, -1, "",size=(150, 20))

        self.stbContenu = wx.StaticBox(self, -1, _("Contenu"))
        self.label_commentaire = wx.StaticText(self.stbContenu, -1, _("Notes\nmodifiables :"))
        self.txt_commentaire = wx.TextCtrl(self.stbContenu, -1, "", style=wx.TE_MULTILINE,size = (150,60))
        self.label_infos = wx.StaticText(self.stbContenu, -1, _("Infos pièce :"))
        self.choice_infos = wx.Choice(self.stbContenu, -1, choices=[],size = (150,20))
        
        self.stbBoutons = wx.StaticBox(self, -1, )
        if dictPiece["nature"] == "FAC":
            self.bouton_avoir = CTRL_Bouton_image.CTRL(self.stbBoutons, texte=_("Avoir\nGlobal"), cheminImage="Images/32x32/Places_refus.png")
        else:
            self.bouton_avoir = CTRL_Bouton_image.CTRL(self.stbBoutons, texte=_(" "), cheminImage="Images/32x32/Rectangle.png")
        self.bouton_ok_direct = CTRL_Bouton_image.CTRL(self.stbBoutons, texte=_("OK vers\nFamille"), cheminImage="Images/32x32/Suivant.png")
        if self.rw:
            self.bouton_ok = CTRL_Bouton_image.CTRL(self.stbBoutons, texte=_("OK via\nTransp."), cheminImage="Images/32x32/Suivant.png")
        else:
            self.bouton_ok = CTRL_Bouton_image.CTRL(self.stbBoutons, texte=_("Voir\nTransp."), cheminImage="Images/32x32/Suivant.png")
        if self.rw:
            self.bouton_annuler = CTRL_Bouton_image.CTRL(self.stbBoutons, id=wx.ID_CANCEL, texte=_("Abandon"), cheminImage="Images/32x32/Annuler.png")
        else:
            self.bouton_annuler = wx.BitmapButton(self.stbBoutons, wx.ID_CANCEL,wx.Bitmap(Chemins.GetStaticPath("Images/BoutonsImages/Retour_L72.png"), wx.BITMAP_TYPE_ANY))
        self.bouton_compl = CTRL_Bouton_image.CTRL(self.stbBoutons, texte=_("Correctif\n+ ou -"), cheminImage="Images/32x32/Questionnaire.png")
    ...
    def __do_layout(self):
        ...
        staticsizer_TIERS = wx.StaticBoxSizer(self.stbTiers, wx.VERTICAL)
        ...
        staticsizer_CAMPgauche = wx.StaticBoxSizer(self.stbCampG, wx.VERTICAL)
        ...
        staticsizer_PRIX = wx.StaticBoxSizer(self.stbPrix, wx.VERTICAL)
        ...
        staticsizer_PIECEgauche = wx.StaticBoxSizer(self.stbPieceGauche, wx.VERTICAL)
        ...
        staticsizer_CONTENU = wx.StaticBoxSizer(self.stbContenu, wx.VERTICAL)
