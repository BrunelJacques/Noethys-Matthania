...
class Panel_Activite(wx.Panel):
    ...
    def __set_properties(self):
        self.ctrl_activite.SetToolTip(wx.ToolTip(_("Activité sélectionnée")))
        self.bouton_activites.SetToolTip(wx.ToolTip(_("Cliquez ici pour sélectionner une activité")))
...
class Dialog(wx.Dialog):
    ...
    def __set_properties(self):
        ...
        self.ctrl_activites.SetToolTip(wx.ToolTip(_("Double-cliquez sur une ligne pour la sélectionner rapidement")))
