...
class Dialog(wx.Dialog):
    def __init__(self, parent, dictFrais={}):
        ...
        # Méthode de calcul
        self.box_calcul = wx.StaticBox(self, -1, _("Méthode de calcul"))
        ...
        self.box_prestation = wx.StaticBox(self, -1, _("Prestation"))
        self.label_frais_label = wx.StaticText(self, -1, _("Label :"))
    ...
    def __set_properties(self):
        ...
        self.SetTitle(_("Appliquer des frais de gestion"))
