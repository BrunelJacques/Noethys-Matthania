...
TEXTE_INTRO = _("Je soussigné{SIGNATAIRE_GENRE} {SIGNATAIRE_NOM}, {SIGNATAIRE_FONCTION}, atteste avoir inscrit pour la famille de {FAMILLE_NOM} l'enfant {INDIVIDU_PRENOM} à l'activité {ACTIVITE_NOM_LONG}.")
...
class Dialog(wx.Dialog):
    def __init__(self, parent, IDinscription=None):
        ...
        # Bandeau
        intro = _("Vous pouvez ici éditer une confirmation d'inscription. Sélectionnez un modèle de document puis cliquez tout simplement sur 'Aperçu' ou sur 'Envoyer Par Email'.")
        ...
        self.ctrl_tableau = wx.CheckBox(self, -1, _("Afficher un tableau comportant les caractéristiques de l'inscription"))
    ...
    def __set_properties(self):
        ...
        self.ctrl_tableau.SetToolTip(wx.ToolTip(_("Afficher un tableau comportant les caractéristiques de l'inscription")))
    ...
    def Sauvegarder(self, demander=True):
        ...
        UTILS_Historique.InsertActions([{
                ...
                "IDcategorie" : 34, 
                "action" : _("Edition d'une confirmation d'inscription pour l'activité '%s'") % self.dictSave["activite"],
                },])
    ...
    def OnBoutonEmail(self, event): 
        ...
        UTILS_Envoi_email.EnvoiEmailFamilles(parent=self, IDfamille=self.IDfamille, nomDoc=FonctionsPerso.GenerationNomDoc("INSCRIPTION", "pdf"), categorie="inscription", listeAdresses=self.listeAdresses)
