...
class Panel(wx.Panel):
    def __init__(self, parent, bordure=0):
        ...
        # Filtres
        self.check_attente_avec_possibilites = wx.CheckBox(self, -1, _("Avec disponibilités"))
        self.check_attente_sans_possibilites = wx.CheckBox(self, -1, _("Sans disponibilités"))
        self.check_attente_refusees = wx.CheckBox(self, -1, _("Refusées"))
        self.check_attente_attribuees = wx.CheckBox(self, -1, _("Attribuées"))
    ...
    def __set_properties(self):
        self.check_attente_avec_possibilites.SetToolTip(wx.ToolTip(_("Inclure les demandes en attente avec disponibilités")))
        self.check_attente_sans_possibilites.SetToolTip(wx.ToolTip(_("Inclure les demandes en attente sans disponibilités")))
        self.check_attente_refusees.SetToolTip(wx.ToolTip(_("Inclure les demandes refusées")))
        self.check_attente_attribuees.SetToolTip(wx.ToolTip(_("Inclure les demandes déjà attribuées")))
        self.bouton_ajouter.SetToolTip(wx.ToolTip(_("Cliquez ici pour ajouter une demande de location")))
        self.bouton_modifier.SetToolTip(wx.ToolTip(_("Cliquez ici pour modifier la demande de location sélectionnée dans la liste")))
        self.bouton_supprimer.SetToolTip(wx.ToolTip(_("Cliquez ici pour supprimer la demande de location sélectionnée dans la liste")))
...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = _("Vous pouvez ici visualiser, saisir, modifier ou supprimer des demandes de locations.")
        titre = _("Liste des demandes de locations")
        self.SetTitle(titre)
