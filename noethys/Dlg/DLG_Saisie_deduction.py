...
class Dialog(wx.Dialog):
    def __init__(self, parent, IDdeduction=None):
        ...
        if self.IDdeduction == None :
            self.SetTitle(_("Saisie d'une déduction"))
        else:
            self.SetTitle(_("Modification d'une déduction"))
    ...
    def __set_properties(self):
        self.ctrl_label.SetToolTip(wx.ToolTip(_("Saisissez ici un label pour cette déduction")))
        self.ctrl_montant.SetToolTip(wx.ToolTip(_("Saisissez ici le montant de la déduction")))
