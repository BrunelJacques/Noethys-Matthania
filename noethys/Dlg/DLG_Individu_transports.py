...
class Panel(wx.Panel):
    def __init__(self, parent, IDindividu=None, dictFamillesRattachees={}):
        ...
        # Propriétés
        self.bouton_prog_ajouter.SetToolTip(wx.ToolTip(_("Cliquez ici pour programmer un transport")))
        self.bouton_prog_modifier.SetToolTip(wx.ToolTip(_("Cliquez ici pour modifier la programmation sélectionnée dans la liste")))
        self.bouton_prog_supprimer.SetToolTip(wx.ToolTip(_("Cliquez ici pour supprimer la programmation sélectionnée dans la liste")))
        self.bouton_liste_ajouter.SetToolTip(wx.ToolTip(_("Cliquez ici pour saisir un ou plusieurs transports")))
        self.bouton_liste_modifier.SetToolTip(wx.ToolTip(_("Cliquez ici pour modifier le transport sélectionné dans la liste")))
        self.bouton_liste_supprimer.SetToolTip(wx.ToolTip(_("Cliquez ici pour supprimer le transport sélectionné ou les transports cochés dans la liste")))
        self.bouton_liste_calendrier.SetToolTip(wx.ToolTip(_("Cliquez ici pour afficher le planning des transports")))
