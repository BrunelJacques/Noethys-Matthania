...
class CTRL_Choix_donnees(wx.Choice):
    ...
    def MAJ(self):
        self.listeLabels = [_("Quantité"), _("Durée")]
...
class CTRL_Choix_regroupement(wx.Choice):
    def __init__(self, parent):
        ...
        self.listeDonnees = [
            ...
            {"label" : _("Catégorie"), "code" : "categorie"},
...
class Parametres(wx.Panel):
    def __init__(self, parent, listview=None):
        ...
        # Catégories
        self.box_categories_staticbox = wx.StaticBox(self, -1, _("Catégories de produits"))
        ...
        self.label_donnees = wx.StaticText(self, -1, _("Données :"))
        self.ctrl_donnees = CTRL_Choix_donnees(self)
        self.label_regroupement = wx.StaticText(self, -1, _("Regroup. :"))
    ...
    def __set_properties(self):
        ...
        self.ctrl_categories.SetToolTip(wx.ToolTip(_("Cochez les catégories à prendre en compte")))
        self.ctrl_donnees.SetToolTip(wx.ToolTip(_("Sélectionnez le type de données à afficher")))
        self.ctrl_regroupement.SetToolTip(wx.ToolTip(_("Sélectionnez le regroupement par période")))
    ...
    def __do_layout(self):
        ...
        grid_sizer_affichage.Add(self.ctrl_donnees, 0, wx.EXPAND, 0)
    ...
    def Actualiser(self, event=None):
        ...
        listeParametres = [ 
            ...
            _("Catégories : %s") % self.ctrl_categories.GetNomsCategories(),
            ]
...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = _("Vous pouvez ici éditer une synthèse des locations pour une période donnée. Commencez par sélectionner une date de début et de fin et cliquer sur le bouton Actualiser. Vous pouvez affiner vos résultats et modifier l'affichage des données grâce aux options proposées.")
        titre = _("Synthèse des locations")
        self.SetTitle(titre)
