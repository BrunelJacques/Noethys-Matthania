...
class Dialog(wx.Dialog):
    ...
    def __set_properties(self):
        self.SetTitle(_("Aperçu de la fusion"))
        self.bouton_premier.SetToolTip(wx.ToolTip(_("Cliquez ici pour atteindre le premier")))
        self.bouton_reculer.SetMinSize((50, -1))
        self.bouton_reculer.SetToolTip(wx.ToolTip(_("Cliquez ici pour atteindre le précédent")))
        self.bouton_avancer.SetMinSize((50, -1))
        self.bouton_avancer.SetToolTip(wx.ToolTip(_("Cliquez ici pour atteindre le suivant")))
        self.bouton_dernier.SetToolTip(wx.ToolTip(_("Cliquez ici pour atteindre le dernier")))
