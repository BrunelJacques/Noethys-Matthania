...
class CTRL_Parametres(CTRL_Propertygrid.CTRL) :
    ...
    def Remplissage(self):
        ...
        # Type
        propriete = wxpg.EnumProperty(label=_("Type"), name="type_document", labels=[_("Détaillé"), _("Simplifié"), _("Totaux")], values=[0, 1, 2], value=0)
        ...
        # Couleur 3
        propriete = wxpg.ColourProperty(label=_("Fond ligne entêtes"), name="couleur_fond_3", value=wx.Colour(230, 230, 255))
        propriete.SetHelpString(_("Sélectionnez une couleur"))
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)

        # Couleur 1
        propriete = wxpg.ColourProperty(label=_("Fond ligne dépôt"), name="couleur_fond_1", value=wx.Colour(204, 204, 255))
        propriete.SetHelpString(_("Sélectionnez une couleur"))
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)

        # Couleur 2
        propriete = wxpg.ColourProperty(label=_("Fond ligne total"), name="couleur_fond_2", value=wx.Colour(230, 230, 255))
        propriete.SetHelpString(_("Sélectionnez une couleur"))
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
