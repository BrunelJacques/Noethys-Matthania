...
class Dialog(wx.Dialog):
    ...
    def __set_properties(self):
        self.SetTitle(_("Saisie d'une perception"))
        self.ctrl_nom.SetToolTip(wx.ToolTip(_("Saisissez le nom")))
    ...
    def OnBoutonOk(self, event):
        if self.GetNom() == "" :
            dlg = wx.MessageDialog(self, _("Vous n'avez saisi aucun nom pour cette perception !"), _("Erreur de saisie"), wx.OK | wx.ICON_EXCLAMATION)
            dlg.ShowModal()
            dlg.Destroy()
