...
from Ol import OL_Etat_nomin_resultats
...
class Dialog(wx.Dialog):
    def __init__(self, parent, dictParametres={}):
        ...
        self.label_intro = wx.StaticText(self, -1, _("Voici la liste des résultats. Vous pouvez maintenant imprimer cette liste ou l'exporter au format texte ou Ms Excel."))
        ...
        self.bouton_export_texte = wx.BitmapButton(self, -1, wx.Bitmap(Chemins.GetStaticPath(u"Images/16x16/Facture.png"), wx.BITMAP_TYPE_ANY))
        self.bouton_export_excel = wx.BitmapButton(self, -1, wx.Bitmap(Chemins.GetStaticPath(u"Images/16x16/Excel.png"), wx.BITMAP_TYPE_ANY))
        
        self.ctrl_recherche = OL_Etat_nomin_resultats.CTRL_Outils(self, listview=self.ctrl_listview)
        self.ctrl_totaux = wx.TextCtrl(self, -1, "", style=wx.TE_MULTILINE)
    ...
    def __set_properties(self):
        self.SetTitle(_("Aperçu des résultats"))
        ...
        self.bouton_export_excel.SetToolTip(wx.ToolTip(_("Cliquez ici pour exporter la liste au format MS Excel")))
...
if __name__ == "__main__":
    ...
    for IDselection, IDprofil, code, ordre in listeSelectionChamps :
        if code in dictChamps :
            ...
            # Champ indisponible
            dictTemp = {"IDselection":IDselection, "IDprofil":IDprofil, "code":code, "ordre":ordre, "label":_("Non disponible"), "type":None, "categorie":None, "titre":None, "formule":None}
