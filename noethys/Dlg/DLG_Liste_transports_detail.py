...
class Panel(wx.Panel):
    def __init__(self, parent):
        ...
        self.box_liste_staticbox = wx.StaticBox(self, -1, _("Liste des transports"))

        # Filtres
        self.box_filtres_staticbox = wx.StaticBox(self, -1, _("Filtres"))
        
        self.label_individu = wx.StaticText(self, -1, _("Individu :"))
        self.ctrl_individu = CTRL_Filtre(self, labelDefaut=_("Tous les individus"))
