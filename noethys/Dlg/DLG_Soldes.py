...
# Auteur:           Ivan LUCAS, JB, modifié JB filtre compta
...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = _("Lliste des comptes des familles avec antériorité de la dette. Double-cliquez sur une ligne pour ouvrir la fiche famille correspondante. Utilisez le champ Date pour connaître la situation des comptes à une date précise.")
        titre = _("DLG_Soldes: Balance âgée")
        ...
        self.label_date = wx.StaticText(self, -1, _("Date de la situation :"))
        self.ctrl_date = CTRL_Saisie_date.Date2(self)
        self.label_filtres = wx.StaticText(self, -1, _("Filtres :"))
        self.check_debit = wx.CheckBox(self, -1, _("Débiteurs"))
        self.check_credit = wx.CheckBox(self, -1, _("Créditeurs"))
        self.check_nul = wx.CheckBox(self, -1, _("Nuls"))
        self.check_compta = wx.CheckBox(self, -1, _("Seulement en compta"))
        ...
        self.Bind(wx.EVT_CHECKBOX, self.OnFiltres, self.check_compta)
        self.Bind(wx.EVT_BUTTON, self.OnBoutonActualiser, self.bouton_actualiser)
        
        # Init contrôles
        self.ctrl_date.SetDate(datetime.date.today()) 
        self.check_debit.SetValue(True)
        self.check_credit.SetValue(False)
        self.check_nul.SetValue(False)
        self.check_compta.SetValue(True)
        self.Actualiser()

    def __set_properties(self):
        self.SetTitle(_("Soldes des comptes"))
        ...
        self.ctrl_date.SetToolTip(_("Veuillez saisir une date de situation"))
        self.check_debit.SetToolTip(_("Afficher les soldes débiteurs"))
        self.check_credit.SetToolTip(_("Afficher les soldes créditeurs"))
        self.check_nul.SetToolTip(_("Afficher les soldes nuls"))
        self.check_compta.SetToolTip(_("Ignorer ce qui n'est pas transféré en compta"))
    ...
    def __do_layout(self):
        ...
        grid_sizer_parametres = wx.FlexGridSizer(rows=1, cols=10, vgap=5, hgap=5)
        ...
        grid_sizer_parametres.Add(self.check_compta, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        grid_sizer_parametres.Add( (5, 5), 0, wx.ALIGN_CENTER_VERTICAL, 0)
    ...
    def OnFiltres(self, event=None):
        self.ctrl_date.Enable(self.check_compta.GetValue())
        self.label_date.Enable(self.check_compta.GetValue())
        self.Actualiser() 
    ...
    def Actualiser(self):
        ...
        afficherCompta = self.check_compta.GetValue()
        self.ctrl_soldes.MAJ(date, afficherDebit, afficherCredit, afficherNul, afficherCompta)
