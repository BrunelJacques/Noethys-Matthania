...
class Dialog(wx.Dialog):
    ...
    def __set_properties(self):
        ...
        self.ctrl_description.SetToolTip(wx.ToolTip(_("Saisissez une description pour ce modèle [Optionnel]")))
    ...
    def OnBoutonOk(self, event):     
        ...
        if IDadresse == None :
            dlg = wx.MessageDialog(self, _("Etes-vous sûr de ne pas vouloir sélectionner d'adresse d'expéditeur pour ce modèle ?"), _("Confirmation"), wx.YES_NO|wx.NO_DEFAULT|wx.CANCEL|wx.ICON_QUESTION)
        ...
        if objet == "" :
            dlg = wx.MessageDialog(self, _("Etes-vous sûr de ne pas vouloir saisir d'objet de message pour ce modèle ?"), _("Confirmation"), wx.YES_NO|wx.NO_DEFAULT|wx.CANCEL|wx.ICON_QUESTION)
            if dlg.ShowModal() != wx.ID_YES :
                dlg.Destroy()
                return
            dlg.Destroy()
