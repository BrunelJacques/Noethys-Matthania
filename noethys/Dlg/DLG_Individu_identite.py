...
class Panel_identite(wx.Panel):
    def __init__(self, parent, IDindividu=None):
        ...
        self.label_civilite = wx.StaticText(self, -1, _("Civilité/genre :"))
        ...
        self.label_numsecu = wx.StaticText(self, -1, _("Num. sécu. :"))
        self.ctrl_numsecu = CTRL_Saisie_numSecu.NumSecu(self)
        self.label_nationalite = wx.StaticText(self, -1, _("Nationalité :"))
        ...
        self.label_deces = wx.StaticText(self, -1, _("Année :"))
