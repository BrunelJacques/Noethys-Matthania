...
class Dialog(wx.Dialog):
    ...
    def __set_properties(self):
        self.SetTitle(_("Sélection d'une catégorie de produits"))
        self.ctrl_categories.SetToolTip(wx.ToolTip(_("Double-cliquez sur une ligne pour la sélectionner rapidement")))
