...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = _("Vous pouvez ici sélectionner un modèle prédéfini d'aide journalière. Cette fonction vous permet de gagner du temps lors de la saisie d'une aide. Sélectionnez une ligne et cliquez sur Ok ou double-cliquez directement sur une ligne.")
        titre = _("Importation d'un modèle d'aide")
    ...
    def __set_properties(self):
        self.SetTitle(_("Importation d'un modèle d'aide"))
        ...
        self.bouton_annuler.SetToolTip(wx.ToolTip(_("Cliquez ici pour importer le modèle d'aide sélectionné")))
    ...
    def GetIDaide(self):
        ...
        if len(selection) == 0:
            ...
            return selection[0].IDaide
        
    def OnBoutonOk(self, event):
        if self.GetIDaide() == None :
            dlg = wx.MessageDialog(self, _("Vous n'avez sélectionné aucun modèle à importer !"), _("Erreur de saisie"), wx.OK | wx.ICON_EXCLAMATION)
            dlg.ShowModal()
            dlg.Destroy()
            return
