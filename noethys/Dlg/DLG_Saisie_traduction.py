...
class Dialog(wx.Dialog):
    def __init__(self, parent, code="", nom=""):
        ...
        intro = _("Double-cliquez sur une ligne pour saisir ou modifier la traduction correspondante. Il est possible de traduire uniquement une partie du logiciel en utilisant la barre de recherche qui appliquera un filtre sur les résultats (Exemple : Tapez 'facture' pour sélectionner uniquement les textes qui concernent les factures).")
        titre = _("Saisie d'une traduction")
        self.SetTitle(titre)
    ...
    def __set_properties(self):
        self.ctrl_nom_langue.SetToolTip(wx.ToolTip(_("Saisissez le nom de la langue (Exemple : 'Anglais'")))
        self.ctrl_code_langue.SetToolTip(wx.ToolTip(_("Saisissez un code alpha pour cette langue sans espaces ni majuscules ni caractères spéciaux (Exemple : 'anglais')")))
        self.bouton_modifier.SetToolTip(wx.ToolTip(_("Cliquez ici pour saisir une traduction pour la ligne sélectionnée dans la liste")))
