...
class Dialog(wx.Dialog):
    ...
    def __set_properties(self):
        self.SetTitle(_("Saisie d'un texte"))
...
if __name__ == "__main__":
    ...
    listeChamps = [
        (_("Nom de l'individu"), _("DUPOND"), "{NOM_INDIVIDU}"),
        (_("Prénom de l'individu"), _("Gérard"), "{PRENOM_INDIVIDU}"),
        ]
    dialog_1 = Dialog(None, texte=_("coucou !"), listeChamps=listeChamps)
