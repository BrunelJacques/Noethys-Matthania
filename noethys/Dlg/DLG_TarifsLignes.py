...
class PanelArticles(wx.Panel):
    ...
    def __set_properties(self):
        self.ctrl_listview.SetToolTip(_("Un clic sur les coches pour ajouter l'article au tarif ou le précocher. Un double clic est pour modifier l'article"))
        self.bouton_ajouter.SetToolTip(_("Créer un nouvel article inexistant"))
        self.bouton_modifier.SetToolTip(_("Modifier les caractéristiques de l'article sélectionné dans la liste"))
...
class Dialog(wx.Dialog):
    ...
    def __set_properties(self):
        ...
        self.ctrl_libelle.SetToolTip(_("128carMax - Saisissez ici une déscription du tarif"))
        ...
        self.label_annee.SetToolTip(_("Saisissez un filtre pour voir les activités antérieures"))
        self.ctrl_annee.SetToolTip(_("Saisissez un filtre pour voir les activités antérieures"))
    ...
    def OnBoutonOk(self, event):
        ...
        if textCode == "" :
            dlg = wx.MessageDialog(self, _("Vous devez obligatoirement donner un code à ce nom_ !"), _("Erreur"), wx.OK | wx.ICON_EXCLAMATION)
            dlg.ShowModal()
            dlg.Destroy()
