...
class Dialog(wx.Dialog):
    def __init__(self, parent, track=None, activeMontant=True):
        ...
        self.SetTitle(_("Saisie d'une pièce"))
        
        # Famille
        self.box_famille_staticbox = wx.StaticBox(self, -1, _("Généralités"))
        self.label_famille = wx.StaticText(self, -1, _("Famille :"))
        self.ctrl_famille = CTRL_Famille(self)
        
        self.label_titulaire_helios = wx.StaticText(self, -1, _("Titulaire Hélios :"))
        self.ctrl_titulaire_helios = CTRL_Titulaire_helios(self)

        # Pièce
        self.box_piece_staticbox = wx.StaticBox(self, -1, _("Pièce"))
        ...
        self.label_prelevement_actif = wx.StaticText(self, -1, _("Activé :"))
        self.ctrl_prelevement_actif = wx.CheckBox(self, -1, "")
    ...
    def __set_properties(self):
        ...
        self.ctrl_titulaire_helios.SetToolTip(wx.ToolTip(_("Sélectionnez ici le titulaire Hélios de la famille")))
        self.ctrl_controle.SetToolTip(wx.ToolTip(_("Une coche verte apparaît si les coordonnées bancaires sont valides")))
        self.ctrl_prelevement_actif.SetToolTip(wx.ToolTip(_("Cochez cette case pour activer le prélèvement automatique sur cette recette")))
