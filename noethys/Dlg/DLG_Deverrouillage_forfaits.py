...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = _("Si vous n'arrivez plus à supprimer certaines consommations liées à des forfaits, utilisez cette fonctionnalité pour les déverrouiller. Elles deviendront alors supprimables. Cochez les consommations à déverrouiller plus cliquer sur le bouton Déverrouiller.")
        titre = _("Déverrouillage de consommations de forfaits")
        self.SetTitle(titre)
        ...
        self.bouton_ok = CTRL_Bouton_image.CTRL(self, texte=_("Déverrouiller"), cheminImage="Images/32x32/Deverrouiller.png")
    ...
    def __set_properties(self):
        ...
        self.bouton_ok.SetToolTip(wx.ToolTip(_("Cliquez ici pour déverrouiller les consommations cochées")))
