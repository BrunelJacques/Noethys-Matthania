...
LISTE_CATEGORIES = [
    ("individu", _("Individu"), "Personnes.png"),
    ("famille", _("Famille"), "Famille.png"),
    ("categorie_produit", _("Catégorie de produits"), "Categorie_produits.png"),
    ("produit", _("Produit"), "Produit.png"),
    ("location", _("Location"), "Location.png"),
    ("location_demande", _("Demande de location"), "Location_demande.png"),
    ("inscription", _("Inscription"), "Activite.png"),
    ]
...
class Dialog(wx.Dialog):
    def __init__(self, parent, type="individu"):
        ...
        intro = _("Vous pouvez ici concevoir des questionnaires personnalisés pour les fiches individuelles et familiales. Commencez par créer des catégories puis paramétrez des questions basées sur les contrôles de votre choix en fonction des données à saisir : texte, liste, entier, etc...")
        titre = _("Questionnaires")
        self.SetTitle(titre)
        ...
        # Type
        self.box_questionnaire_staticbox = wx.StaticBox(self, -1, _("Questionnaire"))
        self.box_type_staticbox = wx.StaticBox(self, -1, _("Type de fiche"))
        self.label_type = wx.StaticText(self, -1, _("Type de fiche :"))
    ...
    def __set_properties(self):
        self.ctrl_type.SetToolTip(wx.ToolTip(_("Sélectionnez ici le type")))
        self.bouton_ajouter.SetToolTip(wx.ToolTip(_("Cliquez ici pour ajouter une catégorie ou une question")))
        self.bouton_modifier.SetToolTip(wx.ToolTip(_("Cliquez ici pour modifier la catégorie ou la question sélectionnée")))
        self.bouton_supprimer.SetToolTip(wx.ToolTip(_("Cliquez ici pour supprimer la catégorie ou la question sélectionnée")))
        self.bouton_monter.SetToolTip(wx.ToolTip(_("Cliquez ici pour monter la catégorie ou la question sélectionnée")))
        self.bouton_descendre.SetToolTip(wx.ToolTip(_("Cliquez ici pour descendre la catégorie ou la question sélectionnée")))
