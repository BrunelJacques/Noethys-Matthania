...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = _("Vous pouvez ici saisir, modifier ou supprimer des écoles. Vous pouvez renseigner les coordonnées de l'établissement ainsi que les secteurs géographiques rattachés. Vous pourrez ensuite inscrire les individus dans ces écoles depuis les fiches individuelles.")
        titre = _("Gestion des écoles")
        self.SetTitle(titre)
    ...
    def __set_properties(self):
        self.bouton_ajouter.SetToolTip(wx.ToolTip(_("Cliquez ici pour ajouter une école")))
        self.bouton_modifier.SetToolTip(wx.ToolTip(_("Cliquez ici pour modifier l'école sélectionnée dans la liste")))
        self.bouton_supprimer.SetToolTip(wx.ToolTip(_("Cliquez ici pour supprimer l'école sélectionnée dans la iste")))
