...
DICT_CATEGORIES = {
    ...
    "navette" : {"singulier":_("arrêt de navettes"), "pluriel":_("arrêts de navettes"), "image":"Bus"},
    "bateau" : {"singulier":_("arrêt maritime"), "pluriel":_("arrêts maritimes"), "image":"Bateau"},
    "train" : {"singulier":_("arrêt de train"), "pluriel":_("arrêts de trains"), "image":"Train"},
    "intercamp" : {"singulier":_("lieu d'intercamp"), "pluriel":_("lieux d'intercamps"), "image":"Horloge3"},
    "pedibus" : {"singulier":_("arrêt de pédibus"), "pluriel":_("arrêts de pédibus"), "image":"Pedibus"},
    }
...
class Dialog(wx.Dialog):
    def __init__(self, parent, categorie="bus",ligne=None):
        name = "DLG_Arrets"
        wx.Dialog.__init__(self, parent, -1, name= name, style=wx.DEFAULT_DIALOG_STYLE|wx.RESIZE_BORDER|wx.MAXIMIZE_BOX|wx.MINIMIZE_BOX)
        self.parent = parent
        self.categorie = categorie
        self.ligne = ligne
    ...
    def __set_properties(self):
        self.ctrl_ligne.SetToolTip(_("Sélectionnez ici une ligne"))
        self.bouton_ajouter.SetToolTip(_("Cliquez ici pour créer un nouvel arrêt"))
        self.bouton_modifier.SetToolTip(_("Cliquez ici pour modifier l'arrêt sélectionné dans la liste"))
        self.bouton_supprimer.SetToolTip(_("Cliquez ici pour supprimer l'arrêt sélectionné dans la liste"))
        self.bouton_monter.SetToolTip(_("Cliquez ici pour monter l'arrêt sélectionné dans la liste"))
        self.bouton_descendre.SetToolTip(_("Cliquez ici pour descendre l'arrêt sélectionné dans la liste"))
        self.bouton_aide.SetToolTip(_("Cliquez ici pour obtenir de l'aide"))
        self.bouton_fermer.SetToolTip(_("Cliquez ici pour fermer"))
        self.bouton_gestion.SetToolTip(_("Cliquez ici pour accéder à la gestion des lignes"))
...
if __name__ == "__main__":
    ...
    dialog_1 = Dialog(None,categorie="intercamp")
