...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        # Bandeau
        titre = _("Scanner un badge RFID")
        intro = _("Veuillez scanner un badge dans votre lecteur RFID.")
        self.SetTitle(titre)
        ...
        self.ctrl_label = wx.StaticText(self.panel, -1, _("Veuillez scanner un badge"))
