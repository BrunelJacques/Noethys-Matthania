...
from Ctrl import CTRL_Graph_tresorerie
...
class Dialog(wx.Dialog):
    def __init__(self, parent, IDcompte_bancaire=None):
        ...
        intro = _("Sélectionnez un compte et une période pour afficher le suivi de la trésorerie correspondante.")
        titre = _("Trésorerie")
        self.SetTitle(titre)
    ...
    def __set_properties(self):
        self.bouton_actualiser.SetToolTip(wx.ToolTip(_("Cliquez ici pour actualiser l'affichage")))
