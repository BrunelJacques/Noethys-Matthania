...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = _("Vous pouvez ici saisir, modifier ou supprimer des listes de diffusion. Ces listes peuvent être utilisées pour abonner par exemple un individu à une lettre mensuelle internet.")
        titre = _("Gestion des listes de diffusion")
        ...
        self.ctrl_recherche = OL_Listes_diffusion.CTRL_Outils(self, listview=self.ctrl_listview)
    ...
    def __set_properties(self):
        self.SetTitle(_("Gestion des listes de diffusion"))
        self.bouton_ajouter.SetToolTip(wx.ToolTip(_("Cliquez ici pour ajouter une liste de diffusion")))
        self.bouton_modifier.SetToolTip(wx.ToolTip(_("Cliquez ici pour modifier la liste de diffusion sélectionnée")))
        self.bouton_supprimer.SetToolTip(wx.ToolTip(_("Cliquez ici pour supprimer la liste de diffusion sélectionnée")))
        self.bouton_vider.SetToolTip(wx.ToolTip(_("Cliquez ici pour vider la liste de diffusion : les abonnements seront supprimés.")))
    ...
    def OnBoutonAide(self, event): 
        ...
        UTILS_Aide.Aide("Listesdediffusion")
