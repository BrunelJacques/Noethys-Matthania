...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        # Bandeau
        intro = _("Vous pouvez ici saisir, modifier ou supprimer des émetteurs de règlements. Commencez toujours par sélectionner un mode de règlement dans la liste déroulante puis utilisez les boutons de commande de la liste des émetteurs.")
        titre = _("Gestion des émetteurs de règlements")
    ...
    def __set_properties(self):
        self.ctrl_mode.SetToolTip(wx.ToolTip(_("Sélectionnez ici un mode de règlement")))
        self.bouton_ajouter.SetToolTip(wx.ToolTip(_("Cliquez ici pour ajouter un émetteur à ce mode de règlement")))
        self.bouton_modifier.SetToolTip(wx.ToolTip(_("Cliquez ici pour modifier l'émetteur sélectionné dans la liste")))
        self.bouton_supprimer.SetToolTip(wx.ToolTip(_("Cliquez ici pour supprimer l'émetteur sélectionné dans la liste")))
        self.boutons_aide.SetToolTip(wx.ToolTip(_("Cliquez ici pour obtenir de l'aide")))
        self.bouton_fermer.SetToolTip(wx.ToolTip(_("Cliquez ici pour fermer la fenetre")))
