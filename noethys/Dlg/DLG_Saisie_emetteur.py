...
class Dialog(wx.Dialog):
    def __init__(self, parent, IDmode=None, IDemetteur=None):
        ...
        self.ctrl_image = CTRL_Image_mode.CTRL(self, table="emetteurs", key="IDemetteur", IDkey=self.IDemetteur, imageDefaut=Chemins.GetStaticPath("Images/Special/Image_non_disponible.png"), style=wx.BORDER_SUNKEN)
        ...
        if self.IDemetteur == None :
            self.SetTitle(_("Création d'un émetteur"))
        else:
            self.Importation()
            self.SetTitle(_("Modification d'un émetteur"))
        
        
        

    def __set_properties(self):
        self.ctrl_nom.SetToolTip(wx.ToolTip(_("Saisissez ici un nom pour cet émetteur")))
        self.bouton_ajouter.SetToolTip(wx.ToolTip(_("Cliquez ici pour importer une image")))
        self.bouton_supprimer.SetToolTip(wx.ToolTip(_("Cliquez ici pour supprimer l'image active")))
