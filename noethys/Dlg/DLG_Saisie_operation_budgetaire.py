...
class Dialog(wx.Dialog):
    def __init__(self, parent, typeOperation="credit", IDoperation_budgetaire=None):
        ...
        self.label_date_budget = wx.StaticText(self, wx.ID_ANY, _("Date budget :"))
        ...
        if self.typeOperation == "credit" : 
            titre = _("Ventilation d'une opération budgétaire au crédit")
        elif self.typeOperation == "debit" : 
            titre = _("Ventilation d'une opération budgétaire au débit")
        else :
            titre = ""
        self.SetTitle(titre)
    ...
    def __set_properties(self):
        self.ctrl_date_budget.SetToolTip(wx.ToolTip(_("Saisissez la date d'impact budgétaire")))
        self.ctrl_categorie.SetToolTip(wx.ToolTip(_("Sélectionnez une catégorie")))
        self.bouton_categories.SetToolTip(wx.ToolTip(_("Cliquez ici pour accéder à la gestion des catégories")))
        self.ctrl_analytique.SetToolTip(wx.ToolTip(_("Sélectionnez un poste analytique")))
        self.bouton_analytiques.SetToolTip(wx.ToolTip(_("Cliquez ici pour accéder à la gestion des postes analytiques")))
        self.ctrl_libelle.SetToolTip(wx.ToolTip(_("Saisissez un libellé (Optionnel)")))
        self.ctrl_montant.SetToolTip(wx.ToolTip(_("Saisissez un montant")))
    ...
    def Sauvegarde(self):
        ...
        if date_budget == None :
            dlg = wx.MessageDialog(self, _("Vous devez obligatoirement saisir une date d'impact budgétaire !"), _("Erreur"), wx.OK | wx.ICON_EXCLAMATION)
            dlg.ShowModal()
            dlg.Destroy()
        ...
        if IDanalytique == None :
            dlg = wx.MessageDialog(self, _("Vous devez obligatoirement sélectionner un code analytique !"), _("Erreur"), wx.OK | wx.ICON_EXCLAMATION)
            dlg.ShowModal()
            dlg.Destroy()
