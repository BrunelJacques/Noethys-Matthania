...
class Dialog(wx.Dialog):
    def __init__(self, parent, IDvirement=None, IDoperation=None):
        ...
        if self.IDvirement != None :
            self.Importation()
            titre = _("Modification d'un virement")
        else :
            titre = _("Saisie d'un virement")
        self.SetTitle(titre)
    ...
    def __set_properties(self):
        ...
        self.ctrl_compte_debit.SetToolTip(wx.ToolTip(_("Sélectionnez le compte à débiter")))
        self.ctrl_compte_credit.SetToolTip(wx.ToolTip(_("Sélectionnez le compte à créditer")))
        self.ctrl_montant.SetToolTip(wx.ToolTip(_("Saisissez le montant du virement")))
    ...
    def Sauvegarde(self):
        ...
        if IDcompte_debit == None :
            dlg = wx.MessageDialog(self, _("Vous devez obligatoirement sélectionner un compte débiteur !"), _("Erreur"), wx.OK | wx.ICON_EXCLAMATION)
            dlg.ShowModal()
            dlg.Destroy()
        ...
        if IDcompte_credit == None :
            dlg = wx.MessageDialog(self, _("Vous devez obligatoirement sélectionner un compte créditeur !"), _("Erreur"), wx.OK | wx.ICON_EXCLAMATION)
            dlg.ShowModal()
            dlg.Destroy()
        ...
        libelle = _("Virement %s -> %s") % (nomCompteDebit, nomCompteCredit)
