...
class CTRL_Groupes(wx.ListBox):
    ...
    def Importation(self, IDactivite):
        ...
        db.Close()
        self.listeDonnees.append( {"ID" : None, "nom" : _("Aucune modification")} )
...
class CTRL_Modes(wx.ListBox):
    ...
    def Importation(self, IDactivite=None):
        ...
        if IDactivite == None : return
        self.listeDonnees = [
            {"ID" : None, "nom" : _("Aucune modification")},
            {"ID" : "reservation", "nom" : _("Réservation")},
            {"ID" : "attente", "nom" : _("Attente")},
            {"ID" : "refus", "nom" : _("Refus")},
        ]
...
class CTRL_Etats(wx.ListBox):
    ...
    def Importation(self, IDactivite=None):
        ...
        self.listeDonnees = [
            {"ID" : None, "nom" : _("Aucune modification")},
            {"ID" : "reservation", "nom" : _("Pointage en attente")},
            {"ID" : "present", "nom" : _("Présent")},
            {"ID" : "absentj", "nom" : _("Absence justifiée")},
            {"ID" : "absenti", "nom" : _("Absence injustifiée")},
        ]
...
class Dialog(wx.Dialog):
    def __init__(self, parent, IDfamille=None, selectionPeriode=[], selectionIndividus=[], selectionActivite=None):
        ...
        titre = _("Modification d'un lot de consommations")
        self.ctrl_bandeau = CTRL_Bandeau.Bandeau(self, titre=titre, texte=intro, hauteurHtml=30, nomImage="Images/32x32/Forfait.png")

        # Panel Selection
        self.box_selection_staticbox = wx.StaticBox(self, -1, _("Sélection des consommations"))
        ...
        # Panel Modifications
        self.box_modifications_staticbox = wx.StaticBox(self, -1, _("Modifications à appliquer"))
    ...
    def __set_properties(self):
        self.SetTitle(_("Modification des consommations par lot"))
        self.bouton_aide.SetToolTip(wx.ToolTip(_("Cliquez ici pour obtenir de l'aide")))
        self.bouton_ok.SetToolTip(wx.ToolTip(_("Cliquez ici pour appliquer les modifications")))
