...
class CTRL_Categories(wx.CheckListBox):
    ...
    def Importation(self):
        ...
        WHERE IDactivite=%d
        ORDER BY nom;""" % self.IDactivite
        # récup si manque enregistrement dans categorie_tarifs
...
class Parametres(wx.Panel):
    def __init__(self, parent, listview=None):
        ...
        # Activité
        self.label_annee = wx.StaticText(self, -1, _("Année de fin de l'activité:"))
    ...
    def __set_properties(self):
        self.ctrl_activite.SetToolTip(_("Sélectionnez une activité"))
        self.ctrl_annee.SetToolTip(_("Précisez l'année pour limiter le choix des activités"))
        self.ctrl_groupes.SetToolTip(_("Cochez les groupes à afficher"))
        self.ctrl_categories.SetToolTip(_("Cochez les catégories à afficher"))
        self.ctrl_regroupement.SetToolTip(_("Sélectionnez un regroupement"))
    ...
    def GetLabelParametres(self):
        ...
        listeParametres.append(_("Activité : %s") % activite)
