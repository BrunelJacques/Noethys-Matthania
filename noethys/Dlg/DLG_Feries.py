...
class Panel(wx.Panel):
    def __init__(self, parent, type="fixe"):
        ...
        self.staticbox = wx.StaticBox(self, -1, _("Jours %ss") % self.type)
        ...
        # Propriétés
        self.bouton_ajouter.SetToolTip(wx.ToolTip(_("Cliquez ici pour ajouter un jour férié %s") % self.type))
        self.bouton_modifier.SetToolTip(wx.ToolTip(_("Cliquez ici pour modifier le jour férié %s sélectionné dans la liste") % self.type))
        self.bouton_supprimer.SetToolTip(wx.ToolTip(_("Cliquez ici pour supprimer le jour férié %s sélectionné dans la liste") % self.type))
...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = _("Vous pouvez ici saisir, modifier ou supprimer des jours fériés. Ces informations sont utilisées dans le calendrier de saisie des consommations et dans le paramétrage des unités des activités.")
        titre = _("Gestion des jours fériés")
        ...
        self.bouton_saisie_auto = CTRL_Bouton_image.CTRL(self, texte=_("Génération auto. des jours variables"), cheminImage="Images/32x32/Magique.png")
    ...
    def __set_properties(self):
        self.SetTitle(_("Gestion des jours fériés"))
        self.bouton_aide.SetToolTip(wx.ToolTip(_("Cliquez ici pour obtenir de l'aide")))
        self.bouton_saisie_auto.SetToolTip(wx.ToolTip(_("Cliquez ici pour saisir automatiquement les jours fériés variables")))
