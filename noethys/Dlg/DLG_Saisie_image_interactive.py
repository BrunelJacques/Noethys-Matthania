...
class Dialog(wx.Dialog):
    def __init__(self, parent, IDmodele=None, nom="", observations="", categorie="categorie_produits", IDdonnee=None, champs_interactifs={}):
        ...
        self._mgr.AddPane(self.ctrl_proprietes_doc, aui.AuiPaneInfo().
                          Name("proprietes_doc").Caption(_("Propriétés de l'image")).
        ...
        self._mgr.AddPane(self.ctrl_proprietes_objet, aui.AuiPaneInfo().
                          Name("proprietes_objet").Caption(_("Propriétés de l'objet")).
    ...
    def MakeToolBar1(self):
        ...
        tbar.AddSimpleTool(ID_OUTIL_DEPLACER, _("Déplacer"), wx.Bitmap(Chemins.GetStaticPath("Images/32x32/Main.png"), wx.BITMAP_TYPE_ANY), _("Déplacer"), aui.ITEM_RADIO)
        ...
        tbar.AddSimpleTool(ID_OUTIL_AFFICHAGE_APERCU, _("Afficher un aperçu PDF"), wx.Bitmap(Chemins.GetStaticPath("Images/32x32/Pdf.png"), wx.BITMAP_TYPE_ANY), _("Afficher un aperçu PDF"))
    ...
    def MakeToolBar2(self):
        ...
        tbar.AddSimpleTool(ID_OUTIL_OBJET_TEXTE_BLOC, _("Insérer un bloc de texte multi-lignes"), wx.Bitmap(Chemins.GetStaticPath("Images/32x32/Texte_ligne.png"), wx.BITMAP_TYPE_ANY), _("Insérer un bloc de texte multi-lignes"))
        ...
        tbar.AddSimpleTool(ID_OUTIL_OBJET_RECTANGLE, _("Insérer un rectangle"), wx.Bitmap(Chemins.GetStaticPath("Images/32x32/Rectangle.png"), wx.BITMAP_TYPE_ANY), _("Insérer un rectangle"))
        ...
        tbar.AddSimpleTool(ID_OUTIL_OBJET_LIGNE, _("Insérer une ligne"), wx.Bitmap(Chemins.GetStaticPath("Images/32x32/Ligne.png"), wx.BITMAP_TYPE_ANY), _("Insérer une ligne"))
        self.Bind(wx.EVT_TOOL, self.ctrl_canvas.OnOutil_ligne, id=ID_OUTIL_OBJET_LIGNE)

        ID_OUTIL_OBJET_CERCLE = wx.Window.NewControlId()
        tbar.AddSimpleTool(ID_OUTIL_OBJET_CERCLE, _("Insérer une ellipse"), wx.Bitmap(Chemins.GetStaticPath("Images/32x32/Cercle.png"), wx.BITMAP_TYPE_ANY), _("Insérer une ellipse"))
        ...
        tbar.AddSimpleTool(ID_OUTIL_OBJET_POLYGONE, _("Insérer un polygone"), wx.Bitmap(Chemins.GetStaticPath("Images/32x32/Polygone.png"), wx.BITMAP_TYPE_ANY), _("Insérer un polygone"))
        ...
        tbar.AddSimpleTool(ID_OUTIL_OBJET_POLYLINE, _("Dessiner un polygone à main levée"), wx.Bitmap(Chemins.GetStaticPath("Images/32x32/Polyline.png"), wx.BITMAP_TYPE_ANY), _("Dessiner un polygone à main levée"))
        ...
        tbar.AddSimpleTool(ID_OUTIL_OBJET_IMAGE_DROPDOWN, _("Insérer une image"), wx.Bitmap(Chemins.GetStaticPath("Images/32x32/Image.png"), wx.BITMAP_TYPE_ANY), _("Insérer une image"))
