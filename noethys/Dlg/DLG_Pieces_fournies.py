...
from Ol import OL_Pieces_fournies
...
class Dialog(wx.Dialog):
    def __init__(self, parent, IDlot=None):
        ...
        # Bandeau
        intro = _("Vous pouvez ici afficher la liste des pièces fournies. Commencez par sélectionner le type de pièce à afficher puis cochez la case 'valide' si vous souhaitez afficher uniquement les pièces valides à une date précise.")
        titre = _("Liste des pièces fournies")
        self.SetTitle(titre)
        ...
        self.label_piece = wx.StaticText(self, wx.ID_ANY, _("Pièce :"))
        self.ctrl_piece = CTRL_Piece(self)
        self.ctrl_valide = wx.CheckBox(self, wx.ID_ANY, _("Uniquement si valide au :"))
        self.ctrl_date = CTRL_Saisie_date.Date2(self)
        self.ctrl_date.SetDate(datetime.date.today())
        self.bouton_actualiser = wx.Button(self, wx.ID_ANY, _("Actualiser la liste"))
    ...
    def __set_properties(self):
        self.ctrl_piece.SetToolTip(wx.ToolTip(_("Sélectionnez une pièce dans la liste")))
        self.ctrl_valide.SetToolTip(wx.ToolTip(_("Cochez cette case pour afficher uniquement les pièces valides à la date choisie")))
        self.ctrl_date.SetToolTip(wx.ToolTip(_("Choisissez la date à laquelle les pièces doivent être valides")))
        self.bouton_actualiser.SetToolTip(wx.ToolTip(_("Cliquez ici pour actualiser la liste en fonction des paramètres sélectionnés")))
    ...
    def MAJ(self):
        ...
        if self.ctrl_valide.GetValue() == True :
            ...
            if date_reference == None :
                dlg = wx.MessageDialog(self, _("Vous devez renseigner une date de référence !"), _("Erreur"), wx.OK | wx.ICON_EXCLAMATION)
                dlg.ShowModal()
                dlg.Destroy()
    ...
    def OnBoutonAide(self, event): 
        ...
        UTILS_Aide.Aide("Listedespiecesfournies")
