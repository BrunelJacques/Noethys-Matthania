...
##        self.ctrl = self.listviewAvecFooter.GetListview()
        ...
        # Properties
        self.bouton_apercu.SetToolTip(wx.ToolTip(_("Cliquez ici pour afficher un aperçu avant impression des données")))
        self.bouton_imprimer.SetToolTip(wx.ToolTip(_("Cliquez ici pour imprimer les données")))
        self.bouton_excel.SetToolTip(wx.ToolTip(_("Cliquez ici pour exporter au format Excel les données")))
        self.bouton_texte.SetToolTip(wx.ToolTip(_("Cliquez ici pour exporter au format texte les données")))
...
class Panel_Graphe(wx.Panel):
    def __init__(self, parent):
        ...
        # Boutons
        self.bouton_apercu = wx.BitmapButton(self, -1, wx.Bitmap(Chemins.GetStaticPath(u"Images/16x16/Apercu.png"), wx.BITMAP_TYPE_ANY))
        self.bouton_options = wx.BitmapButton(self, -1, wx.Bitmap(Chemins.GetStaticPath(u"Images/16x16/Mecanisme.png"), wx.BITMAP_TYPE_ANY))
        ...
        # Properties
        self.bouton_apercu.SetToolTip(wx.ToolTip(_("Cliquez ici pour ouvrir le visualiseur de graphe pour accéder aux fonctions d'export et d'impression")))
        self.bouton_options.SetToolTip(wx.ToolTip(_("Cliquez ici pour accéder aux options du graphe")))
...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = _("Sélectionnez un budget dans la liste déroulante pour afficher les données correspondantes.")
        titre = _("Suivi du budget")
        self.SetTitle(titre)
        self.ctrl_bandeau = CTRL_Bandeau.Bandeau(self, titre=titre, texte=intro, hauteurHtml=30, nomImage="Images/32x32/Tresorerie.png")

        # Généralités
        self.box_generalites_staticbox = wx.StaticBox(self, wx.ID_ANY, _("Paramètres"))
        self.label_budget = wx.StaticText(self, wx.ID_ANY, _("Budget :"))
        ...
        self.check_periode = wx.CheckBox(self, -1, _("Période personnalisée :"))
        self.ctrl_date_debut = CTRL_Saisie_date.Date2(self)
        self.label_au = wx.StaticText(self, wx.ID_ANY, _("au"))
        self.ctrl_date_fin = CTRL_Saisie_date.Date2(self)
        self.bouton_valider_periode = wx.Button(self, -1, _("Valider"))
        
        self.check_inclure = wx.CheckBox(self, -1, _("Inclure les catégories non budgétées"))
        
        # Situation
        self.box_situation_staticbox = wx.StaticBox(self, wx.ID_ANY, _("Situation"))
        self.notebook = wx.Notebook(self, -1, style=wx.BK_BOTTOM)
        
        self.ctrl_donnees = Panel_Donnees(self.notebook)
        self.notebook.AddPage(self.ctrl_donnees, _("Données"))

        self.ctrl_graphe = Panel_Graphe(self.notebook)
        self.notebook.AddPage(self.ctrl_graphe, _("Graphique"))

        # Images des pages
        il = wx.ImageList(16, 16)
        self.image_donnees = il.Add(wx.Bitmap(Chemins.GetStaticPath("Images/16x16/Tableau.png"), wx.BITMAP_TYPE_PNG))
        self.image_graphique = il.Add(wx.Bitmap(Chemins.GetStaticPath("Images/16x16/Barres.png"), wx.BITMAP_TYPE_PNG))
    ...
    def __set_properties(self):
        self.ctrl_budget.SetToolTip(wx.ToolTip(_("Sélectionnez une budget dans la liste")))
        self.check_periode.SetToolTip(wx.ToolTip(_("Cochez cette case pour saisir une autre date que celle définie dans le budget")))
        ...
        self.bouton_valider_periode.SetToolTip(wx.ToolTip(_("Cliquez ici pour valider les dates saisies")))
