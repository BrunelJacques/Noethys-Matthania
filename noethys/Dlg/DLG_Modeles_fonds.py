...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        wx.Dialog.__init__(self, parent, -1, name="DLG_Modeles_fond", style=wx.DEFAULT_DIALOG_STYLE|wx.RESIZE_BORDER|wx.MAXIMIZE_BOX|wx.MINIMIZE_BOX)
        self.parent = parent
        
        # Bandeau
        titre = _("Fonds de page des documents")
        intro = _("Les fonds de page peuvent être insérés dans les modèles de documents afin d'éviter un paramétrage fastidieux de chaque modèle. Ainsi, quand vous modifiez un fond de page, chaque modèle rattaché est impacté.")
        self.SetTitle(titre)
        ...
        # Modèles
        self.stbModeles = wx.StaticBox(self, -1, _("Fonds de page disponibles"))
        self.ctrl_modeles = OL_Modeles_docs.ListView(self.stbModeles, categorie="fond", id=-1, style=wx.LC_REPORT|wx.SUNKEN_BORDER|wx.LC_SINGLE_SEL|wx.LC_HRULES|wx.LC_VRULES)
    ...
    def __set_properties(self):
        self.bouton_ajouter.SetToolTip(wx.ToolTip(_("Cliquez ici pour créer un nouveau fond")))
        self.bouton_modifier.SetToolTip(wx.ToolTip(_("Cliquez ici pour modifier le fond sélectionné dans la liste")))
        self.bouton_supprimer.SetToolTip(wx.ToolTip(_("Cliquez ici pour supprimer le fond sélectionné dans la liste")))
        self.bouton_dupliquer.SetToolTip(wx.ToolTip(_("Cliquez ici pour dupliquer le fond sélectionné dans la liste")))
