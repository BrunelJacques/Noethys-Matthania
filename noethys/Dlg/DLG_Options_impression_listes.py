...
class CTRL_Parametres(CTRL_Propertygrid.CTRL) :
    ...
    def Remplissage(self):
        ...
        # --------------------------- Divers ------------------------------------------
        self.Append( wxpg.PropertyCategory(_("Divers")) )

        # Inclure les images
        propriete = wxpg.BoolProperty(label=_("Inclure les images"), name="inclure_images", value=True)
        propriete.SetHelpString(_("Cochez cette case pour inclure les images"))
        propriete.SetAttribute("UseCheckbox", True)
        self.Append(propriete)

        # Entete de colonne sur chaque page
        propriete = wxpg.BoolProperty(label=_("Afficher les entêtes sur chaque page"), name="entetes_toutes_pages", value=True)
        propriete.SetHelpString(_("Cochez cette case pour afficher les entêtes de colonne sur chaque page"))
        propriete.SetAttribute("UseCheckbox", True)
        self.Append(propriete)

        # Qualité de l'impression
        labels = [_("Brouillon"), _("Basse"), _("Moyenne"), _("Haute")]
        propriete = wxpg.EnumProperty(label=_("Qualité d'impression"), name="qualite_impression", labels=labels, values=[wx.PRINT_QUALITY_DRAFT, wx.PRINT_QUALITY_LOW, wx.PRINT_QUALITY_MEDIUM, wx.PRINT_QUALITY_HIGH] , value=wx.PRINT_QUALITY_MEDIUM)
        propriete.SetHelpString(_("Sélectionnez la qualité d'impression (Moyenne par défaut)"))
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)


        # --------------------------- Marges ------------------------------------------
        self.Append( wxpg.PropertyCategory(_("Marges")) )

        # Gauche
        propriete = wxpg.IntProperty(label=_("Gauche"), name="marge_gauche", value=5)
        propriete.SetHelpString(_("Saisissez une taille de marge"))
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        self.SetPropertyEditor("marge_gauche", "SpinCtrl")

        # Droite
        propriete = wxpg.IntProperty(label=_("Droite"), name="marge_droite", value=5)
        propriete.SetHelpString(_("Saisissez une taille de marge"))
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        ...
        # Haut
        propriete = wxpg.IntProperty(label=_("Haut"), name="marge_haut", value=5)
        propriete.SetHelpString(_("Saisissez une taille de marge"))
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        ...
        # Bas
        propriete = wxpg.IntProperty(label=_("Bas"), name="marge_bas", value=5)
        propriete.SetHelpString(_("Saisissez une taille de marge"))
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        ...
        propriete.SetHelpString(_("Saisissez une épaisseur de trait (Par défaut '0.25')"))
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)

        # Couleur de trait
        propriete = wxpg.ColourProperty(label=_("Couleur de trait"), name="grille_trait_couleur", value=wx.BLACK)
        propriete.SetHelpString(_("Sélectionnez une couleur de trait"))
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        ...
        # Taille police
        propriete = wxpg.IntProperty(label=_("Taille de texte"), name="titre_taille_texte", value=16)
        propriete.SetHelpString(_("Saisissez une taille de texte (16 par défaut)"))
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        self.SetPropertyEditor("titre_taille_texte", "SpinCtrl")

        # Style
        labels = [_("Normal"), _("Light"), "Gras"]
        valeurs = [wx.FONTWEIGHT_NORMAL, wx.FONTWEIGHT_LIGHT, wx.FONTWEIGHT_BOLD]
        propriete = wxpg.EnumProperty(label=_("Style de texte"), name="titre_style", labels=labels, values=valeurs, value=wx.FONTWEIGHT_BOLD)
        propriete.SetHelpString(_("Sélectionnez un style de texte"))
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        
        # Couleur
        propriete = wxpg.ColourProperty(label=_("Couleur de texte"), name="titre_couleur", value=wx.BLACK)
        ...
        propriete = wxpg.EnumProperty(label=_("Alignement du texte"), name="titre_alignement", labels=labels, values=[wx.ALIGN_LEFT, wx.ALIGN_CENTER, wx.ALIGN_RIGHT] , value=wx.ALIGN_LEFT)
        ...
        # --------------------------- Intro ------------------------------------------
        self.Append( wxpg.PropertyCategory(_("Introduction")) )

        # Taille police
        propriete = wxpg.IntProperty(label=_("Taille de texte"), name="intro_taille_texte", value=7)
        propriete.SetHelpString(_("Saisissez une taille de texte (7 par défaut)"))
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        ...
        labels = [_("Normal"), _("Light"), "Gras"]
        valeurs = [wx.FONTWEIGHT_NORMAL, wx.FONTWEIGHT_LIGHT, wx.FONTWEIGHT_BOLD]
        propriete = wxpg.EnumProperty(label=_("Style de texte"), name="intro_style", labels=labels, values=valeurs, value=wx.FONTWEIGHT_NORMAL)
        propriete.SetHelpString(_("Sélectionnez un style de texte"))
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        
        # Couleur
        propriete = wxpg.ColourProperty(label=_("Couleur de texte"), name="intro_couleur", value=wx.BLACK)
        propriete.SetHelpString(_("Sélectionnez une couleur"))
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        ...
        # Alignement
        labels = [_("Gauche"), _("Centre"), _("Droite")]
        propriete = wxpg.EnumProperty(label=_("Alignement du texte"), name="intro_alignement", labels=labels, values=[wx.ALIGN_LEFT, wx.ALIGN_CENTER, wx.ALIGN_RIGHT] , value=wx.ALIGN_LEFT)
        propriete.SetHelpString(_("Sélectionnez le type d'alignement"))
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)

        # --------------------------- Titre de colonne  ------------------------------------------
        self.Append( wxpg.PropertyCategory(_("Entête de colonne")) )

        # Taille police
        propriete = wxpg.IntProperty(label=_("Taille de texte"), name="titre_colonne_taille_texte", value=8)
        propriete.SetHelpString(_("Saisissez une taille de texte (8 par défaut)"))
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        ...
        labels = [_("Normal"), _("Light"), "Gras"]
        valeurs = [wx.FONTWEIGHT_NORMAL, wx.FONTWEIGHT_LIGHT, wx.FONTWEIGHT_BOLD]
        propriete = wxpg.EnumProperty(label=_("Style de texte"), name="titre_colonne_style", labels=labels, values=valeurs, value=wx.FONTWEIGHT_NORMAL)
        propriete.SetHelpString(_("Sélectionnez un style de texte"))
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        
        # Couleur
        propriete = wxpg.ColourProperty(label=_("Couleur de texte"), name="titre_colonne_couleur", value=wx.BLACK)
        propriete.SetHelpString(_("Sélectionnez une couleur"))
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        ...
        # Alignement
        labels = [_("Gauche"), _("Centre"), _("Droite")]
        propriete = wxpg.EnumProperty(label=_("Alignement du texte"), name="titre_colonne_alignement", labels=labels, values=[wx.ALIGN_LEFT, wx.ALIGN_CENTER, wx.ALIGN_RIGHT] , value=wx.ALIGN_CENTER)
        propriete.SetHelpString(_("Sélectionnez le type d'alignement"))
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)

        # Couleur de fond
        propriete = wxpg.ColourProperty(label=_("Couleur de fond"), name="titre_colonne_couleur_fond", value=wx.Colour(240, 240, 240))
        propriete.SetHelpString(_("Sélectionnez une couleur de fond"))
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)

        # --------------------------- Ligne  ------------------------------------------
        self.Append( wxpg.PropertyCategory(_("Ligne")) )

        # Taille police
        propriete = wxpg.IntProperty(label=_("Taille de texte"), name="ligne_taille_texte", value=8)
        propriete.SetHelpString(_("Saisissez une taille de texte (8 par défaut)"))
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        ...
        labels = [_("Normal"), _("Light"), "Gras"]
        valeurs = [wx.FONTWEIGHT_NORMAL, wx.FONTWEIGHT_LIGHT, wx.FONTWEIGHT_BOLD]
        propriete = wxpg.EnumProperty(label=_("Style de texte"), name="ligne_style", labels=labels, values=valeurs, value=wx.FONTWEIGHT_NORMAL)
        propriete.SetHelpString(_("Sélectionnez un style de texte"))
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        
        # Couleur
        propriete = wxpg.ColourProperty(label=_("Couleur de texte"), name="ligne_couleur", value=wx.BLACK)
        propriete.SetHelpString(_("Sélectionnez une couleur"))
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)

        # Multilignes autorisé
        propriete = wxpg.BoolProperty(label=_("Autoriser saut à la ligne"), name="ligne_multilignes", value=True)
        propriete.SetHelpString(_("Cochez cette case pour autoriser le saut à la ligne en cas de colonne trop étroite"))
        propriete.SetAttribute("UseCheckbox", True)
        self.Append(propriete)
        ...
        # Texte de gauche
        valeur = "{DATE_JOUR}"
        propriete = wxpg.StringProperty(label=_("Texte de gauche"), name="pied_page_texte_gauche", value=valeur)
        propriete.SetHelpString(_("Saisissez le texte de gauche du pied de page (Par défaut '%s'). Vous pouvez intégrer les mots-clés suivants : %s") % (valeur, ", ".join(listeChampsPiedsPages)))
        self.Append(propriete)

        # Texte du milieu
        valeur = "{TITRE_DOCUMENT} - {NOM_ORGANISATEUR}"
        propriete = wxpg.StringProperty(label=_("Texte du milieu"), name="pied_page_texte_milieu", value=valeur)
        propriete.SetHelpString(_("Saisissez le texte du milieu du pied de page (Par défaut '%s'). Vous pouvez intégrer les mots-clés suivants : %s") % (valeur, ", ".join(listeChampsPiedsPages)))
        self.Append(propriete)

        # Texte de droite
        valeur = "{NUM_PAGE} / {NBRE_PAGES}"
        propriete = wxpg.StringProperty(label=_("Texte de droite"), name="pied_page_texte_droite", value=valeur)
        propriete.SetHelpString(_("Saisissez le texte de droite du pied de page (Par défaut '%s'). Vous pouvez intégrer les mots-clés suivants : %s") % (valeur, ", ".join(listeChampsPiedsPages)))
        self.Append(propriete)

        # Taille police
        propriete = wxpg.IntProperty(label=_("Taille de texte"), name="pied_page_taille_texte", value=8)
        propriete.SetHelpString(_("Saisissez une taille de texte (8 par défaut)"))
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        ...
        labels = [_("Normal"), _("Light"), "Gras"]
        valeurs = [wx.FONTWEIGHT_NORMAL, wx.FONTWEIGHT_LIGHT, wx.FONTWEIGHT_BOLD]
        propriete = wxpg.EnumProperty(label=_("Style de texte"), name="pied_page_style", labels=labels, values=valeurs, value=wx.FONTWEIGHT_NORMAL)
        propriete.SetHelpString(_("Sélectionnez un style de texte"))
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        
        # Couleur
        propriete = wxpg.ColourProperty(label=_("Couleur de texte"), name="pied_page_couleur", value=wx.BLACK)
        propriete.SetHelpString(_("Sélectionnez une couleur"))
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        ...
        # --------------------------- Pied de colonne  ------------------------------------------
        self.Append( wxpg.PropertyCategory(_("Pied de colonne")) )

        # Taille police
        propriete = wxpg.IntProperty(label=_("Taille de texte"), name="pied_colonne_taille_texte", value=8)
        propriete.SetHelpString(_("Saisissez une taille de texte (8 par défaut)"))
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        ...
        labels = [_("Normal"), _("Light"), "Gras"]
        valeurs = [wx.FONTWEIGHT_NORMAL, wx.FONTWEIGHT_LIGHT, wx.FONTWEIGHT_BOLD]
        propriete = wxpg.EnumProperty(label=_("Style de texte"), name="pied_colonne_style", labels=labels, values=valeurs, value=wx.FONTWEIGHT_NORMAL)
        propriete.SetHelpString(_("Sélectionnez un style de texte"))
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        
        # Couleur
        propriete = wxpg.ColourProperty(label=_("Couleur de texte"), name="pied_colonne_couleur", value=wx.BLACK)
        propriete.SetHelpString(_("Sélectionnez une couleur"))
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        ...
        # Alignement
        labels = [_("Gauche"), _("Centre"), _("Droite")]
        propriete = wxpg.EnumProperty(label=_("Alignement du texte"), name="pied_colonne_alignement", labels=labels, values=[wx.ALIGN_LEFT, wx.ALIGN_CENTER, wx.ALIGN_RIGHT] , value=wx.ALIGN_CENTER)
        propriete.SetHelpString(_("Sélectionnez le type d'alignement"))
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)

        # Couleur de fond
        propriete = wxpg.ColourProperty(label=_("Couleur de fond"), name="pied_colonne_couleur_fond", value=wx.Colour(240, 240, 240))
        propriete.SetHelpString(_("Sélectionnez une couleur de fond"))
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        ...
        # --------------------------- Pied de liste ------------------------------------------
        self.Append( wxpg.PropertyCategory(_("Conclusion")) )

        # Taille police
        propriete = wxpg.IntProperty(label=_("Taille de texte"), name="conclusion_taille_texte", value=7)
        propriete.SetHelpString(_("Saisissez une taille de texte (7 par défaut)"))
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        ...
        labels = [_("Normal"), _("Light"), "Gras"]
        valeurs = [wx.FONTWEIGHT_NORMAL, wx.FONTWEIGHT_LIGHT, wx.FONTWEIGHT_BOLD]
        propriete = wxpg.EnumProperty(label=_("Style de texte"), name="conclusion_style", labels=labels, values=valeurs, value=wx.FONTWEIGHT_BOLD)
        propriete.SetHelpString(_("Sélectionnez un style de texte"))
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        
        # Couleur
        propriete = wxpg.ColourProperty(label=_("Couleur de texte"), name="conclusion_couleur", value=wx.BLACK)
        propriete.SetHelpString(_("Sélectionnez une couleur"))
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        ...
        # Alignement
        labels = [_("Gauche"), _("Centre"), _("Droite")]
        propriete = wxpg.EnumProperty(label=_("Alignement du texte"), name="conclusion_alignement", labels=labels, values=[wx.ALIGN_LEFT, wx.ALIGN_CENTER, wx.ALIGN_RIGHT] , value=wx.ALIGN_LEFT)
        propriete.SetHelpString(_("Sélectionnez le type d'alignement"))
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
...
class CTRL(wx.Panel):
    def __init__(self, parent, dictOptions={}):
        ...
        # Properties
        self.ctrl_radio_portrait.SetToolTip(wx.ToolTip(_("Cliquez ici pour sélectionner une orientation portrait")))
        self.ctrl_image_portrait.SetToolTip(wx.ToolTip(_("Cliquez ici pour sélectionner une orientation portrait")))
        self.ctrl_radio_paysage.SetToolTip(wx.ToolTip(_("Cliquez ici pour sélectionner une orientation paysage")))
        self.ctrl_image_paysage.SetToolTip(wx.ToolTip(_("Cliquez ici pour sélectionner une orientation paysage")))
        self.ctrl_titre.SetToolTip(wx.ToolTip(_("Vous pouvez modifier ici le titre du document")))
        self.ctrl_introduction.SetToolTip(wx.ToolTip(_("Vous pouvez modifier ici l'introduction du document")))
        self.ctrl_conclusion.SetToolTip(wx.ToolTip(_("Vous pouvez modifier ici la conclusion du document")))
...
class Dialog(wx.Dialog):
    def __init__(self, parent, dictOptions={}):
        ...
        # Bandeau
        titre = _("Paramètres d'impression")
        intro = _("Vous pouvez ici modifier les paramètres d'impression par défaut des listes. Cliquez sur le bouton 'Mémoriser les paramètres' pour réutiliser les même paramètres pour toutes les autres impressions de listes.")
        self.SetTitle(titre)
