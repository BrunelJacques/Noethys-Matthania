...
class Dialog(wx.Dialog):
    def __init__(self, parent, IDfamille=None):
        ...
        # Bandeau
        intro = _("Saisissez ici les coordonnées bancaires du compte de la famille à débiter afin d'activer le prélèvement automatique.")
        titre = _("Prélèvement automatique")
        self.SetTitle(titre)
        ...
        self.bouton_rib = wx.Button(self, -1, _("Saisie d'un RIB (Prélèvements nationaux)"))
    ...
    def __set_properties(self):
        self.radio_activation_oui.SetToolTip(wx.ToolTip(_("Cliquez ici pour activer le prélèvement")))
        self.radio_activation_non.SetToolTip(wx.ToolTip(_("Cliquez ici pour désactiver le prélèvement")))
        self.bouton_ajouter.SetToolTip(wx.ToolTip(_("Cliquez ici pour ajouter un mandat")))
        self.bouton_modifier.SetToolTip(wx.ToolTip(_("Cliquez ici pour modifier le mandat sélectionné dans la liste")))
        self.bouton_supprimer.SetToolTip(wx.ToolTip(_("Cliquez ici pour supprimer le mandat sélectionné dans la iste")))
        self.bouton_aide.SetToolTip(wx.ToolTip(_("Cliquez ici pour obtenir de l'aide")))
        self.bouton_rib.SetToolTip(wx.ToolTip(_("Cliquez ici pour paramétrer un RIB pour les prélèvements nationaux (jusqu'au 1er février 2014)")))
    ...
    def OnBoutonFermer(self, event):
        ...
        if activation == True :
            if len(self.ctrl_listview.donnees) == 0 :
                dlg = wx.MessageDialog(self, _("Vous devez saisir au moins un mandat pour pouvoir activer le prélèvement !"), _("Erreur de saisie"), wx.OK | wx.ICON_EXCLAMATION)
                dlg.ShowModal()
                dlg.Destroy()
                return
            ...
            # Pas d'activation
            dlg = wx.MessageDialog(None, _("Vous confirmez que vous ne souhaitez pas activer le prélèvement automatique ?"), _("Confirmation"), wx.YES_NO|wx.YES_DEFAULT|wx.CANCEL|wx.ICON_QUESTION)
