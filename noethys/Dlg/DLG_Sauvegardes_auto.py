...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = _("Vous pouvez ici saisir, modifier ou supprimer des procédures de sauvegardes automatiques. Ces sauvegardes sont réalisées lors de la fermeture du fichier de données ou du logiciel en fonction des paramètres et conditions de votre choix.")
        titre = _("Sauvegardes automatiques")
        self.SetTitle(titre)
        self.ctrl_bandeau = CTRL_Bandeau.Bandeau(self, titre=titre, texte=intro, hauteurHtml=30, nomImage="Images/32x32/Sauvegarde_param.png")
    ...
    def __set_properties(self):
        self.bouton_ajouter.SetToolTip(wx.ToolTip(_("Cliquez ici pour ajouter une procédure de sauvegarde")))
        self.bouton_modifier.SetToolTip(wx.ToolTip(_("Cliquez ici pour modifier la procédure de sauvegarde sélectionnée dans la liste")))
        self.bouton_supprimer.SetToolTip(wx.ToolTip(_("Cliquez ici pour supprimer la procédure de sauvegarde sélectionnée dans la liste")))
