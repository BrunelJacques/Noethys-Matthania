...
DICT_CATEGORIES = {
    "bus" : {"singulier":_("compagnie de bus"), "pluriel":_("compagnies de bus"), "image":"Bus"},
    "car" : {"singulier":_("compagnie de cars"), "pluriel":_("compagnies de cars"), "image":"Car"},
    "navette" : {"singulier":_("type de navettes"), "pluriel":_("types de navettes"), "image":"Bus"},
    "taxi" : {"singulier":_("compagnie de taxis"), "pluriel":_("compagnies de taxis"), "image":"Taxi"},
    "avion" : {"singulier":_("compagnie aérienne"), "pluriel":_("compagnies aériennes"), "image":"Avion"},
    "bateau" : {"singulier":_("compagnie maritime"), "pluriel":_("compagnies maritimes"), "image":"Bateau"},
    "train" : {"singulier":_("compagnie ferroviaire"), "pluriel":_("compagnies ferroviaires"), "image":"Train"},
    "metro" : {"singulier":_("compagnie de métros"), "pluriel":_("compagnies de métro"), "image":"Metro"},
    }
...
class Dialog(wx.Dialog):
    def __init__(self, parent, categorie="avion", mode="gestion"):
        ...
        if self.mode == "selection" :
            intro = _("Vous pouvez ici sélectionner une %s. Double-cliquez sur une ligne pour effectuer rapidement la sélection.") % self.categorieSingulier
            titre = _("Sélection d'une %s") % self.categorieSingulier
    ...
    def __set_properties(self):
        ...
        self.bouton_modifier.SetToolTip(_("Cliquez ici pour modifier la %s sélectionnée dans la liste") % self.categorieSingulier)
        self.bouton_supprimer.SetToolTip(_("Cliquez ici pour supprimer la %s sélectionnée dans la liste") % self.categorieSingulier)
