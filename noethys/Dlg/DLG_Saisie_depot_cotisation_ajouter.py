...
class Dialog(wx.Dialog):
    def __init__(self, parent, tracks=[]):
        ...
        self.label_intro = wx.StaticText(self, -1, _("Double-cliquez sur une cotisation pour l'affecter ou non au dépôt."), style=wx.ALIGN_CENTER)
        
        self.label_tri = wx.StaticText(self, -1, _("Tri par :"))
        self.ctrl_tri = wx.Choice(self, -1, choices = (_("Ordre de saisie"), _("Date de début de validité"), _("Date de fin de validité"), _("Nom des titulaires"), _("Type de cotisation"), _("Nom de cotisation"), _("Numéro de carte"), _("Date de dépôt")))
    ...
    def __set_properties(self):
        self.SetTitle(_("Ajouter ou retirer des cotisations"))
        ...
        self.bouton_bas_tout.SetToolTip(wx.ToolTip(_("Cliquez ici pour ajouter toutes les cotisations dans le dépôt")))
        self.bouton_bas.SetToolTip(wx.ToolTip(_("Cliquez ici pour ajouter la cotisation disponible selectionné dans le dépôt")))
        ...
        self.bouton_haut.SetToolTip(wx.ToolTip(_("Cliquez ici pour retirer la cotisation sélectionnée du dépôt")))
        self.bouton_haut_tout.SetToolTip(wx.ToolTip(_("Cliquez ici pour retirer toutes les cotisations du dépôt")))
    ...
    def OnBoutonBasTout(self, event): 
        dlg = wx.MessageDialog(self, _("Souhaitez-vous vraiment ajouter toutes les cotisations ?"), _("Confirmation"), wx.YES_NO|wx.NO_DEFAULT|wx.CANCEL|wx.ICON_EXCLAMATION)
    ...
    def OnBoutonHautTout(self, event):
        dlg = wx.MessageDialog(self, _("Souhaitez-vous vraiment retirer toutes les cotisations ?"), _("Confirmation"), wx.YES_NO|wx.NO_DEFAULT|wx.CANCEL|wx.ICON_EXCLAMATION)
        reponse = dlg.ShowModal()
        dlg.Destroy()
        if reponse ==  wx.ID_YES :
