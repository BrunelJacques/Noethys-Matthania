...
class Dialog(wx.Dialog):
    def __init__(self, parent, IDfamille=None):
        ...
        intro = _("Vous pouvez ici consulter la liste complète des devis créés dans le logiciel.")
        titre = _("Liste des devis")
        self.ctrl_bandeau = CTRL_Bandeau.Bandeau(self, titre=titre, texte=intro, hauteurHtml=30, nomImage="Images/32x32/Facture.png")

        self.listviewAvecFooter = OL_Devis.ListviewAvecFooter(self, kwargs={"IDfamille" : self.IDfamille})
        self.ctrl_listview = self.listviewAvecFooter.GetListview()
        self.ctrl_listview.MAJ()
        self.ctrl_recherche = OL_Devis.CTRL_Outils(self, listview=self.ctrl_listview)
    ...
    def __set_properties(self):
        self.SetTitle(_("Liste des devis"))
        self.bouton_ouvrir_fiche.SetToolTip(wx.ToolTip(_("Cliquez ici pour ouvrir la fiche famille du devis sélectionné dans la liste")))
        self.bouton_supprimer.SetToolTip(wx.ToolTip(_("Cliquez ici pour supprimer le devis sélectionné dans la liste")))
    ...
    def OnBoutonAide(self, event): 
        ...
        UTILS_Aide.Aide("Listedesdevisgeneres")
