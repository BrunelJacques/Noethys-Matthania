...
class Dialog(wx.Dialog):
    def __init__(self, parent, empecheAnnulation=False):
        ...
        self.staticbox_nom_staticbox = wx.StaticBox(self, -1, _("Nom de l'organisateur"))
        ...
        self.label_adresse = wx.StaticText(self, -1, _("C.P. :"))
        self.ctrl_adresse = CTRL_Saisie_adresse.Adresse(self)
        self.label_tel = wx.StaticText(self, -1, _("Tél :"))
        self.ctrl_tel = CTRL_Saisie_tel.Tel(self, intitule=_("siège"))
        ...
        self.staticbox_numeros_staticbox = wx.StaticBox(self, -1, _("Numéros d'identification"))
        self.label_agrement = wx.StaticText(self, -1, _("Numéro agrément :"))
        self.ctrl_agrement = wx.TextCtrl(self, -1, "")
        self.label_siret = wx.StaticText(self, -1, _("Numéro SIRET :"))
        self.ctrl_siret = wx.TextCtrl(self, -1, "")
        self.label_ape = wx.StaticText(self, -1, _("Code APE :"))
        self.ctrl_ape = wx.TextCtrl(self, -1, "")
