...
class Dialog(wx.Dialog):
    def __init__(self, parent, empecheAnnulation=False):
        ...
        intro = _("Saisissez ici les informations concernant l'organisateur. Ces données seront utilisées dans les différents documents édités par le logiciel.")
        titre = _("L'organisateur")
        ...
        self.stbNom = wx.StaticBox(self, -1, _("Nom de l'organisateur"))
        ...
        self.label_adresse = wx.StaticText(self.stbCoords, -1, _("C.P. :"))
        self.ctrl_adresse = CTRL_Saisie_adresse.Adresse(self.stbCoords)
        self.label_tel = wx.StaticText(self.stbCoords, -1, _("Tél :"))
        self.ctrl_tel = CTRL_Saisie_tel.Tel(self.stbCoords, intitule=_("siège"))
        ...
        self.stbNumeros = wx.StaticBox(self, -1, _("Numéros d'identification"))
        self.label_agrement = wx.StaticText(self.stbNumeros, -1, _("Numéro agrément :"))
        self.ctrl_agrement = wx.TextCtrl(self.stbNumeros, -1, "")
        self.label_siret = wx.StaticText(self.stbNumeros, -1, _("Numéro SIRET :"))
        self.ctrl_siret = wx.TextCtrl(self.stbNumeros, -1, "")
        self.label_ape = wx.StaticText(self.stbNumeros, -1, _("Code APE :"))
        self.ctrl_ape = wx.TextCtrl(self.stbNumeros, -1, "")
        
        self.stbLogo = wx.StaticBox(self, -1, _("Logo"))
        self.ctrl_logo = CTRL_Logo.CTRL(self.stbLogo, qualite=100, couleurFond=wx.Colour(255, 255, 255), size=(83, 83) )
        self.bouton_modifier = wx.BitmapButton(self.stbLogo, -1, wx.Bitmap(Chemins.GetStaticPath(u"Images/16x16/Modifier.png"), wx.BITMAP_TYPE_ANY))
        self.bouton_supprimer = wx.BitmapButton(self.stbLogo, -1, wx.Bitmap(Chemins.GetStaticPath(u"Images/16x16/Supprimer.png"), wx.BITMAP_TYPE_ANY))
    ...
    def __set_properties(self):
        self.SetTitle(_("L'organisateur"))
        self.ctrl_nom.SetToolTip(wx.ToolTip(_("Saisissez ici le nom de l'organisateur")))
        self.ctrl_rue.SetToolTip(wx.ToolTip(_("Saisissez ici la rue de l'adresse de l'organisateur")))
        self.ctrl_site.SetToolTip(wx.ToolTip(_("Saisissez ici l'adresse du site internet de l'organisateur")))
        self.ctrl_agrement.SetMinSize((200, -1))
        self.ctrl_agrement.SetToolTip(wx.ToolTip(_("Saisissez ici le numéro d'agrément de l'organisateur")))
        self.ctrl_siret.SetToolTip(wx.ToolTip(_("Saisissez ici le numéro SIRET de l'organisateur")))
        self.ctrl_ape.SetToolTip(wx.ToolTip(_("Saisissez ici le code APE de l'organisateur")))
        self.ctrl_logo.SetToolTip(wx.ToolTip(_("Logo de l'organisateur")))
        self.bouton_modifier.SetToolTip(wx.ToolTip(_("Cliquez ici pour ajouter ou modifier le logo de l'organisateur")))
        self.bouton_supprimer.SetToolTip(wx.ToolTip(_("Cliquez ici pour supprimer le logo actuel")))
        self.bouton_visualiser.SetToolTip(wx.ToolTip(_("Cliquez ici pour visualiser le logo actuel en taille réelle")))
    ...
    def __do_layout(self):
        ...
        staticbox_numeros = wx.StaticBoxSizer(self.stbNumeros, wx.VERTICAL)
