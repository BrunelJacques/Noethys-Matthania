...
class Dialog(wx.Dialog):
    def __init__(self, parent, listeColonnes=[], listeValeurs=[], type=None):
        wx.Dialog.__init__(self, parent, -1, title=_("Sélection d'éléments"), size=(800, 460))
        self.parent = parent
        ...
        self.label_intro = wx.StaticText(self, -1, _("Veuillez sélectionner les éléments de votre choix :"))
    ...
    def Build_Hyperlink_select(self) :
        ...
        hyper = hl.HyperLinkCtrl(self, -1, _("Tout sélectionner"), URL="")
        ...
        hyper.SetBold(False)
        hyper.SetToolTip(wx.ToolTip(_("Tout sélectionner")))
        hyper.UpdateLink()
        hyper.DoPopup(False)
        return hyper
    ...
    def Build_Hyperlink_deselect(self) :
        """ Construit un hyperlien """
        self.SetFont(wx.Font(8, wx.SWISS, wx.NORMAL, wx.NORMAL, False))
        hyper = hl.HyperLinkCtrl(self, -1, _("Tout dé-sélectionner"), URL="")
        ...
        hyper.SetUnderlines(False, False, True)
        hyper.SetBold(False)
        hyper.SetToolTip(wx.ToolTip(_("Tout dé-sélectionner")))
        hyper.UpdateLink()
        hyper.DoPopup(False)
        return hyper
    ...
    def OnBoutonOk(self, event):
        ...
        if len(selections) == 0 :
            dlg = wx.MessageDialog(self, _("Vous n'avez fait aucune sélection"), _("Erreur de saisie"), wx.OK | wx.ICON_ERROR)
            dlg.ShowModal()
            dlg.Destroy()
            return
