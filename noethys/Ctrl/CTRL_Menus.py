...
class CTRL(gridlib.Grid, glr.GridWithLabelRenderersMixin):
    ...
    def OnCellRightClick(self, event):
        ...
        if (numLigne, numColonne) in self.dictCases:
            ...
            item = wx.MenuItem(menuPop, id, _("Effacer la case"))
            ...
            # Copier
            id = wx.Window.NewControlId()
            item = wx.MenuItem(menuPop, id, _("Copier\tCtrl+C"))
            ...
            # Coller
            id = wx.Window.NewControlId()
            item = wx.MenuItem(menuPop, id, _("Coller\tCtrl+V"))
...
class DLG_Saisie_texte(wx.Dialog):
    def __init__(self, parent, texte=""):
        ...
        # Bandeau
        intro = _("Saisissez ci-dessous un plat par ligne. Pour insérer une légende dans le texte, double-cliquez sur son nom dans la liste ou tapez directement le numéro correspondant entre accolades (Exemples : {3} ou {14}).")
        titre = _("Saisie d'un menu")
        self.SetTitle(titre)
        ...
        # Légendes
        self.staticbox_legendes_staticbox = wx.StaticBox(self, -1, _("Légendes disponibles"))
    ...
    def __set_properties(self):
        self.SetTitle(_("Saisie d'un menu"))
        self.bouton_legendes.SetToolTip(wx.ToolTip(_("Cliquez ici pour accéder à la gestion des légendes")))
