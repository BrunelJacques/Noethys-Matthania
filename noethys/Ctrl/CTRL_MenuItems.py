...
def GetListItemsMenu(self,menuTransports):
    return [
        ...
        {"code": "menu_facturation", "label": _("Facturation"), "items": [
            ...
            "-",
            {"code": "factures_analyse", "label": _("Analyse facturation"),
             "infobulle": _(
            ...
            {"code": "factures_liste",
             "label": _(u"Liste récapitulative de factures"),
             "infobulle": _(u"Liste d'un récapitulatif de factures existantes"),
             "image": "Images/16x16/Facture.png",
