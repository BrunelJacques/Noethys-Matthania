...
class CTRL_Annee(wx.SpinCtrl):
    def __init__(self, parent):
        ...
        self.SetToolTip(wx.ToolTip(_("Sélectionnez une année")))
...
class CTRL_ListBox(wx.ListBox):
    def __init__(self, parent):
        ...
        self.parent = parent
        self.SetToolTip(wx.ToolTip(_("Sélectionnez une ou plusieurs périodes avec les touches SHIFT ou CTRL")))
        self.listeChoix = []
...
class CTRL(wx.Panel):
    def __init__(self, parent):
        """ Selection d'une période pour la grille de saisie des conso """
        wx.Panel.__init__(self, parent, id=-1, style=wx.TAB_TRAVERSAL)
        self.parent = parent
        ...
        self.notebook.AddPage(self.page_mois, _("Mois"))
