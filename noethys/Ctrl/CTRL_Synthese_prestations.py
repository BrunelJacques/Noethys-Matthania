...
class CTRL(HTL.HyperTreeList):
    ...
    def MAJ(self):
        ...
        dictColonnes = {}
        index = 1
        self.dictImpression["entete"].append(_("Prestations"))
        for regroupement in listeRegroupements :
    ...
    def Imprimer(self):
        ...
        dataTableau.append( (_("Synthèse des prestations"), _("%s\nEdité le %s") % (UTILS_Organisateur.GetNom(), dateDuJour)) )
        style = TableStyle([
