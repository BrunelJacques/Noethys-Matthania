...
##        self.checkbox_coupon.SetToolTip(wx.ToolTip(_("Cochez cette case pour insérer un coupon à découper")))
        self.checkbox_repertoire.SetToolTip(wx.ToolTip(_("Cochez cette case pour enregistrer un exemplaire de chaque cotisation au format PDF dans le répertoire indiqué")))
