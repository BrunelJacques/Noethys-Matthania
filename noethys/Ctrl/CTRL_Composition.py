    ...
    def GetInfosIndividus(self):
        ...
        for IDindividu in lstIndividus:
            ...
            if tel_domicile != None:
                dictInfos[IDindividu]["tel_domicile_complet"] = _(
                    "Tél. domicile : %s") % tel_domicile
            else:
                dictInfos[IDindividu]["tel_domicile_complet"] = None
            tel_mobile = dictInfos[IDindividu]["tel_mobile"]
            if tel_mobile != None:
                dictInfos[IDindividu]["tel_mobile_complet"] = _(
                    "Tél. mobile : %s") % tel_mobile
            else:
            ...
            if travail_tel != None:
                dictInfos[IDindividu]["travail_tel_complet"] = _(
                    "Tél. travail : %s") % travail_tel
            else:
...
class VISU_Compo(gescomp.GestCompo):
    ...
    def CreateMenu(self):
        ...
        if IDindividu != None:
            ...
            item = wx.MenuItem(sousMenuCategorie, 601, _("Représentant"),
                               kind=wx.ITEM_RADIO)
...
class CTRL_Graphique(wx.ScrolledWindow, VISU_Compo):
    def __init__(self, parent, IDfamille=None):
        ...
        VISU_Compo.__init__(self,parent,IDfamille)
