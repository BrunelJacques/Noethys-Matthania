...
class CTRL(wx.Panel):
    ...
    def __set_properties(self):
        self.bouton_apercu.SetToolTip(wx.ToolTip(_("Cliquez ici pour afficher un aperçu de la location sélectionnée")))
        self.bouton_email.SetToolTip(wx.ToolTip(_("Cliquez ici envoyer la location sélectionnée par Email")))
        self.bouton_supprimer.SetToolTip(wx.ToolTip(_("Cliquez ici pour supprimer la location sélectionnée ou les locations cochées")))
