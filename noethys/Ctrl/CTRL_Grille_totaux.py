...
class CTRL_Unite_remplissage(wx.Panel):
    def __init__(self, parent):
        ...
        # Contrôle
        self.ctrl = wx.StaticText(self, -1, "XXX")
...
class CTRL(HTL.HyperTreeList):
    ...
    def Remplissage(self):
        ...
        for IDactivite in self.listeActivites :
            if (IDactivite in self.dictGroupeTmp) == False :
                self.dictGroupeTmp[IDactivite] = [(0, _("Groupe unique")),]
        ...
        for IDactivite in self.listeActivites :
            ...
            # Label activité
            label = self.dictActivites[IDactivite]["nom"] if IDactivite in self.dictActivites else "?"
            ...
            # Ligne TOTAL
            total = self.AppendItem(activite, _("Total"))
