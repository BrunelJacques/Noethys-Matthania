...
LISTE_ASSISTANTS = [
    {"code": "nouveau", "image": "Generation.png", "nom": _("Créer une nouvelle activité"),
     "description": _("Personnalisez votre nouvelle activité de A à Z")},

    {"code": "annuelle", "image": "Basket.png", "nom": _("Une activité culturelle ou sportive annuelle"),
     "description": _("Assistant pour créer une activité annuelle : club de gym, danse, couture, etc...")},

    {"code": "sejour", "image": "Camping.png", "nom": _("Un séjour"),
     "description": _("Assistant pour créer un séjour, un camp, un mini-camp...")},

    {"code": "stage", "image": "Guitare.png", "nom": _("Un stage"),
     "description": _("Assistant pour créer un stage de théâtre, de danse, de guitare, etc...")},

    {"code": "cantine", "image": "Repas.png", "nom": _("Une cantine"),
     "description": _("Assistant pour créer une cantine avec un ou plusieurs services")},

    {"code": "sorties", "image": "Bus.png", "nom": _("Des sorties familiales"),
     "description": _("Assistant pour créer une activité de gestion de sorties familiales...")},
