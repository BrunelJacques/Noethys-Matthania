...
class SaisiePays(wx.Panel):
    def __init__(self, parent, mode="pays"):
        ...
        self.IDpays = None
        self.image_pays = wx.StaticBitmap(self, -1, wx.Bitmap(Chemins.GetStaticPath("Images/Drapeaux/france.png"), wx.BITMAP_TYPE_PNG), size=(22, 20))
    ...
    def SetValue(self, IDpays=None, nomPays=None):
        ...
        self.image_pays.SetToolTip(wx.ToolTip(_("Pays de naissance : ") + pays[2]))
        if self.mode == "pays" :
            # Mode pays
            self.bouton_pays.SetToolTip(wx.ToolTip(_("Cliquez ici pour sélectionner un autre pays de naissance")))
            self.image_pays.SetToolTip(wx.ToolTip(_("Pays de naissance : %s") % pays[2]))
        else:
            # Mode nationalité
            self.image_pays.SetToolTip(wx.ToolTip(_("Nationalité : %s") % pays[3]))
            self.bouton_pays.SetToolTip(wx.ToolTip(_("Cliquez ici pour sélectionner une autre nationalité")))
