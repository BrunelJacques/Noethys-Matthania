...
class CTRL(wx.Panel):
    ...
    def __init__(self, parent, categorie=""):
        ...
        self.ctrl_choix_profil.SetToolTip(wx.ToolTip(_("Sélectionnez un profil de configuration")))
        self.bouton_gestion.SetToolTip(wx.ToolTip(_("Cliquez ici pour accéder à la gestion des profils")))
        self.bouton_enregistrer.SetToolTip(wx.ToolTip(_("Cliquez ici pour enregistrer le profil sélectionné")))

        grid_sizer_base = wx.FlexGridSizer(rows=1, cols=3, vgap=5, hgap=5)
        grid_sizer_base.Add(self.ctrl_choix_profil, 0, wx.EXPAND|wx.ALL, 0)
    ...
    def Proposer_creation_profil(self):
        ...
        dlg = wx.MessageDialog(self, _("Vous n'avez sélectionné aucun profil pour enregistrer votre configuration.\n\nSouhaitez-vous créer un nouveau profil maintenant ?"), _("Créer un profil de configuration"), wx.YES_NO|wx.YES_DEFAULT|wx.CANCEL|wx.ICON_QUESTION)
        ...
        dlg = wx.TextEntryDialog(self, _("Saisissez le nom du nouveau profil de configuration :"), _("Saisie d'un profil"), "")
