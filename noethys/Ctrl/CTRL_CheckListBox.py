...
class Panel(wx.Panel):
    ...
    def __set_properties(self):
        self.bouton_cocher_tout.SetToolTip(wx.ToolTip(_("Cliquez ici pour tout cocher")))
        self.bouton_cocher_rien.SetToolTip(wx.ToolTip(_("Cliquez ici pour tout décocher")))
...
class MyFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        boutonTest = wx.Button(panel, -1, _("Test"))
