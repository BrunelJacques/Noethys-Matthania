...
class MyHtml(html.HtmlWindow):
    def __init__(self, parent, texte="", hauteur=25):
        ...
        self.SetPage("<FONT SIZE=-1>%s</FONT>""" % texte)
...
class Bandeau(wx.Panel):
    ...
    def Sizer(self):
        ...
        self.SetSizerAndFit(grid_sizer_vertical)
...
class MyFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.ctrl= Bandeau(panel, _("COUCOU"), _("coincoin"), nomImage="Images/32x32/Femme.png")
