...
class CTRL(wx.Panel):
    def __init__(self, parent):
        ...
        self.checkbox_coupon = wx.CheckBox(self, -1, _("Insérer le coupon-réponse"))
        self.checkbox_codeBarre = wx.CheckBox(self, -1, _("Insérer les codes-barres"))
    ...
    def __set_properties(self):
        ...
        self.checkbox_coupon.SetToolTip(wx.ToolTip(_("Cochez cette case pour insérer un coupon à découper")))
        self.checkbox_codeBarre.SetToolTip(wx.ToolTip(_("Cochez cette case pour insérer un code-barre pour le numéro de lettre")))
        self.checkbox_repertoire.SetToolTip(wx.ToolTip(_("Cochez cette case pour enregistrer un exemplaire de chaque lettre de rappel au format PDF dans le répertoire indiqué")))
