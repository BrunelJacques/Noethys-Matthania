...
class CTRL(wx.Panel):
    ...
    def __set_properties(self):
        self.ctrl_messages.SetToolTip(wx.ToolTip(_("Saisissez ou ou plusieurs messages qui apparaitront sur la page d'accueil du portail")))
        self.bouton_ajouter_message.SetToolTip(wx.ToolTip(_("Cliquez ici pour ajouter un message qui apparaîtra sur la page d'accueil du portail")))
