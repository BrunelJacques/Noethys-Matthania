...
COULEURS = [
    {"label": _("Gris"), "code": "gray", "couleur": "#d2d6de"},
    {"label": _("Rouge"), "code": "danger", "couleur": "#dd4b39"},
    {"label": _("Orange"), "code": "warning", "couleur": "#f39c12"},
    {"label": _("Bleu foncé"), "code": "primary", "couleur": "#3c8dbc"},
    {"label": _("Bleu clair"), "code": "info", "couleur": "#00c0ef"},
    {"label": _("Vert"), "code": "success", "couleur": "#00a65a"},
]
...
class CTRL(wx.TreeCtrl):
    ...
    def Remplissage(self):
        ...
        self.root = self.AddRoot(_("Pages"))
    ...
    def OnContextMenu(self, event):
        ...
        # Item Ajouter
        itemx = wx.MenuItem(menuPop, 10, _("Ajouter"))
        ...
        # Item Modifier
        itemx = wx.MenuItem(menuPop, 20, _("Modifier"))
        ...
        # Item Supprimer
        itemx = wx.MenuItem(menuPop, 30, _("Supprimer"))
        ...
        itemx = wx.MenuItem(menuPop, 40, _("Déplacer vers le haut"))
        ...
        itemx = wx.MenuItem(menuPop, 50, _("Déplacer vers le bas"))
    ...
    def Modifier(self, event):
        ...
        if item == None or dictData == None :
            dlg = wx.MessageDialog(self, _("Vous devez obligatoirement sélectionner une page ou un bloc à modifier !"), "Erreur de saisie", wx.OK | wx.ICON_EXCLAMATION)
            dlg.ShowModal()
            dlg.Destroy()
            return
    ...
    def Supprimer(self, event):
        ...
        dictData = self.GetPyData(item)
        if item == None or dictData == None :
            dlg = wx.MessageDialog(self, _("Vous devez obligatoirement sélectionner une page ou un bloc à supprimer !"), "Erreur de saisie", wx.OK | wx.ICON_EXCLAMATION)
            dlg.ShowModal()
            dlg.Destroy()
            return
        ...
        if dictData["type"] == "page" :
            ...
            if self.GetChildrenCount(item, recursively=True) > 0 :
                ...
                dlg = wx.MessageDialog(self, _("Attention, cette page comporte des blocs.\n\nSouhaitez-vous vraiment supprimer cette page ? Les blocs seront également supprimées !"), _("Suppression"), wx.YES_NO|wx.NO_DEFAULT|wx.CANCEL|wx.ICON_INFORMATION)
                reponse = dlg.ShowModal()
                dlg.Destroy()
            ...
            dlg = wx.MessageDialog(self, _("Souhaitez-vous vraiment supprimer cette page ?"), _("Suppression"), wx.YES_NO|wx.NO_DEFAULT|wx.CANCEL|wx.ICON_INFORMATION)
        ...
        if dictData["type"] == "bloc" :
            ...
            # Confirmation de suppression
            dlg = wx.MessageDialog(self, _("Souhaitez-vous vraiment supprimer ce bloc ?"), _("Suppression"), wx.YES_NO|wx.NO_DEFAULT|wx.CANCEL|wx.ICON_INFORMATION)
            if dlg.ShowModal() == wx.ID_YES :
                DB = GestionDB.DB()
...
class DLG_Saisie_page(wx.Dialog):
    def __init__(self, parent, IDpage=None):
        ...
        self.label_titre = wx.StaticText(self, wx.ID_ANY, _("Titre :"))
        self.ctrl_titre = wx.TextCtrl(self, wx.ID_ANY, "")
        ...
        # Init contrôles
        if self.IDpage != None:
            self.SetTitle(_("Modification d'une page"))
            self.Importation()
        else:
            self.SetTitle(_("Saisie d'une page"))

    def __set_properties(self):
        self.ctrl_titre.SetToolTip(wx.ToolTip(_("Saisissez le titre de la page")))
        self.ctrl_couleur.SetToolTip(wx.ToolTip(_("Sélectionnez une couleur")))
    ...
    def Sauvegarde(self):
        ...
        if titre == "":
            dlg = wx.MessageDialog(self, _("Vous devez obligatoirement saisir un titre !"), _("Erreur"), wx.OK | wx.ICON_EXCLAMATION)
            dlg.ShowModal()
            dlg.Destroy()
...
class DLG_Saisie_bloc(wx.Dialog):
    def __init__(self, parent, IDbloc=None):
        ...
        self.label_couleur = wx.StaticText(self, wx.ID_ANY, _("Couleur :"))
        self.ctrl_couleur = wx.TextCtrl(self, wx.ID_ANY, "")
    ...
    def __set_properties(self):
        self.ctrl_titre.SetToolTip(wx.ToolTip(_("Saisissez le titre du bloc")))
        self.ctrl_couleur.SetToolTip(wx.ToolTip(_("Sélectionnez une couleur")))
        self.bouton_aide.SetToolTip(wx.ToolTip(_("Cliquez ici pour obtenir de l'aide")))
        self.bouton_ok.SetToolTip(wx.ToolTip(_("Cliquez ici pour valider")))
        self.bouton_annuler.SetToolTip(wx.ToolTip(_("Cliquez ici pour annuler")))
    ...
    def Sauvegarde(self):
        ...
        if couleur == "":
            dlg = wx.MessageDialog(self, _("Vous devez obligatoirement sélectionner une couleur !"), _("Erreur"), wx.OK | wx.ICON_EXCLAMATION)
            dlg.ShowModal()
            dlg.Destroy()
