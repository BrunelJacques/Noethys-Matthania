...
class CTRL(HTL.HyperTreeList):
    ...
    def OnContextMenu(self, event):
        ...
        item = wx.MenuItem(
            menu, self.ID_COCHER_TOUTES, "Tout cocher",
            "Cocher toutes les écoles et classes",
        )
        ...
        item = wx.MenuItem(
            menu, self.ID_COCHER_AUCUNE, "Tout décocher",
            "Décocher toutes les écoles et classes",
        )
        item.SetBitmap(wx.Bitmap(
    ...
    def Remplissage(self):
        ...
        item = self.AppendItem(self.root, "Scolarité inconnue", ct_type=1)
