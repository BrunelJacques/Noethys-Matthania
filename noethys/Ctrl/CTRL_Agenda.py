...
class ToolBar(UTILS_Adaptations.ToolBar):
    def __init__(self, parent):
        ...
        # Boutons
        self.AddLabelTool(self.ID_OUTIL_JOUR, _("Jour"), wx.Bitmap(Chemins.GetStaticPath("Images/32x32/Calendrier_jour.png"), wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_RADIO, _("Affichage quotidien"), "")
        self.AddLabelTool(self.ID_OUTIL_SEMAINE, _("Semaine"), wx.Bitmap(Chemins.GetStaticPath("Images/32x32/Calendrier_semaine.png"), wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_RADIO, _("Affichage hebdomadaire"), "")
        self.AddLabelTool(self.ID_OUTIL_MOIS, _("Mois"), wx.Bitmap(Chemins.GetStaticPath("Images/32x32/Calendrier_mois.png"), wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_RADIO, _("Affichage mensuel"), "")
        self.AddSeparator()
        self.AddLabelTool(self.ID_OUTIL_HORIZONTAL, _("Horizontal"), wx.Bitmap(Chemins.GetStaticPath("Images/32x32/Calendrier_horizontal.png"), wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_RADIO, _("Affichage horizontal"), "")
        self.AddLabelTool(self.ID_OUTIL_VERTICAL, _("Vertical"), wx.Bitmap(Chemins.GetStaticPath("Images/32x32/Calendrier_vertical.png"), wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_RADIO, _("Affichage vertical"), "")
        self.ToggleTool(self.ID_OUTIL_VERTICAL, True)
        self.AddSeparator()
        self.AddLabelTool(self.ID_OUTIL_RECULER, _("Reculer"), wx.Bitmap(Chemins.GetStaticPath("Images/32x32/Precedent.png"), wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_NORMAL, _("Reculer"), "")
        self.AddLabelTool(self.ID_OUTIL_AVANCER, _("Avancer"), wx.Bitmap(Chemins.GetStaticPath("Images/32x32/Suivant.png"), wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_NORMAL, _("Avancer"), "")
        self.AddSeparator()
        self.AddLabelTool(self.ID_OUTIL_MOINS, _("Moins"), wx.Bitmap(Chemins.GetStaticPath("Images/32x32/Zoom_moins.png"), wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_NORMAL, _("Afficher moins"), "")
        self.EnableTool(self.ID_OUTIL_MOINS, False)
        self.AddLabelTool(self.ID_OUTIL_PLUS, _("Plus"), wx.Bitmap(Chemins.GetStaticPath("Images/32x32/Zoom_plus.png"), wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_NORMAL, _("Afficher plus"), "")
        self.AddSeparator()
        self.AddLabelTool(self.ID_OUTIL_AUJOURDHUI, _("Aujourd'hui"), wx.Bitmap(Chemins.GetStaticPath("Images/32x32/Jour.png"), wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_NORMAL, _("Aujourd'hui"), "")
        self.AddLabelTool(self.ID_OUTIL_CHERCHER, _("Chercher"), wx.Bitmap(Chemins.GetStaticPath("Images/32x32/Calendrier_zoom.png"), wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_NORMAL, _("Chercher une date"), "")
        self.AddLabelTool(self.ID_OUTIL_APERCU, _("Aperçu"), wx.Bitmap(Chemins.GetStaticPath("Images/32x32/Apercu.png"), wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_NORMAL, _("Aperçu avant impression"), "")
...
##        # schedule.color = wx.Color(200, 200, 200)
    ...
    def AjouteScheduleTest(self):
        ...
        schedule.description = _("Schedule test !")
        self.ctrl_planning.Add(schedule)
