...
class CTRL(HTL.HyperTreeList):
    def __init__(self, parent, IDfamille=None, IDindividu=None, dictFamillesRattachees={}, size=(-1, -1), largeurColonne=270 ): 
        ...
        self.AddColumn(_("Pièces à fournir"))
    ...
    def OnDoubleClick(self, event):
        ...
        if donnees["valide"] != "pasok" :
            dlg = wx.MessageDialog(self, _("Une pièce valide existe déjà !"), _("Erreur de saisie"), wx.OK | wx.ICON_EXCLAMATION)
            dlg.ShowModal()
            dlg.Destroy()
            return False
    ...
    def Remplissage(self):
        ...
        WHERE (NOT inscriptions.statut LIKE 'ko%%') AND activites.date_fin>='%s' %s
