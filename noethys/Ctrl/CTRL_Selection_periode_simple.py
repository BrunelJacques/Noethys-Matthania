...
class Page_Semaines(wx.Panel):
    def __init__(self, parent):
        ...
        # Semaine
        self.label_semaine = wx.StaticText(self, -1, _("Semaine :"))
        ...
        self.bouton_aujourdhui = wx.Button(self, -1, _("Aujourd'hui"))

        # Properties
        self.ctrl_semaine.SetMinSize((70, -1))
        self.ctrl_semaine.SetToolTip(wx.ToolTip(_("Sélectionnez une semaine")))
        self.ctrl_annee.SetMinSize((70, -1))
        self.ctrl_annee.SetToolTip(wx.ToolTip(_("Sélectionnez une année")))
        self.bouton_aujourdhui.SetToolTip(wx.ToolTip(_("Sélectionnez la semaine en cours")))
...
class Page_Mois(wx.Panel):
    def __init__(self, parent):
        ...
        self.ctrl_annee.SetMinSize((70, -1))
        self.ctrl_annee.SetToolTip(wx.ToolTip(_("Sélectionnez une année")))
        self.bouton_aujourdhui.SetToolTip(wx.ToolTip(_("Sélectionnez l'année en cours")))
...
class Page_Vacances(wx.Panel):
    def __init__(self, parent):
        ...
        # Vacances
        self.label_vacances = wx.StaticText(self, -1, _("Période :"))
        ...
        self.ctrl_vacances.SetToolTip(wx.ToolTip(_("Sélectionnez une période de vacances")))
        self.ctrl_annee.SetMinSize((70, -1))
        self.ctrl_annee.SetToolTip(wx.ToolTip(_("Sélectionnez une année")))
...
class Page_Dates(wx.Panel):
    def __init__(self, parent):
        ...
        # Période
        self.label_periode = wx.StaticText(self, wx.ID_ANY, _("Du"))
        self.ctrl_date_debut = CTRL_Saisie_date.Date2(self)
        self.label_au = wx.StaticText(self, wx.ID_ANY, _("au"))
        self.ctrl_date_fin = CTRL_Saisie_date.Date2(self)
        self.bouton_appliquer_dates = wx.Button(self, -1, _("Appliquer"))
        ...
        self.bouton_appliquer_dates.SetToolTip(wx.ToolTip(_("Cliquez ici pour valider la période saisie")))
...
class Page_Jour(wx.Panel):
    def __init__(self, parent):
        ...
        self.bouton_appliquer_dates.SetToolTip(wx.ToolTip(_("Cliquez ici pour valider la date saisie")))
        self.bouton_aujourdhui.SetToolTip(wx.ToolTip(_("Sélectionnez la date du jour")))
...
class CTRL(wx.Notebook):
    def __init__(self, parent, callback=None):
        ...
        self.listePages = [
            {"code": "mois", "ctrl": Page_Mois(self), "label": _("Mois"), "image": "Calendrier_mois.png"},
            {"code": "semaine", "ctrl": Page_Semaines(self), "label": _("Semaine"), "image": "Calendrier3jours.png"},
            {"code": "vacances", "ctrl": Page_Vacances(self), "label": _("Vacances"), "image": "Calendrier3jours.png"},
            {"code": "periode", "ctrl": Page_Dates(self), "label": _("Période"), "image": "Calendrier_jour.png"},
            {"code": "date", "ctrl": Page_Jour(self), "label": _("Jour"), "image": "Calendrier_jour.png"},
        ]
