...
##        self.EnableSelectionVista(True)
    ...
    def MAJ(self):        
        ...
        def GetNomActivite(IDactivite=None):
            ...
            if IDactivite == 777777: return _("Locations")
            if IDactivite == 888888 : return _("Cotisations")
            if IDactivite == 999999 : return _("Autres")
            return _("Activité inconnue")
        ...
        def GetNomFamille(IDfamille=None):
            if IDfamille in self.dictTitulaires :
                ...
                return _("Famille ID%d") % IDfamille
    ...
    def Imprimer(self, Event=None):
        ...
        dataTableau.append( (_("Synthèse des impayés"), _("%s\nEdité le %s") % (UTILS_Organisateur.GetNom(), dateDuJour)) )
        style = TableStyle([
...
##            ('FONT',(0,0),(0,0), "Helvetica-Bold", 10), # Donne la police de caract. + taille de police du titre de groupe
    ...
    def OnContextMenu(self, event):
        ...
        item = wx.MenuItem(menuPop, 10, _("Ouvrir la fiche famille de %s") % nomFamille)
        ...
        item = wx.MenuItem(menuPop, 20, _("Imprimer (PDF)"), _("Imprimer (PDF)"))
        ...
        item = wx.MenuItem(menuPop, 30, _("Exporter au format Excel"), _("Exporter au format Excel"))
