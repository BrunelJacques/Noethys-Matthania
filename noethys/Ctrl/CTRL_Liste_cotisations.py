...
from Ol import OL_Liste_cotisations #OL_Factures
from Dlg import DLG_Filtres_cotisations #DLG_Filtres_factures
...
class CTRL(wx.Panel):
    def __init__(self, parent, filtres=[], codesColonnes = ["IDcotisation", "date_debut", "date_fin", "beneficiaires", "rue", "cp", "ville", "nom", "numero", "montant", "solde", "date_creation_carte", "depot_nom", "activites", "observations"], \
    ...
    def __set_properties(self):
        self.bouton_apercu.SetToolTip(wx.ToolTip(_("Cliquez ici pour afficher un aperçu de la cotisation sélectionnée")))
        self.bouton_email.SetToolTip(wx.ToolTip(_("Cliquez ici envoyer la cotisation sélectionnée par Email")))
        self.bouton_supprimer.SetToolTip(wx.ToolTip(_("Cliquez ici pour supprimer la cotisation sélectionnée ou les cotisations cochées")))
