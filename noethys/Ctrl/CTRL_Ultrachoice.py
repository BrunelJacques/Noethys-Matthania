...
class MyFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        donnees = [
            {"image" : wx.Bitmap(Chemins.GetStaticPath("Images/16x16/Loupe.png"), wx.BITMAP_TYPE_ANY), "label" : _("Item 1"), "description" : _("Ceci est la description de l'item 1 qui est vraiment un texte très long qui devrait normalement dépasser.")} ,
            {"image" : wx.Bitmap(Chemins.GetStaticPath("Images/16x16/Loupe.png"), wx.BITMAP_TYPE_ANY), "label" : _("Item 2"), "description" : _("Ceci est la description de l'item 2")} ,
            {"image" : None, "label" : _("Item 3"), "description" : _("Ceci est la description de l'item 3")} ,
            {"label" : _("Item 4"), "description" : _("Ceci est la description de l'item 4")} ,
            ]
        ...
        for x in range(1, 100) :
            donnees.append({"image" : wx.Bitmap(Chemins.GetStaticPath("Images/32x32/Loupe.png"), wx.BITMAP_TYPE_ANY), "label" : _("Item %d") % x, "description" : _("Ceci est la description de l'item %d") % x})
