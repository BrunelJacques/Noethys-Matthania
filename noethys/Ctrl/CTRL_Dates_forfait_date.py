...
class CTRL(HTL.HyperTreeList):
    def __init__(self, parent, IDactivite=None, IDtarif=None):
        ...
        listeColonnes = [
            ( _("Groupe/Date"), 200, wx.ALIGN_LEFT),
            ( _("Combinaisons d'unités"), 280, wx.ALIGN_LEFT),
            ]
        numColonne = 0
...
class MyFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.bouton1 = wx.Button(panel, -1, _("Modifier"))
        self.bouton2 = wx.Button(panel, -1, _("Sauvegarder"))
