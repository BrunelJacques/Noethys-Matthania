...
class CTRL(wx.Panel):
    ...
    def __set_properties(self):
        self.bouton_apercu.SetToolTip(wx.ToolTip(_("Cliquez ici pour afficher un aperçu de l'inscription sélectionnée")))
        self.bouton_email.SetToolTip(wx.ToolTip(_("Cliquez ici envoyer l'inscription sélectionnée par Email")))
        self.bouton_supprimer.SetToolTip(wx.ToolTip(_("Cliquez ici pour supprimer l'inscription sélectionnée ou les locations cochées")))
