...
class Calendrier(wx.ScrolledWindow):
    ...
    def OnEnter(self, event):
        txt = _("Restez appuyer sur les touches CONTROL, SHIFT ou ALT pour sélectionner plusieurs jours à la fois.")
    ...
    def OnContextMenu(self, nomCase):
        ...
        if self.multiSelections == True :
            ...
            if texteDate != None :
                ...
                if select == False :
                    texte = _("Sélectionner le %02d/%02d/%04d") % (texteDate.day, texteDate.month, texteDate.year)
                else:
                    texte = _("Désélectionner le %02d/%02d/%04d") % (texteDate.day, texteDate.month, texteDate.year)
        ...
        menu.Append(self.popupID4, _("Sélectionner aujourd'hui"))
        ...
        if self.multiSelections == True :
            ...
            menu.Append(self.popupID5, _("Sélectionner tout le mois"))
            ...
            if len(self.listePeriodesVacs) != 0 :
                ...
                menu.AppendMenu(self.popupID3, _("Sélectionner une période de vacances"), sm)
        
            # Tout désélectionner
            self.popupID7 = wx.Window.NewControlId()
            menu.Append(self.popupID7, _("Tout désélectionner"))
            ...
            menu.Append(self.popupID6, _("Exclure les week-ends des sélections"), _("Exclure les week-ends de la sélection"), wx.ITEM_CHECK)
        ...
        menu.Append(self.popupID2, _("Aide sur le calendrier"))
...
class CTRL(wx.Panel):
    def __init__(self, parent, ID=-1, 
        ...
        self.listeMois = [_("Janvier"), _("Février"), _("Mars"), _("Avril"), _("Mai"), _("Juin"), _("Juillet"), _("Août"), _("Septembre"), _("Octobre"), _("Novembre"), _("Décembre")]
        if "linux" in sys.platform :
            self.listeMois = [_("Janv."), _("Fév."), _("Mars"), _("Avril"), _("Mai"), _("Juin"), _("Juil."), _("Août"), _("Sept."), _("Oct."), _("Nov."), _("Déc.")]
        ...
        self.bouton_CalendrierAnnuel.SetToolTip(wx.ToolTip(_("Cliquez ici pour afficher le calendrier annuel")))
...
##            bordLateral = bordLateral
        ...
        if self.typeCalendrier == "annuel" :
            ...
            self.bouton_CalendrierAnnuel.SetToolTip(wx.ToolTip(_("Cliquez ici pour afficher le calendrier mensuel")))
        else:
