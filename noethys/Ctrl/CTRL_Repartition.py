...
class Track(object):
    def __init__(self, donnees):
        ...
        self.montant_str = "%.2f € " % self.montant
        self.IDpayeur = donnees[9]
        if donnees[10] != None:
            self.nom_payeur = donnees[10]
        else: self.nom_payeur = "-"
        ...
        self.montant_ventilation_str = "%.2f € " % self.montant_ventilation
...
class CTRL(HTL.HyperTreeList):
    def __init__(self, parent, IDfamille=None): 
        ...
        listeColonnes = [
            ( _("Date"), 180, wx.ALIGN_LEFT),
            ( _("Mode"), 130, wx.ALIGN_LEFT),
            ( _("Emetteur"), 130, wx.ALIGN_LEFT),
            ( _("Numéro"), 70, wx.ALIGN_LEFT),
            ( _("Payeur"), 100, wx.ALIGN_LEFT),
            ( _("Montant"), 70, wx.ALIGN_LEFT),
            ( _("Ventilé"), 80, wx.ALIGN_LEFT),
            ( _("Dépôt"), 100, wx.ALIGN_LEFT),
            ]
        numColonne = 0
