...
class CTRL(HTL.HyperTreeList):
    def __init__(self, parent, liste_activites=[], mode="attente"):
        ...
        listeColonnes = [
            (_("Activité/Groupe/Individu"), 250, wx.ALIGN_LEFT),
            (_("Date de la réservation"), 200, wx.ALIGN_LEFT),
            (_("Catégorie de tarif"), 200, wx.ALIGN_LEFT),
            ]
        numColonne = 0
    ...
    def Importation(self):
        ...
        for IDinscription, date_inscription, nomCategorie, IDindividu, nomIndividu, prenomIndividu, IDactivite, nomActivite, IDgroupe, nomGroupe, IDcompte_payeur, IDfamille in listeDonnees :
            ...
            nom_individu = "%s %s" % (nomIndividu, prenomIndividu)
    ...
    def Imprimer(self, event=None):
        ...
        def Header():
            ...
            if self.mode == "attente" :
                titre = _("Inscriptions en attente")
            else :
                titre = _("Inscriptions refusées")
    ...
    def ExportExcel(self, event=None):
        ...
        colonnes = [
            (_("Date"), 20), (_("Groupe"), 15), (_("Dispo"), 10), (_("N°"), 10),
            (_("Individu"), 30), (_("Date de saisie"), 30), (_("Catégorie de tarif"), 30),
            ]
        index = 0
