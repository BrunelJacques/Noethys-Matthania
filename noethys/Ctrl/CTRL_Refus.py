...
class CTRL(HTL.HyperTreeList):
    def __init__(self, parent, dictDonnees={}, dictEtatPlaces={}, dictUnitesRemplissage={}): 
        ...
        listeColonnes = [
            ( _("Date/Groupe/Individu"), 250, wx.ALIGN_LEFT),
            ( _("Consommations réservées"), 240, wx.ALIGN_LEFT),
            ( _("Date de la réservation"), 200, wx.ALIGN_LEFT),
            ]
        numColonne = 0
    ...
    def Importation(self):
        ...
        DB = GestionDB.DB()
        req = """
        SELECT IDconso, consommations.IDindividu, consommations.IDactivite, date, consommations.IDunite, consommations.IDgroupe, consommations.etat, date_saisie,
        ...
        WHERE consommations.etat = 'refus' AND consommations.IDactivite IN %s AND %s
        ORDER BY IDconso
        ...
        for IDconso, IDindividu, IDactivite, date, IDunite, IDgroupe, etat, date_saisie, nomIndividu, prenomIndividu, nomUnite, ordreUnite, nomActivite, nomGroupe, IDcompte_payeur, IDfamille in listeDonnees :
            ...
            if (IDindividu in dictIndividus) == False :
                dictIndividus[IDindividu] = {"nomIndividu" : "%s %s" % (nomIndividu, prenomIndividu), "IDfamille" : IDfamille }
...
##        self.Thaw() 
            ...
            for IDactivite in listeActivites :
                ...
                for IDgroupe in listeGroupes :
                    ...
                    for ordreIndividu, IDindividu in listeIndividus :
                        ...
                        texteIndividu = "%d. %s" % (num, nomIndividu)
    ...
    def Imprimer(self, event):
        ...
        nomDoc = FonctionsPerso.GenerationNomDoc("LISTE_REFUS", "pdf")
        ...
        def Header():
            ...
            dataTableau.append( (_("Liste des places refusées"), _("%s\nEdité le %s") % (UTILS_Organisateur.GetNom(), dateDuJour)) )
            style = TableStyle([
        ...
        for date, listeGroupes in self.listeImpression :
            ...
            for nomGroupe, listeIndividus in listeGroupes :
                ...
                for dictIndividu in listeIndividus :
                    ...
                    texteDateSaisie = _("Saisie le %s") % dictIndividu["texteDateSaisie"]
