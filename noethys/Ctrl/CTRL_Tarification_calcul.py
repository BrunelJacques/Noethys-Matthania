...
LISTE_METHODES = [
    { "code" : "montant_unique", "label" : _("Montant unique"), "type" : "unitaire", "nbre_lignes_max" : 1, "entete" : None, "champs" : ("montant_unique", "montant_questionnaire"), "champs_obligatoires" : ("montant_unique",), "tarifs_compatibles" : ("JOURN", "FORFAIT", "CREDIT") },
    { "code" : "qf", "label" : _("En fonction du quotient familial"), "type" : "unitaire", "nbre_lignes_max" : None, "entete" : "tranche", "champs" : ("qf_min", "qf_max", "montant_unique"), "champs_obligatoires" : ("qf_min", "qf_max", "montant_unique"), "tarifs_compatibles" : ("JOURN", "FORFAIT", "CREDIT") },
    
    { "code" : "horaire_montant_unique", "label" : _("Montant unique en fonction d'une tranche horaire"), "type" : "horaire", "nbre_lignes_max" : None, "entete" : None, "champs" : ("heure_debut_min", "heure_debut_max", "heure_fin_min", "heure_fin_max", "temps_facture", "montant_unique", "montant_questionnaire", "label"), "champs_obligatoires" : ("heure_debut_min", "heure_debut_max", "heure_fin_min", "heure_fin_max", "montant_unique"), "tarifs_compatibles" : ("JOURN",) },
    { "code" : "horaire_qf", "label" : _("En fonction d'une tranche horaire et du quotient familial"), "type" : "horaire", "nbre_lignes_max" : None, "entete" : None, "champs" : ("qf_min", "qf_max", "heure_debut_min", "heure_debut_max", "heure_fin_min", "heure_fin_max", "temps_facture", "montant_unique", "label"), "champs_obligatoires" : ("qf_min", "qf_max", "heure_debut_min", "heure_debut_max", "heure_fin_min", "heure_fin_max", "montant_unique"), "tarifs_compatibles" : ("JOURN",) },
    
    { "code" : "duree_montant_unique", "label" : _("Montant unique en fonction d'une durée"), "type" : "horaire", "nbre_lignes_max" : None, "entete" : None, "champs" : ("duree_min", "duree_max", "temps_facture", "montant_unique", "montant_questionnaire", "label"), "champs_obligatoires" : ("duree_min", "duree_max", "montant_unique"), "tarifs_compatibles" : ("JOURN",) },
    { "code" : "duree_qf", "label" : _("En fonction d'une durée et du quotient familial"), "type" : "horaire", "nbre_lignes_max" : None, "entete" : None, "champs" : ("qf_min", "qf_max", "duree_min", "duree_max", "temps_facture", "montant_unique", "label"), "champs_obligatoires" : ("qf_min", "qf_max", "duree_min", "duree_max", "montant_unique"), "tarifs_compatibles" : ("JOURN",) },
    
    { "code" : "montant_unique_date", "label" : _("Montant unique en fonction de la date"), "type" : "unitaire", "nbre_lignes_max" : None, "entete" : None, "champs" : ("date", "montant_unique", "label"), "champs_obligatoires" : ("date", "montant_unique"), "tarifs_compatibles" : ("JOURN",) },
    { "code" : "qf_date", "label" : _("En fonction de la date et du quotient familial"), "type" : "unitaire", "nbre_lignes_max" : None, "entete" : None, "champs" : ("date", "qf_min", "qf_max", "montant_unique", "label"), "champs_obligatoires" : ("date", "qf_min", "qf_max", "montant_unique"), "tarifs_compatibles" : ("JOURN",) },
    
    { "code" : "variable", "label" : _("Tarif libre (Saisi par l'utilisateur)"), "type" : "unitaire", "nbre_lignes_max" : 0, "entete" : None, "champs" : (), "champs_obligatoires" : (), "tarifs_compatibles" : ("JOURN",) },
    { "code" : "choix", "label" : _("Tarif au choix (Sélectionné par l'utilisateur)"), "type" : "unitaire", "nbre_lignes_max" : None, "entete" : None, "champs" : ("montant_unique", "label"), "champs_obligatoires" : ("montant_unique",), "tarifs_compatibles" : ("JOURN", "FORFAIT",) },

    { "code" : "montant_evenement", "label" : _("Montant de l'évènement"), "type" : "unitaire", "nbre_lignes_max" : 0, "entete" : None, "champs" : (), "champs_obligatoires" : (), "tarifs_compatibles" : ("JOURN",) },

    { "code" : "montant_unique_nbre_ind", "label" : _("Montant unique en fonction du nombre d'individus de la famille présents"), "type" : "unitaire", "nbre_lignes_max" : 1, "entete" : "tranche", "champs" : ("montant_enfant_1", "montant_enfant_2", "montant_enfant_3", "montant_enfant_4", "montant_enfant_5", "montant_enfant_6", ), "champs_obligatoires" : ("montant_enfant_1"), "tarifs_compatibles" : ("JOURN",) },
    { "code" : "qf_nbre_ind", "label" : _("En fonction du quotient familial et du nombre d'individus de la famille présents"), "type" : "unitaire", "nbre_lignes_max" : None, "entete" : "tranche", "champs" : ("qf_min", "qf_max", "montant_enfant_1", "montant_enfant_2", "montant_enfant_3", "montant_enfant_4", "montant_enfant_5", "montant_enfant_6", ), "champs_obligatoires" : ("qf_min", "qf_max", "montant_enfant_1"), "tarifs_compatibles" : ("JOURN",) },
    { "code" : "horaire_montant_unique_nbre_ind", "label" : _("Montant unique en fonction du nombre d'individus de la famille présents et de la tranche horaire"), "type" : "unitaire", "nbre_lignes_max" : None, "entete" : "tranche", "champs" : ("heure_debut_min", "heure_debut_max", "heure_fin_min", "heure_fin_max", "temps_facture", "montant_enfant_1", "montant_enfant_2", "montant_enfant_3", "montant_enfant_4", "montant_enfant_5", "montant_enfant_6", "label"), "champs_obligatoires" : ("heure_debut_min", "heure_debut_max", "heure_fin_min", "heure_fin_max", "montant_enfant_1"), "tarifs_compatibles" : ("JOURN",) },
    { "code" : "montant_unique_nbre_ind_degr", "label" : _("Montant dégressif en fonction du nombre d'individus de la famille présents"), "type" : "unitaire", "nbre_lignes_max" : 1, "entete" : "tranche", "champs" : ("montant_enfant_1", "montant_enfant_2", "montant_enfant_3", "montant_enfant_4", "montant_enfant_5", "montant_enfant_6", ), "champs_obligatoires" : ("montant_enfant_1"), "tarifs_compatibles" : ("JOURN",) },
    { "code" : "qf_nbre_ind_degr", "label" : _("Montant dégressif en fonction du quotient familial et du nombre d'individus de la famille présents"), "type" : "unitaire", "nbre_lignes_max" : None, "entete" : "tranche", "champs" : ("qf_min", "qf_max", "montant_enfant_1", "montant_enfant_2", "montant_enfant_3", "montant_enfant_4", "montant_enfant_5", "montant_enfant_6", ), "champs_obligatoires" : ("qf_min", "qf_max", "montant_enfant_1"), "tarifs_compatibles" : ("JOURN",) },
    { "code" : "horaire_montant_unique_nbre_ind_degr", "label" : _("Montant dégressif en fonction du nombre d'individus de la famille présents et de la tranche horaire"), "type" : "unitaire", "nbre_lignes_max" : None, "entete" : "tranche", "champs" : ("heure_debut_min", "heure_debut_max", "heure_fin_min", "heure_fin_max", "temps_facture", "montant_enfant_1", "montant_enfant_2", "montant_enfant_3", "montant_enfant_4", "montant_enfant_5", "montant_enfant_6", "label"), "champs_obligatoires" : ("heure_debut_min", "heure_debut_max", "heure_fin_min", "heure_fin_max", "montant_enfant_1"), "tarifs_compatibles" : ("JOURN",) },
    
    { "code" : "duree_coeff_montant_unique", "label" : _("Montant au prorata d'une durée"), "type" : "horaire", "nbre_lignes_max" : None, "entete" : None, "champs" : ("duree_min", "duree_max", "duree_seuil", "duree_plafond", "unite_horaire", "montant_unique", "montant_min", "montant_max", "montant_questionnaire", "ajustement", "label"), "champs_obligatoires" : ("unite_horaire", "montant_unique"), "tarifs_compatibles" : ("JOURN",) },
    { "code" : "duree_coeff_qf", "label" : _("Montant au prorata d'une durée et selon le quotient familial"), "type" : "horaire", "nbre_lignes_max" : None, "entete" : None, "champs" : ("qf_min", "qf_max", "duree_min", "duree_max", "duree_seuil", "duree_plafond", "unite_horaire", "montant_unique", "montant_min", "montant_max", "ajustement", "label"), "champs_obligatoires" : ("qf_min", "qf_max", "unite_horaire", "montant_unique"), "tarifs_compatibles" : ("JOURN",) },

    { "code" : "taux_montant_unique", "label" : _("Par taux d'effort"), "type" : "unitaire", "nbre_lignes_max" : 1, "entete" : None, "champs" : ("taux", "montant_min", "montant_max", "ajustement", "label"), "champs_obligatoires" : ("taux",), "tarifs_compatibles" : ("JOURN",) },
    { "code" : "taux_qf", "label" : _("Par taux d'effort et par tranches de QF"), "type" : "unitaire", "nbre_lignes_max" : None, "entete" : None, "champs" : ("qf_min", "qf_max", "taux", "montant_min", "montant_max", "ajustement", "label"), "champs_obligatoires" : ("qf_min", "qf_max", "taux",), "tarifs_compatibles" : ("JOURN",) },
    { "code" : "taux_date", "label": _("Par taux d'effort et par date"), "type": "unitaire", "nbre_lignes_max": None, "entete": None, "champs": ("date", "taux", "montant_min", "montant_max", "ajustement", "label"), "champs_obligatoires": ("date", "taux"), "tarifs_compatibles": ("JOURN",)},
    { "code" : "duree_taux_montant_unique", "label" : _("Par taux d'effort et en fonction d'une durée"), "type" : "horaire", "nbre_lignes_max" : None, "entete" : None, "champs" : ("duree_min", "duree_max", "temps_facture", "taux", "montant_min", "montant_max", "ajustement", "label"), "champs_obligatoires" : ("duree_min", "duree_max", "taux"), "tarifs_compatibles" : ("JOURN",) },
    { "code" : "duree_taux_qf", "label" : _("Par taux d'effort et par tranches de QF en fonction d'une durée"), "type" : "horaire", "nbre_lignes_max" : None, "entete" : None, "champs" : ("qf_min", "qf_max", "duree_min", "duree_max", "temps_facture", "taux", "montant_min", "montant_max", "ajustement", "label"), "champs_obligatoires" : ("qf_min", "qf_max", "duree_min", "duree_max", "taux"), "tarifs_compatibles" : ("JOURN",) },

    # Lignes PSU
    { "code" : "forfait_contrat", "label" : _("Forfait contrat"), "type" : "unitaire", "nbre_lignes_max" : 0, "entete" : None, "champs" : (), "champs_obligatoires" : (), "tarifs_compatibles" : ("CREDIT",) },
    { "code" : "psu_revenu", "label" : _("Barême PSU selon revenus"), "type" : "unitaire", "nbre_lignes_max" : None, "entete" : None, "champs" : ("revenu_min", "revenu_max", "taux", "montant_min", "montant_max", "ajustement"), "champs_obligatoires" : ("revenu_min", "revenu_max", "taux"), "tarifs_compatibles" : ("BAREME",) },
    { "code" : "psu_qf", "label" : _("Barême PSU selon QF"), "type" : "unitaire", "nbre_lignes_max" : None, "entete" : None, "champs" : ("qf_min", "qf_max", "taux", "montant_min", "montant_max", "ajustement"), "champs_obligatoires" : ("qf_min", "qf_max", "taux"), "tarifs_compatibles" : ("BAREME",) },

    # Lignes PRODUITS
    {"code" : "produit_montant_unique", "label": _("Montant unique"), "type": "unitaire", "nbre_lignes_max": 1, "entete": None, "champs": ("montant_unique",), "champs_obligatoires": ("montant_unique",), "tarifs_compatibles": ("PRODUIT",)},
    {"code" : "produit_proportionnel_quantite", "label": _("Montant proportionnel à la quantité"), "type": "unitaire", "nbre_lignes_max": 1, "entete": None, "champs": ("montant_unique",), "champs_obligatoires": ("montant_unique",), "tarifs_compatibles": ("PRODUIT",)},

]

LISTE_COLONNES = [
    { "code" : "tranche", "label" : _("Tranche"), "largeur" : 60, "editeur" : None, "infobulle" : _("Tranche") },
    { "code" : "qf_min", "label" : _("QF\nmin >="), "largeur" : 70, "editeur" : "decimal", "infobulle" : _("Quotient familial minimal") },
    { "code" : "qf_max", "label" : _("QF\nmax <="), "largeur" : 70, "editeur" : "decimal", "infobulle" : _("Quotient familial maximal") },
    { "code" : "revenu_min", "label" : _("Revenu\nmin >="), "largeur" : 70, "editeur" : "decimal", "infobulle" : _("Revenu minimal") },
    { "code" : "revenu_max", "label" : _("Revenu\nmax <="), "largeur" : 70, "editeur" : "decimal", "infobulle" : _("Revenu maximal") },
    { "code" : "montant_unique", "label" : _("Tarif"), "largeur" : 70, "editeur" : "decimal4", "infobulle" : _("Montant") },
    { "code" : "montant_questionnaire", "label" : _("Tarif questionnaire"), "largeur" : 130, "editeur" : "questionnaire", "infobulle" : _("Montant renseigné dans les questionnaires familiaux ou individuels") },
    { "code" : "montant_enfant_1", "label" : _("Tarif\n1 ind."), "largeur" : 60, "editeur" : "decimal4", "infobulle" : _("Montant") },
    { "code" : "montant_enfant_2", "label" : _("Tarif\n2 ind."), "largeur" : 60, "editeur" : "decimal4", "infobulle" : _("Montant") },
    { "code" : "montant_enfant_3", "label" : _("Tarif\n3 ind."), "largeur" : 60, "editeur" : "decimal4", "infobulle" : _("Montant") },
    { "code" : "montant_enfant_4", "label" : _("Tarif\n4 ind."), "largeur" : 60, "editeur" : "decimal4", "infobulle" : _("Montant") },
    { "code" : "montant_enfant_5", "label" : _("Tarif\n5 ind."), "largeur" : 60, "editeur" : "decimal4", "infobulle" : _("Montant") },
    { "code" : "montant_enfant_6", "label" : _("Tarif\n6 ind."), "largeur" : 60, "editeur" : "decimal4", "infobulle" : _("Montant") },
    { "code" : "nbre_enfants", "label" : _("Nb enfants"), "largeur" : 70, "editeur" : None, "infobulle" : _("Nombre d'enfants") },
    { "code" : "coefficient", "label" : _("Coefficient"), "largeur" : 70, "editeur" : "decimal", "infobulle" : _("Coefficient") },
    { "code" : "montant_min", "label" : _("Montant\nmin"), "largeur" : 70, "editeur" : "decimal4", "infobulle" : _("Montant minimal") },
    { "code" : "montant_max", "label" : _("Montant\nmax"), "largeur" : 70, "editeur" : "decimal4", "infobulle" : _("Montant maximal") },
    { "code" : "heure_debut_min", "label" : _("Heure Début\nmin >="), "largeur" : 77, "editeur" : "heure", "infobulle" : _("Heure de début minimale") },
    { "code" : "heure_debut_max", "label" : _("Heure Début\nmax <="), "largeur" : 77, "editeur" : "heure", "infobulle" : _("Heure de début maximale") },
    { "code" : "heure_fin_min", "label" : _("Heure Fin\nmin >="), "largeur" : 75, "editeur" : "heure", "infobulle" : _("Heure de fin minimale") },
    { "code" : "heure_fin_max", "label" : _("Heure Fin\nmax <="), "largeur" : 75, "editeur" : "heure", "infobulle" : _("Heure de fin maximale") },
    { "code" : "duree_min", "label" : _("Durée\nmin >="), "largeur" : 70, "editeur" : "heure", "infobulle" : _("Durée minimale") },
    { "code" : "duree_max", "label" : _("Durée\nmax <="), "largeur" : 70, "editeur" : "heure", "infobulle" : _("Durée maximale") },
    { "code" : "date", "label" : _("Date"), "largeur" : 80, "editeur" : "date", "infobulle" : _("Date") },
    { "code" : "label", "label" : _("Label de la prestation (Optionnel)"), "largeur" : 220, "editeur" : None, "infobulle" : _("Label de la prestation. Variables disponibles :\n{QUANTITE}, {TEMPS_REALISE}, {TEMPS_FACTURE}, {HEURE_DEBUT}, {HEURE_FIN}.") },
    { "code" : "temps_facture", "label" : _("Temps facturé\n(pour la CAF)"), "largeur" : 90, "editeur" : "heure", "infobulle" : _("Temps facturé") },
    { "code" : "unite_horaire", "label" : _("Unité\nhoraire"), "largeur" : 70, "editeur" : "heure", "infobulle" : _("Unité horaire de base") },
    { "code" : "duree_seuil", "label" : _("Durée\nseuil"), "largeur" : 70, "editeur" : "heure", "infobulle" : _("Durée seuil") },
    { "code" : "duree_plafond", "label" : _("Durée\nplafond"), "largeur" : 70, "editeur" : "heure", "infobulle" : _("Durée plafond") },
    { "code" : "taux", "label" : _("Taux"), "largeur" : 70, "editeur" : "decimal6", "infobulle" : _("Taux d'effort") },
    { "code" : "ajustement", "label" : _("Majoration/\nDéduction"), "largeur" : 75, "editeur" : "decimal4", "infobulle" : _("Montant à majorer ou à déduire sur le tarif") },
]
...
##        locale.setlocale(locale.LC_ALL, 'C')
    ...
    #                 dlg = wx.MessageDialog(self, _("Cette ligne comporte des valeurs. Souhaitez-vous vraiment la supprimer ?"), _("Suppression"), wx.YES_NO|wx.NO_DEFAULT|wx.CANCEL|wx.ICON_INFORMATION)
    ...
    def Inserer(self, event=None):
        ...
        if self.nbre_lignes_max != None :
            if self.nbre_lignes_max <= self.GetNumberRows() :
                dlg = wx.MessageDialog(self, _("Vous ne pouvez pas saisir d'autres lignes !"), _("Erreur"), wx.OK | wx.ICON_EXCLAMATION)
                dlg.ShowModal()
                dlg.Destroy()
                return False
    ...
    def Supprimer(self, event=None):
        ...
        if mode == None or (self.code in self.dictDonnees) == False:
            dlg = wx.MessageDialog(self, _("Aucune ligne à supprimer."), "Erreur", wx.OK | wx.ICON_EXCLAMATION)
            dlg.ShowModal()
            dlg.Destroy()
            return False
        ...
        if (self.GetNumberRows() - nbre_lignes) == 0 :
            dlg = wx.MessageDialog(self, _("Vous devez conserver au moins une ligne !"), _("Erreur"), wx.OK | wx.ICON_EXCLAMATION)
            dlg.ShowModal()
            dlg.Destroy()
            return False
        ...
        if nbre_lignes == 1 :
            texte = _("Souhaitez-vous vraiment supprimer la ligne n°%d ?") % (num_ligne_debut+1)
        else :
            texte = _("Souhaitez-vous vraiment supprimer %d lignes (n°%d à n°%d) ?") % (nbre_lignes, num_ligne_debut+1, num_ligne_fin+1)
        dlg = wx.MessageDialog(self, texte, _("Supprimer"), wx.YES_NO | wx.NO_DEFAULT | wx.CANCEL | wx.ICON_QUESTION)
        reponse = dlg.ShowModal()
        dlg.Destroy()
    ...
    def Validation(self):
        ...
        if (self.code in self.dictDonnees) == False : 
            dlg = wx.MessageDialog(self, _("Vous devez obligatoirement sélectionner une méthode de calcul !"), "Erreur", wx.OK | wx.ICON_EXCLAMATION)
            dlg.ShowModal()
            dlg.Destroy()
            return False
            ...
            for indexChamp in self.listeColonnes :
                ...
                if codeChamp in self.champs_obligatoires :
                    ...
                    if (numColonne in dictColonnes) == False :
                        dlg = wx.MessageDialog(self, _("Vous devez obligatoirement renseigner la colonne '%s' de la ligne n°%d !") % (label, numLigne+1), "Erreur", wx.OK | wx.ICON_EXCLAMATION)
                        dlg.ShowModal()
                        dlg.Destroy()
                        return False
                    else:
    ...
    def Copier(self, event=None):
        ...
        mode, selections = self.GetSelectionUtilisateur()
        if mode == None or (self.code in self.dictDonnees) == False:
            dlg = wx.MessageDialog(self, _("Aucune donnée à copier."), "Presse-papiers", wx.OK | wx.ICON_INFORMATION)
            dlg.ShowModal()
            dlg.Destroy()
            return False
        ...
        if len(data_lignes) > 0 :
            ...
            if wx.TheClipboard.Open():
                ...
                # Confirmation
                # dlg = wx.MessageDialog(self, _("La sélection de %s a été copiée dans le presse-papiers.") % mode, "Presse-papiers", wx.OK | wx.ICON_INFORMATION)
                # dlg.ShowModal()
                # dlg.Destroy()
    ...
    def Coller(self, event=None):
        ...
        # dlg = wx.TextEntryDialog(self, _("A partir de quelle ligne voulez-vous coller le contenu du presse-papiers ?"), _("Coller"), str(num_ligne_debut))
        # reponse = dlg.ShowModal()
        ...
        # except :
        #     # Confirmation
        #     dlg = wx.MessageDialog(self, _("Le numéro de ligne est erroné."), _("Presse-papiers"), wx.OK | wx.ICON_ERROR)
        #     dlg.ShowModal()
        #     dlg.Destroy()
        #     return False
        ...
        if len(data_lignes) + numLigne > self.GetNumberRows() :
            if self.nbre_lignes_max == None or len(data_lignes) + numLigne <= self.nbre_lignes_max :
                ...
                dlg = wx.MessageDialog(self, _("Souhaitez-vous rajouter %d lignes supplémentaires ?") % nbre, _("Coller"), wx.YES_NO | wx.YES_DEFAULT | wx.CANCEL | wx.ICON_QUESTION)
                reponse = dlg.ShowModal()
                dlg.Destroy()
    ...
    def ContextMenu(self):
        ...
        item = wx.MenuItem(menuPop, id, _("Insérer des lignes"))
        ...
        id = wx.Window.NewControlId()
        item = wx.MenuItem(menuPop, id, _("Supprimer des lignes"))
        ...
        # Item Copier
        id = wx.Window.NewControlId()
        item = wx.MenuItem(menuPop, id, _("Copier les cases"))
        ...
        # Item Coller
        id = wx.Window.NewControlId()
        item = wx.MenuItem(menuPop, id, _("Coller les cases"))
...
class CTRL_Type_quotient(wx.Choice):
    ...
    def GetListeDonnees(self):
        ...
        listeDonnees = db.ResultatReq()
        db.Close()
        listeItems = [_("Indifférent")]
        self.dictDonnees = {0: {"ID": None, "nom": _("Indifférent")}}
        index = 1
...
class Panel(wx.Panel):
    def __init__(self, parent, IDactivite=None, IDtarif=None, track_tarif=None, filtre_methodes=None):
        ...
        self.label_methode = wx.StaticText(self, -1, _("Méthode :"))
        self.ctrl_methode = CTRL_Methode(self, filtre=filtre_methodes)

        self.label_parametres = wx.StaticText(self, -1, _("Paramètres :"))
        ...
        # self.label_info = wx.StaticText(self, -1, _("L'astérisque (*) indique les méthodes de calcul compatibles avec les tarifs de type forfait."))
        # self.label_info.SetFont(wx.Font(7, wx.SWISS, wx.NORMAL, wx.NORMAL, False))

        self.label_type_quotient = wx.StaticText(self, -1, _("Type de QF :"))
    ...
    def __set_properties(self):
        self.ctrl_methode.SetToolTip(wx.ToolTip(_("Sélectionnez une méthode de calcul dans la liste")))
        self.bouton_ajouter_ligne.SetToolTip(wx.ToolTip(_("Cliquez ici pour insérer des lignes")))
        self.bouton_supprimer_ligne.SetToolTip(wx.ToolTip(_("Cliquez ici pour supprimer les lignes sélectionnées")))
        self.bouton_copier.SetToolTip(wx.ToolTip(_("Cliquez ici pour copier les cases sélectionnées du tableau dans le presse-papiers")))
        self.bouton_coller.SetToolTip(wx.ToolTip(_("Cliquez ici pour coller les cases mémorisées dans le presse-papiers dans le tableau")))
        self.ctrl_type_quotient.SetToolTip(wx.ToolTip(_("[OPTIONNEL] Sélectionnez ici le type de QF que vous souhaitez utiliser dans ce tarif. Indifférent par défaut.")))
    ...
    def OnBoutonAjouter(self, event):
        if self.ctrl_methode.GetCode() == None :
            dlg = wx.MessageDialog(self, _("Vous devez d'abord sélectionner une méthode de calcul !"), "Erreur", wx.OK | wx.ICON_EXCLAMATION)
            dlg.ShowModal()
            dlg.Destroy()
            return
