...
class Calendrier(HTL.HyperTreeList):
    def __init__(self, parent, IDactivite=None): 
        ...
        self.AddColumn(_("Périodes / Groupes"))
    ...
    def Initialisation(self):
        ...
        for annee in listeAnnees :
            ...
            if annee in dictTotaux :
                ...
                if total == 1 :
                    label = _("Année %d (1 date)") % annee
                else :
                    label = _("Année %d (%d dates)") % (annee, total)
                        ...
                        for IDunite, nbreOuvertures in dictUnites.items() :
                            if IDunite in dictColonnes :
                                ...
                                if nbreOuvertures == 1 :
                                    ...
                                    texte = _("%s dates") % nbreOuvertures
...
##        self.Expand(self.root)
    ...
    def GetDictGroupes(self):
        ...
        dictGroupes[0] = {"nom":_("Sans groupe"), "ordre":0}
        return dictGroupes
