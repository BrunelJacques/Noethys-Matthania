...
class Panel(wx.Panel):
    def __init__(self, parent):
        ...
        self.bouton_messages_ajouter.SetToolTip(wx.ToolTip(_("Cliquez ici pour saisir un message")))
        self.bouton_messages_modifier.SetToolTip(wx.ToolTip(_("Cliquez ici pour modifier le message sélectionné dans la liste")))
        self.bouton_messages_supprimer.SetToolTip(wx.ToolTip(_("Cliquez ici pour supprimer le message sélectionné dans la liste")))
