...
class Track(object):
    def __init__(self, donnees):
        ...
        self.periodeComplete = _("Du %s au %s") % (self.date_debut_str, self.date_fin_str)
...
class CTRL(HTL.HyperTreeList):
    def __init__(self, parent, IDfamille=None): 
        ...
        listeColonnes = [
            ( _("Période de validité"), 180, wx.ALIGN_LEFT),
            ( _("Nom"), 130, wx.ALIGN_LEFT),
            ( _("Activité"), 70, wx.ALIGN_LEFT),
            ( _("Caisse"), 100, wx.ALIGN_LEFT),
            ( _("Bénéficiaires"), 120, wx.ALIGN_LEFT),
            ( _("Total des déductions"), 150, wx.ALIGN_LEFT),
            ( _("Nbre de dates"), 130, wx.ALIGN_LEFT),
            ]
        numColonne = 0
