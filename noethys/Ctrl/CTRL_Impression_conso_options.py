...
class CTRL(CTRL_Propertygrid.CTRL):
    ...
    def Remplissage(self):
        ...
        propriete.SetEditor("EditeurChoix")
        propriete.SetHelpString(_("Sélectionnez la hauteur de la ligne de l'individu (en pixels)"))
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        ...
        propriete.SetHelpString(_("Sélectionnez la couleur de fond de la ligne de titre"))
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)

        # Couleur du fond d'entête de colonne
        propriete = wxpg.ColourProperty(label=_("Couleur ligne des entêtes"), name="couleur_fond_entetes", value=wx.Colour(240, 240, 240) )
        ...
        propriete.SetHelpString(_("Sélectionnez la couleur de fond de la ligne de total"))
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)

        # Taille nom activité
        propriete = wxpg.IntProperty(label=_("Taille de police du nom d'activité"), name="activite_taille_nom", value=5)
        propriete.SetEditor("SpinCtrl")
        propriete.SetHelpString(_("Taille de police du nom d'activité"))
        propriete.SetAttribute("obligatoire", True)
        propriete.SetAttribute("Min", 0)
        self.Append(propriete)
        ...
        # Catégorie
        self.Append(wxpg.PropertyCategory(_("Colonnes des unités")))

        # Afficher les évènements
        propriete = wxpg.BoolProperty(label=_("Afficher les évènements"), name="afficher_evenements", value=False)
        propriete.SetHelpString(_("Cochez cette case pour afficher les évènements"))
        propriete.SetAttribute("UseCheckbox", True)
        self.Append(propriete)

        # Afficher les étiquettes
        propriete = wxpg.BoolProperty(label=_("Afficher les étiquettes"), name="afficher_etiquettes", value=False)
        propriete.SetHelpString(_("Cochez cette case pour afficher les étiquettes"))
        propriete.SetAttribute("UseCheckbox", True)
        self.Append(propriete)
        ...
        propriete.SetEditor("EditeurChoix")
        propriete.SetHelpString(_("Sélectionnez la largeur de chaque colonne unité (en pixels)"))
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)

        # Catégorie
        self.Append(wxpg.PropertyCategory(_("Colonnes personnalisées")))

        # Largeur colonne unités
        liste_choix = []
        for x in range(5, 105, 5):
            liste_choix.append((str(x), "%d pixels" % x))
        propriete = CTRL_Propertygrid.Propriete_choix(label=_("Largeur par défaut des colonnes"), name="largeur_colonne_perso", liste_choix=liste_choix, valeur="40")
        propriete.SetEditor("EditeurChoix")
        propriete.SetHelpString(_("Sélectionnez la largeur par défaut de toutes les colonnes personnalisées (en pixels)"))
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        ...
        propriete = wxpg.BoolProperty(label=_("Afficher les pièces manquantes"), name="afficher_pieces_manquantes", value=False)
        propriete.SetHelpString(_("Cochez cette case pour afficher les pièces manquantes"))
        propriete.SetAttribute("UseCheckbox", True)
        self.Append(propriete)
        ...
        propriete.SetEditor("EditeurChoix")
        propriete.SetHelpString(_("Sélectionnez la largeur de la colonne Informations (en pixels)"))
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
