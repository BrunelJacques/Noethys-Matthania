...
##        self.SetPhoto(IDindividu=1)
    ...
    def MenuPhoto(self, event):
        ...
        # Item Ajouter
        item = wx.MenuItem(menuPop, 10, _("Importer une photo"))
        ...
        item = wx.MenuItem(menuPop, 20, _("Capturer une photo à partir d'une webcam"))
...
##        
##         # Item Imprimer
##        item = wx.MenuItem(menuPop, 40, _("Imprimer la photo"))
...
##        if self.IDphoto == None : item.Enable(False)
    ...
    def Ajoute_image(self):
        ...
        dlg = wx.FileDialog(
            self, message=_("Choisissez une photo"),
    ...
    def Menu_Supprimer(self, event):
        ...
        txtMessage = _("Souhaitez-vous vraiment supprimer cette photo ?")
