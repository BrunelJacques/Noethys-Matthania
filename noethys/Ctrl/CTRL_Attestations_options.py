...
class CTRL_Parametres(CTRL_Propertygrid.CTRL) :
    ...
    def Remplissage(self):
        ...
        # Catégorie 
        self.Append( wxpg.PropertyCategory(_("Signataire")) )

        propriete = wxpg.EnumProperty(label=_("Signataire du document"), name="signataire", value=0)
        propriete.SetHelpString(_("Sélectionnez le signataire du document (à renseigner au préalable dans le paramétrage de l'activité)"))
        propriete.SetAttribute("obligatoire", True)
        ...
        propriete = wxpg.StringProperty(label=_("Titre du document"), name="texte_titre", value=_("Attestation de présence"))
        propriete.SetHelpString(_("Saisissez le titre du document (Par défaut 'Attestation de présence'). Vous pouvez intégrer les mots-clés suivants : %s") % ", ".join(listeChamps)) 
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        ...
        propriete = wxpg.EnumProperty(label=_("Affichage des prestations"), name="affichage_prestations", labels=[_("Détaillé"), _("Condensé")], values=[0, 1] , value=0)
        ...
        # Catégorie
        self.Append( wxpg.PropertyCategory(_("Prestations antérieures")) )

        # Taille de texte
        propriete = wxpg.IntProperty(label=_("Taille de texte du commentaire"), name="taille_texte_prestations_anterieures", value=5)
        propriete.SetHelpString(_("Saisissez la taille de texte du commentaire de bas de tableaux (5 par défaut)"))
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        self.SetPropertyEditor("taille_texte_prestations_anterieures", "SpinCtrl")

        # Texte d'information
        propriete = wxpg.LongStringProperty(label=_("Texte d'information"), name="texte_prestations_anterieures", value=_("Des prestations antérieures ont été reportées sur cette attestation."))
        propriete.SetHelpString(_("Saisissez un texte d'information pour les prestations antérieures"))
        self.Append(propriete)

        # Catégorie 
        self.Append( wxpg.PropertyCategory(_("Texte d'introduction")) )

        propriete = wxpg.LongStringProperty(label=_("Texte d'introduction"), name="texte_introduction", value=TEXTE_INTRO)
        propriete.SetHelpString(_("Saisissez un texte d'introduction. Vous pouvez intégrer les mots-clés suivants : %s") % ", ".join(listeChamps)) 
        self.Append(propriete)
        ...
        propriete = wxpg.EnumProperty(label=_("Style de texte introduction"), name="style_texte_introduction", labels=[_("Normal"), _("Italique"), "Gras", _("Italique + Gras")], values=[0, 1, 2, 3] , value=1)
        ...
        propriete = wxpg.EnumProperty(label=_("Alignement du texte d'introduction"), name="alignement_texte_introduction", labels=[_("Gauche"), _("Centre"), _("Droite")], values=[0, 1, 2] , value=1)
        ...
        propriete = wxpg.LongStringProperty(label=_("Texte de conclusion"), name="texte_conclusion", value=u"")
