...
class CTRL_Parametres(CTRL_Propertygrid.CTRL) :
    ...
    def Remplissage(self):
        ...
        propriete = wxpg.BoolProperty(label=_("Mémoriser les paramètres"), name="memoriser_parametres", value=True)
        ...
        propriete = wxpg.EnumProperty(label=_("Factures-Avoirs"), name="imprimer_factures", labels=[_("Un seul Avoir ou Facture"),_("Tout imprimer"), _("Seulement Avoirs"), _("Seulement Factures")], values=[0,1,2,3] , value=0)
        propriete.SetHelpString(_("Sélectionnez les pièces à retenir au moment de la génération de la facture)"))
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)

        # Affichage condensé ou détaillé
        propriete = wxpg.EnumProperty(label=_("Afficher le solde"), name="affichage_solde", labels=[_("Actuel"), _("Initial")], values=[0, 1] , value=0)
        propriete.SetHelpString(_("Sélectionnez un type d'affichage pour le solde (Actuel=Solde à ce jour / Initial=Solde au moment de la génération de la facture)"))
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)

        # Inversion Avoir Facture des soldes négatis
        propriete = wxpg.BoolProperty(label=_("Inversion Facture/Avoir si négatifs"), name="inversion_solde", value=True)
        propriete.SetHelpString(_("Cochez cette case si vous souhaitez permuter la nature Facture ou Avoir quand les soldes sont négatifs, ils deviendront positifs"))
        propriete.SetAttribute("UseCheckbox", True)
        self.Append(propriete)

        # Afficher le rappel des impayés
        propriete = wxpg.BoolProperty(label=_("Afficher le rappel des impayés"), name="afficher_impayes", value=True)
        propriete.SetHelpString(_("Cochez cette case si vous souhaitez afficher le rappel des impayés dans le document"))
        propriete.SetAttribute("UseCheckbox", True)
        self.Append(propriete)

        # Intégrer les impayés au solde
        propriete = wxpg.BoolProperty(label=_("Intégrer les impayés au solde"), name="integrer_impayes", value=False)
        propriete.SetHelpString(_("Cochez cette case si vous souhaitez intégrer les impayés dans le solde"))
        propriete.SetAttribute("UseCheckbox", True)
        self.Append(propriete)

        # Afficher les coupons-réponse
        propriete = wxpg.BoolProperty(label=_("Afficher le coupon-réponse"), name="afficher_coupon_reponse", value=True)
        propriete.SetHelpString(_("Cochez cette case si vous souhaitez afficher un coupon-réponse dans le document"))
        propriete.SetAttribute("UseCheckbox", True)
        self.Append(propriete)
        
        # Afficher les messages
        propriete = wxpg.BoolProperty(label=_("Afficher les messages"), name="afficher_messages", value=True)
        propriete.SetHelpString(_("Cochez cette case si vous souhaitez afficher les messages dans le document"))
        propriete.SetAttribute("UseCheckbox", True)
        self.Append(propriete)

        # Afficher les codes-barres
        propriete = wxpg.BoolProperty(label=_("Afficher les codes-barres"), name="afficher_codes_barres", value=True)
        propriete.SetHelpString(_("Cochez cette case si vous souhaitez afficher les codes-barres dans le document"))
        propriete.SetAttribute("UseCheckbox", True)
        self.Append(propriete)
 
        # Afficher les règlements
        propriete = wxpg.BoolProperty(label=_("Afficher les règlements"), name="afficher_reglements", value=True)
        propriete.SetHelpString(_("Cochez cette case si vous souhaitez afficher les règlements dans le document"))
        propriete.SetAttribute("UseCheckbox", True)
        self.Append(propriete) 
       
        # Afficher les avis de prélèvements
        propriete = wxpg.BoolProperty(label=_("Afficher les avis de prélèvements"), name="afficher_avis_prelevements", value=True)
        propriete.SetHelpString(_("Cochez cette case si vous souhaitez afficher les avis de prélèvements dans le document"))
        propriete.SetAttribute("UseCheckbox", True)
        self.Append(propriete) 
        
        # Afficher les QF aux dates concernées
        propriete = wxpg.BoolProperty(label=_("Afficher les QF"), name="afficher_qf_dates", value=True)
        propriete.SetHelpString(_("Cochez cette case si vous souhaitez afficher les QF aux dates concernées dans le document"))
        propriete.SetAttribute("UseCheckbox", True)
        self.Append(propriete)
        ...
        # Afficher le titre
        propriete = wxpg.BoolProperty(label=_("Afficher le titre"), name="afficher_titre", value=True)
        propriete.SetHelpString(_("Cochez cette case si vous souhaitez afficher le titre du le document"))
        propriete.SetAttribute("UseCheckbox", True)
        self.Append(propriete)

        propriete = wxpg.StringProperty(label=_("Titre du document"), name="texte_titre", value=_("Facture"))
        propriete.SetHelpString(_("Saisissez le titre du document (Par défaut 'Facture'). Vous pouvez intégrer les mots-clés suivants : %s") % ", ".join(listeChamps))
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)

        propriete = wxpg.IntProperty(label=_("Taille de texte du titre"), name="taille_texte_titre", value=19)
        propriete.SetHelpString(_("Saisissez la taille de texte du titre (29 par défaut)"))
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        self.SetPropertyEditor("taille_texte_titre", "SpinCtrl")
        
        propriete = wxpg.BoolProperty(label=_("Afficher la période de facturation"), name="afficher_periode", value=True)
        propriete.SetHelpString(_("Cochez cette case si vous souhaitez afficher la période de facturation dans le document"))
        propriete.SetAttribute("UseCheckbox", True)
        self.Append(propriete)
        
        propriete = wxpg.IntProperty(label=_("Taille de texte de la période"), name="taille_texte_periode", value=8)
        propriete.SetHelpString(_("Saisissez la taille de texte de la période (8 par défaut)"))
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        ...
        # Affichage condensé ou détaillé
        propriete = wxpg.EnumProperty(label=_("Affichage des prestations"), name="affichage_prestations", labels=[_("Détaillé"), _("Regroupement par label"), _("Regroupement par label et montant unitaire")], values=[0, 1, 2] , value=0)
        propriete.SetHelpString(_("Sélectionnez un type d'affichage"))
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)

        # Intitulés des prestations
        labels = [_("Intitulé original"), _("Intitulé original + état 'Absence injustifiée'"), _("Nom du tarif"), _("Nom de l'activité")]
        propriete = wxpg.EnumProperty(label=_("Intitulés des prestations"), name="intitules", labels=labels, values=[0, 1, 2, 3] , value=0)
        propriete.SetHelpString(_("Sélectionnez le type d'intitulé à afficher pour les prestations"))
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        
        # Couleur 1
        propriete = wxpg.ColourProperty(label=_("Couleur de fond 1"), name="couleur_fond_1", value=wx.Colour(204, 204, 255) )
        propriete.SetHelpString(_("Sélectionnez la couleur 1"))
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        
        # Couleur 2
        propriete = wxpg.ColourProperty(label=_("Couleur de fond 2"), name="couleur_fond_2", value=wx.Colour(234, 234, 255) )
        propriete.SetHelpString(_("Sélectionnez la couleur 2"))
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        
        # Largeur colonne Date
        propriete = wxpg.IntProperty(label=_("Largeur de la colonne Date (ou Qté)"), name="largeur_colonne_date", value=50)
        propriete.SetHelpString(_("Saisissez la largeur de la colonne Date (50 par défaut)"))
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        self.SetPropertyEditor("largeur_colonne_date", "SpinCtrl")
        
        # Largeur colonne Montant HT
        propriete = wxpg.IntProperty(label=_("Largeur de la colonne Montant HT"), name="largeur_colonne_montant_ht", value=50)
        propriete.SetHelpString(_("Saisissez la largeur de la colonne Montant HT (50 par défaut)"))
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        self.SetPropertyEditor("largeur_colonne_montant_ht", "SpinCtrl")

        # Largeur colonne Montant TVA
        propriete = wxpg.IntProperty(label=_("Largeur de la colonne Montant TVA"), name="largeur_colonne_montant_tva", value=50)
        propriete.SetHelpString(_("Saisissez la largeur de la colonne Montant TVA (50 par défaut)"))
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        self.SetPropertyEditor("largeur_colonne_montant_tva", "SpinCtrl")

        # Largeur colonne Montant TTC
        propriete = wxpg.IntProperty(label=_("Largeur de la colonne Montant TTC"), name="largeur_colonne_montant_ttc", value=70)
        propriete.SetHelpString(_("Saisissez la largeur de la colonne Montant TTC (70 par défaut)"))
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        self.SetPropertyEditor("largeur_colonne_montant_ttc", "SpinCtrl")
        
        # Taille de texte du nom de l'individu
        propriete = wxpg.IntProperty(label=_("Taille de texte de l'individu"), name="taille_texte_individu", value=9)
        propriete.SetHelpString(_("Saisissez la taille de texte de l'individu (9 par défaut)"))
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        self.SetPropertyEditor("taille_texte_individu", "SpinCtrl")

        # Taille de texte du nom de l'activité
        propriete = wxpg.IntProperty(label=_("Taille de texte de l'activité"), name="taille_texte_activite", value=6)
        propriete.SetHelpString(_("Saisissez la taille de texte de l'activité (6 par défaut)"))
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        self.SetPropertyEditor("taille_texte_activite", "SpinCtrl")

        # Taille de texte des noms de colonnes
        propriete = wxpg.IntProperty(label=_("Taille de texte des noms de colonnes"), name="taille_texte_noms_colonnes", value=5)
        propriete.SetHelpString(_("Saisissez la taille de texte des noms de colonnes (5 par défaut)"))
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        self.SetPropertyEditor("taille_texte_noms_colonnes", "SpinCtrl")

        # Taille de texte des prestations
        propriete = wxpg.IntProperty(label=_("Taille de texte des prestations"), name="taille_texte_prestation", value=7)
        propriete.SetHelpString(_("Saisissez la taille de texte des prestations (7 par défaut)"))
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        self.SetPropertyEditor("taille_texte_prestation", "SpinCtrl")

        # Taille de texte des messages
        propriete = wxpg.IntProperty(label=_("Taille de texte des messages"), name="taille_texte_messages", value=7)
        propriete.SetHelpString(_("Saisissez la taille de texte des messages (7 par défaut)"))
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        self.SetPropertyEditor("taille_texte_messages", "SpinCtrl")

        # Taille de texte des labels totaux
        propriete = wxpg.IntProperty(label=_("Taille de texte des labels totaux"), name="taille_texte_labels_totaux", value=9)
        propriete.SetHelpString(_("Saisissez la taille de texte des labels totaux (9 par défaut)"))
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        self.SetPropertyEditor("taille_texte_labels_totaux", "SpinCtrl")

        # Taille de texte des totaux
        propriete = wxpg.IntProperty(label=_("Taille de texte des montants totaux"), name="taille_texte_montants_totaux", value=10)
        propriete.SetHelpString(_("Saisissez la taille de texte des montants totaux (10 par défaut)"))
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        ...
        propriete = wxpg.LongStringProperty(label=_("Texte d'introduction"), name="texte_introduction", value="")
        propriete.SetHelpString(_("Saisissez un texte d'introduction (Aucun par défaut). Vous pouvez intégrer les mots-clés suivants : %s") % ", ".join(listeChamps))
        self.Append(propriete)

        propriete = wxpg.IntProperty(label=_("Taille de texte d'introduction"), name="taille_texte_introduction", value=9)
        propriete.SetHelpString(_("Saisissez la taille de texte d'introduction (9 par défaut)"))
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        self.SetPropertyEditor("taille_texte_introduction", "SpinCtrl")

        propriete = wxpg.EnumProperty(label=_("Style de texte introduction"), name="style_texte_introduction", labels=[_("Normal"), _("Italique"), "Gras", _("Italique + Gras")], values=[0, 1, 2, 3] , value=0)
        propriete.SetHelpString(_("Sélectionnez un style de texte"))
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)

        propriete = wxpg.ColourProperty(label=_("Couleur de fond introduction"), name="couleur_fond_introduction", value=wx.Colour(255, 255, 255) )
        propriete.SetHelpString(_("Sélectionnez une couleur de fond pour le texte d'introduction"))
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)

        propriete = wxpg.ColourProperty(label=_("Couleur de bord introduction"), name="couleur_bord_introduction", value=wx.Colour(255, 255, 255) )
        propriete.SetHelpString(_("Sélectionnez une couleur de bord pour le texte d'introduction"))
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)

        propriete = wxpg.EnumProperty(label=_("Alignement du texte d'introduction"), name="alignement_texte_introduction", labels=[_("Gauche"), _("Centre"), _("Droite")], values=[0, 1, 2] , value=0)
        propriete.SetHelpString(_("Sélectionnez un type d'alignement pour le texte d'introduction"))
        self.Append(propriete)

        # Catégorie 
        self.Append( wxpg.PropertyCategory(_("Texte de conclusion")) )

        propriete = wxpg.LongStringProperty(label=_("Texte de conclusion"), name="texte_conclusion", value="")
        propriete.SetHelpString(_("Saisissez un texte de conclusion (Aucun par défaut). Vous pouvez intégrer les mots-clés suivants : %s") % ", ".join(listeChamps))
        self.Append(propriete)

        propriete = wxpg.IntProperty(label=_("Taille de texte de conclusion"), name="taille_texte_conclusion", value=9)
        propriete.SetHelpString(_("Saisissez la taille de texte de conclusion (9 par défaut)"))
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        self.SetPropertyEditor("taille_texte_conclusion", "SpinCtrl")

        propriete = wxpg.EnumProperty(label=_("Style de texte conclusion"), name="style_texte_conclusion", labels=[_("Normal"), _("Italique"), "Gras", _("Italique + Gras")], values=[0, 1, 2, 3] , value=0)
        propriete.SetHelpString(_("Sélectionnez un style de texte"))
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)

        propriete = wxpg.ColourProperty(label=_("Couleur de fond conclusion"), name="couleur_fond_conclusion", value=wx.Colour(255, 255, 255) )
        propriete.SetHelpString(_("Sélectionnez une couleur de fond pour le texte de conclusion"))
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)

        propriete = wxpg.ColourProperty(label=_("Couleur de bord conclusion"), name="couleur_bord_conclusion", value=wx.Colour(255, 255, 255) )
        propriete.SetHelpString(_("Sélectionnez une couleur de bord pour le texte de conclusion"))
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)

        propriete = wxpg.EnumProperty(label=_("Alignement du texte de conclusion"), name="alignement_texte_conclusion", labels=[_("Gauche"), _("Centre"), _("Droite")], values=[0, 1, 2] , value=0)
        propriete.SetHelpString(_("Sélectionnez un type d'alignement pour le texte de conclusion"))
        self.Append(propriete)

        # Signature 
        self.Append( wxpg.PropertyCategory(_("Signature")) )

        propriete = wxpg.ImageFileProperty(label=_("Image de signature"), name="image_signature")
        propriete.SetHelpString(_("Sélectionnez l'image d'une signature à insérer en fin de document"))
        self.Append(propriete)

        propriete = wxpg.IntProperty(label=_("Taille de l'image (en %)"), name="taille_image_signature", value=100)
        propriete.SetHelpString(_("Saisissez la taille de l'image en pourcentage (100 par défaut)"))
        propriete.SetAttribute("obligatoire", True)
        self.Append(propriete)
        self.SetPropertyEditor("taille_image_signature", "SpinCtrl")

        propriete = wxpg.EnumProperty(label=_("Alignement de l'image"), name="alignement_image_signature", labels=[_("Gauche"), _("Centre"), _("Droite")], values=[0, 1, 2] , value=0)
        propriete.SetHelpString(_("Sélectionnez un type d'alignement pour l'image de signature"))
        self.Append(propriete)
...
class Saisie_Message(wx.Dialog):
    ...
    def OnBoutonOk(self, event):
        if self.GetTitre() == "" :
            dlg = wx.MessageDialog(self, _("Vous devez obligatoirement saisir un titre !"), _("Erreur de saisie"), wx.OK | wx.ICON_EXCLAMATION)
            dlg.ShowModal()
            dlg.Destroy()
        ...
        if self.GetTexte() == "" :
            dlg = wx.MessageDialog(self, _("Vous devez obligatoirement saisir un texte !"), _("Erreur de saisie"), wx.OK | wx.ICON_EXCLAMATION)
            dlg.ShowModal()
            dlg.Destroy()
...
class CTRL_Messages(wx.Panel):
    ...
    def __set_properties(self):
        self.ctrl_messages.SetToolTip(wx.ToolTip(_("Saisissez ou ou plusieurs messages qui apparaitront à la fin du document")))
        self.bouton_ajouter_message.SetToolTip(wx.ToolTip(_("Cliquez ici pour ajouter un message")))
        self.bouton_modifier_message.SetToolTip(wx.ToolTip(_("Cliquez ici pour modifier le message sélectionné dans la liste")))
        self.bouton_supprimer_message.SetToolTip(wx.ToolTip(_("Cliquez ici pour supprimer le message sélectionné dans la liste")))
