...
class CTRL(wx.Panel):
    def __init__(self, parent, filtres=[]):
        ...
        self.check_demandes_actives = wx.CheckBox(self, -1, _("Afficher uniquement les demandes en cours"))
    ...
    def __set_properties(self):
        self.bouton_apercu.SetToolTip(wx.ToolTip(_("Cliquez ici pour afficher un aperçu de la demande sélectionnée")))
        self.bouton_email.SetToolTip(wx.ToolTip(_("Cliquez ici envoyer la demande sélectionnée par Email")))
        self.bouton_supprimer.SetToolTip(wx.ToolTip(_("Cliquez ici pour supprimer la demande sélectionnée ou les locations cochées")))
        ...
        self.check_demandes_actives.SetToolTip(wx.ToolTip(_("Cochez cette case pour afficher uniquement les demandes actives")))
