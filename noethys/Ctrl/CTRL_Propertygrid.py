...
class Propriete_multichoix(ArrayStringProperty):
    ...
    def OnEvent(self, propgrid, primaryEditor, event):
        if event.GetEventType() == wx.wxEVT_COMMAND_BUTTON_CLICKED:
            dlg = wx.MultiChoiceDialog(propgrid, _("Cochez les éléments à sélectionner :"), _("Sélection"), [x[1] for x in self.liste_choix])
            liste_index = []
            index = 0
...
class Bouton_reinitialisation(wx.BitmapButton):
    def __init__(self, parent, ctrl_parametres=None):
        ...
        self.SetToolTip(wx.ToolTip(_("Cliquez ici pour réinitialiser tous les paramètres")))
...
class Bouton_sauvegarde(wx.BitmapButton):
    def __init__(self, parent, ctrl_parametres=None):
        ...
        self.ctrl_parametres = ctrl_parametres
        self.SetToolTip(wx.ToolTip(_("Cliquez ici pour mémoriser tous les paramètres")))
        self.Bind(wx.EVT_BUTTON, self.OnBouton)
...
class CTRL_TEST(CTRL) :
    ...
    def Remplissage(self):
        ...
        propriete = wxpg.BoolProperty(label=_("Afficher le coupon-réponse"), name="coupon_reponse", value=True)
        propriete.SetHelpString(_("Cochez cette case si vous souhaitez afficher un coupon-réponse dans le document"))
        propriete.SetAttribute("UseCheckbox", True)
        self.Append(propriete)
        
        # Afficher les messages
        propriete = wxpg.BoolProperty(label=_("Afficher les messages"), name="messages", value=True)
        ...
        propriete = wxpg.BoolProperty(label=_("Afficher le rappel des impayés"), name="impayes", value=True)
        ...
        propriete = wxpg.BoolProperty(label=_("Afficher les codes-barres"), name="codes_barres", value=True)
        ...
        propriete = wxpg.BoolProperty(label=_("Afficher les avis de prélèvements"), name="avis_prelevements", value=True)
        ...
        propriete = wxpg.StringProperty(label=_("Titre du document"), name="titre_document", value=_("Facture"))
        propriete.SetHelpString(_("Saisissez le titre du document (Par défaut 'Facture')"))
        self.Append(propriete)
        ...
        # Couleur 1
        propriete = wxpg.ColourProperty(label=_("Couleur de fond 1"), name="couleur_fond_1", value=wx.Colour(255, 0, 0) )
        propriete.SetHelpString(_("Sélectionnez la couleur 1"))
        self.Append(propriete)
        
        # Couleur 2
        propriete = wxpg.ColourProperty(label=_("Couleur de fond 2"), name="couleur_fond_2", value=wx.Colour(255, 0, 0) )
        ...
        propriete = wxpg.IntProperty(label=_("Taille de texte de des prestations"), name="taille_texte_prestation", value=7)
        ...
        # Catégorie 
        self.Append( wxpg.PropertyCategory(_("Autres textes")) )

        propriete = wxpg.LongStringProperty(label=_("Texte d'introduction"), name="texte_introduction", value=u"")
        propriete.SetHelpString(_("Saisissez un texte d'introduction (Aucun par défaut)"))
        self.Append(propriete)
        ...
        propriete.SetHelpString(_("Saisissez un texte de conclusion (Aucun par défaut)"))
        self.Append(propriete)
...
if __name__ == '__main__':
    ...
    frame_1 = MyFrame(None, -1, _("TEST"), size=(800, 600))
