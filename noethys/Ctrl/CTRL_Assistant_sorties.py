...
class Page_introduction(Assistant.Page):
    def __init__(self, parent):
        ...
        self.Ajouter_question(titre=_("Bienvenue dans l'assistant de génération d'une activité de type sorties familiales."))
...
class Page_generalites(Assistant.Page):
    def __init__(self, parent):
        ...
        self.Ajouter_question(code="nom", titre=_("Quel est le nom de l'activité ?"), commentaire=_("Exemple : 'Sorties familiales'"), ctrl=Assistant.CTRL_Texte, obligatoire=True)
...
class Page_conclusion(Assistant.Page):
    ...
    def Suite(self):
        ...
        # Nom de tarif
        listeDonnees = [("IDactivite", IDactivite), ("nom", _("Sortie"))]
