...
class Page_Groupes(wx.Panel):
    def __init__(self, parent, IDactivite=None, IDtarif=None):
        ...
        # Groupes
        self.check_groupes = wx.CheckBox(self, -1, _("Uniquement pour les groupes cochés :"))
    ...
    def __set_properties(self):
        self.check_groupes.SetToolTip(wx.ToolTip(_("Cochez cette case si vous souhaitez appliquer un filtre de groupe")))
    ...
    def Validation(self):
        ...
        if self.check_groupes.GetValue() == True :
            if len(self.ctrl_groupes.GetIDcoches()) == 0 :
                dlg = wx.MessageDialog(self, _("Vous n'avez coché aucun groupe !"), "Erreur", wx.OK | wx.ICON_EXCLAMATION)
                dlg.ShowModal()
                dlg.Destroy()
                return False
        return True
...
class Page_Etiquettes(wx.Panel):
    def __init__(self, parent, IDactivite=None, IDtarif=None):
        ...
        # Etiquettes
        self.check_etiquettes = wx.CheckBox(self, -1, _("Uniquement pour les étiquettes cochées :"))
    ...
    def __set_properties(self):
        self.check_etiquettes.SetToolTip(wx.ToolTip(_("Cochez cette case si vous souhaitez appliquer un filtre sur les étiquettes")))
    ...
    def Validation(self):
        ...
        if self.check_etiquettes.GetValue() == True :
            if len(self.ctrl_etiquettes.GetCoches()) == 0 :
                dlg = wx.MessageDialog(self, _("Vous n'avez coché aucune étiquette !"), "Erreur", wx.OK | wx.ICON_EXCLAMATION)
                dlg.ShowModal()
                dlg.Destroy()
                return False
        return True
...
class Page_Cotisations(wx.Panel):
    ...
    def __set_properties(self):
        self.check_cotisations.SetToolTip(wx.ToolTip(_("Cochez cette case pour appliquer ce tarif uniquement lorsque une des cotisations cochées est à jour")))
...
class Page_Questionnaires(wx.Panel):
    def __init__(self, parent, IDactivite=None, IDtarif=None):
        ...
        # Cotisations
        self.check_filtres = wx.CheckBox(self, -1, _("Uniquement selon les filtres suivants :"))
    ...
    def __set_properties(self):
        self.check_filtres.SetToolTip(wx.ToolTip(_("Cochez cette case pour appliquer des filtres sur les questionnaires individuels ou familiaux")))
...
class Page_Caisses(wx.Panel):
    def __init__(self, parent):
        ...
        # Caisses
        self.check_caisses = wx.CheckBox(self, -1, _("Uniquement pour les caisses cochées :"))
    ...
    def __set_properties(self):
        self.check_caisses.SetToolTip(wx.ToolTip(_("Cochez cette case si vous souhaitez appliquer un filtre de caisses")))
    ...
    def Validation(self):
        ...
        if self.check_caisses.GetValue() == True :
            if len(self.ctrl_caisses.GetIDcoches()) == 0 :
                dlg = wx.MessageDialog(self, _("Vous n'avez coché aucune caisse !"), "Erreur", wx.OK | wx.ICON_EXCLAMATION)
                dlg.ShowModal()
                dlg.Destroy()
                return False
        return True
...
class Page_Periodes(wx.Panel):
    def __init__(self, parent):
        ...
        # Caisses
        self.check_periodes = wx.CheckBox(self, -1, _("Uniquement sur les jours cochés :"))
    ...
    def __set_properties(self):
        self.check_periodes.SetToolTip(wx.ToolTip(_("Cochez cette case si vous souhaitez appliquer un filtre de périodes")))
...
class Panel(wx.Panel):
    ...
    def CreationPages(self):
        ...
        self.listePages = [
            {"index" : 0, "code" : "groupes", "ctrl" : Page_Groupes(self, self.IDactivite, self.IDtarif), "label" : _("Groupes")},
            {"index" : 1, "code" : "etiquettes", "ctrl" : Page_Etiquettes(self, self.IDactivite, self.IDtarif), "label" : _("Etiquettes")},
            {"index" : 2, "code" : "cotisations", "ctrl" : Page_Cotisations(self, self.IDactivite, self.IDtarif), "label" : _("Cotisations")},
            {"index" : 3, "code" : "questionnaires", "ctrl" : Page_Questionnaires(self, self.IDactivite, self.IDtarif), "label" : _("Questionnaires")},
            {"index" : 4, "code" : "caisses", "ctrl" : Page_Caisses(self,), "label" : _("Caisses")},
            {"index" : 5, "code" : "periodes", "ctrl" : Page_Periodes(self,), "label" : _("Périodes")},
            ]
