...
class CTRL_Affichage(wx.Choice):
    ...
    def GetListeDonnees(self):
        listeOptions = [
            ("actuellement", _("Actuellement")),
            ("7_prochains_jours", _("7 prochains jours")),
            ("14_prochains_jours", _("14 prochains jours")),
            ("30_prochains_jours", _("30 prochains jours")),
            ("90_prochains_jours", _("90 prochains jours")),
            ("6_prochains_mois", _("6 prochains mois")),
            ("12 prochains_mois", _("12 prochains mois")),
            ("mois_actuel", _("Mois actuel")),
            ("annee_actuelle", _("Année actuelle")),
...
##            ax.set_xlim([min(listeDates), max(listeDates)])      
        ...
        ax.fill_between(listeDates, 0, listeValeurs, facecolor='blue', alpha=0.5, label=_("Trésorerie"))
...
class MyFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.ctrl.MAJ() 
        bouton = wx.Button(panel, -1, _("Test"))
