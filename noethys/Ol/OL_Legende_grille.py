...
class ListView(FastObjectListView):
    def __init__(self, *args, **kwds):
        ...
        self.SetToolTip(wx.ToolTip(_("Retrouvez ici la liste des codes couleurs et icônes utilisés dans la grille des consommations")))
