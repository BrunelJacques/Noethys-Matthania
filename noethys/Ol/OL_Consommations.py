...
class Track(object):
    def __init__(self, donnees):
        ...
        self.individu = "%s %s" % (self.nomIndividu, self.prenomIndividu)
...
##        self.Bind(wx.EVT_LIST_ITEM_ACTIVATED, self.OnItemActivated)
    ...
    def InitObjectListView(self):            
        ...
        liste_Colonnes = [
            ...
            ColumnDefn(_("Date"), 'left', 150, "date", typeDonnee="date", stringConverter=FormateDate),
            ColumnDefn(_("Individu"), "left", 130, "individu", typeDonnee="texte"),
            ColumnDefn(_("Activité"), "left", 120, "nomActivite", typeDonnee="texte"),
            ColumnDefn(_("Unité"), "left", 120, "nomUnite", typeDonnee="texte"),
            ]
...
##        menuPop.AppendSeparator()
        ...
        self.GenerationContextMenu(menuPop, titre=_("Liste des consommations"))
