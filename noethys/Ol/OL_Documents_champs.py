...
class ListView(FastObjectListView):
    ...
    def InitObjectListView(self):            
        ...
        liste_Colonnes = [
            ColumnDefn(u"", 'left', 0, ""),
            ColumnDefn(_("Nom du champ"), 'left', 150, "nom", typeDonnee="texte", isSpaceFilling=True ),
            ColumnDefn(_("Valeur exemple"), 'left', 150, "exemple", typeDonnee="texte"),
            ColumnDefn(_("Code"), 'left', 230, "code", typeDonnee="texte"),
            ]
        
        self.SetColumns(liste_Colonnes)
        self.SetEmptyListMsg(_("Aucun champ disponible"))
    ...
    def OnContextMenu(self, event):
        ...
        # Item Modifier
        item = wx.MenuItem(menuPop, 10, _("Insérer"))
    ...
    def Inserer(self, event):
        if len(self.Selection()) == 0 :
            dlg = wx.MessageDialog(self, _("Vous n'avez sélectionné aucun champ à insérer !"), _("Erreur de saisie"), wx.OK | wx.ICON_EXCLAMATION)
            dlg.ShowModal()
            dlg.Destroy()
            return
...
class MyFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        listeChamps = [
            (_("Nom de l'individu"), _("DUPOND"), _("NOM_INDIVIDU")),
            (_("Prénom de l'individu"), _("Gérard"), _("PRENOM_INDIVIDU")),
            ]
