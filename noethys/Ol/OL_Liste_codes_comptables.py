...
class ListView(FastObjectListView):
    ...
    def InitObjectListView(self):            
        ...
        liste_Colonnes = [
            ...
            ColumnDefn(_("Code comptable"), "center", 200, "code_compta", typeDonnee="texte"),
            ]
    ...
    def OnContextMenu(self, event):
        ...
        # Item Modifier
        item = wx.MenuItem(menuPop, 5, _("Modifier"))
    ...
    def Modifier(self, event=None):
        if len(self.Selection()) == 0 :
            dlg = wx.MessageDialog(self, _("Vous n'avez sélectionné aucune ligne à modifier !"), _("Erreur de saisie"), wx.OK | wx.ICON_EXCLAMATION)
            dlg.ShowModal()
            dlg.Destroy()
            return
        track = self.Selection()[0]
        dlg = wx.TextEntryDialog(self, _("Saisissez le code comptable de la famille de %s :") % track.nomTitulaires, _("Modifier"))
