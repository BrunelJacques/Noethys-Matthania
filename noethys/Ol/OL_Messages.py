...
class ListView(FastObjectListView):
    ...
    def GetTracks(self):
        ...
        if ret != "ok":
            ...
            req = """SELECT IDmessage, type, IDcategorie, date_saisie, IDutilisateur, date_parution, priorite,
            afficher_accueil, afficher_liste, IDfamille, IDindividu, texte, nom, rappel, NULL
            FROM messages 
            %s;""" % condition
            DB.ExecuterReq(req,MsgBox="OL_Messages")
    ...
    def InitObjectListView(self):            
        ...
        liste_Colonnes = [
            ...
            ColumnDefn(_("Texte"), 'left', 950, "texte", typeDonnee="texte", imageGetter=GetImagePriorite),#, isSpaceFilling=True),
            ]
    ...
    def OnContextMenu(self, event):
        ...
        self.GenerationContextMenu(menuPop, titre=_("Liste des messages"))
