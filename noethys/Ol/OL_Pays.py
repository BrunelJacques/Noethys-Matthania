...
##        self.InitObjectListView()
    ...
    def InitObjectListView(self):
        ...
        for track in self.donnees :
            indexImg = imageList.Add(wx.Bitmap(Chemins.GetStaticPath("Images/Drapeaux/%s.png" % track.code_drapeau), wx.BITMAP_TYPE_PNG))            
        ...
        liste_Colonnes = [
            ...
            ColumnDefn(_("Nom du pays"), 'left', 210, "nom", typeDonnee="texte"),
            ColumnDefn(_("Nationalité"), "left", 200, "nationalite", typeDonnee="texte"),
            ]
        
        self.SetColumns(liste_Colonnes)
        self.SetEmptyListMsg(_("Aucun pays"))
...
class BarreRecherche(wx.SearchCtrl):
    def __init__(self, parent):
        ...
        self.SetDescriptiveText(_("Rechercher un pays ou une nationalité..."))
