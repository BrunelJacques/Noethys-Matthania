...
##        locale.setlocale(locale.LC_ALL, 'FR')
    ...
    def InitObjectListView(self):
        ...
        self.SetEmptyListMsg(_("Aucun reçu de règlement"))
...
##        menuPop.AppendSeparator()
        ...
        self.GenerationContextMenu(menuPop, titre=_("Liste des reçus de règlements"))
...
##        CTRL_Facturation_factures.Reedition(IDfacture)
    ...
    def Supprimer(self, event):
        if len(self.Selection()) == 0 :
            dlg = wx.MessageDialog(self, _("Vous n'avez sélectionné aucune reçu à supprimer dans la liste"), _("Erreur de saisie"), wx.OK | wx.ICON_EXCLAMATION)
            dlg.ShowModal()
            dlg.Destroy()
            return
        ...
        dlg = wx.MessageDialog(self, _("Souhaitez-vous vraiment supprimer le reçu n°%d ?") % numero, _("Suppression"), wx.YES_NO|wx.NO_DEFAULT|wx.CANCEL|wx.ICON_INFORMATION)
        ...
        dlg = wx.MessageDialog(self, _("Reçu supprimé !"), _("Suppression"), wx.OK | wx.ICON_INFORMATION)
        dlg.ShowModal()
        dlg.Destroy()
...
class BarreRecherche(wx.SearchCtrl):
    def __init__(self, parent):
        ...
        self.SetDescriptiveText(_("Rechercher un reçu de règlement..."))
