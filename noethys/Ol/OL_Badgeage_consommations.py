...
class Track(object):
    def __init__(self, donnees=None):
        ...
        self.nom_individu = "%s %s" % (self.nom, self.prenom)
...
class ListView(FastObjectListView):
    ...
    def InitObjectListView(self):
        ...
        liste_Colonnes = [
            ...
            ColumnDefn(_("Date"), 'center', 80, "date", typeDonnee="date", stringConverter=FormateDate),
            ColumnDefn(_("Individu"), 'left', 180, "nom_individu", typeDonnee="date"),
            ColumnDefn(_("Unité"), 'left', 100, "nom_unite", typeDonnee="date"),
            ColumnDefn(_("Début"), 'center', 65, "heure_debut", typeDonnee="texte", stringConverter=FormateHeure),
            ColumnDefn(_("Badgeage début"), 'center', 125, "badgeage_debut", typeDonnee="dateheure", stringConverter=FormateHorodatage),
            ColumnDefn(_("Fin"), 'center', 65, "heure_fin", typeDonnee="texte", stringConverter=FormateHeure),
            ColumnDefn(_("Badgeage fin"), 'center', 125, "badgeage_fin", typeDonnee="dateheure", stringConverter=FormateHorodatage),
        ]
    ...
    def GetParametresImpression(self):
        dictParametres = {
            "titre": _("Liste des consommations badgées"),
            "total": _("> %s consommations") % len(self.donnees),
