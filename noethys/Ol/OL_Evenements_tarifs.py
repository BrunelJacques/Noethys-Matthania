...
class ListView(FastObjectListView):
    ...
    def InitObjectListView(self):            
        ...
        liste_Colonnes = [
            ...
            ColumnDefn(_("Description"), "left", 140, "description", typeDonnee="texte"),
            ColumnDefn(_("Méthode de calcul"), 'left', 140, "methode", typeDonnee="texte", stringConverter=GetMethode),
            ColumnDefn(_("Catégories de tarifs"), "left", 140, "categories_tarifs", typeDonnee="texte", stringConverter=GetCategories),
            ]
