...
def GetListeIndividus(listview=None):
    ...
    for IDindividu, nom, prenom, travail_tel, travail_tel_sms, tel_domicile, tel_domicile_sms, tel_mobile, tel_mobile_sms in listeDonnees :
        ...
        if travail_tel != None :
            ...
            dictTemp2["categorie"] = _("Professionnel")
        ...
        if tel_domicile != None :
            ...
            dictTemp2["categorie"] = _("Domicile")
            if listview.afficher_uniquement_sms == False or (listview.afficher_uniquement_sms == True and dictTemp2["sms"] == True):
                listeListeView.append(TrackIndividu(dictTemp2))
...
class ListView(FastObjectListView):
    ...
    def InitObjectListView(self):
        ...
        if self.categorie == "individus" :
            ...
            liste_Colonnes = [
                ...
                ColumnDefn(_("Nom"), 'left', 140, "nom", typeDonnee="texte"),
                ColumnDefn(_("Prénom"), "left", 140, "prenom", typeDonnee="texte"),
                ColumnDefn(_("Catégorie"), "left", 100, "categorie", typeDonnee="texte"),
                ColumnDefn(_("Téléphone"), "left", 100, "tel", typeDonnee="texte"),
                ColumnDefn(_("SMS"), "left", 50, "sms", typeDonnee="bool", stringConverter=FormateSMS),
                ]
            ...
            liste_Colonnes = [
                ...
                ColumnDefn(_("Famille"), 'left', 180, "nomTitulaires", typeDonnee="texte"),
    ...
    def GetParametresImpression(self):
        dictParametres = {
            "titre" : _("Liste des %s") % self.categorie,
            "total" : _("> %s %s") % (len(self.donnees), self.categorie),
