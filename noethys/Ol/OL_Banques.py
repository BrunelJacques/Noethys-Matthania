...
class ListView(FastObjectListView):
    ...
    def InitObjectListView(self):            
        ...
        liste_Colonnes = [
            ColumnDefn(_("ID"), "left", 0, "IDbanque", typeDonnee="entier"),
        ...
        self.SetEmptyListMsg(_("Aucun établissement bancaire"))
    ...
    def Apercu(self, event):
        ...
        prt = UTILS_Printer.ObjectListViewPrinter(self, titre=_("Liste des établissements bancaires"), format="A", orientation=wx.LANDSCAPE)
        prt.Preview()
    ...
    def Ajouter(self, event):
        ...
        from Dlg import DLG_Saisie_banque
    ...
    def Modifier(self, event):
        ...
        if len(self.Selection()) == 0 :
            dlg = wx.MessageDialog(self, _("Vous n'avez sélectionné aucun établissement dans la liste !"), _("Erreur de saisie"), wx.OK | wx.ICON_EXCLAMATION)
            dlg.ShowModal()
            dlg.Destroy()
            return
        from Dlg import DLG_Saisie_banque
    ...
    def Supprimer(self, event):
        ...
        DB.Close()
        if nbreFamilles > 0 :
            dlg = wx.MessageDialog(self, _("Cet établissement bancaire a déjà été attribué à %d famille(s).\n\nVous ne pouvez donc pas le supprimer !") % nbreFamilles, _("Suppression impossible"), wx.OK | wx.ICON_EXCLAMATION)
            dlg.ShowModal()
            dlg.Destroy()
            return
        
        # Confirmation de suppression
        dlg = wx.MessageDialog(self, _("Souhaitez-vous vraiment supprimer cet établissement bancaire ?"), _("Suppression"), wx.YES_NO|wx.NO_DEFAULT|wx.CANCEL|wx.ICON_INFORMATION)
...
class BarreRecherche(wx.SearchCtrl):
    def __init__(self, parent):
        ...
        self.SetDescriptiveText(_("Rechercher un établissement bancaire..."))
