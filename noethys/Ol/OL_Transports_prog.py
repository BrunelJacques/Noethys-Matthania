...
class ListView(FastObjectListView):
    ...
    def InitObjectListView(self):            
        ...
        liste_Colonnes = [
            ColumnDefn(_("ID"), "left", 0, "IDtransport", typeDonnee="entier"),
            ...
            ColumnDefn(_("Au"), 'left', 80, "date_fin", typeDonnee="date", stringConverter=FormateDateCourt),
            ColumnDefn(_("Départ"), 'center', 50, "depart_heure", typeDonnee="texte", stringConverter=FormateHeure),
            ColumnDefn(_("Origine"), 'left', 110, "depart_nom", typeDonnee="texte"),
            ColumnDefn(_("Arrivée"), 'center', 50, "arrivee_heure", typeDonnee="texte", stringConverter=FormateHeure),
            ColumnDefn(_("Destination"), 'left', 110, "arrivee_nom", typeDonnee="texte"),
            ]
        ...
        self.SetEmptyListMsg(_("Aucun transport programmé"))
    ...
    def Impression(self, mode="preview"):
        ...
        prt = UTILS_Printer.ObjectListViewPrinter(self, titre=_("Liste des transports programmés"), format="A", orientation=wx.PORTRAIT)
        if mode == "preview" :
            prt.Preview()
        else:
            prt.Print()
    ...
    def ExportTexte(self, event):
        ...
        UTILS_Export.ExportTexte(self, titre=_("Liste des transports programmés"))
        
    def ExportExcel(self, event):
        from Utils import UTILS_Export
        UTILS_Export.ExportExcel(self, titre=_("Liste des transports programmés"))
    ...
    def Supprimer(self, event):
        ...
        if len(self.Selection()) == 0 :
            ...
            return
        track = self.Selection()[0]
        dlg = wx.MessageDialog(self, _("Souhaitez-vous vraiment supprimer ce transport programmé ?"), _("Suppression"), wx.YES_NO|wx.NO_DEFAULT|wx.CANCEL|wx.ICON_INFORMATION)
