...
class Track(object):
    def __init__(self, donnees):
        ...
        if self.heure_min != None and self.heure_max != None :
            self.tranche_horaire = "%s-%s" % (self.heure_min.replace(":", "h"), self.heure_max.replace(":", "h"))
        else :
            self.tranche_horaire = ""
...
class ListView(FastObjectListView):
    ...
    def InitObjectListView(self):            
        ...
        liste_Colonnes = [
            ...
            ColumnDefn(_("Abrégé"), "left", 60, "abrege", typeDonnee="texte"),
            ColumnDefn(_("Seuil alerte"), "left", 70, "seuil_alerte", typeDonnee="texte"),
            ColumnDefn(_("Plage horaire"), "left", 90, "tranche_horaire", typeDonnee="texte"),
            ColumnDefn(_("Période de validité"), "left", 170, "periode_validite", typeDonnee="texte"),
            ]
        
        self.SetColumns(liste_Colonnes)
        self.SetEmptyListMsg(_("Aucune unité de remplissage"))
    ...
    def Apercu(self, event):
        ...
        prt = UTILS_Printer.ObjectListViewPrinter(self, titre=_("Liste des unités de remplissage"), format="A", orientation=wx.PORTRAIT)
        prt.Preview()
...
##            dlg = wx.MessageDialog(self, _("Cette unité de remplissage a déjà été attribuée à %d remplissage(s).\n\nVous ne pouvez donc pas la supprimer !") % nbreRemplissages, _("Suppression impossible"), wx.OK | wx.ICON_EXCLAMATION)
##            dlg.ShowModal()
##            dlg.Destroy()
##            return

        # Confirmation de suppression
        dlg = wx.MessageDialog(self, _("Souhaitez-vous vraiment supprimer cette unité de remplissage ?"), _("Suppression"), wx.YES_NO|wx.NO_DEFAULT|wx.CANCEL|wx.ICON_INFORMATION)
...
class BarreRecherche(wx.SearchCtrl):
    def __init__(self, parent):
        ...
        self.SetDescriptiveText(_("Rechercher une unité de remplissage..."))
