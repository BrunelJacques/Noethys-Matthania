...
class ListView(FastObjectListView):
    ...
    def Supprimer(self, event):
        ...
        # Vérifie que cette perception n'a pas déjà attribué à une famille
        DB = GestionDB.DB()
