...
class Track(object):
    def __init__(self, IDfamille, autorisation_cafpro, dictQuotient=None):
        ...
        if self.autorisation_cafpro == 1 :
            self.autorisation_cafpro_str = _("Oui")
        else :
...
class ListView(FastObjectListView):
    ...
    def InitObjectListView(self):            
        ...
        liste_Colonnes = [
            ...
            ColumnDefn(_("Accès CAFPRO"), "center", 100, "autorisation_cafpro_str", typeDonnee="texte"),
            ColumnDefn(_("QF"), "center", 80, "quotient", typeDonnee="entier"),
            ColumnDefn(_("Revenu"), 'center', 80, "revenu", typeDonnee="montant", stringConverter=FormateMontant),
