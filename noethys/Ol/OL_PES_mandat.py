...
class ListView(FastObjectListView):
    ...
    def InitObjectListView(self):            
        ...
        liste_Colonnes = [
            ...
            ColumnDefn(_("Date Prélèv."), 'left', 80, "datePrelevement", typeDonnee="date", stringConverter=FormateDateCourt),
            ColumnDefn(_("Nom bordereau"), 'left', 150, "nomLot", typeDonnee="texte"),
...
##        self.SetSortColumn(self.columns[self.numColonneTri])
    ...
    def Impression(self):
        ...
        txtIntro = _("Liste des prélèvements")
        # Récupère le total
        total = 0.0
    ...
    def ExportTexte(self, event=None):
        ...
        UTILS_Export.ExportTexte(self, titre=_("Liste des prélèvements PES ORMC"))
        
    def ExportExcel(self, event=None):
        from Utils import UTILS_Export
        UTILS_Export.ExportExcel(self, titre=_("Liste des prélèvements PES ORMC"))
