...
class ListView(FastObjectListView):
    ...
    def InitObjectListView(self):            
        ...
        self.SetEmptyListMsg(_("Aucune catégorie de produits"))
    ...
    def Apercu(self, event):
        ...
        prt = UTILS_Printer.ObjectListViewPrinter(self, titre=_("Liste des catégories de produits"), format="A", orientation=wx.PORTRAIT)
        prt.Preview()
    ...
    def ExportTexte(self, event):
        ...
        UTILS_Export.ExportTexte(self, titre=_("Liste des catégories de produits"))

    def ExportExcel(self, event):
        from Utils import UTILS_Export
        UTILS_Export.ExportExcel(self, titre=_("Liste des catégories de produits"))
    ...
    def Supprimer(self, event):
        ...
        if nbreProduitsRattaches > 0 :
            dlg = wx.MessageDialog(self, _("Cette catégorie a déjà été attribuée à %d produit(s).\n\nVous ne pouvez donc pas la supprimer !") % nbreProduitsRattaches, _("Suppression impossible"), wx.OK | wx.ICON_EXCLAMATION)
            dlg.ShowModal()
            dlg.Destroy()
            return
