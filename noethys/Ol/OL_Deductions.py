...
class ListView(FastObjectListView):
    ...
    def InitObjectListView(self):            
        ...
        liste_Colonnes = [
            ...
            ColumnDefn(_("Montant"), 'centre', 90, "montant", typeDonnee="montant", stringConverter=FormateMontant),
            ColumnDefn(_("Label"), 'left', 300, "label", typeDonnee="texte"),
            ]
    ...
    def OnContextMenu(self, event):
        ...
        self.GenerationContextMenu(menuPop, titre=_("Liste des déductions"))
