    ...
    def __init__(self, parent, donnees=[], liste_ventilation=[]):
        ...
        for dict_ventilation in self.liste_ventilation:
            ...
            if dict_ventilation["IDfacture"] != None:
                ...
                if IDprefixe != None:
                    numeroStr = "%s-%06d" % (prefixe, num_facture)
                else:
        ...
        if len(dict_factures) > 0:
            ...
            self.texte_factures = ", ".join(liste_temp)
        ...
        if len(dict_prestations) > 0:
            ...
            self.texte_prestations = ", ".join(liste_temp)
...
class ListView(FastObjectListView):
    ...
    def InitObjectListView(self):            
        ...
        liste_Colonnes = [
            ...
            ColumnDefn(_("Mode"), 'left', 90, "nom_mode", typeDonnee="texte"),
            ColumnDefn(_("Emetteur"), 'left', 110, "nom_emetteur", typeDonnee="texte"),
            ...
            ColumnDefn(_("Ventilé"), 'right', 80, "montant_ventilation", typeDonnee="montant", stringConverter=FormateMontant, imageGetter=GetImageVentilation),
            ColumnDefn(_("Date dépôt"), 'left', 75, "date_depot", typeDonnee="date", stringConverter=FormateDateCourt),
            ColumnDefn(_("Nom dépôt"), 'left', 110, "nom_depot", typeDonnee="texte"),
            ColumnDefn(_("Factures associées"), 'left', 130, "texte_factures", typeDonnee="texte"),
            ColumnDefn(_("Prestations associées"), 'left', 250, "texte_prestations", typeDonnee="texte"),
            ]
