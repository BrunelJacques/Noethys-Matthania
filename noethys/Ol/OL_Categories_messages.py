...
import GestionDB
from Dlg import DLG_Saisie_message_categorie
...
class ListView(FastObjectListView):
    ...
    def InitObjectListView(self):            
        ...
        liste_Colonnes = [
            ...
            ColumnDefn(_("Nbre messages"), 'center', 100, "nbreMessages", typeDonnee="entier"),
            ]
    ...
    def Apercu(self, event):
        ...
        prt = UTILS_Printer.ObjectListViewPrinter(self, titre=_("Liste des catégories de messages"), format="A", orientation=wx.PORTRAIT)
        prt.Preview()
    ...
    def Supprimer(self, event):
        ...
        if nbreMessages > 0 :
            dlg = wx.MessageDialog(self, _("Un ou plusieurs messages sont rattachés à cette catégorie. Vous ne pouvez donc pas la supprimer !"), _("Erreur de saisie"), wx.OK | wx.ICON_EXCLAMATION)
            dlg.ShowModal()
            dlg.Destroy()
            return
...
class BarreRecherche(wx.SearchCtrl):
    def __init__(self, parent):
        ...
        self.SetDescriptiveText(_("Rechercher une catégorie..."))
