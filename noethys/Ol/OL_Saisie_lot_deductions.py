...
class ListView(FastObjectListView):
    ...
    def InitObjectListView(self):
        ...
        self.SetColumns([
            ...
            ColumnDefn(_("Total"), "right", 80, "total", typeDonnee="montant", stringConverter=FormateMontant),
            ColumnDefn(_("Payé"), "right", 80, "paye", typeDonnee="montant", stringConverter=FormateMontant),
