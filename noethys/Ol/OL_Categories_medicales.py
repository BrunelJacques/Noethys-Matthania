...
class ListView(FastObjectListView):
    ...
    def InitObjectListView(self):            
        ...
        liste_Colonnes = [
            ...
            ColumnDefn(_("Nbre d'informations"), "left", 110, "nbreInformations", typeDonnee="entier"),
            ]
        
        self.SetColumns(liste_Colonnes)
        self.SetEmptyListMsg(_("Aucune catégorie médicale"))
    ...
    def Apercu(self, event):
        ...
        prt = UTILS_Printer.ObjectListViewPrinter(self, titre=_("Liste des catégories médicales"), format="A", orientation=wx.PORTRAIT)
        prt.Preview()
    ...
    def Ajouter(self, event):
        ...
        dlg = wx.TextEntryDialog(self, _("Saisissez le nom de la nouvelle catégorie :"), _("Saisie d'une catégorie médicale"), "")
    ...
    def Modifier(self, event):
        ...
        dlg = wx.TextEntryDialog(self, _("Modifiez le nom de la catégorie :"), _("Modification d'une catégorie"), nom)
        if dlg.ShowModal() == wx.ID_OK:
            nom = dlg.GetValue()
            if nom == "":
                dlg = wx.MessageDialog(self, _("Le nom que vous avez saisi n'est pas valide."), _("Erreur de saisie"), wx.OK | wx.ICON_EXCLAMATION)
    ...
    def Supprimer(self, event):
        ...
        if self.Selection()[0].nbreInformations > 0 :
            dlg = wx.MessageDialog(self, _("Il est impossible de supprimer une catégorie déjà assigné à une ou plusieurs informations médicales !"), _("Suppression impossible"), wx.OK | wx.ICON_INFORMATION)
            dlg.ShowModal()
            dlg.Destroy()
            return
