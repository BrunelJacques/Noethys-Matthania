...
class ListView(FastObjectListView):
    def __init__(self, *args, **kwds):
        ...
        self.categorieSingulier = kwds.pop("categorieSingulier", "") # "compagnie aérienne"
        self.categoriePluriel = kwds.pop("categoriePluriel", "") # "compagnies aériennes"
    ...
    def InitObjectListView(self):            
        ...
        liste_Colonnes = [
            ColumnDefn(_("ID"), "left", 0, "IDcompagnie", typeDonnee="entier"),
            ColumnDefn(_("Nom"), 'left', 200, "nom", typeDonnee="texte"),
            ColumnDefn(_("Rue"), "left", 140, "rue", typeDonnee="texte"),
            ColumnDefn(_("C.P."), "left", 45, "cp", typeDonnee="texte"),
            ColumnDefn(_("Ville"), "left", 110, "ville", typeDonnee="texte"),
            ColumnDefn(_("Tél."), "left", 100, "tel", typeDonnee="texte"),
            ColumnDefn(_("Fax."), "left", 100, "fax", typeDonnee="texte"),
            ColumnDefn(_("Email"), "left", 100, "mail", typeDonnee="texte"),
            ]
        
        self.SetColumns(liste_Colonnes)
        self.SetEmptyListMsg(_("Aucune %s") % self.categorieSingulier)
    ...
    def Ajouter(self, event):
        ...
        dlg = DLG_Saisie_compagnie.Dialog(self, titre=_("Saisie d'une %s") % self.categorieSingulier)
    ...
    def Modifier(self, event):
        ...
        if len(self.Selection()) == 0 :
            dlg = wx.MessageDialog(self, _("Vous n'avez sélectionné aucune compagnie à modifier dans la liste !"), _("Erreur de saisie"), wx.OK | wx.ICON_EXCLAMATION)
            dlg.ShowModal()
            dlg.Destroy()
            return
        from Dlg import DLG_Saisie_compagnie
        IDcompagnie = self.Selection()[0].IDcompagnie
        dlg = DLG_Saisie_compagnie.Dialog(self, titre=_("Modification d'une %s") % self.categorieSingulier)
    ...
    def Supprimer(self, event):
        ...
        if len(self.Selection()) == 0 :
            dlg = wx.MessageDialog(self, _("Vous n'avez sélectionné aucune compagnie dans la liste !"), _("Erreur de saisie"), wx.OK | wx.ICON_EXCLAMATION)
            dlg.ShowModal()
            dlg.Destroy()
            return
        IDcompagnie = self.Selection()[0].IDcompagnie
...
##            return
        ...
        dlg = wx.MessageDialog(self, _("Souhaitez-vous vraiment supprimer cette compagnie ?"), _("Suppression"), wx.YES_NO|wx.NO_DEFAULT|wx.CANCEL|wx.ICON_INFORMATION)
...
class BarreRecherche(wx.SearchCtrl):
    def __init__(self, parent):
        ...
        self.SetDescriptiveText(_("Rechercher une compagnie..."))
...
class MyFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.myOlv = ListView(panel, id=-1, categorie="avion", categorieSingulier=_("compagnie aérienne"), categoriePluriel=_("compagnies aériennes"), name="OL_test", style=wx.LC_REPORT|wx.SUNKEN_BORDER|wx.LC_SINGLE_SEL|wx.LC_HRULES|wx.LC_VRULES)
        self.myOlv.MAJ() 
