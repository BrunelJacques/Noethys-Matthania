...
class ListView(FastObjectListView):
    ...
    def InitObjectListView(self):            
        ...
        liste_Colonnes = [
            ...
            ColumnDefn(_("Numéro"), 'left', 120, "numero", typeDonnee="texte"),
            ColumnDefn(_("Nom"), 'left', 200, "nom", typeDonnee="texte", isSpaceFilling=True),
            ColumnDefn(_("Solde du jour"), "right", 100, "solde_jour", typeDonnee="montant", stringConverter=FormateMontant),
            ColumnDefn(_("Solde pointé"), "right", 100, "solde_pointe", typeDonnee="montant", stringConverter=FormateMontant),
            ColumnDefn(_("Solde final"), "right", 100, "solde", typeDonnee="montant", stringConverter=FormateMontant),
            ]
    ...
    def OnContextMenu(self, event):
        ...
        # Item Ajouter
        item = wx.MenuItem(menuPop, 10, _("Accéder au compte"))
    ...
    def Apercu(self, event):
        ...
        prt = UTILS_Printer.ObjectListViewPrinter(self, titre=_("Liste des comptes"), format="A", orientation=wx.PORTRAIT)
        prt.Preview()
    ...
    def ExportTexte(self, event):
        ...
        UTILS_Export.ExportTexte(self, titre=_("Liste des comptes"))
        
    def ExportExcel(self, event):
        from Utils import UTILS_Export
        UTILS_Export.ExportExcel(self, titre=_("Liste des comptes"))
...
class ListviewAvecFooter(PanelAvecFooter):
    def __init__(self, parent, kwargs={}):
        dictColonnes = {
            "nom" : {"mode" : "nombre", "singulier" : _("compte"), "pluriel" : _("comptes"), "alignement" : wx.ALIGN_LEFT},
            "solde" : {"mode" : "total"},
