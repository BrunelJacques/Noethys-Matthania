...
class ListView(FastObjectListView):
    ...
    def InitObjectListView(self):            
        ...
        liste_Colonnes = [
            ...
            ColumnDefn(_("Famille"), 'left', 250, "nomTitulaires", typeDonnee="texte"),
            ...
            ColumnDefn(_("Secteur"), "left", 100, "secteur", typeDonnee="texte"),
        ...
        for titre, exemple, code in listeChamps :
            ...
            for x in range(1, nbre+1):
                ...
                code2 = code2.replace("{", "").replace("}", "").replace(u"_x_", "_%d_" % x)
                titre2 = titre2.replace(u"n°x", "n°%d" % x)
    ...
    def OuvrirFicheFamille(self, event):
        ...
        if len(self.Selection()) == 0 :
            dlg = wx.MessageDialog(self, _("Vous n'avez sélectionné aucune fiche famille à ouvrir !"), _("Erreur"), wx.OK | wx.ICON_EXCLAMATION)
            dlg.ShowModal()
            dlg.Destroy()
            return
