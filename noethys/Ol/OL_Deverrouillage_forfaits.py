...
class ListView(FastObjectListView):
    ...
    def InitObjectListView(self):            
        ...
        liste_Colonnes = [
            ColumnDefn(_("ID"), "left", 50, "IDconso"),
            ColumnDefn(_("Date"), 'left', 150, "date", stringConverter=FormateDate),
            ColumnDefn(_("Individu"), "left", 180, "individu"),
            ColumnDefn(_("Activité"), "left", 160, "nomActivite"),
            ColumnDefn(_("Unité"), "left", 160, "nomUnite"),
            ]
    ...
    def Deverrouillage(self):
        ...
        if nbreCoches == 0 :
            dlg = wx.MessageDialog(self, _("Vous n'avez coché aucune consommation à déverrouiller !"), _("Erreur de saisie"), wx.OK | wx.ICON_EXCLAMATION)
            dlg.ShowModal()
            dlg.Destroy()
            return

        # Demande de confirmation
        dlg = wx.MessageDialog(self, _("Souhaitez-vous vraiment déverrouiller les %d consommations cochées ?") % nbreCoches, _("Confirmation"), wx.YES_NO|wx.NO_DEFAULT|wx.CANCEL|wx.ICON_QUESTION)
