...
class Track(object):
    def __init__(self, donnees, index=None):
        ...
        self.detail_reglement = "%s du %s - %s" % (self.mode_reglement, self.date_reglement, self.montant_reglement)
...
class ListView(FastObjectListView):
    ...
    def InitObjectListView(self):                
        ...
        liste_Colonnes = [
            ColumnDefn(_("Index"), "left", 0, "index", typeDonnee="entier"),
            ColumnDefn(_("Famille"), "left", 240, "nomTitulaires", typeDonnee="texte"),
            ColumnDefn(_("Email"), 'left', 180, "adresse", typeDonnee="texte"),
            ColumnDefn(_("Règlement"), "left", 200, "detail_reglement", typeDonnee="texte"),
            ]
    ...
    def Apercu(self, event=None):
        ...
        prt = UTILS_Printer.ObjectListViewPrinter(self, titre=_("Liste des avis de dépôts"), format="A", orientation=wx.PORTRAIT)
        prt.Preview()
    ...
    def ExportTexte(self, event=None):
        ...
        UTILS_Export.ExportTexte(self, titre=_("Liste des avis de dépôts"))
        
    def ExportExcel(self, event=None):
        from Utils import UTILS_Export
        UTILS_Export.ExportExcel(self, titre=_("Liste des avis de dépôts"))
...
class MyFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        listeDonnees = [
            {"IDfamille" : 10, "nomTitulaires": "DUPOND", "adresse" : "dupond@test.test", "pieces" : [], "champs" : {"{DATE_REGLEMENT}" : "01/01/2011", "{MODE_REGLEMENT}" : _("Chèque"), "{MONTANT_REGLEMENT}" : "10.00"} }
            ]
