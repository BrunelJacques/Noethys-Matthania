...
class Track(object):
    def __init__(self, donnees, dictTitulaires):
        ...
        if self.public == "famille" : 
            self.nomPublic = _("Familiale")
        else :
            self.nomPublic = _("Individuelle")
...
class ListView(FastObjectListView):
    ...
    def InitObjectListView(self):            
        ...
        liste_Colonnes = [
            ColumnDefn(_("IDPiece"), "left", 0, "IDpiece", typeDonnee="entier"),
            ColumnDefn(_("Individu"), 'left', 170, "individu_nom_complet", typeDonnee="texte"),
            ColumnDefn(_("Famille"), 'left', 220, "nom_titulaires", typeDonnee="texte"),
            ...
            ColumnDefn(_("Type de pièce"), "left", 100, "nomPublic", typeDonnee="texte"),
            ]

        # Intégration le filtre inscrits/Présents
        if len(self.donnees) > 0 :
            if self.donnees[0].public == "famille" :
                liste_Colonnes.append(ColumnDefn(_("IDfamille"), "left", 40, "IDfamille", typeDonnee="entier"))
            else :
                liste_Colonnes.append(ColumnDefn(_("IDindividu"), "left", 40, "IDindividu", typeDonnee="entier"))
    ...
    def GetParametresImpression(self):
        if len(self.donnees) > 0 :
            intro = _("Pièce sélectionnée : %s") % self.donnees[0].nomPiece
        else :
            intro = ""
        total = _("Un total de %d pièces") % len(self.donnees)
