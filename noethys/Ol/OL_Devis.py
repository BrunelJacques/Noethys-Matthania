...
##        locale.setlocale(locale.LC_ALL, 'FR')
    ...
    def InitObjectListView(self):
        ...
        self.SetEmptyListMsg(_("Aucun devis"))
    ...
    def OnContextMenu(self, event):
        ...
        self.GenerationContextMenu(menuPop, titre=_("Liste des devis"))
    ...
    def Supprimer(self, event):
        ...
        if len(self.Selection()) == 0 :
            dlg = wx.MessageDialog(self, _("Vous n'avez sélectionné aucun devis à supprimer dans la liste !"), _("Erreur de saisie"), wx.OK | wx.ICON_EXCLAMATION)
            dlg.ShowModal()
            dlg.Destroy()
            return
        ...
        dlg = wx.MessageDialog(self, _("Souhaitez-vous vraiment supprimer le devis n°%d ?") % numero, _("Suppression"), wx.YES_NO|wx.NO_DEFAULT|wx.CANCEL|wx.ICON_INFORMATION)
        ...
        dlg = wx.MessageDialog(self, _("Devis supprimé !"), _("Suppression"), wx.OK | wx.ICON_INFORMATION)
        dlg.ShowModal()
        dlg.Destroy()
