...
class ListView(FastObjectListView):
    ...
    def InitObjectListView(self):            
        ...
        dict_colonnes = {
            ...
            "heure_debut": ColumnDefn(_("Début"), 'center', 60, "heure_debut", typeDonnee="texte", stringConverter=FormateHeure),
            ...
            "capacite_max": ColumnDefn(_("Capacité max."), 'center', 100, "capacite_max", typeDonnee="entier"),
            }
    ...
    def Impression(self, mode="preview"):
        ...
        prt = UTILS_Printer.ObjectListViewPrinter(self, titre=_("Liste des évènements"), format="A", orientation=wx.PORTRAIT)
        if mode == "preview" :
            prt.Preview()
        else:
            prt.Print()
    ...
    def ExportTexte(self, event):
        ...
        UTILS_Export.ExportTexte(self, titre=_("Liste des évènements"))
        
    def ExportExcel(self, event):
        from Utils import UTILS_Export
        UTILS_Export.ExportExcel(self, titre=_("Liste des évènements"))
    ...
    def Modifier(self, event):
        ...
        if nbre_conso > 0 :
            dlg = wx.MessageDialog(self, _("Cet évènement est déjà associé à %d consommations.\n\nSouhaitez-vous tout de même le modifier ?") % nbre_conso, _("Modification"), wx.YES_NO | wx.NO_DEFAULT | wx.CANCEL | wx.ICON_INFORMATION)
    ...
    def Supprimer(self, event):
        ...
        nbre_conso = self.GetNbreConsoAssociees(track_evenement)
        if nbre_conso > 0 :
            dlg = wx.MessageDialog(self, _("Suppression interdite.\n\nVous ne pouvez pas supprimer cet évènement car %d consommations y sont déjà associées !") % nbre_conso, _("Suppression"), wx.OK | wx.ICON_ERROR)
            dlg.ShowModal()
            dlg.Destroy()
            return
