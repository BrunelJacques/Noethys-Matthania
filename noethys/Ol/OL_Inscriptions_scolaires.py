...
class ListView(FastObjectListView):
    ...
    def InitObjectListView(self):
        ...
        liste_Colonnes = [
            ...
            ColumnDefn(_("Au"), "left", 72, "date_fin", typeDonnee="date", stringConverter=FormateDate),
            ]
        
        self.SetColumns(liste_Colonnes)
        self.SetEmptyListMsg(_("Aucun inscrit"))
    ...
    def Impression(self, mode="preview"):
        ...
        intro = _("> %s - %d inscrits") % (dictInfosClasse["periode"], len(self.donnees))
    ...
    def ExportTexte(self, event=None):
        ...
        UTILS_Export.ExportTexte(self, titre=_("Liste des inscrits"))
        
    def ExportExcel(self, event=None):
        from Utils import UTILS_Export
        UTILS_Export.ExportExcel(self, titre=_("Liste des inscrits"))
    ...
    def GetInfosClasse(self, IDclasse=None):
        ...
        periode = _("Du %s au %s") % (DateEngFr(str(date_debut)), DateEngFr(str(date_fin)))
        nomComplet = "%s (%s)" % (nom, periode)
    ...
    def Modifier(self, event=None):
        ...
        dlg.SetTitle(_("Modification d'une étape de la scolarité de %s %s") % (prenom, nom))
        dlg.SetDateDebut(date_debut)
        dlg.SetDateFin(date_fin)
    ...
    def Supprimer(self, event=None):
        ...
        dlg = wx.MessageDialog(self, _("Souhaitez-vous vraiment supprimer l'inscription scolaire de %s %s dans cette classe ?") % (prenom, nom), _("Suppression"), wx.YES_NO|wx.NO_DEFAULT|wx.CANCEL|wx.ICON_EXCLAMATION)
        if dlg.ShowModal() == wx.ID_YES :
            ...
            UTILS_Historique.InsertActions([{
                ...
                "IDfamille" : None,
                "IDcategorie" : 32, 
                "action" : _("Inscription scolaire du %s au %s. Ecole : '%s'. Classe : '%s'. Niveau : '%s'") % (DateEngFr(str(date_debut)), DateEngFr(str(date_fin)), nomEcole, nomClasse, abregeNiveau)
                },])
...
class BarreRecherche(wx.SearchCtrl):
    def __init__(self, parent):
        ...
        self.SetDescriptiveText(_("Rechercher un individu..."))
