...
class ListView(FastObjectListView):
    ...
    def InitObjectListView(self):
        ...
        liste_Colonnes = [
            ColumnDefn(_("Prestation"), 'left', 250, "label", typeDonnee="texte", isSpaceFilling=True, isEditable=False),
            ColumnDefn(_("Commentaire"), "left", 150, "commentaire", typeDonnee="texte", isEditable=True),
            ColumnDefn(_("Activité"), "left", 120, "nomActivite", typeDonnee="texte", isEditable=False),
            ColumnDefn(_("Qté"), "left", 50, "nombre", typeDonnee="entier", isEditable=False),
            ColumnDefn(_("Total"), "left", 90, "montant", typeDonnee="montant", stringConverter=FormateMontant, isEditable=False),
            ]
