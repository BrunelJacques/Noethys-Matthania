...
class ListView(FastObjectListView):
    ...
    def InitObjectListView(self):            
        ...
        liste_Colonnes = [
            ...
            ColumnDefn(_("Date de début"), 'left', 165, "date_debut", typeDonnee="date", stringConverter=FormateDate),
            ColumnDefn(_("Date de fin"), 'left', 165, "date_fin", typeDonnee="date", stringConverter=FormateDate),
            ColumnDefn(_("Type de quotient"), 'left', 120, "nom_type_quotient", typeDonnee="texte"),
            ColumnDefn(_("Quotient familial"), 'center', 110, "quotient", typeDonnee="entier"),
            ColumnDefn(_("Revenu"), 'center', 100, "revenu", typeDonnee="montant", stringConverter=FormateMontant),
            ColumnDefn(_("Observations"), 'left', 260, "observations", typeDonnee="texte"),
            ]
        
        self.rowFormatter = rowFormatter
        self.SetColumns(liste_Colonnes)
        self.SetEmptyListMsg(_("Aucun quotient familial/revenu"))
    ...
    def Apercu(self, event):
        ...
        prt = UTILS_Printer.ObjectListViewPrinter(self, titre=_("Liste des quotients familiaux / revenus"), format="A", orientation=wx.PORTRAIT)
        prt.Preview()
    ...
    def Modifier(self, event):
        ...
        if len(self.Selection()) == 0 :
            dlg = wx.MessageDialog(self, _("Vous n'avez sélectionné aucun quotient/revenu à modifier dans la liste"), _("Erreur de saisie"), wx.OK | wx.ICON_EXCLAMATION)
            dlg.ShowModal()
            dlg.Destroy()
            return
    ...
    def Supprimer(self, event):
        ...
        if len(self.Selection()) == 0 :
            dlg = wx.MessageDialog(self, _("Vous n'avez sélectionné aucun quotient familial/revenu à supprimer dans la liste !"), _("Erreur de saisie"), wx.OK | wx.ICON_EXCLAMATION)
            dlg.ShowModal()
            dlg.Destroy()
            return
        dlg = wx.MessageDialog(self, _("Souhaitez-vous vraiment supprimer ce quotient familial/revenu ?"), _("Suppression"), wx.YES_NO|wx.NO_DEFAULT|wx.CANCEL|wx.ICON_INFORMATION)
