...
class Track(object):
    def __init__(self, parent, donnees):
        ...
        if self.IDfamille != None :
            ...
            self.titulaires = _("Aucun titulaire")
...
class ListView(FastObjectListView):
    ...
    def GetTracks(self):
        ...
        req = """
        SELECT prestations.IDprestation, prestations.IDcompte_payeur, prestations.date, prestations.montant, IDfamille
        FROM prestations
        ...
        for IDprestation, IDcompte_payeur, date, montant, IDfamille in listePrestations :
            ...
            if impaye > decimal.Decimal(0.0) :
                if (IDfamille in dictResultats) == False :
                    dictResultats[IDfamille] = {"IDfamille" : IDfamille, "IDcompte_payeur" : IDcompte_payeur, "prestations" : [], "quantite" : 0, "paye" : decimal.Decimal(0.0), "impaye" : decimal.Decimal(0.0) }            
                
                dictResultats[IDfamille]["prestations"].append({"IDprestation" : IDprestation, "montant" : montant, "paye" : paye, "impaye" : impaye })
    ...
    def InitObjectListView(self):
        ...
        self.SetColumns([
            ...
            ColumnDefn(_("Famille"), "left", 250, "titulaires", typeDonnee="texte"),
            ColumnDefn(_("Nbre Prest."), "center", 80, "quantite", typeDonnee="entier"),
            ColumnDefn(_("Impayés"), "right", 80, "impaye", typeDonnee="montant", stringConverter=FormateMontant),
        ])
        self.CreateCheckStateColumn(0)
        self.SetSortColumn(self.columns[2])
        self.SetEmptyListMsg(_("Aucun impayé"))
    ...
    def ExportTexte(self, event):
        ...
        UTILS_Export.ExportTexte(self, titre=_("Liste des comptes à solder"))
        
    def ExportExcel(self, event):
        from Utils import UTILS_Export
        UTILS_Export.ExportExcel(self, titre=_("Liste des comptes à solder"))
...
class ListviewAvecFooter(PanelAvecFooter):
    def __init__(self, parent, kwargs={}):
        dictColonnes = {
            "titulaires" : {"mode" : "nombre", "singulier" : _("famille"), "pluriel" : _("familles"), "alignement" : wx.ALIGN_CENTER},
            "quantite" : {"mode" : "total"},
            "impaye" : {"mode" : "total"},
            }
