...
class ListView(FastObjectListView):
    ...
    def InitObjectListView(self):            
        ...
        liste_Colonnes = [
            ColumnDefn(_("ID"), "left", 0, "IDunite"),
            ColumnDefn(_("Ordre"), "left", 70, "ordre"),
            ColumnDefn(_("Nom"), 'left', 300, "nom", isSpaceFilling=True),
            ColumnDefn(_("Unités principales associées"), "left", 220, "texte_unites_principales"),
            ColumnDefn(_("Unités secondaires associées"), "left", 220, "texte_unites_secondaires"),
            ]

        self.SetColumns(liste_Colonnes)
        self.SetEmptyListMsg(_("Aucune unité"))
    ...
    def Apercu(self, event):
        ...
        prt = UTILS_Printer.ObjectListViewPrinter(self, titre=_("Liste des unités de réservations"), format="A", orientation=wx.PORTRAIT)
        prt.Preview()
    ...
    def Supprimer(self, event):
        ...
        dlg = wx.MessageDialog(self, _("Souhaitez-vous vraiment supprimer cette unité de réservation ?"), _("Suppression"), wx.YES_NO|wx.NO_DEFAULT|wx.CANCEL|wx.ICON_INFORMATION)
