...
class ListView(FastObjectListView):
    ...
    def InitObjectListView(self):
        ...
        self.SetColumns([
            ...
            ColumnDefn(_("Famille"), "left", 260, "titulaires", typeDonnee="texte"),
            ColumnDefn(_("Nbre Conso."), "center", 80, "nbre_conso", typeDonnee="entier", stringConverter=Formate_nbre),
            ColumnDefn(_("Nbre Prest."), "center", 80, "nbre_prestations", typeDonnee="entier", stringConverter=Formate_nbre),
