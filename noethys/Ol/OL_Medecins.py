...
class ListView(FastObjectListView):
    ...
    def InitObjectListView(self):            
        ...
        liste_Colonnes = [
            ColumnDefn(_("ID"), "left", 0, "IDmedecin", typeDonnee="entier"),
            ...
            ColumnDefn(_("Tél. Cabinet"), "left", 100, "tel_cabinet", typeDonnee="texte"),
            ColumnDefn(_("Tél. Mobile"), "left", 100, "tel_mobile", typeDonnee="texte"),
            ]
        
        self.SetColumns(liste_Colonnes)
        self.SetEmptyListMsg(_("Aucun médecin"))
    ...
    def Apercu(self, event):
        ...
        prt = UTILS_Printer.ObjectListViewPrinter(self, titre=_("Liste des médecins"), format="A", orientation=wx.LANDSCAPE)
        prt.Preview()
    ...
    def Supprimer(self, event):
        ...
        DB.Close()
        if nbreIndividus > 0 :
            dlg = wx.MessageDialog(self, _("Ce médecin a déjà été attribué à %d individu(s).\n\nVous ne pouvez donc pas le supprimer !") % nbreIndividus, _("Suppression impossible"), wx.OK | wx.ICON_EXCLAMATION)
            dlg.ShowModal()
            dlg.Destroy()
            return
        
        # Confirmation de suppression
        dlg = wx.MessageDialog(self, _("Souhaitez-vous vraiment supprimer ce médecin ?"), _("Suppression"), wx.YES_NO|wx.NO_DEFAULT|wx.CANCEL|wx.ICON_INFORMATION)
...
class BarreRecherche(wx.SearchCtrl):
    def __init__(self, parent):
        ...
        self.SetDescriptiveText(_("Rechercher un médecin..."))
