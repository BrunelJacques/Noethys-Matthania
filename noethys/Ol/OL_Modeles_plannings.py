...
class ListView(FastObjectListView):
    ...
    def GetTracks(self):
        ...
        LEFT JOIN activites ON activites.IDactivite = modeles_plannings.IDactivite
        ;"""
    ...
    def InitObjectListView(self):            
        ...
        liste_Colonnes = [
            ...
            ColumnDefn(_("Nom"), 'left', 70, "nom", typeDonnee="texte", isSpaceFilling=True),
            ColumnDefn(_("Activite"), 'left', 200, "nomActivite", typeDonnee="texte"),
            ]
    ...
    def Apercu(self, event):
        ...
        prt = UTILS_Printer.ObjectListViewPrinter(self, titre=_("Liste des modèles de plannings"), format="A", orientation=wx.PORTRAIT)
        prt.Preview()
    ...
    def ExportTexte(self, event):
        ...
        UTILS_Export.ExportTexte(self, titre=_("Liste des modèles de plannings"))
        
    def ExportExcel(self, event):
        from Utils import UTILS_Export
        UTILS_Export.ExportExcel(self, titre=_("Liste des modèles de plannings"))
    ...
    def Modifier(self, event):
        ...
        from Dlg import DLG_Saisie_modele_planning
        dlg = DLG_Saisie_modele_planning.Dialog(self, IDmodele=track.IDmodele, IDactivite=track.IDactivite)
        if dlg.ShowModal() == wx.ID_OK:
            IDmodele = dlg.GetIDmodele() 
            self.MAJ(IDmodele)
        dlg.Destroy()
    ...
    def Supprimer(self, event):
        ...
        dlg = wx.MessageDialog(self, _("Souhaitez-vous vraiment supprimer ce modèle de planning ?"), _("Suppression"), wx.YES_NO|wx.NO_DEFAULT|wx.CANCEL|wx.ICON_QUESTION)
