...
##            return self.imgRouge
        ...
        self.SetColumns([
            ...
            ColumnDefn(_("Numéro"), "centre", 60, "numero", typeDonnee="entier", stringConverter=FormateNumero),
            ColumnDefn(_("Famille"), "left", 180, "nomsTitulaires", typeDonnee="texte"),
            ColumnDefn(_("Date début"), "centre", 75, "date_debut", typeDonnee="date", stringConverter=FormateDate),
            ColumnDefn(_("Date fin"), "centre", 75, "date_fin", typeDonnee="date", stringConverter=FormateDate),
            ColumnDefn(_("Total"), "right", 65, "total", typeDonnee="montant", stringConverter=FormateMontant),
            ColumnDefn(_("Réglé"), "right", 65, "regle", typeDonnee="montant", stringConverter=FormateMontant),
            ColumnDefn(_("Solde"), "right", 65, "solde", typeDonnee="montant", stringConverter=FormateMontant),
        ])
        self.SetSortColumn(self.columns[1])
        self.SetEmptyListMsg(_("Aucune attestation de présence"))
...
##        item = wx.MenuItem(menuPop, 60, _("Rééditer la facture (PDF)"))
...
##        menuPop.AppendSeparator()
        ...
        self.GenerationContextMenu(menuPop, titre=_("Liste des attestations de présence"))
...
##        if len(self.Selection()) == 0 :
##            dlg = wx.MessageDialog(self, _("Vous n'avez sélectionné aucune facture à rééditer !"), _("Erreur de saisie"), wx.OK | wx.ICON_EXCLAMATION)
##            dlg.ShowModal()
##            dlg.Destroy()
##            return
...
##        CTRL_Facturation_factures.Reedition(IDfacture)
    ...
    def Supprimer(self, event):
        ...
        if len(self.Selection()) == 0 :
            dlg = wx.MessageDialog(self, _("Vous n'avez sélectionné aucune attestation à supprimer dans la liste"), _("Erreur de saisie"), wx.OK | wx.ICON_EXCLAMATION)
            dlg.ShowModal()
            dlg.Destroy()
            return
        ...
        dlg = wx.MessageDialog(self, _("Souhaitez-vous vraiment supprimer l'attestation n°%d ?") % numero, _("Suppression"), wx.YES_NO|wx.NO_DEFAULT|wx.CANCEL|wx.ICON_INFORMATION)
        ...
        dlg = wx.MessageDialog(self, _("Attestation supprimée !"), _("Suppression"), wx.OK | wx.ICON_INFORMATION)
        dlg.ShowModal()
        dlg.Destroy()
...
class BarreRecherche(wx.SearchCtrl):
    def __init__(self, parent):
        ...
        self.SetDescriptiveText(_("Rechercher une attestation de présence..."))
