...
class ListView(FastObjectListView):
    ...
    def InitObjectListView(self):
        ...
        liste_Colonnes = [
            ...
            ColumnDefn(_("Prévision"), 'center', 90, "duree_prevision", typeDonnee="duree", stringConverter=FormateDuree),
            ColumnDefn(_("Présence"), 'center', 90, "duree_presence", typeDonnee="duree", stringConverter=FormateDuree),
            ColumnDefn(_("Abs déduc."), 'center', 90, "heures_absences_deductibles", typeDonnee="duree", stringConverter=FormateDuree),
            ColumnDefn(_("Abs non déduc."), 'center', 90, "heures_absences_non_deductibles", typeDonnee="duree", stringConverter=FormateDuree),
    ...
    def Apercu(self, event):
        ...
        prt = UTILS_Printer.ObjectListViewPrinter(self, titre=_("Détail de la mensualité"), intro=self.GetIntro(), format="A", orientation=wx.LANDSCAPE)
        prt.Preview()
    ...
    def ExportTexte(self, event):
        ...
        UTILS_Export.ExportTexte(self, titre=_("Détail de la mensualité"), autoriseSelections=False)
        
    def ExportExcel(self, event):
        from Utils import UTILS_Export
        UTILS_Export.ExportExcel(self, titre=_("Détail de la mensualité"), autoriseSelections=False)
