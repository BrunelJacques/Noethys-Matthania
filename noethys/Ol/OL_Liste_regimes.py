...
class ListView(FastObjectListView):
    ...
    def InitObjectListView(self):            
        ...
        liste_Colonnes = [
            ...
            ColumnDefn(_("Régime"), "left", 90, "nomRegime", typeDonnee="texte"),
            ColumnDefn(_("Caisse"), "left", 120, "nomCaisse", typeDonnee="texte"),
            ColumnDefn(_("Numéro Alloc."), "left", 110, "numAlloc", typeDonnee="texte"),
    ...
    def Impression(self, mode="preview"):
        ...
        prt = UTILS_Printer.ObjectListViewPrinter(self, titre=_("Liste des régimes et caisses"), intro=intro, total=total, format="A", orientation=wx.PORTRAIT)
        if mode == "preview" :
            prt.Preview()
        else:
            prt.Print()
    ...
    def ExportTexte(self, event):
        ...
        UTILS_Export.ExportTexte(self, titre=_("Liste des régimes et caisses"))

    def ExportExcel(self, event):
        from Utils import UTILS_Export
        UTILS_Export.ExportExcel(self, titre=_("Liste des régimes et caisses"))
