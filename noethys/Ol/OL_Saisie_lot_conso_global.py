...
class ListView(FastObjectListView):
    ...
    def GetTracks(self):
        ...
        WHERE (NOT inscriptions.statut LIKE 'ko%%') AND inscriptions.IDactivite=%d
        ;""" % self.IDactivite
        DB.ExecuterReq(req,MsgBox="ExecuterReq")
    ...
    def InitObjectListView(self):
        ...
        listeColonnes = [
            ...
            ColumnDefn(_(""), "left", 20, "statut", typeDonnee="texte", imageGetter=GetImageStatut),
            ColumnDefn(_("Individu"), "left", 170, "nomCompletIndividu", typeDonnee="texte"),
            ColumnDefn(_("Famille"), "left", 250, "titulaires", typeDonnee="texte"),
            ColumnDefn(_("Groupe"), "left", 120, "nomGroupe", typeDonnee="texte"),
            ColumnDefn(_("Catégorie de tarif"), "left", 150, "nom_categorie_tarif", typeDonnee="texte"),
            ]
    ...
    def Apercu(self, event):
        ...
        prt = UTILS_Printer.ObjectListViewPrinter(self, titre=_("Liste des individus"), format="A", orientation=wx.PORTRAIT)
        prt.Preview()
    ...
    def ExportTexte(self, event):
        ...
        UTILS_Export.ExportTexte(self, titre=_("Liste des individus"))
        
    def ExportExcel(self, event):
        from Utils import UTILS_Export
        UTILS_Export.ExportExcel(self, titre=_("Liste des individus"))
...
class ListviewAvecFooter(PanelAvecFooter):
    def __init__(self, parent, kwargs={}):
        dictColonnes = {
            "nomCompletIndividu" : {"mode" : "nombre", "singulier" : _("individu"), "pluriel" : _("individus"), "alignement" : wx.ALIGN_CENTER},
