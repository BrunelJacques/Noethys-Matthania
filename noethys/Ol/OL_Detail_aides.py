...
class ListView(FastObjectListView):
    ...
    def InitObjectListView(self):            
        ...
        liste_Colonnes = [
            ...
            ColumnDefn(_("Date"), 'centre', 160, "date", typeDonnee="date", stringConverter=FormateDateLong),
            ColumnDefn(_("Individu"), 'centre', 90, "prenomIndividu", typeDonnee="texte"),
            ColumnDefn(_("Montant"), 'centre', 70, "montant", typeDonnee="montant", stringConverter=FormateMontant),
            ColumnDefn(_("Label"), 'left', 160, "label", typeDonnee="texte"),
            ColumnDefn(_("Prestation"), 'left', 300, "textePrestation", typeDonnee="texte"),
            ]
...
##        menuPop.AppendSeparator()
    ...
    def Apercu(self, event):
        ...
        prt = UTILS_Printer.ObjectListViewPrinter(self, titre=_("Liste des déductions"), format="A", orientation=wx.LANDSCAPE)
        prt.Preview()
    ...
    def Supprimer(self, event):
        ...
        montant = self.Selection()[0].montant
        IDprestation = self.Selection()[0].IDprestation
        dlg = wx.MessageDialog(self, _("Souhaitez-vous vraiment supprimer cette déduction ?"), _("Suppression"), wx.YES_NO|wx.NO_DEFAULT|wx.CANCEL|wx.ICON_INFORMATION)
...
class BarreRecherche(wx.SearchCtrl):
    def __init__(self, parent):
        ...
        self.SetDescriptiveText(_("Rechercher une déduction..."))
