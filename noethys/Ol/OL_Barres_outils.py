...
class ListView(FastObjectListView):
    ...
    def InitObjectListView(self):        
        ...
        liste_Colonnes = [
            ColumnDefn(_("Nom"), 'left', 200, "label"),
            ColumnDefn(_("Nbre éléments"), "left", 90, "nbreElements"),
            ColumnDefn(_("Observations"), "left", 250, "observations"),
            ]
        
        self.SetColumns(liste_Colonnes)
        self.CreateCheckStateColumn(0)
        self.SetEmptyListMsg(_("Aucune barre d'outils"))
    ...
    def Impression(self, mode="preview"):
        ...
        prt = UTILS_Printer.ObjectListViewPrinter(self, titre=_("Liste des barres d'outils"), intro="", total="", format="A", orientation=wx.LANDSCAPE)
        if mode == "preview" :
            prt.Preview()
        else:
            prt.Print()
    ...
    def ExportTexte(self, event):
        ...
        UTILS_Export.ExportTexte(self, titre=_("Liste des barres d'outils"))
        
    def ExportExcel(self, event):
        from Utils import UTILS_Export
        UTILS_Export.ExportExcel(self, titre=_("Liste des barres d'outils"))
    ...
    def Modifier(self, event=None):
        if len(self.Selection()) == 0 :
            dlg = wx.MessageDialog(self, _("Vous n'avez sélectionné aucune barre d'outils à modifier dans la liste"), _("Erreur de saisie"), wx.OK | wx.ICON_EXCLAMATION)
            dlg.ShowModal()
            dlg.Destroy()
            return
    ...
    def Supprimer(self, event=None):
        ...
        dlg = wx.MessageDialog(self, _("Souhaitez-vous vraiment supprimer la barre d'outils '%s' ?") % track.label, _("Suppression"), wx.YES_NO|wx.NO_DEFAULT|wx.CANCEL|wx.ICON_QUESTION)
...
class MyFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        listeBarres = [
            "barre_perso_111###Ma barre 1###observations###textedroite###notes_versions;|;licence_logiciel;-;tutoriels_videos",
            "barre_perso_222###Ma barre 2###bservations###textedroite###notes_versions;|;licence_logiciel;-;tutoriels_videos",
            "barre_perso_333###Ma barre 3###bservations###textedroite###notes_versions;|;licence_logiciel;-;tutoriels_videos"
            ] 
